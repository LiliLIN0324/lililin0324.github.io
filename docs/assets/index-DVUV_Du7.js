...
import{r as i,j as e,A as Qe,m as je,L as te,u as et,M as tt,a as nt,b as at,g as Re,c as rt,d as st,R as it,e as B,H as ot,f as lt}from"./vendor-crHWKeSW.js";import{m as pe}from"./maplibre-BkiGPtbL.js";import{U as ze,L as dt,D as ct,R as ut,M as mt,C as ht,a as pt,b as gt,X as Ge,c as Fe}from"./icons-CgSqI4NK.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))d(o);new MutationObserver(o=>{for(const j of o)if(j.type==="childList")for(const k of j.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&d(k)}).observe(document,{childList:!0,subtree:!0});function I(o){const j={};return o.integrity&&(j.integrity=o.integrity),o.referrerPolicy&&(j.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?j.credentials="include":o.crossOrigin==="anonymous"?j.credentials="omit":j.credentials="same-origin",j}function d(o){if(o.ep)return;o.ep=!0;const j=I(o);fetch(o.href,j)}})();function ft({onFinish:v}){const[s,I]=i.useState(!0),d=i.useRef(null),o=i.useRef({x:-1e3,y:-1e3});return i.useEffect(()=>{const j=d.current;if(!j)return;const k=j.getContext("2d");if(!k)return;let c,g=[];const E=()=>{j.width=window.innerWidth,j.height=window.innerHeight},N=t=>{o.current={x:t.clientX,y:t.clientY}},R=t=>{t.touches.length>0&&(o.current={x:t.touches[0].clientX,y:t.touches[0].clientY})};window.addEventListener("resize",E),window.addEventListener("mousemove",N),window.addEventListener("touchmove",R),E();class n{constructor(){this.x=Math.random()*j.width,this.y=Math.random()*j.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>j.width)&&(this.vx*=-1),(this.y<0||this.y>j.height)&&(this.vy*=-1);let r=o.current.x-this.x,b=o.current.y-this.y,_=Math.sqrt(r*r+b*b),L=r/_,H=b/_;const F=150;let P=(F-_)/F;_<F&&(this.x-=L*P*this.density*.5,this.y-=H*P*this.density*.5)}draw(){k&&(k.fillStyle="rgba(255, 255, 255, 0.8)",k.beginPath(),k.arc(this.x,this.y,this.size,0,Math.PI*2),k.fill())}}for(let t=0;t<120;t++)g.push(new n);const h=()=>{k.clearRect(0,0,j.width,j.height);for(let t=0;t<g.length;t++){g[t].update(),g[t].draw();for(let r=t+1;r<g.length;r++){const b=g[t].x-g[r].x,_=g[t].y-g[r].y,L=Math.sqrt(b*b+_*_);L<100&&(k.beginPath(),k.strokeStyle=`rgba(255, 255, 255, ${.2*(1-L/100)})`,k.lineWidth=.6,k.moveTo(g[t].x,g[t].y),k.lineTo(g[r].x,g[r].y),k.stroke())}}c=requestAnimationFrame(h)};return h(),()=>{cancelAnimationFrame(c),window.removeEventListener("resize",E),window.removeEventListener("mousemove",N),window.removeEventListener("touchmove",R)}},[]),e.jsx(Qe,{onExitComplete:v,children:s&&e.jsxs(je.div,{onClick:()=>I(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:d,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(je.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(je.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const xt=`---
id: "01"
...
`;function Ut(v){const s=/^---\r?\n([\s\S]*?)\r?\n---/,I=v.match(s);let d={},o=v;if(I){const j=I[1];o=v.slice(I[0].length).trim();const k=j.split(/\r?\n/);let c=null,g=[];k.forEach(E=>{if(E.trim()==="")return;const R=E.indexOf(":");if(R!==-1&&!E.startsWith(" ")){c&&(d[c]=g.join(`
`)),c=E.slice(0,R).trim();let n=E.slice(R+1).trim();n==="|"?g=[]:(d[c]=n,c=null,g=[])}else c&&E.startsWith("  ")&&g.push(E.slice(2))}),c&&g.length>0&&(d[c]=g.join(`
`)),Object.keys(d).forEach(E=>{let N=d[E];if(typeof N=="string")if(N=N.trim(),N.startsWith('"')&&N.endsWith('"')&&(N=N.slice(1,-1)),N.startsWith("[")&&N.endsWith("]"))try{d[E]=JSON.parse(N)}catch{d[E]=[N.slice(1,-1).trim()]}else N==="true"?d[E]=!0:N==="false"?d[E]=!1:!isNaN(Number(N))&&N.trim()!==""?d[E]=Number(N):d[E]=N})}return{id:d.id||"",slug:d.slug||"",title:d.title||"",category:d.category||"",year:d.year||"",description:d.description||"",tech:d.tech||[],abstract:d.abstract||"",challenge:d.challenge||"",solution:d.solution||"",hasDemo:d.hasDemo||!1,icon:d.icon||"",code:d.code||"",logo:d.icon||"",image:d.image||[],content:o}}function G(v){const s=Ut(v);return{id:s.id,slug:s.slug,title:s.title,category:s.category,year:s.year,description:s.description,tech:s.tech,hasDemo:s.hasDemo,details:{abstract:s.abstract,description:s.description,challenge:s.challenge,solution:s.solution,logo:s.logo,icon:s.icon,code:s.code,image:s.image,content:s.content}}}const Ne=[G(xt),G(bt),G(yt),G(vt),G(jt),G(wt)],Me=[G(kt),G(Nt),G(Mt),G(St),G(Lt),G(Dt),G(It)],Se=[G(Ct),G(At)],Le=[G(Et),G(Tt),G(Pt)],De=[G(_t),G(Rt),G(zt),G(Gt),G(Ft),G(Bt),G(Ot)],ce=({data:v,type:s})=>{const[I,d]=i.useState("grid");return e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8",children:[e.jsxs("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:["Selected ",s==="research"?"Researches":s==="design"?"Designs":s==="game"?"Games":s==="planning"?"Planning":s==="tutorials"?"Tutorials":"Platform"]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>d("grid"),className:`px-3 py-1 text-xs font-mono ${I==="grid"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"GRID"}),e.jsx("button",{onClick:()=>d("list"),className:`px-3 py-1 text-xs font-mono ${I==="list"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"LIST"})]}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Idx: ",v.length]})]})]}),I==="list"?e.jsx("div",{className:"space-y-4",children:v.map(o=>e.jsx("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-4 md:p-6 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm",children:e.jsxs("div",{className:"flex flex-row gap-4 md:gap-6 items-center flex-1",children:[e.jsxs(te,{to:`/${s}/${o.slug}`,className:"flex-grow min-w-0 w-full flex flex-row gap-4 md:gap-6 items-center",children:[e.jsx("div",{className:"flex-shrink-0 w-16 h-16 md:w-20 md:h-20 border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800",children:o.details.logo?e.jsx("img",{src:o.details.logo,alt:o.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-8 h-8",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",o.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:o.year})]}),e.jsx("h3",{className:"text-base md:text-lg lg:text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 truncate",children:o.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-sm line-clamp-1",children:o.description})]})]}),o.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${o.slug}#demo`},className:"flex-shrink-0 px-3 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]})},o.slug))}):e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6",children:v.map(o=>e.jsxs("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-4 md:p-6 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm flex flex-col",children:[e.jsxs(te,{to:`/${s}/${o.slug}`,className:"flex flex-col h-full",children:[e.jsx("div",{className:"flex-shrink-0 w-full aspect-square border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800 mb-4",children:o.details.logo?e.jsx("img",{src:o.details.logo,alt:o.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-12 h-12",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",o.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:o.year})]}),e.jsx("h3",{className:"text-base md:text-lg font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 line-clamp-2",children:o.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-sm line-clamp-2",children:o.description})]})]}),o.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${o.slug}#demo`},className:"flex-shrink-0 w-full mt-4 px-3 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]},o.slug))})]})},ge=v=>{const s=document.getElementById(v);s&&s.scrollIntoView({behavior:"smooth",block:"start"})},Vt="modulepreload",Ht=function(v,s){return new URL(v,s).href},Be={},O=function(s,I,d){let o=Promise.resolve();if(I&&I.length>0){let k=function(N){return Promise.all(N.map(R=>Promise.resolve(R).then(n=>({status:"fulfilled",value:n}),n=>({status:"rejected",reason:n}))))};const c=document.getElementsByTagName("link"),g=document.querySelector("meta[property=csp-nonce]"),E=(g==null?void 0:g.nonce)||(g==null?void 0:g.getAttribute("nonce"));o=k(I.map(N=>{if(N=Ht(N,d),N in Be)return;Be[N]=!0;const R=N.endsWith(".css"),n=R?'[rel="stylesheet"]':"";if(!!d)for(let r=c.length-1;r>=0;r--){const b=c[r];if(b.href===N&&(!R||b.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${N}"]${n}`))return;const t=document.createElement("link");if(t.rel=R?"stylesheet":Vt,R||(t.as="script"),t.crossOrigin="",t.href=N,E&&t.setAttribute("nonce",E),document.head.appendChild(t),R)return new Promise((r,b)=>{t.addEventListener("load",r),t.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${N}`)))})}))}function j(k){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=k,window.dispatchEvent(c),!c.defaultPrevented)throw k}return o.then(k=>{for(const c of k||[])c.status==="rejected"&&j(c.reason);return s().catch(j)})},Wt=i.lazy(()=>O(()=>import("./ClusterVisualizer-wcGO4Osm.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),$t=i.lazy(()=>O(()=>import("./UR-platform-Cu-r45u-.js"),__vite__mapDeps([6,1,2,3,4,5]),import.meta.url)),qt=i.lazy(()=>O(()=>import("./heatmapper-CXmUYFv5.js"),__vite__mapDeps([7,1,2,3,4]),import.meta.url)),Kt=i.lazy(()=>O(()=>import("./openstreetmap-BSxgW8Dt.js"),__vite__mapDeps([8,1,2,3,4,5]),import.meta.url)),Xt=i.lazy(()=>O(()=>import("./photogeo-BT_AJHmu.js"),__vite__mapDeps([9,1,2,3,4]),import.meta.url)),Zt=i.lazy(()=>O(()=>import("./photogeomap-DRPoeAt9.js"),__vite__mapDeps([10,1,2,3,4]),import.meta.url)),Yt=i.lazy(()=>O(()=>import("./clusteringevents-D3zghNTm.js"),__vite__mapDeps([11,1,2,3,4]),import.meta.url));i.lazy(()=>O(()=>import("./litflow-3_s9HW8y.js"),__vite__mapDeps([12,1,2,3,4]),import.meta.url));const Jt=i.lazy(()=>O(()=>import("./boxupcyberspace-GUt7T_Ci.js"),__vite__mapDeps([13,1,2,3,4]),import.meta.url)),Qt=i.lazy(()=>O(()=>import("./epsteinscret-CA1xk4Lo.js"),__vite__mapDeps([14,1,2,3,4]),import.meta.url)),en=i.lazy(()=>O(()=>import("./wechatgame-Cv9iwI3m.js"),__vite__mapDeps([15,1,2,3,4]),import.meta.url)),tn=i.lazy(()=>O(()=>import("./riffle-D84mkK7n.js"),__vite__mapDeps([16,1,2,3,4]),import.meta.url)),nn=i.lazy(()=>O(()=>import("./genstyle-GYPDpE_-.js"),__vite__mapDeps([17,1,2,3,4]),import.meta.url)),an=i.lazy(()=>O(()=>import("./genshot-Dx8CE5Ld.js"),__vite__mapDeps([18,1,2,3,4]),import.meta.url)),rn=v=>({"cluster-visualizer-3d":Wt,"participatory-urban-regeneration-empowered-by-artificial-intelligence":$t,heatmapper:qt,"how-to-add-openstreetmap-in-website":Kt,"how-to-get-sequential-events-from-photo-by-phone":Xt,"how-to-visualize-photo-geolocation-data-on-map":Zt,"how-to-build-game-in-wechat-mini-program":en,"how-to-conduct-time-geo-sequential-clustering-from-album":Yt,"box-up-my-stuff-in-cyberspace":Jt,"epstein-mystery-archive":Qt,"riffle-ai-game-generation-tool":tn,genstyle:nn,"genshot-AI-video-generation-tool":an})[v],we={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
...
}`},sn=({src:v,...s})=>{const[I,d]=i.useState(!1),[o,j]=i.useState(!1),k=()=>{d(!0),j(!0)},c=()=>{d(!1),j(!0)};return i.useEffect(()=>{const g=setTimeout(()=>{o||(d(!1),j(!0))},3e3);return()=>clearTimeout(g)},[o]),e.jsxs(e.Fragment,{children:[e.jsx("iframe",{src:v,onLoad:k,onError:c,style:{display:"none"},title:"detector"}),!o&&e.jsx("div",{className:"w-full my-4",children:e.jsxs("a",{href:v,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-600 hover:bg-neutral-100 transition-colors",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"访问链接"]})}),o&&I&&e.jsx("div",{className:"w-full my-6",children:e.jsx("iframe",{src:v,className:"w-full h-96 rounded-lg shadow-md border border-neutral-200",allowFullScreen:!0,...s})}),o&&!I&&e.jsx("div",{className:"w-full my-4",children:e.jsxs("a",{href:v,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-600 hover:bg-neutral-100 transition-colors",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"访问链接"]})})]})},ue=({data:v,type:s})=>{var R;const{id:I}=et(),[d,o]=i.useState("details"),[j,k]=i.useState(!1),c=v.find(n=>n.slug===I),g=n=>{const h=/^(#{1,6})\s+(.+)$/gm,t=[];let r;for(;(r=h.exec(n))!==null;){const b=r[1].length,_=r[2].trim(),L=_.toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");t.push({level:b,text:_,id:L})}return t},E=(R=c==null?void 0:c.details)!=null&&R.content?g(c.details.content):[],N=n=>{const h=document.getElementById(n);h&&h.scrollIntoView({behavior:"smooth",block:"start"})};return i.useEffect(()=>{const n=()=>{window.location.hash.includes("demo")?o("demo"):o("details")};return n(),window.addEventListener("hashchange",n),()=>window.removeEventListener("hashchange",n)},[I]),c?e.jsxs("div",{className:"flex flex-col animate-in slide-in-from-right-4 duration-500 h-screen",children:[e.jsxs("div",{className:"sticky top-0 z-5 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-800 px-4 md:px-6 py-3 md:py-4 flex justify-between items-center shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-4 md:gap-6",children:[e.jsx(te,{to:`/${s}`,className:"flex items-center gap-2 text-xs font-mono text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors uppercase tracking-wider",children:"← Index"}),e.jsx("div",{className:"h-4 w-px bg-neutral-200 dark:bg-neutral-700 hidden md:block"}),e.jsx("h2",{className:"text-xs md:text-sm font-bold text-neutral-900 dark:text-neutral-100 truncate max-w-[120px] md:max-w-[200px]",children:c.title})]}),e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>o("details"),className:`px-2 md:px-3 py-1 text-xs font-mono ${d==="details"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"DOCS"}),c.hasDemo&&e.jsxs("button",{onClick:()=>o("demo"),className:`px-2 md:px-3 py-1 text-xs font-mono flex items-center gap-2 ${d==="demo"?"bg-white dark:bg-neutral-700 text-blue-600 dark:text-blue-400 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:[e.jsxs("span",{className:"relative flex h-2 w-2",children:[e.jsx("span",{className:"animate-ping absolute h-full w-full rounded-full bg-blue-400 opacity-75"}),e.jsx("span",{className:"relative rounded-full h-2 w-2 bg-blue-500"})]}),"DEMO"]})]})]}),e.jsx("div",{className:`flex-1 ${d==="details"?"overflow-y-auto":"overflow-hidden"}`,children:d==="details"?e.jsxs("div",{className:"flex flex-col p-4 md:p-6 lg:p-10 w-full h-full max-w-7xl mx-auto",children:[e.jsxs("div",{className:"mb-8 md:mb-10",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:c.tech.map((n,h)=>e.jsx("span",{className:"px-2 py-1 text-xs font-mono bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700 rounded-sm",children:n},h))}),e.jsxs("div",{className:"flex items-center gap-4 text-sm text-neutral-500 dark:text-neutral-400 mb-4",children:[e.jsxs("span",{className:"font-mono text-xs uppercase tracking-wide",children:["NO. ",c.id]}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("span",{children:c.year}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("span",{children:c.category})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-light mb-6 text-neutral-900 dark:text-neutral-100 tracking-tight",children:c.title}),e.jsx("div",{className:"bg-gradient-to-r from-neutral-50 dark:from-neutral-800 to-white dark:to-neutral-900 border-l-4 border-neutral-900 dark:border-neutral-500 p-6 md:p-8 rounded-r-lg",children:e.jsxs("p",{className:"font-serif text-base md:text-lg text-neutral-700 dark:text-neutral-300 leading-relaxed italic",children:['"',c.description,'"']})})]}),e.jsxs("div",{className:"grid md:grid-cols-12 gap-6 md:gap-8 w-full flex-grow",children:[e.jsxs("div",{className:"md:col-span-12 lg:col-span-8 space-y-8 md:space-y-10",children:[c.details.abstract&&e.jsxs("section",{id:"abstract",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Abstract"}),e.jsx("p",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 whitespace-normal",children:c.details.abstract})]}),c.details.challenge&&e.jsxs("section",{id:"challenges",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Challenges"}),e.jsx("p",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 whitespace-normal",children:c.details.challenge})]}),c.details.solution&&e.jsxs("section",{id:"methodology",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Methodology"}),e.jsx("p",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 whitespace-normal",children:c.details.solution})]}),c.details.content&&e.jsxs("section",{id:"content",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Content"}),e.jsx("div",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 prose prose-neutral dark:prose-invert max-w-none",children:e.jsx(tt,{remarkPlugins:[at],rehypePlugins:[nt],components:{table:({children:n})=>e.jsx("table",{className:"min-w-full border-collapse border border-neutral-300 dark:border-neutral-600",children:n}),thead:({children:n})=>e.jsx("thead",{className:"bg-neutral-50 dark:bg-neutral-800",children:n}),th:({children:n})=>e.jsx("th",{className:"border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-left font-semibold text-neutral-900 dark:text-neutral-100 text-sm",children:n}),td:({children:n})=>e.jsx("td",{className:"border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-neutral-700 dark:text-neutral-300 text-sm",children:n}),h1:({children:n,...h})=>{const r=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h1",{id:r,className:"text-2xl font-bold mb-4 text-neutral-900 dark:text-neutral-100",...h,children:n})},h2:({children:n,...h})=>{const r=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h2",{id:r,className:"text-xl font-bold mb-6 mt-8 text-neutral-800 dark:text-neutral-200",...h,children:n})},h3:({children:n,...h})=>{const r=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h3",{id:r,className:"text-lg font-semibold mb-4 mt-6 text-neutral-800 dark:text-neutral-200",...h,children:n})},h4:({children:n,...h})=>{const r=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h4",{id:r,className:"text-base font-semibold mb-3 mt-4 text-neutral-700 dark:text-neutral-300",...h,children:n})},h5:({children:n,...h})=>{const r=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h5",{id:r,className:"text-sm font-semibold mb-2 mt-3 text-neutral-700 dark:text-neutral-300",...h,children:n})},h6:({children:n,...h})=>{const r=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h6",{id:r,className:"text-xs font-semibold mb-2 mt-2 text-neutral-600 dark:text-neutral-400",...h,children:n})},p:({children:n,...h})=>e.jsx("p",{className:"mb-4 leading-relaxed",...h,children:n}),a:({children:n,href:h,...t})=>e.jsx("a",{href:h,className:"text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline decoration-1 hover:decoration-2 transition-all duration-200 font-medium",target:"_blank",rel:"noopener noreferrer",...t,children:n}),img:({src:n,alt:h,...t})=>{var b;return((b=t.className)==null?void 0:b.includes("h-32"))||(h==null?void 0:h.includes("BCR"))||(h==null?void 0:h.includes("BHV"))||(h==null?void 0:h.includes("SVF"))||(h==null?void 0:h.includes("NDVI"))||(h==null?void 0:h.includes("EV"))||(h==null?void 0:h.includes("WR"))||(h==null?void 0:h.includes("Dist_"))?e.jsx("img",{src:n,alt:h,className:"max-w-full h-32 object-cover rounded-lg shadow-sm",...t}):e.jsx("img",{src:n,alt:h,className:"w-full max-w-full h-auto rounded-lg shadow-md my-6",...t})},iframe:({src:n,title:h,...t})=>e.jsx(sn,{src:n,title:h||"Embedded content",...t})},children:c.details.content})})]}),(c.details.code||c.details.codeComponent||we[c.slug])&&e.jsxs("section",{id:"code",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Code Example"}),e.jsx("div",{className:"bg-neutral-900 dark:bg-neutral-800 text-neutral-100 dark:text-neutral-100 p-6 rounded-lg overflow-x-auto",children:e.jsx("pre",{className:"text-sm font-mono leading-relaxed",children:e.jsx("code",{children:we[c.slug]||c.details.codeComponent||`// Code file: ${c.details.code}`})})})]})]}),e.jsx("div",{className:"md:col-span-12 lg:col-span-4 hidden lg:block",children:e.jsxs("div",{className:"sticky top-24 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg overflow-hidden",children:[e.jsxs("div",{className:"flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-700",children:[e.jsx("h3",{className:"text-xs font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500",children:"Contents"}),e.jsx("button",{onClick:()=>k(!j),className:"text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors",children:e.jsx("svg",{className:`w-4 h-4 transform transition-transform ${j?"rotate-90":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),e.jsx("div",{className:`${j?"max-h-0":"max-h-96"} overflow-hidden transition-all duration-300`,children:e.jsxs("div",{className:"p-4 space-y-2 overflow-y-auto max-h-80",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx("h4",{className:"text-xs font-mono text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-2",children:"Overview"}),c.details.abstract&&e.jsx("button",{onClick:()=>ge("abstract"),className:"text-sm text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-white dark:hover:bg-neutral-700 px-2 py-1 rounded transition-all w-full text-left text-left",children:"Abstract"})]}),E.length>0&&e.jsxs("div",{className:"space-y-1 mt-4",children:[e.jsx("h4",{className:"text-xs font-mono text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-2",children:"Content Sections"}),E.map((n,h)=>e.jsx("button",{onClick:()=>N(n.id),className:`text-sm hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-white dark:hover:bg-neutral-700 px-2 py-1 rounded transition-all w-full text-left block ${n.level===1?"font-semibold text-neutral-800 dark:text-neutral-200":n.level===2?"font-medium text-neutral-700 dark:text-neutral-300 ml-2":n.level===3?"text-neutral-600 dark:text-neutral-400 ml-4":n.level===4?"text-neutral-600 dark:text-neutral-400 ml-6":n.level===5?"text-neutral-500 dark:text-neutral-500 ml-8":"text-neutral-500 dark:text-neutral-500 ml-10"}`,children:n.text},h))]}),e.jsxs("div",{className:"space-y-1 mt-4",children:[e.jsx("h4",{className:"text-xs font-mono text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-2",children:"Methodology"}),c.details.solution&&e.jsx("button",{onClick:()=>ge("methodology"),className:"text-sm text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-white dark:hover:bg-neutral-700 px-2 py-1 rounded transition-all w-full text-left",children:"Approach"}),c.details.challenge&&e.jsx("button",{onClick:()=>ge("challenges"),className:"text-sm text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-white dark:hover:bg-neutral-700 px-2 py-1 rounded transition-all w-full text-left",children:"Challenges"})]}),e.jsxs("div",{className:"space-y-1 mt-4",children:[e.jsx("h4",{className:"text-xs font-mono text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-2",children:"Resources"}),(c.details.code||c.details.codeComponent||we[c.slug])&&e.jsx("button",{onClick:()=>ge("code"),className:"text-sm text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-white dark:hover:bg-neutral-700 px-2 py-1 rounded transition-all w-full text-left",children:"Code Example"})]})]})})]})})]})]}):e.jsx("div",{className:"w-full h-full bg-neutral-100 dark:bg-neutral-900 relative",children:e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"absolute inset-0 flex items-center justify-center text-neutral-400 dark:text-neutral-500 font-mono",children:"Loading demo..."}),children:(()=>{const n=rn(c.slug);return n?e.jsx(n,{}):e.jsx("div",{className:"absolute inset-0 flex items-center justify-center text-neutral-400 dark:text-neutral-500 font-mono",children:"DEMO NOT AVAILABLE"})})()})})})]}):e.jsx("div",{className:"p-4 md:p-10 font-mono",children:"PROJECT_NOT_FOUND"})},on=()=>e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100 border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8",children:"About Me"}),e.jsxs("div",{className:"font-light text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed max-w-none",children:[e.jsxs("p",{className:"text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 md:mb-6 font-light",children:["I am Lili Lin, a Master's student at Seoul National University in the City Energy Lab, where my research focuses on ",e.jsx("span",{className:"font-medium border-b border-neutral-300 dark:border-neutral-600",children:"AI-assisted urban planning"}),", especially on ",e.jsx("span",{className:"font-medium border-b border-neutral-300 dark:border-neutral-600",children:"urban heat environments"}),". I received my Bachelor's degree in Architecture from Huazhong University of Science and Technology."]}),e.jsx("p",{className:"text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 md:mb-6 font-light",children:"In my current researches, I use machine learning models and statistic analysis to understand how environmental factors influence climate-related risks. Using Landsat 8 and spatial regression to quantified how Local Climate Zones affect urban heat resilience in NYC and LA; Examined the MAUP problem using GBDT and PDP analyses to reveal non-linear relationships between urban form, land cover, and heat exposure across multiple spatial scales in Seoul."}),e.jsxs("p",{className:"text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 md:mb-6 font-light",children:["I am also ",e.jsx("span",{className:"font-medium border-b border-neutral-300 dark:border-neutral-600",children:"UI&UX designer and front-end developer"})," passionate about creating intuitive digital experiences. I have designed and developed several web applications and design systems. My technical skills include React, TypeScript, Three.js, Figma."]}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-8 md:mt-12 border-t border-neutral-100 dark:border-neutral-800 pt-6 md:pt-8",children:e.jsxs("div",{children:[e.jsx("h4",{className:"font-mono text-xs text-neutral-400 dark:text-neutral-500 uppercase mb-4",children:"Core Competencies"}),e.jsxs("ul",{className:"space-y-2 text-sm text-neutral-700 dark:text-neutral-300",children:[e.jsx("li",{children:"Urban Climate & Resilience"}),e.jsx("li",{children:"AI-Assisted Urban Planning"}),e.jsx("li",{children:"Machine Learning & Data Analysis"}),e.jsx("li",{children:"Spatial Statistics & GIS"}),e.jsx("li",{children:"React / Next.js ecosystem"}),e.jsx("li",{children:"TypeScript Architecture"}),e.jsx("li",{children:"WebGL / Three.js"}),e.jsx("li",{children:"UI Systems Design"})]})]})})]})]}),ln=()=>e.jsxs("div",{className:"h-full flex flex-col justify-center items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500",children:[e.jsx("div",{className:"w-16 h-16 border border-neutral-300 dark:border-neutral-600 flex items-center justify-center mb-6 text-2xl rotate-45 hover:rotate-90 transition-transform duration-500",children:"✉️"}),e.jsx("h2",{className:"text-3xl font-bold text-neutral-900 dark:text-neutral-100 mb-4",children:"CONTACT_FOR_COLLABORATION"}),e.jsx("a",{href:"mailto:lily1326685527@gmail.com?subject=Research%20Collaboration",className:"bg-neutral-900 dark:bg-neutral-700 text-white px-8 py-3 text-sm font-mono hover:bg-neutral-700 dark:hover:bg-neutral-600 transition-colors",children:"SEND_TRANSMISSION"})]}),ke=({href:v,label:s})=>e.jsx("a",{href:v,target:"_blank",rel:"noopener noreferrer",className:"w-8 h-8 flex items-center justify-center border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all rounded-sm text-xs font-mono",children:s}),dn=()=>{const v=[...Ne.map(t=>({...t,type:"planning"})),...Me.map(t=>({...t,type:"design"})),...Se.map(t=>({...t,type:"game"})),...Le.map(t=>({...t,type:"platform"})),...De.map(t=>({...t,type:"tutorial"}))],[s,I]=i.useState(0),d=v.length-1,[o,j]=i.useState(0),k=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260305-222003.mp4",title:"Welcome to My Portfolio",subtitle:"Explore my projects in urban planning, design, game development, and AI tutorials."},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260304_heatmap_2.mp4",title:"Data Visualization",subtitle:"Interactive heatmaps and spatial analysis for urban research."}],[c,g]=i.useState(0),[E,N]=i.useState({}),R=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/%E5%BE%AE%E4%BF%A1%E8%A7%86%E9%A2%912026-02-09_184301_354.mp4",title:"Video Title 1"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260225-192100.mp4",title:"Video Title 2"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video3.mp4",title:"Video Title 3"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video4.mp4",title:"Video Title 4"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video5.mp4",title:"Video Title 5"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video6.mp4",title:"Video Title 6"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video7.mp4",title:"Video Title 7"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video8.mp4",title:"Video Title 8"}],n=(t,r)=>{var L,H;const b=t;if(console.log(`Checking audio for video ${r}:`,{audioTracks:(L=b.audioTracks)==null?void 0:L.length,mozHasAudio:b.mozHasAudio,webkitAudioDecodedByteCount:b.webkitAudioDecodedByteCount,videoTracks:(H=b.videoTracks)==null?void 0:H.length,readyState:b.readyState}),b.audioTracks&&b.audioTracks.length>0){const F=Array.from(b.audioTracks).some(P=>P.enabled);console.log(`Video ${r} has audioTracks:`,F),N(P=>({...P,[r]:F}));return}if("mozHasAudio"in b){const F=b.mozHasAudio;console.log(`Video ${r} mozHasAudio:`,F),N(P=>({...P,[r]:F}));return}const _=b.webkitAudioDecodedByteCount;if(typeof _=="number"&&_>0){console.log(`Video ${r} webkitAudioDecodedByteCount:`,_),N(F=>({...F,[r]:!0}));return}if(b.readyState>=3){setTimeout(()=>{const F=b.webkitAudioDecodedByteCount,P=b.mozHasAudio,Y=F>0||P===!0;console.log(`Video ${r} delayed check:`,{delayedWebkitAudio:F,delayedMozAudio:P,hasAudio:Y}),N(K=>({...K,[r]:Y}))},500);return}console.log(`Video ${r} default to has audio`),N(F=>({...F,[r]:!0}))};i.useEffect(()=>{const t=setInterval(()=>{j(r=>(r+1)%k.length)},8e3);return()=>clearInterval(t)},[k.length]);const h=i.useRef(null);return i.useEffect(()=>{const t=h.current;if(!t)return;const r=b=>{const _=b.target;t.contains(_)&&(b.preventDefault(),I(L=>b.deltaY>0?Math.min(L+1,d):Math.max(L-1,0)))};return t.addEventListener("wheel",r,{passive:!1}),()=>t.removeEventListener("wheel",r)},[d]),e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500",children:[e.jsxs("div",{className:"relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-2xl overflow-hidden mb-8 md:mb-10 shadow-2xl",children:[k.map((t,r)=>e.jsx("div",{className:`absolute inset-0 transition-opacity duration-1000 ${r===o?"opacity-100":"opacity-0"}`,children:e.jsx("video",{className:"absolute inset-0 w-full h-full object-cover",src:t.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0})},r)),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"}),e.jsxs("div",{className:"absolute bottom-0 left-0 right-0 p-6 md:p-10",children:[e.jsx("h1",{className:"text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3",children:k[o].title}),e.jsx("p",{className:"text-base md:text-lg text-white/80 max-w-2xl",children:k[o].subtitle})]}),e.jsx("div",{className:"absolute bottom-6 right-6 md:bottom-10 md:right-10 flex gap-2",children:k.map((t,r)=>e.jsx("button",{onClick:()=>j(r),className:`w-2 h-2 md:w-3 md:h-3 rounded-full transition-all duration-300 ${r===o?"bg-white w-6 md:w-8":"bg-white/50 hover:bg-white/80"}`},r))}),e.jsx("button",{onClick:()=>j(t=>(t-1+k.length)%k.length),className:"absolute left-4 md:left-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/30 hover:bg-black/50 text-white flex items-center justify-center transition-all duration-300 opacity-0 hover:opacity-100 group-hover:opacity-100",style:{opacity:.7},children:e.jsx("svg",{className:"w-5 h-5 md:w-6 md:h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:()=>j(t=>(t+1)%k.length),className:"absolute right-4 md:right-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/30 hover:bg-black/50 text-white flex items-center justify-center transition-all duration-300 opacity-0 hover:opacity-100 group-hover:opacity-100",style:{opacity:.7},children:e.jsx("svg",{className:"w-5 h-5 md:w-6 md:h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),e.jsxs("div",{className:"mb-10 md:mb-12",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Video Gallery"}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:[c+1," / ",R.length]}),e.jsxs("div",{className:"flex gap-1",children:[e.jsx("button",{onClick:()=>g(t=>(t-1+R.length)%R.length),className:"w-8 h-8 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 flex items-center justify-center transition-colors",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:()=>g(t=>(t+1)%R.length),className:"w-8 h-8 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 flex items-center justify-center transition-colors",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]})]})]}),e.jsx("div",{className:"relative overflow-hidden",children:e.jsx("div",{className:"flex transition-transform duration-500 ease-out",style:{transform:`translateX(-${c*(100/4)}%)`},children:R.map((t,r)=>e.jsx("div",{className:"w-1/4 flex-shrink-0 px-2",children:e.jsxs("div",{className:"relative aspect-[9/16] rounded-xl overflow-hidden bg-neutral-100 dark:bg-neutral-800 group cursor-pointer",onMouseEnter:b=>{const _=b.currentTarget.querySelector("video");_&&_.play().catch(L=>console.log("Video play failed:",L))},onMouseLeave:b=>{const _=b.currentTarget.querySelector("video");_&&_.pause()},children:[e.jsx("video",{className:"w-full h-full object-cover transition-transform duration-300 group-hover:scale-105",src:t.src,muted:!0,loop:!0,playsInline:!0,preload:"metadata",onCanPlay:b=>n(b.currentTarget,r)}),E[r]&&e.jsx("div",{className:"absolute top-2 right-2 w-6 h-6 rounded-full bg-black/50 flex items-center justify-center",children:e.jsx("svg",{className:"w-3 h-3 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),e.jsx("div",{className:"absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300",children:e.jsx("p",{className:"text-white text-xs font-medium truncate",children:t.title})})]})},r))})}),e.jsx("div",{className:"flex justify-center gap-2 mt-4",children:Array.from({length:Math.ceil(R.length/4)}).map((t,r)=>e.jsx("button",{onClick:()=>g(r*4),className:`h-2 rounded-full transition-all duration-300 ${Math.floor(c/4)===r?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2"}`},r))})]}),e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"All Projects"}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:[s+1," / ",v.length]})]}),e.jsx("div",{ref:h,className:"relative w-full h-[400px] flex items-center justify-center overflow-hidden z-10",children:v.map((t,r)=>{var Y;const b=r-s;if(b<-2||b>3)return null;const _=1-Math.abs(b)*.08,L=b*60,H=-Math.abs(b)*120,F=b*-6,P=b===0?1:.5;return e.jsx("div",{className:"absolute w-full max-w-7xl transition-all duration-500 ease-out",style:{transform:`
                  translateY(${L+20}px)
                  translateZ(${H}px)
                  rotateX(${F}deg)
                  scale(${_})
                `,opacity:P,zIndex:100-Math.abs(b)},children:e.jsx("div",{className:"bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl p-6 shadow-lg",children:e.jsxs("div",{className:"flex gap-6",children:[e.jsx("div",{className:"w-36 h-36 bg-neutral-100 dark:bg-neutral-800 overflow-hidden rounded-md flex-shrink-0",children:e.jsx("img",{src:t.details.logo,alt:t.title,className:"w-full h-full object-cover"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("span",{className:"text-[10px] font-mono px-2 py-1 bg-neutral-100 rounded",children:t.type.toUpperCase()}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-400",children:t.year})]}),e.jsx("h3",{className:"text-xl font-bold mb-2",children:t.title}),e.jsx("p",{className:"text-sm text-neutral-600 mb-4 line-clamp-3",children:t.description}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:(Y=t.tech)==null?void 0:Y.slice(0,3).map((K,W)=>e.jsx("span",{className:"text-[10px] font-mono px-2 py-1 bg-blue-50 text-blue-700 rounded",children:K},W))}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("a",{href:`#/${t.type}/${t.slug}`,className:"px-4 py-2 text-xs font-mono bg-neutral-200 hover:bg-neutral-300 rounded",children:"VIEW"}),t.hasDemo&&e.jsx("a",{href:`#/${t.type}/${t.slug}#demo`,className:"px-4 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 rounded",children:"DEMO"})]})]})]})})},`${t.type}-${t.slug}`)})})]})},cn=()=>{const[v,s]=i.useState(!1);i.useEffect(()=>{const d=localStorage.getItem("theme"),o=window.matchMedia("(prefers-color-scheme: dark)").matches;(d==="dark"||!d&&o)&&(s(!0),document.documentElement.classList.add("dark"))},[]);const I=()=>{const d=!v;s(d),d?(document.documentElement.classList.add("dark"),localStorage.setItem("theme","dark")):(document.documentElement.classList.remove("dark"),localStorage.setItem("theme","light"))};return e.jsx("button",{onClick:I,className:"flex items-center gap-2 px-3 py-2 border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all",title:v?"切换到日间模式":"切换到夜间模式",children:v?e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"})}):e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"})})})},Oe="https://pub-e0170f3fece2419a85fa1ce02c1f1a28.r2.dev/223_cities_cluster_with_index.zip",un="/data/223_cities_cluster_with_index_deciles.csv",re=v=>{const s=v.replace("#",""),I=parseInt(s.slice(0,2),16),d=parseInt(s.slice(2,4),16),o=parseInt(s.slice(4,6),16);return[I,d,o]},se=(v,s,I)=>{const d=Math.round(v[0]+(s[0]-v[0])*I),o=Math.round(v[1]+(s[1]-v[1])*I),j=Math.round(v[2]+(s[2]-v[2])*I);return`rgb(${d}, ${o}, ${j})`},ie=[{key:"K_5",label:"Cluster K=5",category:"cluster",type:"number"},{key:"K_12",label:"Cluster K=12",category:"cluster",type:"number"},{key:"K_20",label:"Cluster K=20",category:"cluster",type:"number"},{key:"K_26",label:"Cluster K=26",category:"cluster",type:"number"},{key:"elev_mean",label:"Elevation Mean(m)",category:"terrain",type:"number"},{key:"elev_std",label:"Elevation Std(m)",category:"terrain",type:"number"},{key:"elev_range",label:"Elevation Range(m)",category:"terrain",type:"number"},{key:"slope_mean",label:"Slope Mean(°)",category:"terrain",type:"number"},{key:"slope_std",label:"Slope Std(N/A)",category:"terrain",type:"number"},{key:"slope_rang",label:"Slope Range(N/A)",category:"terrain",type:"number"},{key:"LandArea",label:"Land Area",category:"urban",type:"number"},{key:"Buiheight",label:"Building Height(m)",category:"urban",type:"number"},{key:"BldArea",label:"Building Area(m²)",category:"urban",type:"number"},{key:"CoverRatio",label:"Building Coverage",category:"urban",type:"number"},{key:"FAR",label:"Floor Area Ratio(N/A)",category:"urban",type:"number"},{key:"GreenArea",label:"Green Area(m²)",category:"urban",type:"number"},{key:"GrHeight",label:"Green Height(m)",category:"urban",type:"number"},{key:"GreenRatio",label:"Green Ratio(N/A)",category:"urban",type:"number"},{key:"GrVolRatio",label:"Green Volume Ratio(N/A)",category:"urban",type:"number"},{key:"ISF",label:"Impervious Surface Fraction(N/A)",category:"urban",type:"number"},{key:"MIN_DistWB",label:"Mini Distance to WaterBody(m)",category:"urban",type:"number"},{key:"MIN_DistGL",label:"Mini Distance to GreenLand(m)",category:"urban",type:"number"},{key:"MIN_DistMT",label:"Mini Distance to Mountain(m)",category:"urban",type:"number"}],mn=()=>{var _e;const v=i.useRef(null),s=i.useRef(null),[I,d]=i.useState(!0),[o,j]=i.useState(0),[k,c]=i.useState(null),[g,E]=i.useState(null),[N,R]=i.useState([]),[n,h]=i.useState(null),[t,r]=i.useState("K_12"),[b,_]=i.useState(!0),[L,H]=i.useState(null),[F,P]=i.useState(null),[Y,K]=i.useState(!1),[W,Ue]=i.useState(null),[Ve,Ie]=i.useState(!1),[gn,fn]=i.useState(null),[Ce,me]=i.useState(!1),[Ae,oe]=i.useState(0),[He,ne]=i.useState(""),[fe,We]=i.useState(!1),[le,$e]=i.useState(!0),[Ee,Te]=i.useState(!0),[xe,qe]=i.useState({}),[xn,bn]=i.useState(!1),[$,Ke]=i.useState("global"),he=i.useRef(null),Pe=i.useRef(null),Xe=i.useRef(!1),de=i.useRef(null),Ze=(a,m)=>{let w=a.features;n!==null&&(w=w.filter(p=>{var u;const y=(u=p.properties)==null?void 0:u.Place;return y!==void 0&&Number(y)===Number(n)}));const x=w.map(p=>{var y;return(y=p.properties)==null?void 0:y[m]}).filter(p=>{if(p==null)return!1;if(typeof p=="string"){const u=p.trim();if(u===""||/^(na|nan|null)$/i.test(u))return!1}const y=Number(p);return!(Number.isNaN(y)||y===-9999)}).map(p=>Number(p)),A=w.reduce((p,y)=>{var S;const u=(S=y.properties)==null?void 0:S[m];let l=!1;if(u==null)l=!0;else if(typeof u=="string"){const D=u.trim();if(D===""||/^(na|nan|null)$/i.test(D))l=!0;else{const z=Number(u);(Number.isNaN(z)||z===-9999)&&(l=!0)}}else{const D=Number(u);(Number.isNaN(D)||D===-9999)&&(l=!0)}return p+(l?1:0)},0);let C=NaN,M=NaN,f=0;if(x.length>0){C=x[0],M=x[0],f=x[0];for(let p=1;p<x.length;p++){const y=x[p];y<C&&(C=y),y>M&&(M=y),f+=y}}return{count:w.length,min:C,max:M,mean:x.length>0?f/x.length:NaN,nanCount:A}};i.useEffect(()=>{(async()=>{try{const x=(await(await fetch(un)).text()).trim().split(`
`);if(x.length<2)return;const A=x[0].split(",").map(u=>u.trim()),C={},f=x[x.length-1].split(","),y=x[1].split(",");A.forEach((u,l)=>{if(u===""||u.includes("Place")||u.includes("Sum")||u.includes("FID")||u.includes("index"))return;const S=parseFloat(y[l]),D=parseFloat(f[l]);!isNaN(S)&&!isNaN(D)&&D>S&&(C[u]={min:S,max:D})}),console.log("Loaded attribute ranges:",C),qe(C)}catch(m){console.error("Failed to load deciles:",m)}})()},[]),i.useEffect(()=>{!fe&&!g&&(async()=>{var m;d(!0),j(0),c(null);try{j(10),console.log("开始下载..."),he.current=new AbortController;const w=await fetch(Oe,{signal:he.current.signal});if(console.log("响应状态:",w.status),!w.ok)throw new Error(`HTTP error! status: ${w.status}`);j(30);const x=w.headers.get("content-length"),A=x?parseInt(x):null;console.log("预期文件大小:",A);const C=(m=w.body)==null?void 0:m.getReader();if(!C)throw new Error("无法读取响应流");let M=0;const f=[];for(;;){const{done:z,value:T}=await C.read();if(z)break;f.push(T),M+=T.length,j(A?30+Math.round(M/A*60):50)}console.log("下载完成, 收到:",M),A&&M!==A&&console.log("警告: 文件大小不匹配 (可能压缩传输)");const p=new Uint8Array(M);let y=0;for(const z of f)p.set(z,y),y+=z.length;if(j(90),fe){console.log("本地数据已加载，跳过网络数据"),d(!1);return}console.log("开始解析 Shapefile...");const u=await Re(p);console.log("Shapefile 解析完成:",u);let l=[];if(u.type==="FeatureCollection"?l=u.features:Array.isArray(u)?l=u:u.type==="Feature"&&(l=[u]),console.log("解析完成，特征数量:",l==null?void 0:l.length),fe)return;const S={type:"FeatureCollection",features:l||[]};E(S),j(100);const D=new Map;S.features.forEach(z=>{var X;const T=Number(((X=z.properties)==null?void 0:X.Place)??0);D.has(T)||D.set(T,{id:T,name:`Place ${T}`,featureCount:0});const U=D.get(T);U&&U.featureCount++}),R(Array.from(D.values()).sort((z,T)=>z.id-T.id)),d(!1)}catch(w){if(w.name==="AbortError"){console.log("网络请求已取消");return}c(w instanceof Error?w.message:"Failed to load"),d(!1)}})()},[]),i.useEffect(()=>{g&&H(Ze(g,t))},[g,n,t,$,xe]),i.useEffect(()=>{if(!g)return;const a=s.current;if(!a)return;const m=()=>{var x,A,C,M;if(g.features.forEach((f,p)=>{f.id===void 0&&(f.id=p)}),a.getSource("cluster"))a.getSource("cluster").setData(g);else{console.log("初始化 cluster 数据源..."),a.addSource("cluster",{type:"geojson",data:g,generateId:!0}),a.addLayer({id:"cluster-fill",type:"fill",source:"cluster",layout:{},paint:{"fill-opacity":.7}}),a.addLayer({id:"cluster-line",type:"line",source:"cluster",layout:{},paint:{"line-color":"#7e7f80ff","line-width":1}}),a.addLayer({id:"cluster-highlight",type:"line",source:"cluster",layout:{},paint:{"line-color":"#632ffdff","line-width":3,"line-opacity":["case",["boolean",["feature-state","selected"],!1],1,0]}}),a.on("click","cluster-fill",p=>{var y;if(p.features&&p.features.length>0){const u=p.features[0],l=u.id;de.current!==null&&de.current!==void 0&&a.setFeatureState({source:"cluster",id:de.current},{selected:!1}),l!==void 0?(a.setFeatureState({source:"cluster",id:l},{selected:!0}),de.current=l):de.current=null,Ue(u),Ie(!0),((y=u.properties)==null?void 0:y.Place)!==void 0&&h(Number(u.properties.Place))}}),a.on("mouseenter","cluster-fill",()=>{a.getCanvas().style.cursor="pointer"}),a.on("mouseleave","cluster-fill",()=>{a.getCanvas().style.cursor=""});const f=g.features;if(f.length>0)try{const p=new pe.LngLatBounds,y=Math.max(1,Math.floor(f.length/2e3));for(let u=0;u<f.length;u+=y){const l=f[u];if(!((x=l.geometry)!=null&&x.coordinates))continue;const S=l.geometry.type,D=l.geometry.coordinates;S==="Point"?p.extend(D):S==="LineString"||S==="MultiPoint"?D.forEach(z=>p.extend(z)):S==="Polygon"||S==="MultiLineString"?(A=D[0])==null||A.forEach(z=>p.extend(z)):S==="MultiPolygon"&&((M=(C=D[0])==null?void 0:C[0])==null||M.forEach(z=>p.extend(z)))}p.isEmpty()||a.fitBounds(p,{padding:50,duration:1e3})}catch(p){console.error("Fit bounds error:",p)}}},w=()=>{var T;if(!a.getLayer("cluster-fill"))return;const x=null;a.setFilter("cluster-fill",x),a.setFilter("cluster-line",x),a.setFilter("cluster-highlight",x);const A=(()=>{var be;let U=1/0,X=-1/0;for(const ye of g.features){const Z=Number((be=ye.properties)==null?void 0:be[t]);Number.isNaN(Z)||Z===-9999||(Z<U&&(U=Z),Z>X&&(X=Z))}return{min:U===1/0?0:U,max:X===-1/0?0:X}})(),C=n!==null&&L?{min:L.min,max:L.max}:A,M=$==="city"?C:A,f=M.min,p=M.max;let y;if(t.includes("K_")){const U=Math.round(((T=xe[t])==null?void 0:T.max)??p),X=Array.from({length:26},(ae,ve)=>{const q=ve/25;let J,Q,ee;if(q<.167){const V=q/.167;J=0,Q=0,ee=Math.round(139+116*V)}else if(q<.333){const V=(q-.167)/.167;J=0,Q=Math.round(255*V),ee=255}else if(q<.5){const V=(q-.333)/.167;J=0,Q=Math.round(255-128*V),ee=Math.round(255-255*V)}else if(q<.667){const V=(q-.5)/.167;J=Math.round(255*V),Q=255,ee=0}else if(q<.833){const V=(q-.667)/.167;J=255,Q=Math.round(255-128*V),ee=0}else{const V=(q-.833)/.167;J=255,Q=Math.round(127-127*V),ee=0}return`#${J.toString(16).padStart(2,"0")}${Q.toString(16).padStart(2,"0")}${ee.toString(16).padStart(2,"0")}`}),ye=Array.from({length:U+1},(ae,ve)=>X[Math.round(ve*25/U)]).slice(0,U+1),Z=["interpolate",["linear"],["get",t]];for(let ae=0;ae<=U;ae++)Z.push(ae,ye[ae]);y=Z}else t==="CoverRatio"||t==="ISF"||t==="GreenRatio"?y=["interpolate",["linear"],["get",t],f,"#3182bd",p,"#e6550d"]:t.includes("elev")||t.includes("slope")?y=["interpolate",["linear"],["get",t],f,"#31a354",p,"#756bb1"]:y=["interpolate",["linear"],["get",t],f,"#31a354",p,"#756bb1"];a.setPaintProperty("cluster-fill","fill-color",y);const u=n!==null,l=Number(n),z=["case",["any",["==",["get",t],-9999],["==",["get",t],null]],0,u?["case",["==",["to-number",["get","Place"]],l],.8,.15]:.7];a.setPaintProperty("cluster-fill","fill-opacity",z)};a.isStyleLoaded()?(m(),w()):a.once("load",()=>{m(),w()})},[g,n,t]),i.useEffect(()=>{var w,x,A,C;if(!g||n===null)return;const a=s.current;if(!a)return;const m=g.features.filter(M=>{var p;const f=(p=M.properties)==null?void 0:p.Place;return f!==void 0&&Number(f)===Number(n)});if(m.length!==0)try{const M=new pe.LngLatBounds;let f=0;const p=Math.max(1,Math.floor(m.length/2e3));for(let y=0;y<m.length;y+=p){const u=m[y];if(!((w=u.geometry)!=null&&w.coordinates))continue;const l=u.geometry.type,S=u.geometry.coordinates;l==="Point"?(M.extend(S),f++):l==="LineString"||l==="MultiPoint"?(S.forEach(D=>M.extend(D)),f++):l==="Polygon"||l==="MultiLineString"?((x=S[0])==null||x.forEach(D=>M.extend(D)),f++):l==="MultiPolygon"&&((C=(A=S[0])==null?void 0:A[0])==null||C.forEach(D=>M.extend(D)),f++)}!M.isEmpty()&&f>0&&a.fitBounds(M,{padding:50,duration:1e3})}catch(M){console.error("Fly to error:",M)}},[n]),i.useEffect(()=>((async()=>{(!v.current||s.current)&&console.log("开始初始化地图...");try{const m=new pe.Map({container:v.current,style:{version:8,sources:{"osm-tiles":{type:"raster",tiles:["https://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png"],tileSize:256,attribution:'&copy; <a href="https://carto.com/">CARTO</a>'}},layers:[{id:"simple-tiles",type:"raster",source:"osm-tiles",minzoom:0,maxzoom:19}]},center:[4.75,45.75],zoom:10});m.addControl(new pe.NavigationControl,"top-right"),m.on("load",()=>{console.log("地图样式加载完成")}),m.on("error",w=>{var C;const x=String(((C=w==null?void 0:w.error)==null?void 0:C.message)||(w==null?void 0:w.message)||"");x.includes("ERR_ABORTED")||x.includes("AbortError")||x.includes("Canceled")||x.includes("cancelled")||console.error("地图错误:",w)}),s.current=m,console.log("地图初始化完成")}catch(m){console.error("地图初始化错误:",m)}})(),()=>{s.current&&(s.current.remove(),s.current=null,Xe.current=!1)}),[]),i.useEffect(()=>{const a=s.current;if(!a)return;const m=()=>{a.getLayer("simple-tiles")&&a.setLayoutProperty("simple-tiles","visibility",le?"visible":"none")};a.isStyleLoaded()?m():a.once("style.load",m)},[le]);const Ye=async a=>{var w;const m=(w=a.target.files)==null?void 0:w[0];if(m){he.current&&he.current.abort(),me(!0),oe(0),ne("正在读取文件..."),c(null),K(!0),P(URL.createObjectURL(m));try{console.log("开始读取文件:",m.name,"大小:",m.size);let x=[];const A=m.name.endsWith(".zip"),C=m.name.endsWith(".shp");if(!A&&!C){c("请上传 .zip 文件 (包含 Shapefile)"),me(!1);return}ne("正在读取文件...");const M=await m.arrayBuffer();oe(30),ne("正在解析 Shapefile...");const f=await Re(M);console.log("Shapefile 解析完成:",f),f.type==="FeatureCollection"?x=f.features:Array.isArray(f)?x=f:f.type==="Feature"&&(x=[f]),console.log("解析到的 features 数量:",x.length),oe(95),ne(`已解析 ${x.length} 个 Features...`);const p={type:"FeatureCollection",features:x};oe(98),ne("正在处理 Place 数据...");const y=new Map;p.features.forEach(u=>{var D;const l=Number(((D=u.properties)==null?void 0:D.Place)??0);y.has(l)||y.set(l,{id:l,name:`Place ${l}`,featureCount:0});const S=y.get(l);S&&S.featureCount++}),oe(100),ne("加载完成!"),setTimeout(()=>{We(!0),E(p),R(Array.from(y.values()).sort((u,l)=>u.id-l.id)),me(!1),K(!1),d(!1)},500)}catch(x){const A=x instanceof Error?x.message:"未知错误";c(`加载失败: ${A}`),me(!1),d(!1)}}},Je=ie.reduce((a,m)=>(a[m.category]||(a[m.category]=[]),a[m.category].push(m),a),{});return e.jsxs("div",{className:"relative w-full h-full bg-gray-100",children:[Ce&&e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-8 w-80 text-center",children:[e.jsxs("div",{className:"relative w-20 h-20 mx-auto mb-4",children:[e.jsx("div",{className:"absolute inset-0 border-4 border-gray-100 rounded-full"}),e.jsx("div",{className:"absolute inset-0 border-4 border-purple-600 rounded-full border-t-transparent animate-spin"}),e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx(ze,{className:"text-purple-600",size:24})})]}),e.jsx("p",{className:"text-gray-800 font-medium mb-3",children:He}),e.jsx("div",{className:"w-full bg-gray-100 rounded-full h-3 mb-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-purple-500 to-purple-600 transition-all duration-300",style:{width:`${Ae}%`}})}),e.jsxs("p",{className:"text-sm text-gray-400",children:[Ae,"%"]})]})}),I&&!Ce?e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(dt,{className:"animate-spin h-12 w-12 text-purple-600 mx-auto mb-4"}),e.jsx("p",{className:"text-gray-600",children:"正在加载 Shapefile..."}),e.jsx("div",{className:"w-48 h-2 bg-gray-200 rounded-full mx-auto mt-3 overflow-hidden",children:e.jsx("div",{className:"h-full bg-purple-600 transition-all duration-300",style:{width:`${o}%`}})}),e.jsxs("p",{className:"text-xs text-gray-400 mt-2",children:[o,"%"]}),e.jsxs("div",{className:"flex gap-2 mt-4 justify-center",children:[e.jsxs("a",{href:Oe,download:"223_cities_cluster_with_index.zip",className:"inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:[e.jsx(ct,{size:14}),"下载本地"]}),e.jsxs("button",{onClick:()=>{var a;return(a=Pe.current)==null?void 0:a.click()},className:"inline-flex items-center gap-2 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded-lg text-sm transition-colors",title:"支持 .zip (Shapefile)",children:[e.jsx(ze,{size:14}),"加载 Shapefile"]})]}),e.jsx("p",{className:"text-xs text-gray-400 mt-2",children:"支持 .zip (Shapefile)"}),e.jsx("input",{ref:Pe,type:"file",accept:".shp,.zip",onChange:Ye,className:"hidden"})]})}):null,k&&e.jsxs("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-red-50 border border-red-200 rounded-xl px-6 py-5 shadow-lg",children:[e.jsx("p",{className:"text-red-600 font-medium",children:"加载失败"}),e.jsx("p",{className:"text-red-400 text-sm mt-1 mb-4",children:k}),e.jsx("div",{className:"flex gap-2",children:e.jsxs("button",{onClick:()=>window.location.reload(),className:"inline-flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-sm transition-colors",children:[e.jsx(ut,{size:14}),"刷新重试"]})})]}),b&&e.jsxs("div",{className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-72",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("h2",{className:"font-bold text-gray-800 flex items-center gap-2",children:[e.jsx(mt,{size:18}),"Cluster Map"]}),e.jsx("button",{onClick:()=>_(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(ht,{size:18})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("span",{className:"text-sm text-gray-600",children:"显示地图底图"}),e.jsx("button",{onClick:()=>$e(!le),className:`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${le?"bg-purple-600":"bg-gray-300"}`,children:e.jsx("span",{className:`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${le?"translate-x-6":"translate-x-1"}`})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Place (Count)"}),e.jsxs("select",{value:n??"",onChange:a=>h(a.target.value?Number(a.target.value):null),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:[e.jsxs("option",{value:"",children:["All Places (",((_e=g==null?void 0:g.features)==null?void 0:_e.length)??0,")"]}),N.map(a=>e.jsxs("option",{value:a.id,children:[a.name," (",a.featureCount,")"]},a.id))]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Attribute"}),e.jsx("select",{value:t,onChange:a=>r(a.target.value),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:Object.entries(Je).map(([a,m])=>[e.jsx("optgroup",{label:a.charAt(0).toUpperCase()+a.slice(1),children:m.map(w=>e.jsx("option",{value:w.key,children:w.label},w.key))},a)])})]}),L&&e.jsxs("div",{className:"bg-gray-50 rounded-lg p-3 space-y-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(pt,{size:14,className:"text-purple-500"}),e.jsx("span",{className:"text-xs font-medium text-gray-500",children:"Statistics"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-xs",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Count:"})," ",e.jsx("span",{className:"font-medium",children:L.count})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Min:"})," ",e.jsx("span",{className:"font-medium",children:L.min.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Max:"})," ",e.jsx("span",{className:"font-medium",children:L.max.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Mean:"})," ",e.jsx("span",{className:"font-medium",children:L.mean.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"NaN:"})," ",e.jsx("span",{className:"font-medium",children:L.nanCount})]})]})]})]})]}),!b&&e.jsx("button",{onClick:()=>_(!0),className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(gt,{size:18})}),Ve&&W&&e.jsxs("div",{className:"absolute top-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-80 max-h-96 overflow-y-auto",children:[e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-medium text-gray-400 uppercase tracking-wider mb-1",children:"Feature Details"}),e.jsxs("div",{className:"mb-3",children:[W.properties.Place&&e.jsxs("div",{className:"text-lg font-semibold text-purple-600",children:["Place: ",W.properties.Place]}),W.properties["City Name"]&&e.jsxs("div",{className:"text-sm font-medium text-gray-700",children:["City: ",W.properties["City Name"]]}),e.jsxs("div",{className:"text-sm font-medium text-gray-500",children:["Place ID: ",W.properties["Place ID"]??"N/A"]})]})]}),e.jsx("button",{onClick:()=>Ie(!1),className:"p-1 hover:bg-gray-100 rounded-full transition-colors",children:e.jsx(Ge,{size:20,className:"text-gray-400"})})]}),e.jsx("div",{className:"space-y-2",children:ie.map(a=>{var w;const m=(w=W.properties)==null?void 0:w[a.key];return m==null?null:e.jsxs("button",{onClick:()=>r(a.key),className:`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${t===a.key?"bg-purple-100 text-purple-700":"bg-gray-50 text-gray-600 hover:bg-gray-100"}`,children:[e.jsx("span",{children:a.label}),e.jsx("span",{className:"font-mono font-medium",children:typeof m=="number"?m.toFixed(2):m})]},a.key)})}),e.jsx("div",{className:"mt-3 pt-3 border-t border-gray-200",children:e.jsx("button",{onClick:()=>h(null),className:"w-full px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:"显示全部区域"})})]}),e.jsx("div",{ref:v,className:"w-full h-full"}),Ee&&g&&e.jsxs("div",{className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-64",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("h3",{className:"font-semibold text-gray-800 flex items-center gap-2",children:[e.jsx(Fe,{size:16}),"Legend"]}),e.jsx("button",{onClick:()=>Te(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(Ge,{size:16})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"颜色映射"}),e.jsx("button",{onClick:()=>Ke($==="global"?"city":"global"),className:`text-xs px-2 py-1 rounded ${$==="global"?"bg-gray-200 text-gray-700":"bg-purple-100 text-purple-700"}`,children:$==="global"?"全局":"城市"})]}),e.jsx("div",{className:"space-y-3",children:t.includes("K_")?(()=>{var x,A;const a=Math.round(((x=xe[t])==null?void 0:x.max)??30),m=Array.from({length:26},(C,M)=>{const f=M/25;let p,y,u;if(f<.167){const l=f/.167;p=0,y=0,u=Math.round(139+116*l)}else if(f<.333){const l=(f-.167)/.167;p=0,y=Math.round(255*l),u=255}else if(f<.5){const l=(f-.333)/.167;p=0,y=Math.round(255-128*l),u=Math.round(255-255*l)}else if(f<.667){const l=(f-.5)/.167;p=Math.round(255*l),y=255,u=0}else if(f<.833){const l=(f-.667)/.167;p=255,y=Math.round(255-128*l),u=0}else{const l=(f-.833)/.167;p=255,y=Math.round(127-127*l),u=0}return`#${p.toString(16).padStart(2,"0")}${y.toString(16).padStart(2,"0")}${u.toString(16).padStart(2,"0")}`}),w=Array.from({length:a+1},(C,M)=>m[Math.round(M*25/a)]);return e.jsxs("div",{children:[e.jsx("div",{className:"text-xs text-gray-500 mb-2",children:((A=ie.find(C=>C.key===t))==null?void 0:A.label)||t}),e.jsx("div",{className:"flex flex-wrap gap-px",children:w.map((C,M)=>e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("div",{className:"w-3 h-3 rounded-sm",style:{backgroundColor:C}}),e.jsx("span",{className:"text-[6px] text-gray-400",children:M})]},M))})]})})():t==="CoverRatio"||t==="ISF"||t==="GreenRatio"?(()=>{var u;const a=(()=>{var D;let l=1/0,S=-1/0;for(const z of g.features){const T=Number((D=z.properties)==null?void 0:D[t]);Number.isNaN(T)||T===-9999||(T<l&&(l=T),T>S&&(S=T))}return{min:l===1/0?0:l,max:S===-1/0?0:S}})(),m=n!==null&&L?{min:L.min,max:L.max}:a,w=((u=ie.find(l=>l.key===t))==null?void 0:u.label)||t,x=a.max>a.min?Math.max(0,Math.min(1,(m.min-a.min)/(a.max-a.min))):0,A=a.max>a.min?Math.max(0,Math.min(1,(m.max-a.min)/(a.max-a.min))):0,C=Math.max(0,A-x),M=re("#3182bd"),f=re("#e6550d"),p=se(M,f,x),y=se(M,f,A);return e.jsxs("div",{children:[$==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[w,"（城市区间）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,130,189,0.2), rgba(230,85,13,0.2))"},children:n!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${x*100}%`,width:`${C*100}%`,background:`linear-gradient(to right, ${p}, ${y})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(2)}),e.jsx("span",{children:m.max.toFixed(2)})]})]}),$==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[w,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #3182bd, #e6550d)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:a.min.toFixed(2)}),e.jsx("span",{children:a.max.toFixed(2)})]})]})]})})():t.includes("elev")||t.includes("slope")?(()=>{var u;const a=(()=>{var D;let l=1/0,S=-1/0;for(const z of g.features){const T=Number((D=z.properties)==null?void 0:D[t]);Number.isNaN(T)||T===-9999||(T<l&&(l=T),T>S&&(S=T))}return{min:l===1/0?0:l,max:S===-1/0?0:S}})(),m=n!==null&&L?{min:L.min,max:L.max}:a,w=((u=ie.find(l=>l.key===t))==null?void 0:u.label)||t,x=a.max>a.min?Math.max(0,Math.min(1,(m.min-a.min)/(a.max-a.min))):0,A=a.max>a.min?Math.max(0,Math.min(1,(m.max-a.min)/(a.max-a.min))):0,C=Math.max(0,A-x),M=re("#31a354"),f=re("#756bb1"),p=se(M,f,x),y=se(M,f,A);return e.jsxs("div",{children:[$==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[w,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:n!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${x*100}%`,width:`${C*100}%`,background:`linear-gradient(to right, ${p}, ${y})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(1)}),e.jsxs("span",{children:[m.max.toFixed(0),"+"]})]})]}),$==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[w,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:a.min.toFixed(1)}),e.jsxs("span",{children:[a.max.toFixed(0),"+"]})]})]})]})})():(()=>{var u;const a=(()=>{var D;let l=1/0,S=-1/0;for(const z of g.features){const T=Number((D=z.properties)==null?void 0:D[t]);Number.isNaN(T)||T===-9999||(T<l&&(l=T),T>S&&(S=T))}return{min:l===1/0?0:l,max:S===-1/0?0:S}})(),m=n!==null&&L?{min:L.min,max:L.max}:a,w=((u=ie.find(l=>l.key===t))==null?void 0:u.label)||t,x=a.max>a.min?Math.max(0,Math.min(1,(m.min-a.min)/(a.max-a.min))):0,A=a.max>a.min?Math.max(0,Math.min(1,(m.max-a.min)/(a.max-a.min))):0,C=Math.max(0,A-x),M=re("#31a354"),f=re("#756bb1"),p=se(M,f,x),y=se(M,f,A);return e.jsxs("div",{children:[$==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[w,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:n!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${x*100}%`,width:`${C*100}%`,background:`linear-gradient(to right, ${p}, ${y})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(2)}),e.jsx("span",{children:m.max.toFixed(2)})]})]}),$==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[w,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:a.min.toFixed(2)}),e.jsx("span",{children:a.max.toFixed(2)})]})]})]})})()})]}),!Ee&&e.jsx("button",{onClick:()=>Te(!0),className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(Fe,{size:18})})]})},hn=()=>{const[v,s]=i.useState(!1),[I,d]=i.useState(!1),[o,j]=i.useState(!1),[k,c]=i.useState({x:0,y:0}),[g,E]=i.useState("/data/fig/lili/lili_01.png"),[N,R]=i.useState("Exploring the intersection of technology and creativity."),n=rt(),h=st(),r=n.pathname.split("/").filter(Boolean)[0]||"",b={design:"/data/fig/lili/lili_05.png",game:"/data/fig/lili/lili_03.png",platform:"/data/fig/lili/lili_11.png",tutorial:"/data/fig/lili/lili_04.png",about:"/data/fig/lili/lili_02.png",planning:"/data/fig/lili/lili_06.png"},_=["/data/fig/lili/lili_01.png","/data/fig/lili/lili_07.png","/data/fig/lili/lili_08.png","/data/fig/lili/lili_09.png","/data/fig/lili/lili_10.png","/data/fig/lili/lili_12.png"],L=["Exploring the intersection of technology and creativity.","Turning data into meaningful visual stories.","Building digital experiences that inspire.","Bridging the gap between design and development.","Creating solutions that matter in the real world.","Passionate about geospatial technology and urban planning."],H=()=>{const P=Math.floor(Math.random()*_.length);return _[P]},F=()=>{const P=Math.floor(Math.random()*L.length);return L[P]};return i.useEffect(()=>{r===""?E(H()):b[r]?E(b[r]):E(H()),R(F())},[r]),e.jsx("div",{className:"h-screen p-0 bg-neutral-100 dark:bg-neutral-900 flex flex-col",children:e.jsxs("div",{className:"w-full flex flex-col relative h-full",children:[e.jsxs("header",{className:"border-b border-neutral-200 dark:border-neutral-800 p-4 flex justify-between items-center bg-white dark:bg-neutral-900 z-30 shrink-0 relative",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("button",{onClick:()=>s(!v),className:"md:hidden w-8 h-8 flex items-center justify-center border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100",children:"☰"}),e.jsxs("h1",{className:"text-xl md:text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100",children:["Lili Lin ",e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600 font-light mx-2",children:"/"})," ",e.jsx("span",{className:"text-sm font-mono font-normal text-neutral-500 dark:text-neutral-400",children:"PORTFOLIO"})]})]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(cn,{}),e.jsxs("button",{onClick:()=>{j(!0);const P=k.x+360*2+Math.random()*360,Y=k.y+360*2+Math.random()*360;c({x:P,y:Y}),setTimeout(()=>{const K=["planning","design","game","platform","tutorial","about"],W=K[Math.floor(Math.random()*K.length)];h(`/${W}`),j(!1)},1e3)},className:"flex items-center gap-2 px-3 py-2 border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all",title:"🎲 Explore a random project",children:[e.jsx("div",{className:"w-5 h-5",style:{perspective:"100px"},children:e.jsxs("div",{className:"w-full h-full relative transition-transform duration-1000 ease-out",style:{transform:`rotateX(${k.x}deg) rotateY(${k.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"translateZ(10px)"},children:e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"5px",height:"5px",backgroundColor:"#dc2626"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]})}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateY(180deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-3  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-3  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-3  w-full h-full justify-center"})]}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateY(-90deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-5 marg w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-5  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-5  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"})]}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateY(90deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-1  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-1  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{}),e.jsx("div",{className:" rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-1  w-full h-full justify-center"})]}),e.jsx("div",{className:"absolute w-full h-full bg-white border-gray-400  justify-center rounded flex  p-0.5",style:{transform:"rotateX(90deg) translateZ(10px)"},children:e.jsxs("div",{className:"grid grid-cols-3 border w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]})}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateX(-90deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{children:e.jsx("div",{})}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{children:e.jsx("div",{})}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"})]})]})}),e.jsx("span",{className:"text-sm font-medium",children:"Jump"})]}),e.jsxs("nav",{className:"hidden sm:flex gap-0",children:[e.jsx(te,{to:"/",onClick:()=>{window.innerWidth<768&&s(!0)},className:`px-4 py-3 text font-medium border-b-4 transition-all ${r===""?"border-neutral-900 dark:border-neutral-100 text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-950":"border-transparent text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"}`,children:e.jsx("span",{children:"Home"})}),[{key:"planning",label:"Planning",short:"Planning"},{key:"design",label:"Design",short:"Design"},{key:"game",label:"Game",short:"G"},{key:"platform",label:"Platform",short:"P"},{key:"tutorial",label:"Tutorial",short:"T"},{key:"about",label:"About",short:"A"}].map(P=>e.jsx(te,{to:`/${P.key}`,onClick:()=>{window.innerWidth<768&&s(!0)},className:`px-4 py-3 text font-medium border-b-4 transition-all ${r===P.key?"border-neutral-900 dark:border-neutral-100 text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-950":"border-transparent text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"}`,children:e.jsx("span",{children:P.label})},P.key))]}),e.jsxs("div",{className:"sm:hidden relative",children:[e.jsxs("button",{onClick:()=>d(!I),className:"flex items-center gap-2 px-3 py-2 border border-neutral-200 dark:border-neutral-700 text-neutral-900 dark:text-neutral-100 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-800",children:[e.jsx("span",{className:"text-sm font-medium",children:r===""?"Home":r.charAt(0).toUpperCase()+r.slice(1)}),I?"✕":"▼"]}),I&&e.jsxs("div",{className:"absolute right-0 top-10 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-lg z-50 min-w-[160px]",children:[e.jsx(te,{to:"/",onClick:()=>{d(!1),s(!0)},className:`block px-4 py-3 text-sm font-medium transition-all ${r===""?"bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100":"text-neutral-600 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800"}`,children:"Home"}),[{key:"planning",label:"Planning"},{key:"design",label:"Design"},{key:"game",label:"Game"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"},{key:"about",label:"About"}].map(P=>e.jsx(te,{to:`/${P.key}`,onClick:()=>{d(!1),s(!0)},className:`block px-4 py-3 text-sm font-medium transition-all ${r===P.key?"bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100":"text-neutral-600 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800"}`,children:P.label},P.key))]})]})]})]}),e.jsxs("main",{className:"flex flex-row flex-1 overflow-hidden relative",children:[v&&e.jsx("aside",{className:"md:hidden border-r border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 w-64 pt-2 px-4 pb-4 flex-shrink-0 overflow-y-auto h-full z-20",children:e.jsxs("div",{className:"flex flex-col gap-6 w-full mt-4",children:[g&&e.jsx("div",{className:"w-full flex justify-center py-4",children:e.jsx("img",{src:g,alt:"Lili's avatar",className:"w-40 h-auto object-contain rounded-lg border border-neutral-100 dark:border-neutral-800 shadow-sm",style:{display:"block",maxWidth:"100%"}})}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("h3",{className:"text-sm font-mono text-neutral-500 dark:text-neutral-400 mb-2",children:"Lili Lin"}),e.jsx("h3",{className:"text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-2",children:"林丽丽"}),e.jsx("p",{className:"text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed",children:"Designer | Developer | Product Maker"}),e.jsx("p",{className:"text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed",children:"Passionate about creating meaningful digital experiences that bridge technology and creativity."})]}),e.jsxs("div",{className:"pt-6 border-t border-neutral-100 dark:border-neutral-800 text-center gap-4",children:[e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 italic mb-3",children:['"',N,'"']}),e.jsxs("div",{className:"flex items-center justify-center gap-2 text-xs",children:[e.jsx("a",{href:"https://github.com/lililin0324",className:"flex items-center gap-1 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"GitHub",children:e.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})})}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("a",{href:"mailto:lili0324@snu.ac.kr",className:"flex items-center gap-1 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"Email",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("a",{href:"https://www.linkedin.com/in/lililin0324",className:"flex items-center gap-1 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"LinkedIn",children:e.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"})})})]})]})]})]})}),e.jsx("aside",{className:"hidden md:flex border-r border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex-col w-64 p-4 overflow-y-auto h-full z-10 shrink-0",children:e.jsxs("div",{className:"flex flex-col gap-6 w-full mt-4 black",children:[g&&e.jsx("div",{className:"w-full flex justify-center py-4",children:e.jsx("img",{src:g,alt:"Lili's avatar",className:"w-40 h-auto object-contain rounded-lg border border-neutral-100 dark:border-neutral-800 shadow-sm",style:{display:"block",maxWidth:"100%"}})}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(ke,{href:"https://github.com/lililin0324",label:"GH"}),e.jsx(ke,{href:"mailto:lili0324@snu.ac.kr",label:"EM"}),e.jsx(ke,{href:"https://www.linkedin.com/in/lililin0324",label:"LK"})]}),e.jsxs("div",{className:"mt-4 space-y-3",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("h3",{className:"text-sm font-mono text-neutral-500 dark:text-neutral-400 mb-2",children:"ABOUT"}),e.jsx("p",{className:"text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed",children:"I'm Lili, a designer and developer passionate about creating meaningful digital experiences that bridge technology and creativity."})]}),e.jsx("div",{className:"pt-3 border-t border-neutral-100 dark:border-neutral-800 text-center",children:e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 italic",children:['"',N,'"']})})]})]})}),e.jsx("section",{className:"flex-1 relative w-full h-[calc(100vh-4rem)] overflow-y-auto",children:e.jsxs(it,{children:[e.jsx(B,{path:"/",element:e.jsx(dn,{})}),e.jsx(B,{path:"/planning",element:e.jsx(ce,{data:Ne,type:"planning"})}),e.jsx(B,{path:"/planning/:id",element:e.jsx(ue,{data:Ne,type:"planning"})}),e.jsx(B,{path:"/design",element:e.jsx(ce,{data:Me,type:"design"})}),e.jsx(B,{path:"/design/:id",element:e.jsx(ue,{data:Me,type:"design"})}),e.jsx(B,{path:"/game",element:e.jsx(ce,{data:Se,type:"game"})}),e.jsx(B,{path:"/game/:id",element:e.jsx(ue,{data:Se,type:"game"})}),e.jsx(B,{path:"/platform",element:e.jsx(ce,{data:Le,type:"platform"})}),e.jsx(B,{path:"/platform/:id",element:e.jsx(ue,{data:Le,type:"platform"})}),e.jsx(B,{path:"/tutorial",element:e.jsx(ce,{data:De,type:"tutorial"})}),e.jsx(B,{path:"/tutorial/:id",element:e.jsx(ue,{data:De,type:"tutorial"})}),e.jsx(B,{path:"/clusteringeomap",element:e.jsx(mn,{})}),e.jsx(B,{path:"/about",element:e.jsx(on,{})}),e.jsx(B,{path:"/contact",element:e.jsx(ln,{})})]})})]})]})})};function pn(){const[v,s]=i.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(ot,{children:e.jsx(hn,{})}),!v&&e.jsx(ft,{onFinish:()=>s(!0)})]})}lt.createRoot(document.getElementById("root")).render(e.jsx(pn,{}));
