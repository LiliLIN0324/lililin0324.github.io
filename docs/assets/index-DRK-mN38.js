const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-_F_u3F9e.js","assets/vendor-C3K-8TKq.js","assets/maplibre-DKOg2DWH.js","assets/vendor-Dgihpmma.css","assets/icons-C2kTgXKj.js","assets/UR-platform-CdUD71uN.js","assets/openstreetmap-NDlxPSj5.js","assets/photogeo-BRzFMndk.js"])))=>i.map(i=>d[i]);
import{r as h,j as e,A as M,m as R,c as U,u as z,L as C,R as G,a as f,N as _,b as F,H}from"./vendor-C3K-8TKq.js";import"./maplibre-DKOg2DWH.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))m(r);new MutationObserver(r=>{for(const t of r)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&m(a)}).observe(document,{childList:!0,subtree:!0});function o(r){const t={};return r.integrity&&(t.integrity=r.integrity),r.referrerPolicy&&(t.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?t.credentials="include":r.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function m(r){if(r.ep)return;r.ep=!0;const t=o(r);fetch(r.href,t)}})();function q({onFinish:n}){const[i,o]=h.useState(!0),m=h.useRef(null),r=h.useRef({x:-1e3,y:-1e3});return h.useEffect(()=>{const t=m.current;if(!t)return;const a=t.getContext("2d");if(!a)return;let l,c=[];const d=()=>{t.width=window.innerWidth,t.height=window.innerHeight},g=s=>{r.current={x:s.clientX,y:s.clientY}},x=s=>{s.touches.length>0&&(r.current={x:s.touches[0].clientX,y:s.touches[0].clientY})};window.addEventListener("resize",d),window.addEventListener("mousemove",g),window.addEventListener("touchmove",x),d();class u{constructor(){this.x=Math.random()*t.width,this.y=Math.random()*t.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>t.width)&&(this.vx*=-1),(this.y<0||this.y>t.height)&&(this.vy*=-1);let p=r.current.x-this.x,y=r.current.y-this.y,b=Math.sqrt(p*p+y*y),w=p/b,D=y/b;const L=150;let A=(L-b)/L;b<L&&(this.x-=w*A*this.density*.5,this.y-=D*A*this.density*.5)}draw(){a&&(a.fillStyle="rgba(255, 255, 255, 0.8)",a.beginPath(),a.arc(this.x,this.y,this.size,0,Math.PI*2),a.fill())}}for(let s=0;s<120;s++)c.push(new u);const j=()=>{a.clearRect(0,0,t.width,t.height);for(let s=0;s<c.length;s++){c[s].update(),c[s].draw();for(let p=s+1;p<c.length;p++){const y=c[s].x-c[p].x,b=c[s].y-c[p].y,w=Math.sqrt(y*y+b*b);w<100&&(a.beginPath(),a.strokeStyle=`rgba(255, 255, 255, ${.2*(1-w/100)})`,a.lineWidth=.6,a.moveTo(c[s].x,c[s].y),a.lineTo(c[p].x,c[p].y),a.stroke())}}l=requestAnimationFrame(j)};return j(),()=>{cancelAnimationFrame(l),window.removeEventListener("resize",d),window.removeEventListener("mousemove",g),window.removeEventListener("touchmove",x)}},[]),e.jsx(M,{onExitComplete:n,children:i&&e.jsxs(R.div,{onClick:()=>o(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-[9999] bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:m,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(R.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(R.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const B="modulepreload",J=function(n){return"/"+n},k={},N=function(i,o,m){let r=Promise.resolve();if(o&&o.length>0){let a=function(d){return Promise.all(d.map(g=>Promise.resolve(g).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),c=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));r=a(o.map(d=>{if(d=J(d),d in k)return;k[d]=!0;const g=d.endsWith(".css"),x=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${x}`))return;const u=document.createElement("link");if(u.rel=g?"stylesheet":B,g||(u.as="script"),u.crossOrigin="",u.href=d,c&&u.setAttribute("nonce",c),document.head.appendChild(u),g)return new Promise((j,s)=>{u.addEventListener("load",j),u.addEventListener("error",()=>s(new Error(`Unable to preload CSS for ${d}`)))})}))}function t(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return r.then(a=>{for(const l of a||[])l.status==="rejected"&&t(l.reason);return i().catch(t)})},$=`import { useState,useEffect, useRef } from 'react';\r
