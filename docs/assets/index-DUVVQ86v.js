const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-Xov-xRHK.js","assets/vendor-mVDRKbTk.js","assets/maplibre-DKOg2DWH.js","assets/vendor-Dgihpmma.css","assets/icons-Dv4VGnsH.js","assets/UR-platform-CnCbtq1B.js","assets/openstreetmap-AHML1FGp.js","assets/photogeo-Cuuh30b1.js"])))=>i.map(i=>d[i]);
import{r as p,c as C,j as e,H as I,u as A,L as v,R as O,a as d,N as k,b as U}from"./vendor-mVDRKbTk.js";import"./maplibre-DKOg2DWH.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))c(r);new MutationObserver(r=>{for(const t of r)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&c(o)}).observe(document,{childList:!0,subtree:!0});function i(r){const t={};return r.integrity&&(t.integrity=r.integrity),r.referrerPolicy&&(t.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?t.credentials="include":r.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function c(r){if(r.ep)return;r.ep=!0;const t=i(r);fetch(r.href,t)}})();const E="modulepreload",P=function(a){return"/"+a},w={},f=function(n,i,c){let r=Promise.resolve();if(i&&i.length>0){let o=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),j=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));r=o(i.map(l=>{if(l=P(l),l in w)return;w[l]=!0;const u=l.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${h}`))return;const m=document.createElement("link");if(m.rel=u?"stylesheet":E,u||(m.as="script"),m.crossOrigin="",m.href=l,j&&m.setAttribute("nonce",j),document.head.appendChild(m),u)return new Promise((S,T)=>{m.addEventListener("load",S),m.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${l}`)))})}))}function t(o){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=o,window.dispatchEvent(s),!s.defaultPrevented)throw o}return r.then(o=>{for(const s of o||[])s.status==="rejected"&&t(s.reason);return n().catch(t)})},D=`import { useState,useEffect, useRef } from 'react';\r
...
`,G=`import React, { useState } from "react";\r
