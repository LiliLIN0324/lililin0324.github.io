...
import{r as l,j as e,L as X,u as tt,c as nt,d as at,e as rt,f as U,H as st,g as it}from"./react-vendor-6zld6QO8.js";import{A as Pe,m as ge}from"./framer-DvVmTyA1.js";import{M as lt,r as ot,a as dt}from"./markdown-q3GborES.js";import{b as Ge}from"./geo-Z02C8O4I.js";import{m as be}from"./maplibre-BedwuVXB.js";import{U as Be,L as ct,D as ut,R as mt,M as ht,C as gt,a as pt,b as xt,X as Oe,c as Ve}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const p of document.querySelectorAll('link[rel="modulepreload"]'))o(p);new MutationObserver(p=>{for(const b of p)if(b.type==="childList")for(const y of b.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&o(y)}).observe(document,{childList:!0,subtree:!0});function L(p){const b={};return p.integrity&&(b.integrity=p.integrity),p.referrerPolicy&&(b.referrerPolicy=p.referrerPolicy),p.crossOrigin==="use-credentials"?b.credentials="include":p.crossOrigin==="anonymous"?b.credentials="omit":b.credentials="same-origin",b}function o(p){if(p.ep)return;p.ep=!0;const b=L(p);fetch(p.href,b)}})();function ft({onFinish:g}){const[s,L]=l.useState(!0),o=l.useRef(null),p=l.useRef({x:-1e3,y:-1e3});return l.useEffect(()=>{const b=o.current;if(!b)return;const y=b.getContext("2d");if(!y)return;let i,n=[];const P=()=>{b.width=window.innerWidth,b.height=window.innerHeight},N=r=>{p.current={x:r.clientX,y:r.clientY}},I=r=>{r.touches.length>0&&(p.current={x:r.touches[0].clientX,y:r.touches[0].clientY})};window.addEventListener("resize",P),window.addEventListener("mousemove",N),window.addEventListener("touchmove",I),P();class t{constructor(){this.x=Math.random()*b.width,this.y=Math.random()*b.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>b.width)&&(this.vx*=-1),(this.y<0||this.y>b.height)&&(this.vy*=-1);let k=p.current.x-this.x,R=p.current.y-this.y,u=Math.sqrt(k*k+R*R),m=k/u,S=R/u;const B=150;let z=(B-u)/B;u<B&&(this.x-=m*z*this.density*.5,this.y-=S*z*this.density*.5)}draw(){y&&(y.fillStyle="rgba(255, 255, 255, 0.8)",y.beginPath(),y.arc(this.x,this.y,this.size,0,Math.PI*2),y.fill())}}for(let r=0;r<120;r++)n.push(new t);const d=()=>{y.clearRect(0,0,b.width,b.height);for(let r=0;r<n.length;r++){n[r].update(),n[r].draw();for(let k=r+1;k<n.length;k++){const R=n[r].x-n[k].x,u=n[r].y-n[k].y,m=Math.sqrt(R*R+u*u);m<100&&(y.beginPath(),y.strokeStyle=`rgba(255, 255, 255, ${.2*(1-m/100)})`,y.lineWidth=.6,y.moveTo(n[r].x,n[r].y),y.lineTo(n[k].x,n[k].y),y.stroke())}}i=requestAnimationFrame(d)};return d(),()=>{cancelAnimationFrame(i),window.removeEventListener("resize",P),window.removeEventListener("mousemove",N),window.removeEventListener("touchmove",I)}},[]),e.jsx(Pe,{onExitComplete:g,children:s&&e.jsxs(ge.div,{onClick:()=>L(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:o,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(ge.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(ge.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const bt=`---
id: "01"
...
`;function Ut(g){const s=/^---\r?\n([\s\S]*?)\r?\n---/,L=g.match(s);let o={},p=g;if(L){const b=L[1];p=g.slice(L[0].length).trim();const y=b.split(/\r?\n/);let i=null,n=[];y.forEach(P=>{if(P.trim()==="")return;const I=P.indexOf(":");if(I!==-1&&!P.startsWith(" ")){i&&(o[i]=n.join(`
`)),i=P.slice(0,I).trim();let t=P.slice(I+1).trim();t==="|"?n=[]:(o[i]=t,i=null,n=[])}else i&&P.startsWith("  ")&&n.push(P.slice(2))}),i&&n.length>0&&(o[i]=n.join(`
`)),Object.keys(o).forEach(P=>{let N=o[P];if(typeof N=="string")if(N=N.trim(),N.startsWith('"')&&N.endsWith('"')&&(N=N.slice(1,-1)),N.startsWith("[")&&N.endsWith("]"))try{o[P]=JSON.parse(N)}catch{o[P]=[N.slice(1,-1).trim()]}else N==="true"?o[P]=!0:N==="false"?o[P]=!1:!isNaN(Number(N))&&N.trim()!==""?o[P]=Number(N):o[P]=N})}return{id:o.id||"",slug:o.slug||"",title:o.title||"",category:o.category||"",year:o.year||"",description:o.description||"",tech:o.tech||[],abstract:o.abstract||"",challenge:o.challenge||"",solution:o.solution||"",hasDemo:o.hasDemo||!1,icon:o.icon||"",code:o.code||"",logo:o.icon||"",image:o.image||[],content:p}}function G(g){const s=Ut(g);return{id:s.id,slug:s.slug,title:s.title,category:s.category,year:s.year,description:s.description,tech:s.tech,hasDemo:s.hasDemo,details:{abstract:s.abstract,description:s.description,challenge:s.challenge,solution:s.solution,logo:s.logo,icon:s.icon,code:s.code,image:s.image,content:s.content}}}const Se=[G(bt),G(vt),G(yt),G(jt),G(wt),G(kt)],Ce=[G(Nt),G(Mt),G(Lt),G(St),G(Ct),G(Dt),G(It)],De=[G(At),G(Pt)],Ie=[G(Et),G(_t),G(Tt)],Ae=[G(Rt),G(zt),G(Ft),G(Gt),G(Bt),G(Ot),G(Vt)],me=({data:g,type:s})=>{const[L,o]=l.useState("grid"),[p,b]=l.useState(1),y=55,i={2:{text:"Self-introduction",link:"/about"},5:{text:"View 1037pinpin Project",link:"/design/1037pinpin"},11:{text:"View Perslearn Project",link:"/design/perslearn"},21:{text:"View Dragon Diffusion Project",link:"/design/dragon-diffussion"},27:{text:"View Genstyle Project",link:"/design/genstyle"},43:{text:"View Luoshu Project",link:"/design/bazi-fengshui-analysis"},48:{text:"View Genshot Project",link:"/design/genshot"}};return e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500",children:[s==="design"?e.jsxs("div",{className:"flex flex-col lg:flex-row gap-6 lg:gap-8",children:[e.jsxs("div",{className:"flex-1 lg:flex-shrink-0 lg:w-[55%]",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-4",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Portfolio PDF"}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Page ",p," / ",y]})]}),e.jsxs("div",{className:"relative flex items-center justify-center gap-2",children:[e.jsx("button",{onClick:()=>b(n=>Math.max(1,n-1)),disabled:p<=1,className:"flex-shrink-0 w-10 h-10 rounded-full bg-white dark:bg-neutral-800 shadow-lg hover:shadow-xl disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-300 border border-neutral-200 dark:border-neutral-700",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsxs("div",{className:"relative flex-1 bg-neutral-100 dark:bg-neutral-800 rounded-lg overflow-hidden shadow-2xl border border-neutral-300 dark:border-neutral-600",style:{aspectRatio:"4/2.8"},children:[e.jsx("iframe",{src:`https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/lili_ui_portfolio.pdf#page=${p}&view=Fit&scrollbar=0&toolbar=0&navpanes=0`,className:"absolute inset-0 w-[110%] h-[110%] pointer-events-none",title:"Portfolio PDF",style:{border:"none",transform:"translate(-2.5%, -5%)"}},p),e.jsx("div",{className:"absolute inset-0 bg-transparent z-10",style:{pointerEvents:"none"}})]}),e.jsx("button",{onClick:()=>b(n=>Math.min(y,n+1)),disabled:p>=y,className:"flex-shrink-0 w-10 h-10 rounded-full bg-white dark:bg-neutral-800 shadow-lg hover:shadow-xl disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-300 border border-neutral-200 dark:border-neutral-700",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),e.jsx("div",{className:"flex justify-center gap-1 mt-4 flex-wrap",children:Array.from({length:y}).map((n,P)=>{const N=P+1,I=p===N,t=i[N];return e.jsx("button",{onClick:()=>b(N),className:`h-1.5 rounded-full transition-all duration-300 ${I?"bg-neutral-800 dark:bg-neutral-200 w-6":t?"bg-blue-500 w-1.5 hover:bg-blue-600":"bg-neutral-300 dark:bg-neutral-600 w-1.5 hover:bg-neutral-400"}`,title:t?i[N].text:`Page ${N}`},P)})}),i[p]&&e.jsx("div",{className:"mt-3 flex justify-center",children:e.jsxs(X,{to:i[p].link,className:"inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded-full transition-colors shadow-md hover:shadow-lg",children:[e.jsx("span",{children:i[p].text}),e.jsx("svg",{className:"w-3 h-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M14 5l7 7m0 0l-7 7m7-7H3"})})]})})]}),e.jsxs("div",{className:"flex-1 lg:w-[45%]",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-4",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Selected Designs"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>o("grid"),className:`px-2 py-1 text-xs font-mono ${L==="grid"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"GRID"}),e.jsx("button",{onClick:()=>o("list"),className:`px-2 py-1 text-xs font-mono ${L==="list"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"LIST"})]}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Idx: ",g.length]})]})]}),e.jsx("div",{className:"overflow-y-auto",style:{aspectRatio:"4/2.7"},children:L==="list"?e.jsx("div",{className:"space-y-0",children:g.map(n=>e.jsx("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-3 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm",children:e.jsxs("div",{className:"flex flex-row gap-3 items-center flex-1",children:[e.jsxs(X,{to:`/${s}/${n.slug}`,className:"flex-grow min-w-0 w-full flex flex-row gap-3 items-center",children:[e.jsx("div",{className:"flex-shrink-0 w-12 h-12 border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800",children:n.details.logo?e.jsx("img",{src:n.details.logo,alt:n.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-1",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",n.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:n.year})]}),e.jsx("h3",{className:"text-sm font-bold text-neutral-900 dark:text-neutral-100 mb-0.5 group-hover:text-blue-600 truncate",children:n.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-xs line-clamp-1",children:n.description})]})]}),n.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${n.slug}#demo`},className:"flex-shrink-0 px-2 py-1 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]})},n.slug))}):e.jsx("div",{className:"grid grid-cols-2 gap-3",children:g.map(n=>e.jsxs("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-3 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm flex flex-col",children:[e.jsxs(X,{to:`/${s}/${n.slug}`,className:"flex flex-col h-full",children:[e.jsx("div",{className:"flex-shrink-0 w-full aspect-square border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800 mb-2",children:n.details.logo?e.jsx("img",{src:n.details.logo,alt:n.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-8 h-8",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-1",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",n.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:n.year})]}),e.jsx("h3",{className:"text-sm font-bold text-neutral-900 dark:text-neutral-100 mb-0.5 group-hover:text-blue-600 line-clamp-2",children:n.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-xs line-clamp-2",children:n.description})]})]}),n.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${n.slug}#demo`},className:"flex-shrink-0 w-full mt-2 px-2 py-1 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]},n.slug))})})]})]}):e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8",children:[e.jsxs("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:["Selected ",s==="research"?"Researches":s==="game"?"Games":s==="planning"?"Planning":s==="tutorials"?"Tutorials":"Platform"]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>o("grid"),className:`px-3 py-1 text-xs font-mono ${L==="grid"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"GRID"}),e.jsx("button",{onClick:()=>o("list"),className:`px-3 py-1 text-xs font-mono ${L==="list"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"LIST"})]}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Idx: ",g.length]})]})]}),s!=="design"&&(L==="list"?e.jsx("div",{className:"space-y-4",children:g.map(n=>e.jsx("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-4 md:p-6 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm",children:e.jsxs("div",{className:"flex flex-row gap-4 md:gap-6 items-center flex-1",children:[e.jsxs(X,{to:`/${s}/${n.slug}`,className:"flex-grow min-w-0 w-full flex flex-row gap-4 md:gap-6 items-center",children:[e.jsx("div",{className:"flex-shrink-0 w-16 h-16 md:w-20 md:h-20 border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800",children:n.details.logo?e.jsx("img",{src:n.details.logo,alt:n.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-8 h-8",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",n.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:n.year})]}),e.jsx("h3",{className:"text-base md:text-lg lg:text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 truncate",children:n.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-sm line-clamp-1",children:n.description})]})]}),n.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${n.slug}#demo`},className:"flex-shrink-0 px-3 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]})},n.slug))}):e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6",children:g.map(n=>e.jsxs("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-4 md:p-6 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm flex flex-col",children:[e.jsxs(X,{to:`/${s}/${n.slug}`,className:"flex flex-col h-full",children:[e.jsx("div",{className:"flex-shrink-0 w-full aspect-square border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800 mb-4",children:n.details.logo?e.jsx("img",{src:n.details.logo,alt:n.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-12 h-12",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",n.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:n.year})]}),e.jsx("h3",{className:"text-base md:text-lg font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 line-clamp-2",children:n.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-sm line-clamp-2",children:n.description})]})]}),n.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${n.slug}#demo`},className:"flex-shrink-0 w-full mt-4 px-3 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]},n.slug))}))]})},ve=g=>{const s=document.getElementById(g);s&&s.scrollIntoView({behavior:"smooth",block:"start"})},$t="modulepreload",Ht=function(g,s){return new URL(g,s).href},Ue={},$=function(s,L,o){let p=Promise.resolve();if(L&&L.length>0){let y=function(N){return Promise.all(N.map(I=>Promise.resolve(I).then(t=>({status:"fulfilled",value:t}),t=>({status:"rejected",reason:t}))))};const i=document.getElementsByTagName("link"),n=document.querySelector("meta[property=csp-nonce]"),P=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));p=y(L.map(N=>{if(N=Ht(N,o),N in Ue)return;Ue[N]=!0;const I=N.endsWith(".css"),t=I?'[rel="stylesheet"]':"";if(!!o)for(let k=i.length-1;k>=0;k--){const R=i[k];if(R.href===N&&(!I||R.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${N}"]${t}`))return;const r=document.createElement("link");if(r.rel=I?"stylesheet":$t,I||(r.as="script"),r.crossOrigin="",r.href=N,P&&r.setAttribute("nonce",P),document.head.appendChild(r),I)return new Promise((k,R)=>{r.addEventListener("load",k),r.addEventListener("error",()=>R(new Error(`Unable to preload CSS for ${N}`)))})}))}function b(y){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=y,window.dispatchEvent(i),!i.defaultPrevented)throw y}return p.then(y=>{for(const i of y||[])i.status==="rejected"&&b(i.reason);return s().catch(b)})},Wt=l.lazy(()=>$(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),qt=l.lazy(()=>$(()=>import("./UR-platform-B26NuqWS.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),Kt=l.lazy(()=>$(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),Xt=l.lazy(()=>$(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),Zt=l.lazy(()=>$(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),Yt=l.lazy(()=>$(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),Jt=l.lazy(()=>$(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));l.lazy(()=>$(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const Qt=l.lazy(()=>$(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),en=l.lazy(()=>$(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),tn=l.lazy(()=>$(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),nn=l.lazy(()=>$(()=>import("./riffle-BuqCfcTA.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),an=l.lazy(()=>$(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),rn=l.lazy(()=>$(()=>import("./genshot-8Uy4GIux.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),sn=g=>({"cluster-visualizer-3d":Wt,"participatory-urban-regeneration-empowered-by-artificial-intelligence":qt,heatmapper:Kt,"how-to-add-openstreetmap-in-website":Xt,"how-to-get-sequential-events-from-photo-by-phone":Zt,"how-to-visualize-photo-geolocation-data-on-map":Yt,"how-to-build-game-in-wechat-mini-program":tn,"how-to-conduct-time-geo-sequential-clustering-from-album":Jt,"box-up-my-stuff-in-cyberspace":Qt,"epstein-mystery-archive":en,"riffle-ai-game-generation-tool":nn,genstyle:an,"genshot-AI-video-generation-tool":rn})[g],Me={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
