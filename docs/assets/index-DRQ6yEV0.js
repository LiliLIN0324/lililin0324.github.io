...
import{r as i,j as e,L as $,u as wc,R as kc,a as zc,c as Nc,d as qc,e as Cc,f as O,H as Mc,g as Sc}from"./react-vendor-6zld6QO8.js";import{A as Ac,m as Xe}from"./framer-DvVmTyA1.js";import{M as Ic,r as Lc,a as Dc}from"./markdown-q3GborES.js";import{b as ec}from"./geo-Z02C8O4I.js";import{m as Oe}from"./maplibre-BedwuVXB.js";import{U as cc,L as Ec,D as _c,R as Pc,M as Rc,C as Tc,a as Gc,b as Bc,X as tc,c as ac}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&t(n)}).observe(document,{childList:!0,subtree:!0});function g(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(r){if(r.ep)return;r.ep=!0;const s=g(r);fetch(r.href,s)}})();function Uc({onFinish:c}){const[b,g]=i.useState(!0),t=i.useRef(null),r=i.useRef({x:-1e3,y:-1e3});return i.useEffect(()=>{const s=t.current;if(!s)return;const n=s.getContext("2d");if(!n)return;let k,j=[];const E=()=>{s.width=window.innerWidth,s.height=window.innerHeight},q=o=>{r.current={x:o.clientX,y:o.clientY}},y=o=>{o.touches.length>0&&(r.current={x:o.touches[0].clientX,y:o.touches[0].clientY})};window.addEventListener("resize",E),window.addEventListener("mousemove",q),window.addEventListener("touchmove",y),E();class z{constructor(){this.x=Math.random()*s.width,this.y=Math.random()*s.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>s.width)&&(this.vx*=-1),(this.y<0||this.y>s.height)&&(this.vy*=-1);let _=r.current.x-this.x,G=r.current.y-this.y,U=Math.sqrt(_*_+G*G),D=_/U,ce=G/U;const R=150;let M=(R-U)/R;U<R&&(this.x-=D*M*this.density*.5,this.y-=ce*M*this.density*.5)}draw(){n&&(n.fillStyle="rgba(255, 255, 255, 0.8)",n.beginPath(),n.arc(this.x,this.y,this.size,0,Math.PI*2),n.fill())}}for(let o=0;o<120;o++)j.push(new z);const C=()=>{n.clearRect(0,0,s.width,s.height);for(let o=0;o<j.length;o++){j[o].update(),j[o].draw();for(let _=o+1;_<j.length;_++){const G=j[o].x-j[_].x,U=j[o].y-j[_].y,D=Math.sqrt(G*G+U*U);D<100&&(n.beginPath(),n.strokeStyle=`rgba(255, 255, 255, ${.2*(1-D/100)})`,n.lineWidth=.6,n.moveTo(j[o].x,j[o].y),n.lineTo(j[_].x,j[_].y),n.stroke())}}k=requestAnimationFrame(C)};return C(),()=>{cancelAnimationFrame(k),window.removeEventListener("resize",E),window.removeEventListener("mousemove",q),window.removeEventListener("touchmove",y)}},[]),e.jsx(Ac,{onExitComplete:c,children:b&&e.jsxs(Xe.div,{onClick:()=>g(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:t,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(Xe.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(Xe.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const Oc=`---
id: "00"
slug: "chicken-utopia"
...
tech: ["Python","Three.js","React", "SOM","K-Means"]\r
...
\r
项目代码库：\r
https://github.com/LiliLIN0324/gloabl-urban-heat\r
\r
# 项目介绍\r
\r
本项目的核心是一个基于 **SOM（自组织映射）+ K-means** 两阶段聚类方法的空间数据研究：对全球 **204 个城市**的城市热岛（Urban Heat Island, UHI）时空格局进行划分与可视化，并关联建筑、冠层、水体、绿地、山体等城市形态指标，探究「城市形态如何影响热岛强度」。配套的 3D 可视化工具则把这一高维聚类结果放到可交互的三维空间中，让复杂的数据格局变得一目了然。\r
\r
# 项目重点\r
基于 **SOM + K-means** 两阶段聚类，对全球 **204 个城市**的城市热岛时空序列（2017–2019、昼夜双时相、2,178 维特征、142,506 个网格）做格局划分，并结合城市形态指标分析热岛成因，配套 Three.js/React 交互式 3D 可视化。\r
\r
## 1. 项目速览\r
\r
| 维度 | 内容 |\r
|------|------|\r
| 研究对象 | 全球城市热岛（UHI）时空格局 |\r
| 样本规模 | 原始 269 城 → 清洗后 223 城 → 剔除南半球后 **204 城**（共 142,506 个空间网格单元） |\r
| 时间范围 | 2017–2019 三年 × 白天/夜间双时相 |\r
| 特征维度 | 2,178 维（UHI 7 天滑动平均时间序列） |\r
| 聚类方法 | 两阶段：SOM 自组织映射（降维）→ K-means（聚类） |\r
| 聚类方案 | K = 5 / 12 / 20 / 26 四组对照 |\r
| 城市形态指标 | 建筑高度/密度/容积率、冠层、绿地、水体/山体距离等 10+ 项 |\r
| 主要产出 | 聚类结果 Shapefile、热岛曲线图、形态指标空间分布图 |\r
\r
## 2. 研究背景与目标\r
\r
**城市热岛**是指城市建成区气温显著高于周边郊区的现象。本项目不只看「哪座城市热」，而是想回答两个问题：\r
\r
1. **全球城市的昼夜热岛规律有没有共性模式？** —— 用聚类把 204 座城市在 2017–2019 三年间白天/夜间的热岛变化曲线分成几类「格局」；\r
2. **城市形态如何影响热岛强度？** —— 把聚类结果与建筑、冠层、水体、绿地、山体等形态指标叠合分析，找出「哪些建设方式让城市更热 / 更凉」。\r
\r
具体研究目标：\r
\r
1. 处理 2017–2019 三年、白天/夜间两个时相的城市热岛滑动平均时间序列数据；\r
2. 用 **SOM** 将高维热岛时间序列映射到低维神经元网格，提取每个空间单元的最佳匹配单元（**BMU**）；\r
3. 对 SOM 神经元权重做 **K-means** 聚类，考察 K = 5 / 12 / 20 / 26，划分热岛格局类型；\r
4. 用**分区统计（Zonal Statistics）**计算建筑、冠层、水体、绿地、山体等城市形态指标；\r
5. 将聚类结果与形态指标合并，完成空间可视化与影响因素分析。\r
\r
## 3. 方法与流程总览\r
\r
> 遇到生词别慌，先看文末[术语速查](#附录术语速查)。核心链路其实只有三步：**算热岛 → SOM+K-means 分类 → 叠合形态指标找规律**。\r
\r
\`\`\`\r
全球影像 + 城市边界\r
   │  ① 预处理：逐日 UHI = 建成区 LST − 草地 LST，再做 7 天滑动平均\r
   ▼\r
UHI 滑动平均时间序列（每样本 2,178 维）\r
   │  ② SOM 把高维序列映射到 1,890 个神经元 → 每个网格得到 BMU 坐标\r
   ▼\r
   │  ③ 对神经元权重做 K-means（K = 5/12/20/26）\r
   ▼\r
每个空间网格的「聚类标签」\r
   │  ④ 分区统计算出形态指标 → 与聚类结果合并\r
   ▼\r
热岛格局类型图 + 城市形态对热岛的影响分析\r
\`\`\`\r
\r
整体流程共 **五个阶段**，每个阶段对应 \`coding/\` 下的一个 Notebook/脚本：\r
\r
| 阶段 | 文件 | 目的 | 主要产出 |\r
|------|------|------|----------|\r
| ① 数据预处理 | \`a_data_process.ipynb\` | 原始影像 → 城市热岛滑动平均时间序列 | 白天/夜间 UHI 序列 CSV |\r
| ② SOM + K-means 聚类（主流程） | \`b_SOM_kmeans_process.ipynb\` 及其 NEW / discord 变体 | 降维 + 聚类，输出各 K 值标签 | 聚类标签 CSV、SOM 模型、神经元权重 |\r
| ③ 形态指标分区统计 | \`c_Bui&Cano_data_zonalst.ipynb\` + \`e_Cost_DistWB.py\` | 建筑/冠层/水体/绿地/山体指标 | 各城市形态指标统计表 |\r
| ④ 合并与可视化 | \`d_zonalst&cluster_merge_visual.ipynb\` | 聚类 + 指标合并，制图 | Shapefile、空间分布图 |\r
| ⑤ 验证（辅助） | \`验证.ipynb\` | 对比本机与老师产出一致性 | 差异率为 0 的校验结果 |\r
\r
> 另有 \`CFA可视化.ipynb\`（CFA 结果可视化）为辅助脚本；\`main.py\` 是 PyCharm 新建项目的占位文件，无实际逻辑，可忽略。\r
\r
## 4. 目录结构\r
\r
\`\`\`\r
gloabl-urban-heat/\r
├── main.py                      # PyCharm 占位脚本（无业务逻辑，可忽略）\r
├── coding/                      # 处理代码（Jupyter Notebook）\r
│   ├── a_data_process.ipynb          # ① 原始数据 → UHI 滑动平均时间序列\r
│   ├── b_SOM_kmeans_process.ipynb    # ② SOM + K-means 聚类（主流程）\r
│   ├── b_SOM_kmeans_process NEW.ipynb# ② 更新版（新增半球/排序等处理）\r
│   ├── b_SOM_kmeans_process_discord.ipynb # ② 聚类结果按 K 分组的散点/热力图\r
│   ├── c_Bui&Cano_data_zonalst.ipynb # ③ 建筑/冠层/水体/绿地/山体分区统计\r
│   ├── d_zonalst&cluster_merge_visual.ipynb # ④ 聚类 + 形态指标合并与可视化\r
│   ├── e_Cost_DistWB.py              # 成本距离（Cost Distance）脚本（ArcGIS, Py2.7）\r
│   ├── CFA可视化.ipynb               # 辅助：CFA 结果可视化\r
│   └── 验证.ipynb                    # 辅助：验证模型产物一致性\r
├── city/                        # 城市数据与聚类结果\r
│   ├── 223_cities_combined_moving_ave_cluster*.csv  # 热岛滑动平均 + 聚类标签\r
│   ├── 223_cities_som_clustered_data.csv            # SOM 聚类数据（含神经元坐标）\r
│   ├── 223_cities_with_hemisphere*.csv              # 标注南北半球（用于剔除南半球）\r
│   ├── BMUs.npy / node_weights.npy / Neuron_Coordinates_only.csv  # SOM 产物\r
│   ├── *.shp / *.dbf / *.prj / *.shx / *.cpg       # 聚类结果 Shapefile\r
│   └── results/                  # 输出结果\r
│       ├── bmus_kmeans_K*.csv    # 各 K 值聚类结果（K=5/12/20/26）\r
│       ├── discord/              # 按 K 分组的热岛序列对比图\r
│       ├── picture/              # 可视化图片（K=5）\r
│       └── picture_d/            # 可视化图片（K=5/12/20/26）\r
├── pkl/                         # 序列化模型\r
│   ├── som.pkl                  # 训练好的 SOM 模型\r
│   └── clustinstances_kmeans.pkl# K-means 聚类实例\r
└── 老师发的/                    # 老师提供的参考产物（用于验证）\r
    ├── BMUs.npy\r
    └── node_weights.npy\r
\`\`\`\r
\r
...
| 数据 | 分辨率 | 用途（对应变量） | 来源 |\r
|------|--------|----------------|------|\r
| 山体地形单元 GBLU | 30 m | 到山体最小成本距离 \`MIN_DistMT\` | [Zenodo](https://zenodo.org/records/13187969) |\r
| 水体（ESA WorldCover） | 10 m | 到水体最小成本距离 \`MIN_DistWB\` | [Zenodo](https://zenodo.org/records/5571936) |\r
| 高程（Copernicus DSM） | 30 m | 高程/坡度、参考区去噪掩膜 | [Copernicus](https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/collections-description/COP-DEM) |\r
| 植被种类（ESA WorldCover） | 10 m | 草地参考区、绿地率 \`GreenRatio\` / 绿容比 \`GrVolRatio\` | [Zenodo](https://zenodo.org/records/5571936) |\r
| 树木冠层 CHM（WRI & Meta） | 25 m（另有 1 m 版） | 冠层密度 / 体积比 \`Candensity\` \`CanovRatio\` | [公众号说明](https://mp.weixin.qq.com/s/OXRbSSiAaOSyrR6Qv49F9w) |\r
| Built-up 建成区（ESA WorldCover） | 10 m | 建成区范围、不透水面比例 \`ISF\` | [Zenodo](https://zenodo.org/records/5571936) |\r
| 建筑高度 GHS（JRC） | 100 m | 建筑高度 \`Buiheight\`（= \`MEAN\`） | [GHSL](https://ghsl.jrc.ec.europa.eu/) |\r
| 建筑面积 GHS（JRC） | 10 m | 建筑密度 \`Buidensity\`、容积率 \`FAR\` | [GHSL](https://ghsl.jrc.ec.europa.eu/) |\r
\r
### 5.2 下载方式\r
\r
- **Copernicus DEM（COP-DEM）**：全球 30 m / 90 m（欧洲部分 10 m）。可经欧空局 [Panda](https://panda.copernicus.eu/panda) 或 [OpenTopography](https://portal.opentopography.org/datasetMetadata?otCollectionID=OT.032021.4326.1) 下载；批量下载用 AWS CLI：\r
  \`\`\`bash\r
  aws s3 ls s3://raster/COP30/ --recursive --endpoint-url https://opentopography.s3.sdsc.edu --no-sign-request\r
  aws s3 cp s3://raster/COP30/ . --recursive --endpoint-url https://opentopography.s3.sdsc.edu --no-sign-request\r
  \`\`\`\r
- **ESA WorldCover**：从 [worldcover2020.esa.int](https://worldcover2020.esa.int) 下载，本地存放于 \`C:\\ESA\`。\r
- **GHS 建筑高度/面积**：EPSG 54009（Mollweide）投影、数据年份 2018、版本 2023A。\r
\r
> **主要数据文件示例**（便于核对文件命名）：山体 \`GBLU_v1_S90W080\`；水体/植被/Built-up \`ESA_WorldCover_10m_2020_v100_N00E006_Map\`；高程 \`Copernicus_DSM_10_N23_00_E112_00_DEM\`；冠层 \`meta_chm_lat=90.0_lon=-110.0_avg\`；建筑高度 \`GHS_BUILT_H_AGBH_E2018_GLOBE_R2023A_54009_100_V1_0.tif\`；建筑面积 \`GHS_BUILT_S_E2018_GLOBE_R2023A_54009_10_V1_0.tif\`。\r
\r
## 6. 处理流程详解\r
\r
### ① 数据预处理 — \`a_data_process.ipynb\`\r
\r
把原始影像变成可用特征：**逐日 UHI = 建成区地表温度 − 草地（参考区）地表温度**，再做 **7 天滑动平均（MA）**，最终得到三年、双时相的 UHI 时间序列。具体步骤：\r
\r
- **00 数据预处理**：建成区 tif → shapefile；裁剪草地并提取为参考区 shapefile，生成「建成区 + 草地」两类 shapefile。\r
  - \`00_00\` 每次运行前需执行的初始化代码；\r
  - \`00_00*\` 调用高程处理 Notebook 生成参考区：对建成区高程栅格取**中位数**，并**剔除大于「建成区 median + 50」的高程值**（去噪）；\r
  - \`00_01\` 将建成区 shapefile 拆分为多个文件；\r
  - \`00_02\` 用掩膜提取草地与稀疏植被，得到参考区草地 shapefile；\r
  - \`00_03\` 用草地 shapefile 裁剪栅格；\r
  - \`00_04\` 生成的 tif 转 shapefile。\r
- **输出**：白天/夜间分离的 UHI 时间序列 \`0_18_day_2017_2019_data.csv\`、\`0_18_night_2017_2019_data.csv\`。\r
\r
### ② SOM + K-means 聚类 — \`b_SOM_kmeans_process.ipynb\`\r
\r
核心聚类流程，共 4 步：\r
\r
1. 对标准化后的热岛时间序列训练 **SOM**，得到每个空间单元的 **BMU**；\r
2. 把高维特征映射为二维神经元坐标；\r
3. 对 **SOM 神经元权重**执行 K-means，分别以 K = 5 / 12 / 20 / 26 聚类；\r
4. 输出各 K 值聚类标签 CSV，并对聚类做排序、统计各类均值，绘制热岛序列曲线图。\r
\r
> 变体说明：\`b_SOM_kmeans_process NEW.ipynb\` 在原版基础上新增了半球标注与排序等处理；\`b_SOM_kmeans_process_discord.ipynb\` 专门绘制按 K 分组的散点/热力图。\r
\r
**主要产物**：\`pkl/som.pkl\`、\`pkl/clustinstances_kmeans.pkl\`；\`city/BMUs.npy\`（142,506 × 2，各空间单元的 SOM 神经元坐标）、\`city/node_weights.npy\`（1,890 × 2,178，神经元权重）、\`city/results/bmus_kmeans_K{5,12,20,26}.csv\`。\r
\r
### ③ 城市形态指标分区统计 — \`c_Bui&Cano_data_zonalst.ipynb\`\r
\r
用 ArcPy / rasterio / GeoPandas 对每个城市的空间网格做**分区统计（Zonal Statistics）**，把形态数据落到与聚类相同的空间单元上：\r
\r
| 类别 | 指标 |\r
|------|------|\r
| 建筑（Building） | 建筑高度 \`Buiheight\`、建筑密度、容积率 \`FAR\` |\r
| 冠层（Canopy） | 冠层密度、冠层覆盖率 \`CoverRatio\` |\r
| 绿地（Greenland） | 绿地率 \`GreenRatio\`、绿容比 \`GrVolRatio\` |\r
| 建成区（Built-up, ESA） | 建成区面积/比例、不透水面比例 \`ISF\` |\r
| 水体（Water） | 到水体最小成本距离 \`MIN_DistWB\` |\r
| 山体（Mountain） | 到山体最小成本距离 \`MIN_DistMT\` |\r
\r
其中到水体/山体的成本距离由 \`e_Cost_DistWB.py\`（ArcGIS \`CostDistance\`，需 Python 2.7 环境）计算。\r
\r
### ④ 合并与可视化 — \`d_zonalst&cluster_merge_visual.ipynb\`\r
\r
提取 X/Y 坐标、城市名、Place ID、Sum ID 与聚类标签；CSV 转 Shapefile（WGS 1984）；将聚类结果与建筑/冠层/水体/绿地/山体指标合并，绘制各指标的空间分布图。\r
\r
### ⑤ 验证 — \`验证.ipynb\`\r
\r
对比 \`老师发的/\` 与 \`city/\` 下的 \`BMUs.npy\`、\`node_weights.npy\`，确认两套模型产物完全一致（差异率 0.0000%），保证分析可复现。\r
\r
## 7. 变量定义\r
\r
| 变量 | 含义 / 公式 |\r
|------|-------------|\r
| \`MEAN\` | 建筑高度（Building Height, m） |\r
| \`Buidensity\` | 建筑密度 = 建筑面积 / 用地面积 = Count × (10m × 10m) / cell(m²) |\r
| \`FAR\` | 容积率 = 建筑密度 × 建筑高度 / 层高 = \`Buidensity\` × \`MEAN\` / 3 |\r
| \`Candensity\` | 植被覆盖密度 = 植被面积 / 总面积 = Count × (25m × 25m) / cell(m²) |\r
| \`CanovRatio\` | 冠层体积比 = 冠层密度 × 植被高度 = \`Candensity\` × \`MEAN_2\` |\r
| \`Cluster\` | 聚类标签，最终方案 K = 5 / 12 / 20 / 26 |\r
| \`Place\` | 城市标签（label） |\r
| \`Place ID\` | 每个城市内部的编号 |\r
| \`Sum ID\` | 全样本编号 |\r
| \`City Name\` | 城市名 |\r
| \`Hemisphere\` | 所在半球 |\r
\r
> \`Count\` 为网格内像元个数，\`cell\` 为网格面积；建筑像元 10 m、冠层像元 25 m；\`MEAN_2\` 为植被（冠层）高度。\r
\r
## 8. 核心数据与产出\r
\r
| 文件 | 说明 |\r
|------|------|\r
| \`223_cities_combined_moving_ave_cluster.csv\` | 2,178 维热岛滑动平均特征 + 坐标/城市信息 + K_5/K_12/K_20/K_26 聚类标签 |\r
| \`223_cities_som_clustered_data.csv\` | 2,178 维特征 + \`Neuron_Coordinates\`（SOM 神经元坐标） |\r
| \`223_cities_combined_moving_ave_cluster_sort_xy.*\` | 精简后的聚类结果 Shapefile（X/Y/Place/City/Cluster） |\r
| \`BMUs.npy\` | 142,506 个空间单元 → 二维神经元坐标映射 |\r
| \`node_weights.npy\` | 1,890 个 SOM 神经元 × 2,178 维特征权重 |\r
\r
**关键规模参数**：\r
\r
- **样本**：最终 204 城（269 → 清洗 223 → 剔除南半球后 204，仅北半球），共 **142,506** 个空间网格单元；\r
- **特征维度**：**2,178** 维（2017–2019 年 × 白天/夜间 × 滑动平均），列名形如 \`gf_Day2017_001_to_gf_Day2017_007\`、\`gf_Nit2019_359_to_gf_Nit2019_365\`（\`Day\` 白天、\`Nit\` 夜间）；\r
- **SOM 规模**：1,890 个神经元；\r
- **聚类方案**：K = 5 / 12 / 20 / 26 四组对照。\r
\r
## 9. 运行环境与依赖\r
\r
- **Python 3**（Jupyter Notebook）\r
  - 数据处理：\`pandas\`、\`numpy\`、\`rasterio\`、\`geopandas\`、\`pyproj\`\r
  - 聚类/机器学习：\`pydlc\`（SOM）、\`scikit-learn\`（K-means）、\`pickle\`\r
  - 可视化：\`matplotlib\` 等\r
- **ArcGIS / ArcPy**：分区统计与成本距离（\`e_Cost_DistWB.py\` 需 Python 2.7 环境）\r
\r
## 10. 注意事项与复现提示\r
\r
1. \`main.py\` 为 PyCharm 新建项目的占位脚本，无实际业务逻辑，可忽略；\r
2. 部分 Notebook 的 Markdown 注释为 GBK 编码，在 UTF-8 下可能显示乱码，**不影响代码逻辑**；\r
3. \`e_Cost_DistWB.py\` 中的硬编码路径（\`D:\\file\\...\`）与工作目录为作者本机路径，复现时需按需修改。\r
\r
## 附录：术语速查\r
\r
| 术语 | 含义 |\r
|------|------|\r
| **UHI** | Urban Heat Island，城市热岛，城市建成区相对郊区的升温现象 |\r
| **MA** | Moving Average，滑动平均（对日 UHI 做 7 天滑动平均以去除噪声） |\r
| **LST** | Land Surface Temperature，地表温度 |\r
| **SOM** | Self-Organizing Map，自组织映射，一种把高维数据映射到低维网格的无监督神经网络 |\r
| **BMU** | Best Matching Unit，最佳匹配单元，即与某样本最相似的 SOM 神经元 |\r
| **K-means** | 一种按距离把样本划分为 K 类的经典聚类算法 |\r
| **分区统计** | Zonal Statistics，按空间区域统计其覆盖的栅格值 |\r
| **成本距离** | Cost Distance，ArcGIS 中考虑通行成本的路径/距离分析 |\r
\r
\r
\r
\r
...
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/100.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/101.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/102.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/103.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/104.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/105.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/106.jpg)`,Vc=`---
id: "01"
slug: "hongqiqu"
title: "红旗渠遗产价值评估"
category: "planning"
...
image:["https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/01.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/02.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/03.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/04.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/05.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/06.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/07.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/08.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/09.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/10.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/11.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/12.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/13.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/14.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/15.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/16.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/17.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/18.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/19.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/20.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/21.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/22.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/23.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/24.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/25.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/26.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/27.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/28.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/29.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/30.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/31.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/32.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/33.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/34.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/35.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/36.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/37.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/38.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/39.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/40.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/41.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/42.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/43.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/44.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/45.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/46.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/47.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/48.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/49.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/50.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/51.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/52.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/53.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/54.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/55.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/56.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/57.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/58.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/59.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/60.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/61.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/62.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/63.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/64.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/65.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/66.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/67.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/68.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/69.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/70.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/71.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/72.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/73.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/74.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/75.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/76.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/77.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/78.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/79.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/80.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/81.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/82.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/83.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/84.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/85.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/86.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/87.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/88.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/89.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/90.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/91.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/92.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/93.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/94.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/95.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/96.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/97.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/98.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/99.jpg"]\r
---\r
\r
# 效果展示\r
...
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/01.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/02.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/03.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/04.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/05.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/06.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/07.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/08.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/09.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/10.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/11.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/12.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/13.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/14.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/15.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/16.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/17.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/18.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/19.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/20.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/21.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/22.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/23.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/24.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/25.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/26.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/27.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/28.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/29.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/30.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/31.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/32.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/33.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/34.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/35.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/36.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/37.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/38.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/39.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/40.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/41.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/42.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/43.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/44.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/45.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/46.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/47.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/48.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/49.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/50.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/51.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/52.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/53.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/54.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/55.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/56.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/57.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/58.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/59.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/60.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/61.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/62.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/63.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/64.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/65.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/66.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/67.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/68.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/69.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/70.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/71.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/72.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/73.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/74.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/75.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/76.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/77.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/78.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/79.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/80.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/81.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/82.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/83.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/84.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/85.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/86.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/87.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/88.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/89.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/90.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/91.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/92.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/93.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/94.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/95.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/96.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/97.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/98.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/local-climate-zones/99.jpg)\r
\r
## 版本1\r
随着气候变化不断加剧，深入理解城市环境中的**热韧性（Heat Resilience, HR）对于建设气候韧性城市至关重要。尽管已有大量研究探讨了城市形态与城市热岛效应（Urban Heat Island, UHI）**之间的关系，但针对热韧性的研究仍相对有限，且现有研究往往仅关注单次极端高温事件。此外，如何将复杂的城市形态研究结果转化为可实际应用的城市规划政策，仍面临较大挑战。<br>\r
\r
**局部气候区（Local Climate Zones, LCZ）**提供了一种基于热环境特征的城市形态分类框架，相较于复杂的城市形态指标，其分类体系更加直观，也更便于规划决策者理解和应用。然而，现有LCZ研究主要集中于城市热岛效应，对热韧性的关注仍较少。<br>\r
\r
本研究以纽约市为案例，分析不同LCZ类型与城市热韧性之间的关系，以弥补现有研究的不足。研究将热韧性定义为极端高温天气与正常高温天气之间地表温度（Land Surface Temperature, LST）的差值。基于2010—2019年的Landsat 8遥感影像，并筛选云量较低的影像，依据气温百分位数识别并构建三组极端高温与正常高温天气事件。进一步结合LCZ地图、GIS数据以及人口普查区（Census Tract）数据，利用**空间面板模型（Spatial Panel Model）**评估不同LCZ类型及大尺度景观因素对城市热韧性的影响。<br>\r
\r
研究结果表明，与LCZ 2（紧凑型中层建筑）相比，LCZ 1（紧凑型高层建筑）和LCZ 4（开放型高层建筑）显著提高热韧性差异，而LCZ 3（紧凑型低层建筑）则显著降低热韧性差异。此外，当正常高温天气本身具有更高的气温，或从正常高温到极端高温期间的温度增幅更大时，城市热韧性差异也会显著增加。<br>\r
\r
这些研究结果为城市规划者和政策制定者制定热风险适应策略提供了参考，并表明可以将LCZ框架进一步纳入气候适应规划与城市治理体系，从而为建设更具热韧性的城市提供规划依据。<br>\r
## 更新后的版本\r
随着气候变化不断加剧，深入理解城市环境中的热韧性（Heat Resilience, HR）对于建设气候韧性城市至关重要。尽管已有大量研究探讨城市形态与城市热岛效应（Urban Heat Island, UHI）之间的关系，但针对热韧性的研究仍相对有限，许多研究仅关注单次极端高温事件。此外，如何将复杂的城市形态研究结果转化为实际可行的城市规划政策，仍然面临挑战。<br>\r
\r
局部气候区（Local Climate Zones, LCZ）提供了一种基于热环境特征的城市形态分类方法，对于政策制定者而言更加直观易懂。然而，现有大多数LCZ研究仍主要关注城市热岛效应，对热韧性的关注较少。本研究旨在弥补这一研究空白，探讨美国五个主要气候区中LCZ与热韧性之间的关系。基于美国能源部（DOE）Building America项目划分的不同气候区进行比较，进一步分析不同气候区在能源消耗和建成环境特征方面的差异，以及这些差异如何导致LCZ表现出共同特征与区域差异。<br>\r
\r
热韧性被定义为极端高温天气与正常高温天气之间地表温度（Land Surface Temperature, LST）的差值。**使用1990—2019年的气温数据，并依据气温第85百分位确定高温事件；同时使用2013—2019年的Landsat 8遥感影像，在去除云层后筛选云量最低的影像以获取相应的LST观测数据，**结合LCZ地图、GIS数据和人口普查区（Census Tract）信息，通过空间面板模型评估不同LCZ类型及大尺度景观因素对不同气候区热韧性的影响。考虑到不同气候区之间存在显著的温度差异，研究进一步揭示了各气候区在热韧性影响方面的显著差异。<br>\r
\r
在2013—2019年期间，通过筛选云量最低的遥感影像，研究依据气温百分位数确定了三组极端高温与正常高温事件。分析结果表明，与LCZ 2（紧凑型中层建筑）相比，LCZ 1（紧凑型高层建筑）和LCZ 4（开放型高层建筑）显著提高热韧性，而LCZ 3（紧凑型低层建筑）则降低热韧性。<br>\r
\r
在不同气候区中，我们假设温度和湿度的差异会导致LCZ产生不同的热韧性响应，并表现出不同程度的敏感性。研究选取纽约市作为湿润大陆性气候区（CZ-MixedHumid）的代表城市、西雅图作为海洋性气候区（Marine）的代表城市、洛杉矶作为炎热干燥气候区（Hot-Dry）的代表城市、芝加哥作为寒冷气候区（Cold）的代表城市，以及休斯顿作为炎热湿润气候区（Hot-Humid）的代表城市，以探究不同气候区之间相似与不同的热韧性模式。这些差异源于各城市独特的温度和湿度特征，以及风环境的影响，从而使不同LCZ区域呈现出不同的热韧性动态。<br>\r
\r
尽管不同区域之间存在差异，但在正常高温天气具有较高温度，以及从正常高温天气到极端高温天气出现显著温度升高的情况下，LCZ 1、LCZ 2、LCZ 3和LCZ 4在极端高温事件中均表现出较强的热韧性强度。这些研究结果为城市规划者和政策制定者建设具有热韧性的城市提供了有价值的参考，并表明可以将LCZ框架纳入不同气候区的气候适应策略与城市治理体系。<br>\r
\r
**关键词：** 热韧性、气候区、局部气候区<br>\r
\r
**主题类别：** WELL BEING_热环境<br>\r
\r
\r
\r
**abstract-version1**\r
As climate change intensifies, understanding heat resilience (HR) in urban environments is crucial for developing climate-resilient cities. While numerous studies have examined the relationship between urban form and urban heat islands (UHI), few have focused on HR, often limiting their analysis to single extreme heat events. Additionally, <strong>translating complex urban form findings into practical urban planning policies remains challenging.</strong><br>\r
The concept of local climate zones (LCZ) offers a thermally-based classification of urban forms, which is more accessible for policymakers. However, most LCZ studies focus on UHI, with little attention to HR. This study addresses this gap by analyzing the relationship between LCZs and HR in New York City. HR is defined as the difference in land surface temperature (LST) between extreme heat and normal heat days. <strong>Using Landsat 8 imagery from 2010 to 2019 and selecting days with minimal cloud cover, the study identifies three pairs of heat events based on air temperature percentiles.</strong> LCZ map and GIS data, combined with census tract information, are analyzed using a spatial panel model to assess the influence of different LCZs and large-scale landscapes on HR. The results reveal that LCZ 1 (Compact high-rise) and LCZ 4 (Open high-rise) significantly increase HR compared to LCZ 2 (Compact mid-rise), while LCZ 3 (Compact low-rise) reduces HR. Additionally, HR is significantly elevated during extreme events with higher temperatures in normal heat days and greater temperature increases between normal and extreme heat days. These insights offer valuable guidance for urban planners and policymakers in designing heat-resilient cities by incorporating the LCZ framework into climate adaptation strategies and urban governance.\r
\r
\r
**Abstract-update:**\r
As climate change intensifies, understanding heat resilience (HR) in urban environments is essential for the development of climate-resilient cities. While numerous studies have explored the relationship between urban form and urban heat islands (UHI), limited attention has been given to HR, with many studies focusing solely on single extreme heat events. Furthermore, translating complex urban form findings into practical urban planning policies remains challenging.<br>\r
\r
The concept of local climate zones (LCZ) offers a thermally-based classification of urban forms, which is more accessible for policymakers. However, most LCZ studies focus on UHI, with little attention to HR. This study addresses this gap by examining the relationship between LCZs and HR across five major climate zones in the United States. By comparing different climate zones based on the DOE Building America program, we consider how variations in energy consumption and built environment characteristics lead to both commonalities and differences in LCZs.<br>\r
\r
HR is defined as the difference in land surface temperature (LST) between extreme heat and normal heat days. **Using air temperature data from 1990 to 2019 to identify heat events based on the 85th percentile of air temperature, and Landsat 8 imagery from 2013 to 2019 to obtain LST observations on days with minimal cloud cover after cloud removal,** LCZ maps and GIS data, combined with census tract information, are analyzed using a spatial panel model to assess the influence of different LCZs and large-scale landscapes on HR in various climate zones. Recognizing the considerable temperature variability across these zones, the results reveal significant differences in HR impacts.<br>\r
\r
From 2013 to 2019, by selecting days with minimal cloud cover, the study identifies three pairs of heat events based on air temperature percentiles. The analysis shows that LCZ 1 (Compact high-rise) and LCZ 4 (Open high-rise) significantly increase HR compared to LCZ 2 (Compact mid-rise), while LCZ 3 (Compact low-rise) reduces HR.<br>\r
\r
In each climate zone, we hypothesize that differences in temperature and humidity create unique HR responses across LCZs, leading to varied sensitivity levels. We selected NewYork City for CZ-MixedHumid, Seattle from the Marine climate zone, Los Angeles from the Hot-Dry zone, Chicago from the Cold zone, and Houston from the Hot-Humid zone to investigate similar and differing patterns. These variations arise from the unique temperature and humidity profiles of these cities, as well as the influence of wind, resulting in distinct HR dynamics across different LCZ regions.<br>\r
\r
...
## 附图\r
\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/01.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/02.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/03.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/04.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/05.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/06.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/07.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/08.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/09.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/10.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/11.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/12.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/13.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/14.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/15.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/16.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/17.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/18.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/19.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/20.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/21.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/22.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/23.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/24.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/25.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/26.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/27.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/28.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/29.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/30.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/31.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/32.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/33.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/34.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/35.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/36.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/37.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/38.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/39.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/40.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/41.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/42.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/43.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/44.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/45.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/46.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/47.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/48.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/49.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/50.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/51.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/52.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/53.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/54.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/55.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/56.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/57.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/58.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/59.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/60.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/61.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/62.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/63.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/64.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/65.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/66.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/67.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/68.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/69.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/70.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/71.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/72.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/73.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/74.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/75.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/76.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/77.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/78.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/79.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/80.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/81.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/82.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/83.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/84.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/85.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/86.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/87.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/88.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/89.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/90.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/91.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/92.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/93.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/94.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/95.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/96.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/97.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/98.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/previous-planning-research/99.jpg)\r
`,Zc=`---\r
id: "08"\r
slug: "heatmapper"\r
...
<h2>效果展示</h2>\r
<div style="display:flex; flex-direction:column; gap:16px;">\r
<video controls playsinline style="width:100%; border-radius:12px; box-shadow:0 10px 24px rgba(0,0,0,.08); border:1px solid #e5e7eb;" src="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/DragonDiffusion-Demo.mp4"></video>\r
...
\r
## 技术【Stable Diffusion XL】【ControlNet】【LoRA】【Stable Diffusion lighting】\r
\r
## 那个时代发生了什么？\r
Stable Diffusion XL (SDXL)刚成为主流。ComfyUI 刚刚开始火。ControlNet 很火。LoRA 开始普及。Agent 这个词刚开始进入 AI 产品。所以那个时候大家最大的痛点不是：画不好。而是：怎么把几十个 AI 能力串起来。于是就出现了：Task→Node→Pipeline→Canvas→Layer这种设计。其实和今天 ComfyUI 很像。\r
\r
## 为什么会做 Node？\r
因为当时：一个 Prompt 根本不够。例如：帮我设计一个电商海报。AI不会直接生成最终结果。而是：需求→拆解→背景→主体→Logo→字体→局部修改→导出。所以：Workflow才是真正重要的。\r
\r
## 为什么研究 LoRA？\r
因为那时候：基础模型能力有限。想画：某个品牌/某种IP/某种风格怎么办？训练 LoRA。所以很多公司：每天都在：训练→测试→Bad Case→重新训练。\r
## 为什么 Infinite Canvas（无限画布）那么重要？\r
因为那个时代：生成一张图以后。不能像今天 Flux Kontext一样：一句话：把衣服换成红色。当时只能：重新生成。或者：局部重绘。于是：无限画布就变成：AI Photoshop。\r
\r
## 2024.2 Dragon Diffusion遇到了什么问题？\r
Stability AI 于 2024 年 2 月正式发布了新一代文生图模型 Stable Cascade。该模型基于 Würstchen 架构，采用独特的三阶段扩散方法，在图像质量、文字理解和生成速度上超越了以往的 SDXL，同时大幅降低了对硬件显存的要求。\r
产品定位也发生了变化。以前：Dragon是：AI画图,后来变成：AI设计工具,再后来：这里已经变成：中国产业视觉大模型。这是完全不同的定位。\r
所以我们开始讨论：普通人到底能不能用？ToC：自己装修、自己设计、自己印刷。其实就在找：真正能传播出去的场景。\r
## 2026 年可能怎么做？\r
现在如果重新设计智图，可能是：User→Planner Agent→Image Agent→Edit Agent→Layout Agent→QA Agent→Export\r
\r
\r
# PPT 汇报\r
\r
...
id: "02"\r
slug: "anyreal"\r
title: "AnyReal - AI 虚拟影棚"\r
category: "UI&UX Design"\r
year: "2024"\r
description: "三步生成高真实度商品营销图的 AIGC 内容生产引擎，面向电商与品牌营销场景。"\r
tech: ["Figma","AI Product Design","SaaS"]\r
abstract: "AnyReal 是一款面向电商与品牌营销场景的 AI 虚拟影棚 / AIGC 营销内容生产引擎，解决商品营销物料生产成本高、周期长、门槛高的痛点。底层依托自研视觉大模型与 AIGC 联合实验室的科研能力，以真实场景 + 可控可调 + AI 模特为核心差异。"\r
challenge: "传统商品图拍摄需要 10-20 天、成本 8000-20000 元。市面 AI 工具多为背景替换，无法改变商品展示角度，光影不变，效果不真实。"\r
solution: "设计了三步生图工作流：上传 3D 资产 → 选场景模板 → 调角度大小生成。搭配背景模版中台、文生图/图生图、图像后处理、视频生成等模块，将生图效率从"天级"降到"分钟级"。"\r
hasDemo: true\r
icon: "https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/logo.jpg"\r
image:["https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/01.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/02.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/03.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/04.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/05.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/06.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/07.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/08.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/09.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/10.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/11.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/12.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/13.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/14.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/15.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/16.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/17.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/18.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/19.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/20.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/21.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/22.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/23.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/24.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/25.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/26.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/27.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/28.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/29.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/30.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/31.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/32.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/33.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/34.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/35.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/36.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/37.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/38.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/39.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/40.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/41.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/42.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/43.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/44.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/45.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/46.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/47.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/48.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/49.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/50.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/51.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/52.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/53.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/54.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/55.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/56.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/57.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/58.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/59.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/60.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/61.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/62.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/63.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/64.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/65.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/66.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/67.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/68.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/69.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/70.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/71.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/72.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/73.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/74.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/75.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/76.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/77.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/78.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/79.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/80.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/81.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/82.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/83.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/84.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/85.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/86.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/87.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/88.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/89.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/90.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/91.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/92.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/93.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/94.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/95.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/96.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/97.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/98.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/99.jpg"]\r
---\r
\r
# 效果展示\r
<div style="display:flex; flex-direction:column; gap:16px;">\r
<video controls playsinline style="width:100%; border-radius:12px; box-shadow:0 10px 24px rgba(0,0,0,.08); border:1px solid #e5e7eb;" src="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/AnyReal.mp4"></video>\r
</div>\r
\r
技术【Stable diffusion】【ControlNet】【Blender】\r
\r
## 这个项目是基于一个真实的商业需求。\r
以前的商品的背景很假，怎么样能够将真实的商品放到真实的背景中，并且可以调整角度和镜头。2023年的时候，利用ControlNet的 Depth（深度图） 和 NormalMap（法线贴图） 将3D软件（如Blender、SketchUp）中导出的低模或白模结构精准“锁定”，在二次渲染或文生图时保留3D资产的空间构图与立体轮廓。 \r
\r
## AnyReal 当时流程\r
电商卖家上传商品 3D 模型→调整：光照/相机角度/场景/材质→渲染→生成营销图片\r
所以那个时代很多团队都会用AI + 3D 而不是今天的AI + Inpainting\r
而 FLUX.1 是 2024 年 8 月 1 日才发布。也就是说：\r
项目开始的时候，Flux 甚至还没正式发布。\r
就算发布了，当时也只是第一版 FLUX.1，主要能力还是文生图（Text-to-Image），成熟的图片编辑工作流还没有形成。\r
真正让很多团队开始大量使用 Fill（Inpainting）、Redux、Depth、Canny 等编辑能力，是 2024 年 11 月发布 FLUX.1 Tools 之后。\r
\r
## 如果现在重新做 AnyReal，会怎么做？\r
我们在 2024 年设计 AnyReal 时，受限于当时图像生成模型的能力，因此采用了基于 3D 建模和渲染的方案，以保证商品结构和材质的可控性。\r
\r
随着 FLUX Fill、FLUX Kontext 等图像编辑模型的发展，如今很多营销图可以直接基于商品图片进行局部编辑和场景生成，大幅降低建模成本，提高生成效率。很多场景已经不需要完整建模了。比如："把白底商品图变成巴黎咖啡馆场景"　现在模型直接就能做。\r
\r
今天（2026）的思路已经变化很大了，如果重新设计，我会考虑采用 AI Image Editing + Workflow 的架构，而不是完全依赖 3D 渲染。 流程：商品图片→Segmentation（抠图）→Flux Kontext / Fill→换背景→换光照→换模特→营销图。\r
\r
\r
\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/01.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/02.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/03.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/04.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/05.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/06.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/07.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/08.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/09.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/10.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/11.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/12.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/13.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/14.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/15.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/16.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/17.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/18.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/19.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/20.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/21.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/22.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/23.jpg)\r
![AnyReal](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/24.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/25.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/26.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/27.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/28.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/29.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/30.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/31.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/32.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/33.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/34.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/35.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/36.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/37.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/38.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/39.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/40.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/41.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/42.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/43.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/44.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/45.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/46.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/47.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/48.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/49.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/50.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/51.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/52.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/53.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/54.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/55.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/56.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/57.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/58.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/59.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/60.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/61.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/62.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/63.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/64.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/65.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/66.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/67.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/68.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/69.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/70.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/71.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/72.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/73.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/74.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/75.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/76.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/77.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/78.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/79.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/80.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/81.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/82.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/83.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/84.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/85.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/86.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/87.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/88.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/89.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/90.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/91.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/92.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/93.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/94.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/95.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/96.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/97.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/98.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/anyreal/99.jpg)\r
\r
---\r
\r
# AnyReal 项目文档\r
...
### 1.1 项目背景\r
\r
AnyReal 是一款面向电商与品牌营销场景的 **AI 虚拟影棚 / AIGC 营销内容生产引擎**，解决"商品营销物料生产成本高、周期长、门槛高"的痛点。底层依托自研**视觉大模型**与 AIGC 联合实验室的科研能力，以真实场景 + 可控可调 + AI 模特为核心差异化优势。\r
\r
### 1.2 产品定位\r
\r
- 产品名：**AnyReal AI 虚拟影棚**\r
- 一句话定位：**三步生成高真实度商品营销图，并延伸至品牌营销视频的 AIGC 内容生产引擎**。\r
- 核心价值：把传统"10–20 天、数千到上万元"的棚拍/3D 渲染流程，压缩为"数分钟、百元级"的 SaaS 化生成。\r
\r
### 1.3 目标用户与价值\r
\r
| 维度 | 说明 |\r
| --- | --- |\r
| 核心用户 | 电商商家、品牌方、营销/广告 agencies、家居/泛零售品类运营 |\r
| 核心痛点 | 商品图拍摄贵、3D 渲染慢且不真实、现有 AI 工具仅背景替换效果差 |\r
| 交付价值 | 低成本、高真实、可个性化、可批量的营销图文视频产能 |\r
\r
## 2. 产品功能架构\r
\r
\`\`\`\r
...
## 3. AI 生图「三步法」\r
\r
1. **商品上传**：上传商品 3D 模型，环拍视频启动 AI 训练。\r
2. **场景创建**：从海量场景模板库中选择。\r
3. **参数调节**：选择商品摆放角度与大小，生成高真实度场景图。\r
\r
## 4. 竞品对比\r
\r
| 维度 | 传统棚拍 | 3D 渲染 | AnyReal |\r
| --- | --- | --- | --- |\r
| 时间 | 10–20 天 | 3–5 天 | **数分钟** |\r
| 成本 | 8000–20000 元 | 2000 元 | **0.5 元/张生成，100 元/张高清下载** |\r
| 门槛 | 专业门槛高 | 设计门槛高 | **低门槛、低学习成本** |\r
\r
### AnyReal 三大自研优势\r
\r
| 优势 | 说明 |\r
| --- | --- |\r
| **真实场景** | 使用真实场景图而非 AI 生成场景，最终效果更具真实感 |\r
| **可控可调** | 光影、比例、角度算法自适应，且支持手动精准调整 |\r
| **添加模特** | 可生成 AI 模特与家具的交互，真实生活气息强 |\r
\r
## 5. 商业模式\r
\r
- 商品训练服务：**1000 元/件**\r
...
---\r
\r
*说明：本文档为基于 AnyReal 产品介绍材料的项目综述，涉及量化经营指标请以内部最新数据为准。*\r
`,Qc=`---\r
id: "03"\r
...
![Genshot99](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/genshot/99.jpg)`,Jc=`---\r
id: "04"\r
slug: "genstyle"\r
...
![genstyle](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/genstyle/99.jpg)`,et=`---\r
id: "05"\r
...
同时，我也更加明确了自己的优势与不足：空间设计能力能够迁移到游戏场景中，而构图、色彩和美术表达仍需要持续积累。`,rt=`---
id: "05"
...
## 效果展示\r
\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/01.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/02.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/03.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/04.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/05.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/06.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/07.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/08.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/09.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/10.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/11.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/12.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/13.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/14.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/15.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/16.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/17.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/18.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/19.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/20.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/21.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/22.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/23.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/24.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/25.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/26.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/27.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/28.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/29.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/30.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/31.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/32.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/33.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/34.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/35.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/36.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/37.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/38.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/39.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/40.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/41.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/42.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/43.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/44.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/45.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/46.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/47.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/48.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/49.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/50.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/51.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/52.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/53.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/54.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/55.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/56.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/57.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/58.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/59.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/60.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/61.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/62.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/63.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/64.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/65.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/66.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/67.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/68.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/69.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/70.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/71.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/72.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/73.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/74.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/75.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/76.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/77.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/78.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/79.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/80.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/81.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/82.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/83.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/84.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/85.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/86.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/87.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/88.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/89.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/90.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/91.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/92.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/93.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/94.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/95.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/96.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/97.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/98.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/agentic-rag/99.jpg)\r
\r
---`,st=`---\r
id: "02"\r
slug: "knowledge-graph-urban-planning"\r
title: "城市规划文本知识图谱生成与多模型评测"\r
category: "Knowledge Graph"\r
year: "2025-present"\r
description: "纽约和上海总体规划中气候变化适应的比较分析"\r
tech: ["Knowledge Graph", "NLP", "Python", "LDA", "BERT", "HuggingFace", "GPT-4 API", "Embedding Models", "Qwen3", "Multilingual-E5", "BGE-M3", "Cosine Similarity", "NetworkX"]\r
...
\r
\r
# 城市规划文本知识图谱生成与多模型比较\r
## Knowledge Graph Generation from Urban Planning Texts\r
### ——纽约与上海城市规划文本中的气候变化适应比较\r
\r
# 效果展示\r
\r
“基于城市规划文本的知识图谱生成：纽约和上海总体规划中气候变化适应的比较分析” \r
...
\r
github 仓库链接\r
https://github.com/LiliLIN0324/Knowledge_Graph\r
\r
\r
---\r
\r
## 项目概览\r
\r
城市规划文本通常篇幅较长，包含大量政策、规划目标、空间策略与专业概念。当我们需要比较不同城市的规划文本时，仅依靠关键词频率很难回答：**不同城市真正关注哪些核心议题？这些议题之间又存在怎样的关系？**\r
\r
本项目尝试使用 **Knowledge Graph（知识图谱）** 将城市规划文本中的核心概念及其语义关系进行结构化表达，并进一步比较不同模型在知识图谱生成任务中的表现。\r
\r
项目以 **纽约市与上海市的城市规划文本** 为研究对象，聚焦 **Climate Change Adaptation（气候变化适应）** 与 **Urban Planning（城市规划）**，并设计了从传统 Topic Modeling 到 BERT、LLM、Embedding Model 的多种知识图谱生成方法。\r
\r
---\r
\r
## 01 · 研究问题\r
...
本项目主要围绕两个问题展开：\r
\r
- **Knowledge Graph 能否帮助我们识别并比较不同城市规划文本中的核心概念与语义关系？**\r
- **不同类型的 NLP / AI 模型，在城市规划知识图谱生成任务中各有什么优势与局限？**\r
\r
为了回答这些问题，我设计并比较了四类方法：**LDA → Fine-tuned BERT → GPT-4 → Embedding Models**。不仅比较模型最终生成的知识图谱，也从语义理解能力、跨语言能力、节点/关系识别能力、可解释性、计算效率、可扩展性、实际应用成本等维度分析不同方法。\r
\r
---\r
\r
## 02 · 知识图谱设计\r
\r
为了让不同城市的规划文本能够在同一个框架下进行比较，我首先定义了一个由 **10 个核心概念节点**组成的领域知识框架。\r
\r
### 气候变化适应\r
\r
- Resilience\r
...
- Land Use Planning\r
- Urban Design\r
- Transportation Planning\r
- Sustainable Development\r
\r
这些概念作为两个城市规划文本的共同语义框架。\r
\r
---\r
\r
## 03 · Knowledge Graph 如何表示规划文本？\r
\r
本项目中的知识图谱不仅关注“一个概念有没有出现”，还进一步计算：\r
\r
### Node Weight · 节点权重\r
\r
节点权重表示某个概念在规划文本中的重要程度。例如，**Resilience** 若与大量句子具有较高的语义相似度，其 Node Weight 就相对较高——**节点越大，表示该概念在文本中越重要**。\r
\r
---\r
\r
### Edge Weight · 边权重\r
\r
边权重表示两个概念之间的关联强度。例如，**Resilience ↔ Climate Proofing** 若经常共同出现且在语义空间中关联较强，其 Edge Weight 就更高——**边越粗，表示两个概念之间的关系越强**。\r
\r
最终形成的 Knowledge Graph 可同时表达“什么概念重要”，以及“这些概念之间如何关联”。\r
\r
---\r
\r
# 04 · 方法一：LDA Topic Modeling\r
\r
第一种方法采用传统的 **Latent Dirichlet Allocation（LDA）**：首先对城市规划文本进行预处理，识别与 Climate Adaptation、Urban Planning 相关的主题，再将其映射到预定义的 10 个核心概念。\r
\r
### 节点权重\r
\r
通过主题与固定概念之间的语义相似度估计节点的重要程度。\r
\r
### 边权重\r
\r
通过不同主题 / 子节点之间的共现关系估计概念之间的关联程度。\r
\r
### 优势\r
\r
- 实现简单\r
...
---\r
\r
# 05 · 方法二：Fine-tuned BERT\r
\r
第二种方法使用 **Multilingual BERT**，尝试通过领域文本训练提升模型对城市规划语境的理解能力，模型采用 **Masked Language Modeling（MLM）** 进行 Fine-tuning。基本流程为：\r
\r
\`\`\`text\r
Planning Documents\r
        ↓\r
Text Chunking\r
        ↓\r
Random Masking\r
        ↓\r
Fine-tuned Multilingual BERT\r
        ↓\r
Sentence / Concept Embeddings\r
        ↓\r
Cosine Similarity\r
        ↓\r
Node / Edge Weights\r
...
### Node Weight\r
\r
首先获取模型最后隐藏层的 Mean Pooling 向量，随后对概念与文本句子进行向量化、归一化，计算 Cosine Similarity，并对句子层面的相似度进行平均，最终得到节点的重要性分数。\r
\r
### Edge Weight\r
\r
通过比较模型训练前后两个概念关系的语义相似度变化，估计概念之间的关系强度。\r
\r
---\r
\r
# 06 · 方法三：Direct LLM\r
\r
第三种方法直接使用 **GPT-4 API** 对规划文本中的概念及关系进行评分。与前两种方法相比，它不再依赖传统的词频或训练后的向量，而是直接利用 LLM 的上下文理解能力。例如，对于一个节点，让模型回答“Climate Proofing 在气候变化适应规划中的重要程度是多少？”，并在 **0.1–1.0** 的范围内给出评分；对于两个节点之间的关系，同样要求模型对“Resilience 与 Climate Proofing 在该规划文本中的关系有多强？”进行关系强度评分。\r
\r
### 优势\r
\r
* 能够理解复杂上下文\r
* 具有较强的跨语言能力\r
* 输出形式直观\r
* 能够直接利用 LLM 的语义推理能力\r
\r
### 局限\r
\r
* 存在 Hallucination 风险\r
* 模型具有一定黑盒属性\r
* API 存在成本与延迟\r
* 模型版本或调用结果可能产生变化\r
\r
因此，LLM 方法虽然具有较强的语义理解能力，但其结果仍需要进一步验证。\r
\r
---\r
\r
# 07 · 方法四：Embedding Models\r
\r
第四种方法采用专门的 **Text Embedding Models**，实验中比较了 Gemini Embedding、Qwen3-Embedding、Multilingual-E5、BGE-M3。整体流程为：\r
\r
\`\`\`text\r
Planning Documents\r
        ↓\r
...
## Embedding 模型选择\r
\r
在模型选择阶段，我综合考虑了 Zero-shot 能力、Embedding Dimensions、Memory Usage、Max Tokens、Multilingual Capability、Semantic Textual Similarity 等因素，实验中使用了 Qwen/Qwen3-Embedding-0.6B、BAAI/bge-m3、intfloat/multilingual-e5-large-instruct、Gemini Embedding。\r
\r
---\r
\r
## Node Weight\r
\r
对于每一个固定概念：获取 Concept Embedding 与 Planning Sentence Embedding，计算 Cosine Similarity，并对所有句子的相似度进行平均，最终得到 **Node Weight = Concept 与规划文本之间的平均语义相似度**。\r
\r
---\r
\r
## Edge Weight\r
\r
边权重同时考虑 Concept Co-occurrence 与 Semantic Similarity，计算形式为 \`edge_raw = α × co-occurrence + β × semantic similarity\`。因此，相比单纯统计词语共同出现次数，该方法进一步加入了语义层面的信息。\r
\r
---\r
\r
# 08 · Knowledge Graph 构建与可视化\r
\r
完成 Node / Edge Weight 计算后，使用 **NetworkX** 构建 Knowledge Graph。\r
\r
图中的节点大小表示 Concept Importance、节点颜色表示 Concept Category、边粗细表示 Relationship Strength，最终可以将两个城市的规划文本转化为结构化的知识网络。\r
\r
这样就能从原本的长篇规划文本中，更直观地观察核心概念是什么、哪些概念关系最紧密、不同城市的规划关注点有什么区别。\r
\r
---\r
\r
# 09 · 模型比较\r
...
| 方法              | 优势                   | 局限                           |\r
| --------------- | -------------------- | ---------------------------- |\r
| LDA             | 简单、快速、容易实现           | 上下文理解能力有限                    |\r
| Fine-tuned BERT | 能够进行领域适应，具有上下文语义理解能力 | 需要 Fine-tuning，计算成本更高        |\r
| GPT-4           | 上下文理解与语义推理能力较强       | Hallucination、API 成本、延迟、黑盒问题 |\r
| Embedding       | 向量化速度快，适合大规模文本与批量处理  | 可解释性相对较弱                     |\r
\r
这一比较也让我认识到：**模型并不存在绝对的“最好”，不同方法更适合不同的任务。** 关注主题发现，LDA 成本较低；需要领域适应，可用 Fine-tuned BERT；强调复杂语义理解，可用 LLM；需要处理大量文档、计算语义相似度并进一步用于 Knowledge Graph 或 Retrieval，则 Embedding Model 更具实际优势。\r
\r
---\r
\r
# 10 · 实验结果\r
...
## NYC vs. Shanghai\r
\r
实验结果显示，两个城市存在一些共同关注的概念，例如 Climate Proofing、Adaptive Capacity、Sustainable Development、Resilience，但不同方法也识别出了两个城市之间的不同侧重点。\r
\r
### New York City\r
\r
模型结果中较明显的概念包括 Resilience、Climate Proofing、Adaptive Capacity、Ecosystem-based Adaptation、Zoning、Urban Design，整体上更突出 **Resilience / Equity / Climate Adaptation**。\r
\r
### Shanghai\r
\r
模型结果中较明显的概念包括 Sustainable Development、Resilience、Land Use Planning、Transportation Planning、Urban Planning、Zoning，整体上更突出 **Sustainable Development / Balanced Urbanization**。\r
\r
---\r
\r
# 11 · 不同 Embedding Models 的表现\r
\r
不同 Embedding 模型并没有产生完全相同的知识图谱。实验中观察到：Qwen3 生成的结果相对更加平衡，节点权重差异没有过度集中；Multilingual-E5 在 NYC 的结果中表现较好，部分重要节点具有更高的权重；BGE-M3 在 Shanghai 的结果中表现相对较好。\r
\r
这说明 **Embedding Model 的选择本身也会影响 Knowledge Graph 对概念重要性与关系强度的敏感程度**。因此在实际应用中，不能简单地认为“换一个 Embedding Model 就只是换了一个向量模型”——模型选择会进一步影响下游的 **Similarity → Node Weight → Edge Weight → Knowledge Graph**。\r
\r
---\r
\r
# 12 · Expert Validation\r
\r
为了避免完全依赖模型输出，本项目进一步加入了 **Expert Validation**。领域专家对生成的 Knowledge Graph 进行人工审核与排序，重点评价 Nodes（某些节点是否被模型高估或低估）与 Edges（不同概念之间的关系强度是否符合领域知识）。最终形成：\r
\r
\`\`\`text\r
Planning Documents\r
        ↓\r
...
Knowledge Graph\r
        ↓\r
Human Expert Validation\r
        ↓\r
Model Comparison\r
\`\`\`\r
\r
这一步的意义在于：**模型生成的结果并不直接等于 Ground Truth**，在规划、政策等专业领域中 Human-in-the-loop 仍然非常重要。\r
\r
---\r
\r
# 13 · 项目思考\r
\r
这个项目让我意识到，Knowledge Graph Generation 并不是单纯的“把文本变成图”。真正困难的部分在于：\r
\r
### 1. 如何定义知识？\r
\r
需要先确定哪些概念值得成为 Knowledge Nodes。\r
\r
### 2. 如何衡量重要性？\r
\r
“一个词出现很多次”并不一定意味着它真正重要，因此需要引入 **Semantic Similarity** 来补充传统 Frequency-based 方法。\r
\r
### 3. 如何定义关系？\r
\r
两个概念同时出现，并不意味着一定存在强语义关系。因此本项目尝试将 **Co-occurrence + Semantic Similarity** 结合起来。\r
\r
### 4. 如何评价模型？\r
\r
不能只看模型输出是否“看起来合理”，还需要从**准确性、稳定性、可解释性、成本、效率、跨语言能力**等多个维度综合判断。\r
\r
---\r
\r
# 14 · 项目总结\r
\r
本项目构建了一套面向城市规划文本的 Knowledge Graph Generation Framework，并比较了 **LDA → Fine-tuned BERT → GPT-4 → Embedding Models** 四类不同的文本语义建模方法。\r
\r
最终通过 Knowledge Graph 将规划文本中的 **Concept Importance + Semantic Relationships** 进行结构化表达，并进一步用于比较纽约与上海在气候变化适应及城市规划议题上的差异。\r
\r
从模型比较来看，**传统 Topic Modeling 更简单，但语义表达能力有限；BERT 可以进行领域适应；LLM 具有更强的上下文理解能力，但存在黑盒、成本与幻觉问题；Embedding Models 则在大规模文本处理、跨语言语义表示和批量计算方面具有较好的可扩展性。** 因此，本项目最终并没有试图寻找一个“万能模型”，而是希望建立一个**根据任务目标选择模型，并通过结构化表示与人工验证提高结果可靠性的分析框架**。\r
\r
---\r
\r
## My Contribution\r
...
* 设计研究框架与模型比较方案\r
* 设计 10 个领域核心概念节点\r
* 选择 NYC 与 Shanghai 作为比较对象\r
\r
### NLP / AI\r
\r
* 实现 LDA Topic Modeling\r
* Fine-tune Multilingual BERT\r
* 设计 GPT-4 API Prompt 与评分机制\r
* 调用并比较 Qwen3 / E5 / BGE-M3 / Gemini Embedding\r
\r
### Knowledge Graph\r
\r
* 设计 Node Weight 计算方法\r
* 设计 Edge Weight 计算方法\r
* 融合 Semantic Similarity 与 Co-occurrence\r
* 使用 NetworkX 构建与可视化 Knowledge Graph\r
\r
### Evaluation\r
\r
* 建立多模型横向比较框架\r
* 分析不同模型的优势与局限\r
* 比较 NYC / Shanghai 的知识结构差异\r
* 设计 Expert Validation 流程\r
\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/01.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/02.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/03.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/04.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/05.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/06.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/07.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/08.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/09.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/10.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/11.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/12.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/13.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/14.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/15.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/16.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/17.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/18.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/19.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/20.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/21.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/22.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/23.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/24.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/25.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/26.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/27.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/28.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/29.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/30.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/31.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/32.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/33.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/34.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/35.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/36.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/37.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/38.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/39.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/40.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/41.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/42.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/43.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/44.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/45.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/46.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/47.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/48.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/49.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/50.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/51.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/52.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/53.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/54.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/55.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/56.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/57.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/58.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/59.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/60.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/61.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/62.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/63.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/64.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/65.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/66.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/67.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/68.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/69.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/70.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/71.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/72.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/73.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/74.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/75.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/76.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/77.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/78.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/79.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/80.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/81.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/82.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/83.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/84.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/85.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/86.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/87.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/88.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/89.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/90.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/91.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/92.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/93.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/94.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/95.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/96.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/97.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/98.jpg)\r
![alt text](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/knowledge-graph-urban-planning/99.jpg)\r
...
\r
## 项目代码链接\r
https://github.com/LiliLIN0324/pur-ai\r
\r
---\r
\r
### 1. **这个项目解决什么问题？**\r
\r
这个项目旨在利用 AI 辅助城市更新，通过城市空间数据和城市形态指标作为条件，生成符合一定空间约束和城市形态目标的设计方案，从而帮助城市更新方案进行快速探索和评估。\r
\r
---\r
\r
### 2. **为什么选择生成模型？**\r
\r
因为目标是根据城市空间约束和形态目标，生成多个可能的城市设计方案，而不是预测一个固定结果。\r
\r
---\r
\r
### 3. **为什么使用 ControlNet？**\r
\r
普通 Stable Diffusion 的生成自由度比较高，但对具体空间结构的控制比较弱。我们的城市更新任务对道路、建筑、水体等空间结构有比较明确的约束，所以采用 ControlNet，把城市空间条件作为额外的控制输入，在保留生成能力的同时增强对空间结构的控制。\r
\r
---\r
\r
### 4. **城市数据怎么变成模型输入？**\r
\r
我主要负责这一侧。对不同来源的城市空间数据进行清洗、统一空间尺度和格式，并整理成模型需要的多通道 Tensor。具体训练代码中，原始数据组织为 **5 个通道：1 个语义 Mask + 4 个辅助城市数据**；之后将语义 Mask 转换为 RGB，与 4 个辅助通道组成 **7-channel Hint**，再加入额外的街道条件，形成最终的 ControlNet 条件输入。 \r
\r
---\r
\r
### 5. **Prompt 在这里干什么？**\r
\r
Prompt 主要用于提供高层的城市形态目标。我们根据城市语义 Mask 和辅助城市数据计算绿地率、水域比例、建筑覆盖率、道路密度、FAR、开放空间比例、平均建筑高度和平均 LST 等指标，并将这些指标组织成结构化文本，再通过文本编码器得到文本条件。 \r
\r
> **Hint 告诉模型“空间上怎么摆”，Prompt 告诉模型“总体上要达到什么样的城市形态”。**\r
\r
---\r
\r
### 6. **生成以后怎么判断结果好不好？**\r
\r
目标指标 → Prompt → 生成 → RGB 转 Mask → 重新计算城市形态指标 → Target vs Generated。\r
\r
---\r
\r
### 7. **你们做过哪些关键实验/改进？为什么？**\r
\r
我们主要做了几方面的改进：\r
\r
* **预训练 ControlNet 微调**：基于已有模型进行城市领域微调，而不是从头训练。\r
* **LoRA 微调**：支持通过 LoRA 进行参数高效微调。\r
* **多通道城市条件**：将语义 Mask 和 4 个辅助城市数据组成 7-channel Hint。\r
* **街道条件增强**：从语义 Mask 中提取道路类别，形成额外的 3-channel Street Condition，与 7-channel Hint 合并形成 10-channel ControlNet 条件。\r
* **城市形态 Prompt**：将城市形态指标转化为结构化文本条件，为模型提供高层城市形态约束。\r
* **城市形态 Loss**：生成结果重新转换为语义 Mask，计算城市形态指标，与真实结果进行比较，并将 Morphology Loss 与 Diffusion Loss 结合。\r
\r
---\r
\r
### 8. **各自分工？**\r
\r
我主要负责城市数据侧，包括数据清洗、整理、标准化和 Tensor 构造；CS 同学主要负责 ControlNet / Stable Diffusion 的模型训练和工程实现。\r
\r
---\r
\r
# Level 1：项目概述\r
...
### 1. **项目解决什么问题？**\r
\r
《人工智能赋能下的参与式城市更新》旨在利用 AI 辅助城市更新和城市形态生成。\r
\r
### 2. **输入是什么？**\r
\r
城市空间数据，包括城市语义 Mask、建筑高度、土地利用、LST 等辅助城市数据。训练代码中原始数据组织为 **5-channel：1 个语义 Mask + 4 个辅助通道**，之后进一步构造成 ControlNet 所需的条件输入。\r
\r
### 3. **输出是什么？**\r
\r
生成城市形态图，并可以进一步转换成语义 Mask，计算城市形态指标。\r
\r
语义类别包括：\r
\r
* **0**：背景\r
...
不是单纯做分类或预测，而是希望：\r
\r
> **给定城市形态约束和目标 → 生成满足约束的城市空间方案。**\r
\r
---\r
\r
### 5. **为什么需要 ControlNet？**\r
\r
本项目基于 ControlNet 架构，结合 Stable Diffusion 的组件，实现城市形态的条件控制生成。\r
\r
因为普通 Stable Diffusion 对城市空间结构的控制不够精确，所以通过 ControlNet 将城市空间条件作为额外控制输入。\r
\r
**核心组件：**\r
\r
* **ControlNet**：处理城市空间条件，增强结构控制\r
* **UNet**：扩散模型主干，执行去噪\r
* **AutoencoderKL**：负责图像与潜空间之间的编码、解码\r
* **CLIP / 文本编码器**：处理 Prompt 文本条件\r
\r
---\r
\r
### 6. **怎么评价生成结果？**\r
\r
通过生成结果重新计算城市形态指标，并与真实/目标指标进行比较。\r
\r
主要指标包括：\r
\r
* 绿化率 \`green_rate\`\r
* 水域比例 \`water_rate\`\r
* 建筑覆盖率 \`building_coverage_rate\`\r
* 道路密度 \`road_density\`\r
* 容积率 \`FAR\`\r
* 开放空间比例 \`open_space_rate\`\r
* 平均建筑高度\r
* 平均地表温度 \`LST\`\r
\r
---\r
\r
# Level 2：流程 Pipeline\r
\r
\`\`\`text\r
                    AI4City\r
                       │\r
      ...
      城市原始数据               城市形态指标\r
          │                         │\r
          ↓                         ↓\r
    5-channel data                Prompt\r
          │                         │\r
    ┌─────┴─────┐                   ↓\r
    ↓           ↓                  文本编码器\r
Semantic Mask  4 Auxiliary           │\r
    │           │                    ↓\r
    ↓           └───────→ 7-channel Hint\r
  RGB 3ch\r
                                +\r
                    ...
                    城市形态指标重新计算\r
                                │\r
                                ↓\r
                      Target vs Generated\r
\`\`\`\r
\r
---\r
\r
> **“为什么不是直接用 Stable Diffusion？”**\r
\r
因为我们的任务不是开放式城市图片生成，而是有明确空间约束的城市形态生成，需要控制道路、建筑、水体等空间结构，所以增加 ControlNet 对城市条件进行显式控制。\r
\r
---\r
\r
# Level 3：部分技术细节\r
...
7-channel Hint\r
      +\r
3-channel Street Condition\r
      ↓\r
10-channel ControlNet Condition\r
      +\r
Text Condition\r
      ↓\r
ControlNet\r
...
5-channel 原始城市数据\r
        ↓\r
1-channel Semantic Mask\r
+\r
4-channel Auxiliary\r
        ↓\r
3-channel RGB Semantic Mask\r
+\r
4-channel Auxiliary\r
        ↓\r
7-channel Hint\r
...
### DDIM\r
\r
> 它是扩散模型的采样方法，用于从噪声逐步生成最终图像。项目代码中使用 DDIM 进行生成，推理过程中使用 50 步采样。\r
\r
---\r
\r
# 流程图\r
       ...
       └──────────────┐               │\r
                ...
                + 3-channel Street    │\r
                    ...
                    10-channel Condition\r
                      ...
                      ┌───────┴───────┐\r
                      ↓               ↓\r
                Diffusion Loss    Morphology Loss\r
                      │               │\r
                      └───────┬───────┘\r
                              ↓\r
                          Total Loss\r
...
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/participatory-urban-regeneration/03.jpg)\r
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/participatory-urban-regeneration/04.jpg)\r
...
icon: "https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/logo.jpg"
image:["https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/01.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/02.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/03.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/04.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/05.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/06.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/07.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/08.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/09.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/10.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/11.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/12.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/13.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/14.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/15.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/16.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/17.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/18.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/19.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/20.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/21.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/22.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/23.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/24.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/25.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/26.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/27.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/28.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/29.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/30.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/31.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/32.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/33.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/34.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/35.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/36.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/37.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/38.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/39.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/40.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/41.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/42.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/43.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/44.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/45.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/46.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/47.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/48.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/49.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/50.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/51.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/52.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/53.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/54.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/55.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/56.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/57.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/58.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/59.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/60.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/61.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/62.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/63.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/64.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/65.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/66.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/67.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/68.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/69.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/70.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/71.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/72.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/73.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/74.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/75.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/76.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/77.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/78.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/79.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/80.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/81.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/82.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/83.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/84.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/85.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/86.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/87.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/88.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/89.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/90.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/91.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/92.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/93.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/94.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/95.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/96.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/97.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/98.jpg","https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/99.jpg"]
---

<div style="display:flex; flex-direction:column; gap:16px;">
<video controls playsinline style="width:100%; border-radius:12px; box-shadow:0 10px 24px rgba(0,0,0,.08); border:1px solid #e5e7eb;" src="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/campus-public-space-vitality-modeling.mp4"></video>
</div>
...
狩猎相机组的研究题目为 **「户外环境与人群跟踪的校园空间活力建模」**。
...
空间的活力在评价空间质量和吸引力上起着重要作用。相较于以往低样本调查或低精度定位获取的人群活力数据，主动感知技术能够实现对个体环境感知与行为活动的精准反馈。同时，图像采集技术手段（如打猎相机）的进步已允许研究者实现对校园人群活动与物质环境的长时段、高精度捕捉，使得针对人本尺度公共空间的活力建模成为可能。

该组通过研究发现户外环境对个体环境感知与行为活动存在影响，同时通过时序数据研究风热环境对行人活动的影响，结果表明：**场地内风速对行人通过数量有正向影响，热感指数与人群停留时间有负向影响**。

## 英文摘要

The vitality of space plays an important role in evaluating spatial quality and attractiveness. Compared with the low-sample surveys or low-precision positioning of crowd vitality data in the past, active perception technology can achieve accurate feedback on individual environmental perception and behavioral activities. At the same time, the progress of image acquisition technology (such as hunting cameras) has allowed researchers to achieve long-term and high-precision capture of campus crowd activities and material environments, making it possible to model public space activities at the human scale.

The group found that outdoor environments have an impact on individual environmental perception and behavioral activities. At the same time, through time-series data research, the impact of wind and heat environment on pedestrian activities was studied. The results showed that **wind speed has a positive effect on the number of pedestrians passing through the site, and the heat index has a negative effect on the length of time people stay**.


![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/01.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/02.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/03.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/04.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/05.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/06.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/07.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/08.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/09.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/10.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/11.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/12.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/13.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/14.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/15.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/16.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/17.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/18.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/19.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/20.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/21.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/22.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/23.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/24.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/25.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/26.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/27.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/28.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/29.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/30.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/31.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/32.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/33.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/34.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/35.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/36.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/37.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/38.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/39.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/40.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/41.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/42.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/43.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/44.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/45.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/46.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/47.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/48.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/49.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/50.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/51.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/52.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/53.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/54.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/55.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/56.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/57.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/58.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/59.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/60.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/61.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/62.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/63.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/64.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/65.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/66.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/67.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/68.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/69.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/70.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/71.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/72.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/73.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/74.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/75.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/76.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/77.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/78.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/79.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/80.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/81.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/82.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/83.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/84.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/85.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/86.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/87.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/88.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/89.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/90.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/91.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/92.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/93.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/94.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/95.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/96.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/97.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/98.jpg)
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/campus-public-space-vitality-modeling/99.jpg)

---

## 参考链接

<https://mp.weixin.qq.com/s?__biz=Mzg3NjQ2Mjc5NA==&mid=2247525414&idx=1&sn=fe70b061b93cbc6d38d8d38a6b32bfc1&chksm=cf33f383f8447a9586418622ca0e2f7a76c6e7c5257d49098f0c0e51e0381fd7ed643dda5ea3&scene=178&cur_album_id=2912679801638027265#rd>
`,ot=`---\r
id: "01"\r
slug: "litflow"\r
...
> 💡 **小提示**：MCP 是一个快速发展的开放标准，未来会有越来越多的工具和应用支持它。现在学习 MCP，就是提前掌握 AI 时代的「通用语言」！`,Nt=`---
id: "09"
...
> 💡 **小提示**：没有绝对最好的数据库，只有最适合你项目的数据库。根据实际需求选择，才是最明智的决定！`,qt=`---\r
id: "10"\r
slug: "leetcode-notes"\r
title: "从 0 到 1 学数据结构——我的 Python3 学习笔记"\r
category: "Tutorial"\r
year: "2026-9-5"\r
description: "一份从零开始学数据结构的个人学习笔记，用 Python3 边学边记，从最基础的 number、list 讲到链表、哈希表、堆和树，读者也可以跟着一起学。"\r
tech: ["Python3", "Jupyter Notebook", "数据结构", "算法", "LeetCode"]\r
icon: "https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/leetcode-notes/logo.jpg"\r
abstract: |\r
  这是我自己的学习笔记，记录从 0 到 1 学习数据结构的过程。用 Jupyter Notebook 边学边记、边写边跑，从最基础的数据结构讲起，循序渐进，最后用力扣热门题来巩固。如果你也对数据结构感兴趣，可以跟着一起学。\r
---\r
\r
# 从 0 到 1 学数据结构\r
\r
这份笔记记录了我从零开始学习数据结构的过程，全部用 **Python3** 手写代码、边学边记。它按「先易后难」的顺序，把数据结构一个个吃透：从最简单的数字和列表开始，一路学到链表、哈希表、堆和树。如果你也对数据结构感兴趣，可以跟着这份笔记一起学。\r
\r
- **仓库地址**：https://github.com/LiliLIN0324/leetcode-notes\r
- **完整笔记**：\`python3数据结构.ipynb\`（基础）、\`力扣100题.ipynb\`（做题）、\`跟刷.ipynb\`（跟刷）\r
\r
---\r
\r
## 学习路线\r
\r
整条路线从易到难，一共 13 个主题：\r
\r
> number（数字） → list（列表） → tuple（元组） → set（集合） → dictionary（字典） → string（字符串） → array（数组） → linked list（链表） → hash table（哈希表） → queue（队列） → stack（栈） → heap（堆） → tree（树）\r
\r
前 7 个是 Python 自带的常用结构，后 6 个是更「算法味」的结构。下面按这个顺序逐个过一遍。\r
\r
---\r
\r
## 01 number —— 数字\r
\r
Python 的数字主要有三种：整数 \`int\`、小数 \`float\`、复数 \`complex\`；布尔值 \`bool\` 也是一种数字（\`True\` 非 0、\`False\` 为 0）。\r
\r
\`\`\`python\r
a = 10          # int\r
b = 3.14        # float\r
c = 1 + 2j      # complex\r
\r
print(10 / 3)   # 3.333...  真除法\r
print(10 // 3)  # 3         整除（向下取整）\r
print(10 % 3)   # 1         取余\r
print(2 ** 3)   # 8         幂\r
\`\`\`\r
\r
一句话记住：\`/\` 是除法、\`//\` 是整除、\`%\` 取余、\`**\` 是幂。\r
\r
---\r
\r
## 02 list —— 列表\r
\r
列表是最常用的结构：**有序、可变、能装任意类型**，用 \`[]\` 表示。\r
\r
\`\`\`python\r
a = [1, 2, 3, 4, 5]\r
\r
a.append(6)     # 末尾加一个 -> [1,2,3,4,5,6]\r
a[0] = 9        # 按下标改 -> [9,2,3,4,5,6]\r
print(a[0:3])   # 切片，取下标 0~2 -> [9,2,3]\r
\`\`\`\r
\r
支持索引、切片、增删改，是最「万金油」的容器。\r
\r
---\r
\r
## 03 tuple —— 元组\r
\r
元组和列表很像，但**不可变**：一旦创建就不能增删改，用 \`()\` 表示。\r
\r
\`\`\`python\r
t = (1, 2, 3, 4, 5)\r
print(t[0])      # 1\r
print(t[0:3])    # 切片 (1, 2, 3)\r
# t[0] = 9       # ❌ 会报错：元组不可变\r
\`\`\`\r
\r
因为不可变，元组更安全，也常被用作字典的 key。\r
\r
---\r
\r
## 04 set —— 集合\r
\r
集合是**无序、不重复**的元素集合，用 \`{}\` 表示，天然带「去重」能力。\r
\r
\`\`\`python\r
s = {1, 2, 2, 3, 4}\r
print(s)         # {1, 2, 3, 4}  自动去重\r
\r
s.add(5)         # 加\r
s.remove(2)      # 删\r
\`\`\`\r
\r
常用来做去重、求交集并集、判断「某个元素在不在」。\r
\r
---\r
\r
## 05 dictionary —— 字典\r
\r
字典是**键值对（key : value）**的集合，key 唯一，查找非常快，用 \`{}\` 表示。\r
\r
\`\`\`python\r
d = {"name": "小明", "age": 18, "city": "北京"}\r
\r
print(d["name"])      # 小明\r
d["phone"] = "123..." # 新增一对\r
\`\`\`\r
\r
「根据 key 取 value」是字典的核心用法，也是后面哈希表的基础。\r
\r
---\r
\r
## 06 string —— 字符串\r
\r
字符串是**不可变的字符序列**，自带一整套处理文本的方法。\r
\r
\`\`\`python\r
s = "hello world"\r
\r
print(len(s))        # 11   长度\r
print(s.upper())     # HELLO WORLD\r
print(s.count("l"))  # 3    统计子串出现次数\r
print(s.split())     # ['hello', 'world']\r
\`\`\`\r
\r
常用：\`len / count / upper / lower / split / isalpha / isdigit\`。\r
\r
---\r
\r
## 07 array —— 数组\r
\r
数组是**相同类型、连续内存**的元素集合，按下标访问是 O(1)，非常快。\r
\r
\`\`\`python\r
# Python 里常用 list 充当数组；要真正的同类型数组可用 array 模块\r
from array import array\r
a = array("i", [1, 2, 3, 4, 5])\r
\r
print(a[0])     # 1\r
a[0] = 9        # 改\r
\`\`\`\r
\r
特点：**读快、写慢**（插入删除要搬元素），适合「按位置频繁访问」的场景。\r
\r
---\r
\r
## 08 linked list —— 链表\r
\r
链表由一个个**节点（node）**组成，每个节点存一个值 \`val\` 和一个指向下一节点的指针 \`next\`。\r
\r
\`\`\`python\r
class ListNode:\r
...
\r
# 1 -> 2 -> 3\r
head = ListNode(1, ListNode(2, ListNode(3)))\r
\`\`\`\r
\r
和数组相反：链表**插入删除快、随机访问慢**（要顺着 next 一个个找）。\r
\r
---\r
\r
## 09 hash table —— 哈希表\r
\r
哈希表通过「哈希函数」把 key 映射到位置，实现 **O(1) 的查找**。Python 里直接就是 \`dict\` 和 \`set\`。\r
\r
\`\`\`python\r
d = {"apple": 1, "banana": 2}\r
print(d["apple"])     # O(1) 查到 1\r
\`\`\`\r
\r
它的核心思想是：**用空间换时间**，让「找某个 key」几乎不用遍历。\r
\r
---\r
\r
## 10 queue —— 队列\r
\r
队列是**先进先出（FIFO）**的结构，像排队：先来的先走。用 \`deque\` 最方便。\r
\r
\`\`\`python\r
...
q.append(1)      # 从右边入队\r
q.append(2)\r
print(q.popleft())  # 1   从左边出队（先进先出）\r
\`\`\`\r
\r
---\r
\r
## 11 stack —— 栈\r
\r
栈是**后进先出（LIFO）**的结构，像叠盘子：后放的先拿。用 list 就能实现。\r
\r
\`\`\`python\r
stack = []\r
stack.append(1)   # 压栈\r
stack.append(2)\r
print(stack.pop())  # 2   弹栈（后进先出）\r
\`\`\`\r
\r
---\r
\r
## 12 heap —— 堆\r
\r
堆是一种特殊的树，分**小顶堆**（堆顶最小）和**大顶堆**，常用于「取最大/最小」和排序。Python 用 \`heapq\`。\r
\r
\`\`\`python\r
import heapq\r
\r
a = [3, 1, 4, 1, 5]\r
heapq.heapify(a)          # 变成小顶堆\r
print(heapq.heappop(a))   # 1   弹出最小的\r
\`\`\`\r
\r
\`heapq\` 默认是小顶堆，取前 k 大/前 k 小这类题最常用它。\r
\r
---\r
\r
## 13 tree —— 树\r
\r
树描述**父子关系**，比如二叉树每个节点最多有两个子节点 \`left\` 和 \`right\`。\r
\r
\`\`\`python\r
tree = {\r
    "value": 1,\r
    "left": {"value": 2, "left": None, "right": None},\r
    "right": {"value": 3, "left": None, "right": None},\r
}\r
\`\`\`\r
\r
树的三种遍历（前序 / 中序 / 后序）和「递归」是重点，很多算法题都绕着树转。\r
\r
---\r
\r
## 学完基础之后\r
\r
把上面 13 个结构过一遍，基础就搭好了。接下来可以：\r
\r
1. 打开 \`python3数据结构.ipynb\`，跟着笔记亲手跑一遍每个例子；\r
2. 进入 \`力扣100题.ipynb\`，用刚学到的结构去解热门题；\r
3. 用 \`跟刷.ipynb\` 保持节奏，按专题持续练习。\r
\r
## 参考资源\r
\r
- **GitHub 仓库**：https://github.com/LiliLIN0324/leetcode-notes\r
- **力扣（LeetCode 中国）**：https://leetcode.cn/\r
- **LeetCode 官网**：https://leetcode.com/\r
\r
---\r
\r
> 💡 **小提示**：数据结构这东西，看懂了不算会，亲手把每个例子敲一遍、每道题写一遍，才真正变成自己的。跟着这份笔记从 0 到 1 慢慢走，量变会带来质变！\r
`;function Ct(c){const b=/^---\r?\n([\s\S]*?)\r?\n---/,g=c.match(b);let t={},r=c;if(g){const n=g[1];r=c.slice(g[0].length).trim();const k=n.split(/\r?\n/);let j=null,E=[];k.forEach(q=>{if(q.trim()==="")return;const z=q.indexOf(":");if(z!==-1&&!q.startsWith(" ")){j&&(t[j]=E.join(`
`)),j=q.slice(0,z).trim();let C=q.slice(z+1).trim();C==="|"?E=[]:C===""?E=[]:(t[j]=C,j=null,E=[])}else j&&q.startsWith("  ")&&E.push(q.slice(2))}),j&&E.length>0&&(t[j]=E.join(`
`)),Object.keys(t).forEach(q=>{let y=t[q];if(typeof y=="string")if(y=y.trim(),y.startsWith('"')&&y.endsWith('"')&&(y=y.slice(1,-1)),typeof y=="string"&&y.includes(`
`)&&/^\s*-/.test(y)){const z=y.split(/\r?\n/).map(C=>C.replace(/^\s*-\s*/,"").trim()).filter(C=>C!=="");t[q]=z.map(C=>C.startsWith('"')&&C.endsWith('"')||C.startsWith("'")&&C.endsWith("'")?C.slice(1,-1):C)}else if(y.startsWith("[")&&y.endsWith("]"))try{t[q]=JSON.parse(y)}catch{t[q]=[y.slice(1,-1).trim()]}else y==="true"?t[q]=!0:y==="false"?t[q]=!1:!isNaN(Number(y))&&y.trim()!==""?t[q]=Number(y):t[q]=y})}let s=[];if(Array.isArray(t.image)&&t.image.length>0)s=t.image;else{const n=/!\[.*?\]\(([^)\s]+)\)/g;let k;for(;(k=n.exec(r))!==null;)s.push(k[1])}return{id:t.id||"",slug:t.slug||"",title:t.title||"",category:t.category||"",year:t.year||"",description:t.description||"",tech:t.tech||[],abstract:t.abstract||"",challenge:t.challenge||"",solution:t.solution||"",hasDemo:t.hasDemo||!1,icon:t.icon||"",code:t.code||"",logo:t.icon||"",image:s,content:r}}function A(c){const b=Ct(c);return{id:b.id,slug:b.slug,title:b.title,category:b.category,year:b.year,description:b.description,tech:b.tech,hasDemo:b.hasDemo,details:{abstract:b.abstract,description:b.description,challenge:b.challenge,solution:b.solution,logo:b.logo,icon:b.icon,code:b.code,image:b.image,content:b.content,demoOnly:b.demoOnly||!1}}}const Le=[A(Oc),A(Fc),A(Hc),A($c),A(Vc),A(Kc),A(Wc),A(Zc)],De=[A(Xc),A(Yc),A(Qc),A(Jc),A(et),A(ct),A(tt)],Ee=[A(at),A(bt),A(pt),A(nt),A(rt),A(it)],_e=[A(gt),A(st),A(dt),A(ft),A(ut)],Pe=[A(ot),A(ht),A(lt)],Re=[A(vt),A(mt),A(jt),A(yt),A(xt),A(wt),A(kt),A(zt),A(Nt),A(qt)],Mt={design:"Products",game:"Games",ai:"AI",planning:"Planning",platform:"Platform",tutorial:"Tutorials",research:"Research"},vc=({className:c})=>e.jsx("div",{className:"flex h-full w-full items-center justify-center text-ink-3/50",children:e.jsx("svg",{className:c,fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})}),mc=({to:c,className:b=""})=>e.jsx($,{to:c,className:`btn-accent ${b}`,children:"Demo"}),St=!1,At=({project:c,type:b,index:g})=>{var t;return e.jsx("li",{className:"group border-b border-rule transition-colors duration-300 hover:bg-surface",children:e.jsxs("div",{className:"flex items-center gap-4 py-4 md:gap-6 md:py-5",children:[e.jsx("span",{className:"nums-tabular hidden w-10 shrink-0 self-start pt-1 text-lg font-bold leading-none tracking-masthead text-ink-3/60 transition-colors group-hover:text-accent-text sm:block",children:String(g+1).padStart(2,"0")}),e.jsxs($,{to:`/${b}/${c.slug}`,className:"flex min-w-0 flex-1 items-center gap-4 md:gap-6",children:[e.jsx("div",{className:"h-16 w-16 shrink-0 overflow-hidden border border-rule bg-surface-2 md:h-20 md:w-20",children:c.details.logo?e.jsx("img",{src:c.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105",onError:r=>{r.target.style.display="none"}}):e.jsx(vc,{className:"h-7 w-7"})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h3",{className:"truncate text-base font-bold tracking-tight text-ink md:text-lg lg:text-xl",children:e.jsx("span",{className:"wipe-underline",children:c.title})}),e.jsx("p",{className:"mt-1 truncate text-sm text-ink-2",children:c.description})]}),e.jsx("div",{className:"hidden shrink-0 flex-wrap justify-end gap-1.5 lg:flex lg:max-w-[16rem]",children:(t=c.tech)==null?void 0:t.slice(0,3).map(r=>e.jsx("span",{className:"chip",children:r},r))}),e.jsx("span",{className:"eyebrow nums-tabular hidden w-12 shrink-0 text-right md:block",children:c.year})]}),c.hasDemo&&e.jsx(mc,{to:`/${b}/${c.slug}#demo`,className:"shrink-0"})]})})},It=({project:c,type:b,index:g})=>{var t;return e.jsxs("article",{className:"group flex flex-col border border-rule bg-surface transition-colors duration-300 hover:border-rule-strong",children:[e.jsxs($,{to:`/${b}/${c.slug}`,className:"flex flex-1 flex-col",children:[e.jsx("div",{className:"aspect-square w-full overflow-hidden border-b border-rule bg-surface-2",children:c.details.logo?e.jsx("img",{src:c.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-[1.05]",onError:r=>{r.target.style.display="none"}}):e.jsx(vc,{className:"h-10 w-10"})}),e.jsxs("div",{className:"flex flex-1 flex-col p-4",children:[e.jsxs("div",{className:"flex items-baseline justify-between gap-3",children:[e.jsx("span",{className:"nums-tabular text-sm font-bold tracking-masthead text-ink-3/70 transition-colors group-hover:text-accent-text",children:String(g+1).padStart(2,"0")}),e.jsx("span",{className:"eyebrow nums-tabular",children:c.year})]}),e.jsx("h3",{className:"mt-2.5 line-clamp-2 text-base font-bold leading-snug tracking-tight text-ink md:text-lg",children:e.jsx("span",{className:"wipe-underline",children:c.title})}),e.jsx("p",{className:"mt-1.5 line-clamp-2 text-sm leading-relaxed text-ink-2",children:c.description}),((t=c.tech)==null?void 0:t.length)>0&&e.jsx("div",{className:"mt-3 flex flex-wrap gap-1.5",children:c.tech.slice(0,2).map(r=>e.jsx("span",{className:"chip",children:r},r))})]})]}),c.hasDemo&&e.jsx("div",{className:"border-t border-rule p-3",children:e.jsx(mc,{to:`/${b}/${c.slug}#demo`,className:"w-full"})})]})},ye=({data:c,type:b})=>{const[g,t]=i.useState("grid"),r=Mt[b]??"Works";return e.jsxs("div",{className:"shell animate-rise-in py-8 md:py-12",children:[b==="design"&&St,e.jsxs("div",{className:"section-head",children:[e.jsxs("p",{className:"eyebrow",children:[b," / Index"]}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(c.length).padStart(2,"0")," Entries"]})]}),e.jsxs("div",{className:"mt-5 flex flex-wrap items-end justify-between gap-4 border-b border-rule pb-5",children:[e.jsxs("h1",{className:"text-display-sm",children:["Selected ",r]}),e.jsx("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:["grid","list"].map(s=>e.jsx("button",{onClick:()=>t(s),"aria-pressed":g===s,className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${g===s?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:s},s))})]}),g==="list"?e.jsx("ul",{className:"mt-2 border-t border-rule",children:c.map((s,n)=>e.jsx(At,{project:s,type:b,index:n},s.slug))}):e.jsx("div",{className:"mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 xl:grid-cols-4",children:c.map((s,n)=>e.jsx(It,{project:s,type:b,index:n},s.slug))})]})},Lt="modulepreload",Dt=function(c,b){return new URL(c,b).href},bc={},T=function(b,g,t){let r=Promise.resolve();if(g&&g.length>0){let n=function(q){return Promise.all(q.map(y=>Promise.resolve(y).then(z=>({status:"fulfilled",value:z}),z=>({status:"rejected",reason:z}))))};const k=document.getElementsByTagName("link"),j=document.querySelector("meta[property=csp-nonce]"),E=(j==null?void 0:j.nonce)||(j==null?void 0:j.getAttribute("nonce"));r=n(g.map(q=>{if(q=Dt(q,t),q in bc)return;bc[q]=!0;const y=q.endsWith(".css"),z=y?'[rel="stylesheet"]':"";if(!!t)for(let _=k.length-1;_>=0;_--){const G=k[_];if(G.href===q&&(!y||G.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${q}"]${z}`))return;const o=document.createElement("link");if(o.rel=y?"stylesheet":Lt,y||(o.as="script"),o.crossOrigin="",o.href=q,E&&o.setAttribute("nonce",E),document.head.appendChild(o),y)return new Promise((_,G)=>{o.addEventListener("load",_),o.addEventListener("error",()=>G(new Error(`Unable to preload CSS for ${q}`)))})}))}function s(n){const k=new Event("vite:preloadError",{cancelable:!0});if(k.payload=n,window.dispatchEvent(k),!k.defaultPrevented)throw n}return r.then(n=>{for(const k of n||[])k.status==="rejected"&&s(k.reason);return b().catch(s)})},Et=i.lazy(()=>T(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),_t=i.lazy(()=>T(()=>import("./UR-platform-DFO5eSKd.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),Pt=i.lazy(()=>T(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),Rt=i.lazy(()=>T(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),Tt=i.lazy(()=>T(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),Gt=i.lazy(()=>T(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),Bt=i.lazy(()=>T(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));i.lazy(()=>T(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const Ut=i.lazy(()=>T(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),Ot=i.lazy(()=>T(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),pc=i.lazy(()=>T(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),Ft=i.lazy(()=>T(()=>import("./72HourGameJamDemo-BWPUgRvj.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),Ht=i.lazy(()=>T(()=>import("./PeaceEliteHustCampusDemo-D-DWwJkq.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),Wt=i.lazy(()=>T(()=>import("./BMWMetaIslandDemo-7uu2MOZP.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),Vt=i.lazy(()=>T(()=>import("./riffle-RlweP75u.js"),__vite__mapDeps([24,1,2,3]),import.meta.url)),Kt=i.lazy(()=>T(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([25,1,2,3]),import.meta.url)),$t=i.lazy(()=>T(()=>import("./genshot-BoH35G7G.js"),__vite__mapDeps([26,1,2,3]),import.meta.url)),Zt=i.lazy(()=>T(()=>import("./dragon-diffusion-Dj4t-WNK.js"),__vite__mapDeps([27,1,2,3]),import.meta.url)),Xt=i.lazy(()=>T(()=>import("./anyreal-DKKTpW8w.js"),__vite__mapDeps([28,1,2,3]),import.meta.url)),Yt=i.lazy(()=>T(()=>import("./previous-archi-work-CvNoz6hg.js"),__vite__mapDeps([29,1,2,3]),import.meta.url)),Qt=i.lazy(()=>T(()=>import("./hongqiqu-y3eLCJ-3.js"),__vite__mapDeps([30,1,2,3]),import.meta.url)),nc=c=>({"cluster-visualizer-3d":Et,"participatory-urban-regeneration-empowered-by-artificial-intelligence":_t,heatmapper:Pt,"how-to-add-openstreetmap-in-website":Rt,"how-to-get-sequential-events-from-photo-by-phone":Tt,"how-to-visualize-photo-geolocation-data-on-map":Gt,kittylovecarrots:pc,"how-to-build-game-in-wechat-mini-program":pc,"72-hour-game-jam":Ft,"peace-elite-hust-campus":Ht,"bmw-meta-island":Wt,"how-to-conduct-time-geo-sequential-clustering-from-album":Bt,"box-up-my-stuff-in-cyberspace":Ut,"epstein-mystery-archive":Ot,"riffle-ai-game-generation-tool":Vt,genstyle:Kt,"genshot-AI-video-generation-tool":$t,"dragon-diffussion":Zt,anyreal:Xt,"previous-archi-work":Yt,hongqiqu:Qt})[c],rc={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
...
}`},Jt=({images:c,captions:b})=>{const[g,t]=i.useState(0),[r,s]=i.useState(new Set(c.map((y,z)=>z))),n=c.filter((y,z)=>r.has(z));if(i.useEffect(()=>{g>=n.length&&t(Math.max(0,n.length-1))},[n.length,g]),n.length===0)return null;const k=y=>{s(z=>{const C=new Set(z);return C.delete(y),C})},j=()=>{t(y=>y===0?n.length-1:y-1)},E=()=>{t(y=>y===n.length-1?0:y+1)},q=b==null?void 0:b[g];return e.jsxs("div",{className:"w-full",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-lg shadow-lg bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center max-h-[350px]",children:[e.jsx("img",{src:n[g],className:"max-w-full max-h-[350px] w-auto h-auto object-contain",alt:q||`Carousel Image ${g+1}`,onError:()=>k(g)}),e.jsx("button",{onClick:j,className:"absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:E,className:"absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),n.length>1&&e.jsx("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1 z-10",children:n.map((y,z)=>e.jsx("button",{onClick:()=>t(z),className:`h-1.5 rounded-full transition-all duration-300 ${g===z?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2 hover:bg-neutral-400"}`,"aria-label":`Go to slide ${z+1}`},z))})]}),q&&e.jsxs("div",{className:"mt-2 text-center",children:[e.jsx("p",{className:"text-sm text-neutral-600 dark:text-neutral-400 italic",children:q}),e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500 mt-1 font-mono",children:[g+1," / ",n.length]})]}),!q&&e.jsxs("p",{className:"mt-2 text-xs text-neutral-400 dark:text-neutral-500 text-center font-mono",children:[g+1," / ",n.length]})]})},ea=({src:c,...b})=>{const[g,t]=i.useState(!1),[r,s]=i.useState(!1);return i.useEffect(()=>{const n=setTimeout(()=>{r||(t(!1),s(!0))},3e3);return()=>clearTimeout(n)},[r]),e.jsxs(e.Fragment,{children:[e.jsx("iframe",{src:c,onLoad:()=>{t(!0),s(!0)},onError:()=>{t(!1),s(!0)},style:{display:"none"},title:"detector"}),!r&&e.jsx("div",{className:"my-4 w-full",children:e.jsxs("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"Open link"]})}),r&&g&&e.jsx("div",{className:"my-6 w-full border border-rule bg-surface-2",children:e.jsx("iframe",{src:c,className:"h-96 w-full border-0",allowFullScreen:!0,...b})}),r&&!g&&e.jsx("div",{className:"my-4 w-full",children:e.jsxs("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"Open link"]})})]})},ca={iframe:({src:c,title:b,...g})=>e.jsx(ea,{src:c,title:b||"Embedded content",...g}),imagecarousel:({images:c,captions:b})=>{const g=(c||"").split(",").map(r=>r.trim()).filter(Boolean),t=b?b.split("|").map(r=>r.trim()):void 0;return e.jsx(Jt,{images:g,captions:t})},table:({children:c})=>e.jsx("div",{className:"my-6 overflow-x-auto border border-rule",children:e.jsx("table",{className:"min-w-full border-collapse text-sm",children:c})}),thead:({children:c})=>e.jsx("thead",{className:"border-b border-rule bg-surface-2",children:c}),th:({children:c})=>e.jsx("th",{className:"border-r border-rule px-3 py-2 text-left font-mono text-[10px] uppercase tracking-eyebrow text-ink-2 last:border-r-0",children:c}),td:({children:c})=>e.jsx("td",{className:"border-r border-t border-rule px-3 py-2 text-ink-2 last:border-r-0",children:c}),h1:({children:c,...b})=>{const t=(typeof c=="string"?c:(c==null?void 0:c.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h1",{id:t,className:"mt-10 mb-5 text-xl font-bold tracking-tight text-ink first:mt-0",...b,children:c})},h2:({children:c,...b})=>{const t=(typeof c=="string"?c:(c==null?void 0:c.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h2",{id:t,className:"mt-8 mb-4 text-lg font-bold tracking-tight text-ink",...b,children:c})},h3:({children:c,...b})=>{const t=(typeof c=="string"?c:(c==null?void 0:c.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h3",{id:t,className:"mt-6 mb-3 text-base font-bold text-ink",...b,children:c})},h4:({children:c,...b})=>e.jsx("h4",{className:"mt-5 mb-2 text-sm font-semibold text-ink",...b,children:c}),h5:({children:c,...b})=>e.jsx("h5",{className:"mt-4 mb-2 text-sm font-semibold text-ink-2",...b,children:c}),h6:({children:c,...b})=>e.jsx("h6",{className:"mt-3 mb-2 font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",...b,children:c}),p:({children:c,...b})=>{var r;const g=kc.Children.toArray(c),t=g.length===1&&((r=g[0])==null?void 0:r.type)==="img";return e.jsx("p",{className:t?"mb-0 leading-relaxed text-ink-2":"mb-4 leading-relaxed text-ink-2",...b,children:c})},a:({children:c,href:b,...g})=>e.jsx("a",{href:b,className:"text-accent-text underline decoration-1 underline-offset-2 transition-colors hover:text-ink",target:"_blank",rel:"noopener noreferrer",...g,children:c}),img:({src:c,alt:b,...g})=>(b==null?void 0:b.match(/BCR|BHV|SVF|NDVI|EV|WR|Dist_/))?e.jsx("img",{src:c,alt:b,className:"h-32 max-w-full border border-rule object-cover",onError:r=>{r.target.style.display="none"},...g}):e.jsx("img",{src:c,alt:b,className:"my-0 h-auto w-full border border-rule object-cover",onError:r=>{r.target.style.display="none"},...g})},xe=({data:c,type:b})=>{var j,E,q,y,z;const{id:g}=wc(),t=c.find(C=>C.slug===g),[r,s]=i.useState(t!=null&&t.hasDemo&&((j=t==null?void 0:t.details)!=null&&j.demoOnly)?"demo":"details"),[n,k]=i.useState(!1);return i.useEffect(()=>{const C=()=>{var o;t!=null&&t.hasDemo&&((o=t==null?void 0:t.details)!=null&&o.demoOnly)||window.location.hash.includes("demo")&&(t!=null&&t.hasDemo)?s("demo"):s("details")};return C(),window.addEventListener("hashchange",C),()=>window.removeEventListener("hashchange",C)},[g,t==null?void 0:t.hasDemo,(E=t==null?void 0:t.details)==null?void 0:E.demoOnly]),t?e.jsxs("div",{className:"animate-rise-in pb-16",children:[e.jsx("div",{className:"sticky top-0 z-20 border-b border-rule bg-surface/85 backdrop-blur",children:e.jsxs("div",{className:"shell flex h-14 items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-4",children:[e.jsx($,{to:`/${b}`,className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3 transition-colors hover:text-ink",children:"← Index"}),e.jsx("span",{className:"hidden h-3 w-px bg-rule md:block","aria-hidden":"true"}),e.jsx("h2",{className:"truncate text-sm font-bold tracking-tight text-ink",children:t.title})]}),!((q=t.details)!=null&&q.demoOnly)&&e.jsxs("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:[e.jsx("button",{onClick:()=>s("details"),className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${r==="details"?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:"Docs"}),t.hasDemo&&e.jsxs("button",{onClick:()=>s("demo"),className:`flex items-center gap-2 px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${r==="demo"?"bg-accent text-accent-ink":"text-ink-3 hover:text-ink"}`,children:[e.jsxs("span",{className:"relative flex h-1.5 w-1.5",children:[e.jsx("span",{className:"absolute h-full w-full animate-ping rounded-full bg-accent-ink/75"}),e.jsx("span",{className:"relative h-1.5 w-1.5 rounded-full bg-accent-ink"})]}),"Demo"]})]})]})}),r==="details"?e.jsx("div",{className:"shell py-8 md:py-12",children:e.jsxs("div",{className:"mx-auto max-w-4xl",children:[((y=t.tech)==null?void 0:y.length)>0&&e.jsx("div",{className:"mb-6 flex flex-wrap gap-1.5",children:t.tech.map((C,o)=>e.jsx("span",{className:"chip",children:C},o))}),e.jsxs("div",{className:"mb-6 flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:[e.jsxs("span",{children:["NO. ",t.id]}),e.jsx("span",{className:"text-rule","aria-hidden":"true",children:"/"}),e.jsx("span",{children:t.year}),e.jsx("span",{className:"text-rule","aria-hidden":"true",children:"/"}),e.jsx("span",{children:t.category})]}),e.jsx("h1",{className:"text-display-sm mb-6",children:t.title}),e.jsxs("details",{className:"group mb-12 border border-rule bg-surface",open:n,onToggle:C=>k(C.target.open),children:[e.jsxs("summary",{className:"flex cursor-pointer list-none items-center justify-between px-5 py-4 select-none md:px-7",children:[e.jsx("span",{className:"eyebrow",children:"Overview"}),e.jsxs("span",{className:"font-mono text-[10px] uppercase tracking-eyebrow text-ink-3 transition-transform duration-300 group-open:rotate-180",children:[n?"Collapse":"Expand"," ▾"]})]}),e.jsxs("div",{className:"space-y-6 border-t border-rule px-5 pb-6 pt-5 md:px-7 md:pb-8 md:pt-6",children:[t.description&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Description"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.description})]}),t.details.abstract&&t.details.abstract!==t.description&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Abstract"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.details.abstract})]}),t.details.challenge&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Challenges"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.details.challenge})]}),t.details.solution&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Methodology"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.details.solution})]})]})]}),t.details.content&&e.jsxs("section",{id:"content",children:[e.jsx("div",{className:"section-head mb-8",children:e.jsx("p",{className:"eyebrow",children:"Content"})}),e.jsx("div",{className:"prose-custom text-base leading-relaxed text-ink-2",children:e.jsx(Ic,{remarkPlugins:[Dc],rehypePlugins:[Lc],components:ca,children:t.details.content})})]}),(t.details.code||t.details.codeComponent||rc[t.slug])&&e.jsxs("section",{id:"code",className:"mt-12",children:[e.jsx("div",{className:"section-head mb-5",children:e.jsx("p",{className:"eyebrow",children:"Code Example"})}),e.jsx("pre",{className:"overflow-x-auto border border-rule bg-ink p-5 font-mono text-[13px] leading-relaxed text-canvas md:p-7",children:e.jsx("code",{children:rc[t.slug]||t.details.codeComponent||`// Code file: ${t.details.code}`})})]})]})}):(z=t.details)!=null&&z.demoOnly?e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"flex items-center justify-center py-20",children:e.jsx("p",{className:"eyebrow",children:"Loading demo..."})}),children:(()=>{const C=nc(t.slug);return C?e.jsx(C,{}):e.jsx("div",{className:"flex items-center justify-center py-20",children:e.jsx("p",{className:"eyebrow",children:"Demo not available"})})})()}):e.jsx("div",{className:"h-[calc(100vh-3.5rem)] w-full bg-surface-2",children:e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"flex h-full items-center justify-center",children:e.jsx("p",{className:"eyebrow",children:"Loading demo..."})}),children:(()=>{const C=nc(t.slug);return C?e.jsx(C,{}):e.jsx("div",{className:"flex h-full items-center justify-center",children:e.jsx("p",{className:"eyebrow",children:"Demo not available"})})})()})})]}):e.jsx("div",{className:"shell flex h-full items-center justify-center py-20",children:e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"eyebrow",children:"Error"}),e.jsx("p",{className:"mt-3 text-display-sm",children:"Project not found"}),e.jsx($,{to:"/",className:"btn-ghost mt-6",children:"← Back to index"})]})})},ta=[{zh:"城市气候与韧性",en:"Urban Climate & Resilience"},{zh:"AI 辅助城市规划",en:"AI-Assisted Urban Planning"},{zh:"机器学习与数据分析",en:"Machine Learning & Data Analysis"},{zh:"空间统计与 GIS",en:"Spatial Statistics & GIS"},{zh:"React / Next.js 生态",en:"React / Next.js Ecosystem"},{zh:"TypeScript 架构",en:"TypeScript Architecture"},{zh:"WebGL / Three.js 3D 可视化",en:"WebGL / Three.js"},{zh:"UI 设计系统",en:"UI Systems Design"}],aa="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/certificate/",ba=c=>`${aa}${encodeURIComponent(c)}`,pa=[{category:"奖学金与荣誉 · Scholarships & Honors",items:[{name:"优秀外国人研究奖学金",year:"2024",images:[{file:"优秀外国人研究奖学金2024.jpg"}]},{name:"优秀毕业生",year:"2024"},{name:"国家励志奖学金",year:"2020",images:[{file:"国家励志奖学金2020.jpg"}]},{name:"国家励志奖学金",year:"2021",images:[{file:"国家励志奖学金2021.jpg"}]},{name:"国家励志奖学金",year:"2022",images:[{file:"国家励志奖学金2022.jpg"}]},{name:"国家励志奖学金",year:"2023",images:[{file:"国家励志奖学金2023.jpg"}]},{name:"学习优秀奖学金",year:"2020",images:[{file:"学习优秀奖学金-2020.jpg"}]},{name:"自强奖学金",year:"2023",images:[{file:"自强奖学金2023.jpg"}]},{name:"三好学生",year:"2021",images:[{file:"三好学生2021.jpg"}]},{name:"三好学生",year:"2023",images:[{file:"三好学生2023.jpg"}]},{name:"优秀学生干部",year:"2022",images:[{file:"优秀学生干部2022.jpg"}]},{name:"优秀共青团员",year:"2020",images:[{file:"优秀共青团员2020.jpg"}]},{name:"优秀共青团员",year:"2022",images:[{file:"优秀共青团员2022.jpg"}]}]},{category:"竞赛奖项 · Competitions",items:[{name:"腾讯游戏极限开发挑战赛 金奖",year:"2021",images:[{file:"腾讯华科Gamejams金奖2021.jpg"}]},{name:"eVolo 摩天大楼建筑竞赛 编辑部推荐奖",year:"2022",images:[{file:"evolo摩天大楼竞赛2022.jpg"}]},{name:"“互联网+”大学生创新创业大赛 武汉市银奖 / 湖北省铜奖",year:"2022",images:[{file:"互联网+省赛市赛名单2022.jpg",label:"武汉市银奖 / 湖北省铜奖名单"},{file:"互联网+省赛铜奖2022.jpg",label:"省赛铜奖证书"}]},{name:"中央国际玻璃国际建筑设计竞赛 佳作奖",year:"2023",images:[{file:"中央国际玻璃竞赛2023.jpg"}]},{name:"米兰设计周省级一等奖",year:"2023",images:[{file:"米兰设计周2023.jpg"}]},{name:"亚洲设计学年奖 银奖、铜奖、优秀奖",year:"2023"}]},{category:"项目与其他 · Projects & Recognition",items:[{name:"国家级大创项目《红旗渠类山地灌渠工程遗产价值判定与数字化平台构建》",year:"2023"},{name:"Digital Futures workshop 参与证书",year:"2023",images:[{file:"digitalfuture2023.jpg"}]},{name:"最佳跨界融合奖 · 同济 AI4CITIES 工作坊",year:"2025",images:[{file:"AI4CITIES最佳跨界融合奖.jpg"}]}]}],na=()=>e.jsx("svg",{className:"h-5 w-5",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.6,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M6 18L18 6M6 6l12 12"})}),ra=()=>e.jsxs("svg",{className:"h-3.5 w-3.5 opacity-60 transition group-hover:opacity-100",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.8,children:[e.jsx("circle",{cx:"11",cy:"11",r:"7"}),e.jsx("path",{strokeLinecap:"round",d:"M21 21l-4.35-4.35M8 11h6M11 8v6"})]}),ic=({dir:c})=>e.jsx("svg",{className:"h-5 w-5",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.8,children:c==="left"?e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"}):e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M9 5l7 7-7 7"})}),ia=()=>{const[c,b]=i.useState(null);i.useEffect(()=>{if(!c)return;const n=j=>{j.key==="Escape"&&b(null)};window.addEventListener("keydown",n);const k=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",n),document.body.style.overflow=k}},[c]);const[g,t]=i.useState(null),[r,s]=i.useState(0);return i.useEffect(()=>{var E;if(!g)return;const n=((E=g.images)==null?void 0:E.length)??0,k=q=>{q.key==="Escape"&&t(null),n>1&&q.key==="ArrowLeft"&&s(y=>(y-1+n)%n),n>1&&q.key==="ArrowRight"&&s(y=>(y+1)%n)};window.addEventListener("keydown",k);const j=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",k),document.body.style.overflow=j}},[g]),e.jsxs("div",{className:"shell animate-rise-in py-8 md:py-12",children:[e.jsxs("div",{className:"mx-auto max-w-5xl",children:[e.jsx("div",{className:"section-head",children:e.jsx("p",{className:"eyebrow",children:"About / Bio"})}),e.jsx("h1",{className:"mt-5 text-display-sm",children:"关于我"}),e.jsx("h1",{className:"mt-5 text-display-sm",children:"About Me"}),e.jsxs("div",{className:"mt-8 space-y-5 text-base leading-relaxed text-ink-2 md:text-lg",children:[e.jsxs("p",{children:["我是林丽丽，毕业于",e.jsx("strong",{className:"font-semibold text-ink",children:"首尔大学城市与区域规划专业"}),"，拥有",e.jsx("strong",{className:"font-semibold text-ink",children:"华中科技大学建筑学"}),"背景。"]}),e.jsxs("p",{children:["我关注 ",e.jsx("strong",{className:"font-semibold text-ink",children:"AI 与产品创新"}),"，喜欢从用户需求出发，将复杂的技术转化为直观、易用的产品体验。过去的实践涵盖 AI 视频、AI 图像、AI 电商等多模态产品，也参与过产品策划、AI Workflow、交互设计与前端开发。"]}),e.jsxs("p",{children:["与此同时，我持续探索 ",e.jsx("strong",{className:"font-semibold text-ink",children:"AI × 城市 × 空间"})," 的交叉领域，研究城市气候、城市形态、空间统计与机器学习，并尝试将数据、AI 与设计结合起来解决真实世界的问题。"]}),e.jsx("p",{children:"我喜欢设计，也喜欢写代码。对我而言，产品、设计与技术并不是彼此独立的领域，而是构建好产品的不同语言。"})]}),e.jsxs("div",{className:"mt-12 border-t border-rule pt-10 md:mt-16 md:pt-12",children:[e.jsx("p",{className:"eyebrow",children:"Core Competencies"}),e.jsx("div",{className:"mt-6 grid grid-cols-1 gap-x-8 gap-y-7 sm:grid-cols-2 lg:grid-cols-4",children:ta.map((n,k)=>e.jsxs("div",{className:"group border-t border-rule pt-4 transition-colors hover:border-accent",children:[e.jsx("span",{className:"font-mono text-xs tabular-nums text-ink-3 transition-colors group-hover:text-accent",children:String(k+1).padStart(2,"0")}),e.jsx("div",{className:"mt-2.5 text-sm font-semibold leading-snug text-ink",children:n.zh}),e.jsx("div",{className:"mt-1 text-xs text-ink-3",children:n.en})]},n.en))})]}),e.jsxs("div",{className:"mt-12 border-t border-rule pt-10 md:mt-16 md:pt-12",children:[e.jsx("p",{className:"eyebrow",children:"Awards & Honors"}),e.jsx("h2",{className:"mt-3 text-2xl font-semibold tracking-tight text-ink md:text-3xl",children:"获奖与荣誉"}),e.jsx("div",{className:"mt-6 grid gap-10 md:grid-cols-3 md:gap-8",children:pa.map(n=>e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold uppercase tracking-wider text-ink",children:n.category}),e.jsx("ul",{className:"mt-4 space-y-3 border-t border-rule pt-4",children:n.items.map(k=>{const j=!!k.images&&k.images.length>0;return e.jsx("li",{children:j?e.jsxs("button",{type:"button",onClick:()=>{t(k),s(0)},className:"group flex w-full items-baseline justify-between gap-3 text-left text-sm leading-snug",children:[e.jsx("span",{className:"text-ink-2 underline decoration-dotted decoration-current underline-offset-4 transition group-hover:text-ink",children:k.name}),e.jsxs("span",{className:"flex shrink-0 items-center gap-1.5 font-medium tabular-nums text-ink",children:[k.year,e.jsx(ra,{})]})]}):e.jsxs("div",{className:"flex items-baseline justify-between gap-3 text-sm leading-snug",children:[e.jsx("span",{className:"text-ink-2",children:k.name}),e.jsx("span",{className:"shrink-0 font-medium tabular-nums text-ink",children:k.year})]})},`${k.name}-${k.year}`)})})]},n.category))})]})]}),g&&g.images&&zc.createPortal(e.jsxs("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm md:p-12",onClick:()=>t(null),role:"dialog","aria-modal":"true",children:[e.jsx("button",{type:"button","aria-label":"关闭",onClick:()=>t(null),className:"absolute right-4 top-4 z-10 rounded-full border border-white/20 p-2 text-white/80 transition hover:bg-white/10 hover:text-white",children:e.jsx(na,{})}),g.images.length>1&&e.jsx("button",{type:"button","aria-label":"上一张",onClick:n=>{n.stopPropagation(),s(k=>(k-1+g.images.length)%g.images.length)},className:"absolute left-3 top-1/2 z-10 -translate-y-1/2 rounded-full border border-white/20 p-2 text-white/80 transition hover:bg-white/10 hover:text-white md:left-8",children:e.jsx(ic,{dir:"left"})}),g.images.length>1&&e.jsx("button",{type:"button","aria-label":"下一张",onClick:n=>{n.stopPropagation(),s(k=>(k+1)%g.images.length)},className:"absolute right-3 top-1/2 z-10 -translate-y-1/2 rounded-full border border-white/20 p-2 text-white/80 transition hover:bg-white/10 hover:text-white md:right-8",children:e.jsx(ic,{dir:"right"})}),e.jsxs("figure",{className:"relative max-w-3xl",onClick:n=>n.stopPropagation(),children:[e.jsx("img",{src:ba(g.images[r].file),alt:`${g.name} ${g.year}`,className:"max-h-[80vh] w-auto max-w-full rounded-md object-contain shadow-2xl"}),e.jsxs("figcaption",{className:"mt-3 text-center text-sm",children:[e.jsx("span",{className:"text-white/90",children:g.name}),e.jsxs("span",{className:"text-white/50",children:[" · ",g.year]}),g.images[r].label&&e.jsxs("span",{className:"text-white/50",children:[" · ",g.images[r].label]}),g.images.length>1&&e.jsxs("span",{className:"text-white/50",children:[" · ",r+1," / ",g.images.length]})]})]})]}),document.body)]})},ga=()=>e.jsx("div",{className:"shell flex h-full flex-col items-center justify-center py-20 text-center",children:e.jsxs("div",{className:"animate-rise-in max-w-md space-y-8",children:[e.jsx("div",{className:"flex justify-center",children:e.jsx("span",{className:"icon-btn h-14 w-14",children:e.jsx("svg",{className:"h-5 w-5",fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("p",{className:"eyebrow",children:"Contact"}),e.jsx("h2",{className:"text-display-sm",children:"Let's work together"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:"Interested in collaboration, research, or just want to say hello? Reach out anytime."})]}),e.jsxs("div",{className:"flex flex-col items-center gap-3 pt-4",children:[e.jsxs("a",{href:"mailto:lily1326685527@gmail.com?subject=Research%20Collaboration",className:"btn-solid",children:["Send message",e.jsx("svg",{className:"h-3 w-3",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14 5l7 7m0 0l-7 7m7-7H3"})})]}),e.jsx("p",{className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:"lily1326685527@gmail.com"})]})]})}),Ye=({href:c,label:b})=>e.jsx("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"icon-btn font-mono text-[10px] tracking-eyebrow",children:b}),gc=[{city:"上海",country:"中国",date:"2024",note:"法租界的梧桐树影"},{city:"东京",country:"日本",date:"2025",note:"下北泽的午后散步"},{city:"首尔",country:"韩国",date:"2025",note:"汉江边的晚风与霓虹"},{city:"新加坡",country:"新加坡",date:"2026",note:"滨海湾的花园城市漫游"},{city:"明尼阿波利斯",country:"美国",date:"2025",note:"密西西比河畔的秋日"},{city:"剑桥",country:"英国",date:"2025",note:"康河上的撑船与学院回廊"},{city:"武汉",country:"中国",date:"2023",note:"东湖绿道与热干面的早晨"},{city:"香港",country:"中国",date:"2024",note:"中环半山扶梯的夜色"}],sc=["from-amber-500/20 via-orange-400/10 to-yellow-500/20","from-emerald-500/20 via-teal-400/10 to-cyan-500/20","from-rose-500/20 via-pink-400/10 to-fuchsia-500/20","from-sky-500/20 via-blue-400/10 to-indigo-500/20","from-violet-500/20 via-purple-400/10 to-plum-500/20","from-lime-500/20 via-green-400/10 to-emerald-500/20","from-red-500/20 via-orange-400/10 to-amber-500/20","from-cyan-500/20 via-teal-400/10 to-sky-500/20"],sa={上海:"🏙️",东京:"🗼",首尔:"🏯",新加坡:"🌿",明尼阿波利斯:"🌊",剑桥:"🎓",武汉:"🌸",香港:"🌃"},da=({entry:c,index:b})=>{const[g,t]=i.useState(!1),r=sc[b%sc.length],s=sa[c.city]??"📍";return e.jsx("div",{className:"relative cursor-pointer select-none",style:{perspective:"800px"},onClick:()=>t(n=>!n),onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),children:e.jsxs("div",{className:"relative w-full transition-transform duration-500 ease-editorial",style:{transformStyle:"preserve-3d",transform:g?"rotateY(180deg)":"rotateY(0deg)",aspectRatio:"3/4"},children:[e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center gap-2 border border-dashed border-rule bg-surface p-4",style:{backfaceVisibility:"hidden"},children:[e.jsx("div",{className:"absolute inset-x-3 top-2 flex justify-between",children:Array.from({length:16}).map((n,k)=>e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-canvas"},k))}),e.jsx("div",{className:"absolute inset-x-3 bottom-2 flex justify-between",children:Array.from({length:16}).map((n,k)=>e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-canvas"},k))}),e.jsx("span",{className:"text-3xl",children:s}),e.jsx("p",{className:"text-base font-bold tracking-tight text-ink",children:c.city}),e.jsx("p",{className:"eyebrow text-ink-3",children:c.country}),c.date&&e.jsx("span",{className:"mt-1 inline-block border border-rule px-2 py-0.5 font-mono text-[10px] uppercase tracking-eyebrow text-ink-3",children:c.date}),e.jsx("div",{className:"absolute right-3 top-5 -rotate-12 opacity-30",children:e.jsxs("svg",{width:"40",height:"40",viewBox:"0 0 40 40",fill:"none",children:[e.jsx("circle",{cx:"20",cy:"20",r:"17",stroke:"currentColor",strokeWidth:"1.5",className:"text-ink-3"}),e.jsx("path",{d:"M8 8l24 24M8 32L32 8",stroke:"currentColor",strokeWidth:"0.8",className:"text-ink-3"})]})})]}),e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center overflow-hidden border border-rule-strong bg-surface-2",style:{backfaceVisibility:"hidden",transform:"rotateY(180deg)"},children:[c.photo?e.jsx("img",{src:c.photo,alt:c.city,className:"absolute inset-0 h-full w-full object-cover"}):e.jsx("div",{className:`absolute inset-0 bg-gradient-to-br ${r}`}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent"}),e.jsxs("div",{className:"relative z-10 px-4 text-center",children:[e.jsx("p",{className:"text-lg font-bold tracking-tight text-white",children:c.city}),c.note&&e.jsx("p",{className:"mt-1.5 text-xs leading-relaxed text-white/70",children:c.note})]}),e.jsx("div",{className:"absolute inset-2 border border-dashed border-white/10"})]})]})})},fa=()=>e.jsxs("section",{className:"shell border-t border-rule pt-12 md:pt-16",children:[e.jsxs("div",{className:"section-head",children:[e.jsx("p",{className:"eyebrow",children:"Wander"}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(gc.length).padStart(2,"0")," cities"]})]}),e.jsxs("div",{className:"mt-5 flex items-end justify-between gap-4",children:[e.jsx("h2",{className:"text-display-sm",children:"City Walks"}),e.jsxs("p",{className:"max-w-xs text-right text-xs leading-relaxed text-ink-3",children:["用脚步丈量城市，",e.jsx("br",{className:"hidden sm:inline"}),"在每个街角发现故事。"]})]}),e.jsx("div",{className:"mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5",children:gc.map((c,b)=>e.jsx(da,{entry:c,index:b},c.city))})]}),ua="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig",B=c=>`${ua}/${c}/logo.jpg`,oa=new Map([...De.map(c=>["design",c]),...Ee.map(c=>["game",c]),..._e.map(c=>["ai",c]),...Le.map(c=>["planning",c]),...Pe.map(c=>["platform",c]),...Re.map(c=>["tutorial",c])].map(([c,b])=>[`/${c}/${b.slug}`,{title:b.title,year:b.year,category:b.category,description:b.description||b.details.abstract||""}])),ha=c=>oa.get(c),Ie=[2022,2023,2024,2025,2026],dc=[{zh:"产品",en:"Product",listHref:"/design",color:"#5ec5d4",items:[{name:"Counting",year:2022,logo:B("counting"),href:"/design/early-campus-experience"},{name:"1037拼拼",year:2022,logo:B("1037pinpin"),href:"/design/early-campus-experience"},{name:"PersLearn",year:2023,logo:B("perslearn"),href:"/design/early-campus-experience"}]},{zh:"AI 产品",en:"AI Product",listHref:"/design",color:"#3f6fd8",items:[{name:"智图",year:2023,logo:B("dragon-diffusion"),href:"/design/dragon-diffussion"},{name:"AnyReal",year:2024,logo:B("anyreal"),href:"/design/anyreal"},{name:"Genshot",year:2024,logo:B("genshot"),href:"/design/genshot-AI-video-generation-tool"},{name:"洛书八字",year:2025,logo:B("bazi"),href:"/design/bazi-fengshui-analysis"},{name:"Genstyle",year:2025,logo:B("genstyle"),href:"/design/genstyle"},{name:"Riffle",year:2026,logo:B("riffle"),href:"/design/riffle-ai-game-generation-tool"}]},{zh:"游戏 & 用户体验",en:"Game & User Experience",listHref:"/game",color:"#9b5bc9",items:[{name:"无名之路",year:2022,logo:B("game-jam"),href:"/game/72-hour-game-jam"},{name:"和平精英",year:2022,logo:B("peace-elite-hust"),href:"/game/peace-elite-hust-campus"},{name:"宝马元宇宙",year:2022,logo:B("bmw-meta-island"),href:"/game/bmw-meta-island"},{name:"Bilibili 实习",year:2023,logo:B("guangzhou-xinyuan"),href:"/game/guangzhou-xinyuan-tech"},{name:"微信小游戏",year:2026,logo:B("kittylovecarrots"),href:"/game/kittylovecarrots"}]},{zh:"AI 辅助城市规划",en:"AI-aided Planning",listHref:"/ai",color:"#1b2c5e",items:[{name:"全球空间聚类",year:2023,logo:B("cluster-visualizer-3d"),href:"/planning/cluster-visualizer-3d"},{name:"RAG 城市助手",year:2024,logo:B("agentic-rag"),href:"/ai/prompt-engineering-agentic-rag"},{name:"知识图谱",year:2024,logo:B("knowledge-graph-urban-planning"),href:"/ai/knowledge-graph-urban-planning"},{name:"Diffusion 城市更新",year:2025,logo:B("participatory-urban-regeneration"),href:"/ai/participatory-urban-regeneration-empowered-by-artificial-intelligence"},{name:"机器学习城市热韧性",year:2026,logo:B("urban-heat-resilience-ml"),href:"/ai/urban-heat-resilience-machine-learning"}]}],la=4,va=1,ma=`calc(${va}rem + ${la/2}rem - 1.5px)`,ja=16,ya=`-${ja/2}rem`,jc=c=>{c.currentTarget.style.visibility="hidden"},xa=c=>c.metaKey||c.ctrlKey||c.shiftKey||c.altKey,wa=()=>{const[c,b]=i.useState(null),g=i.useRef(null);return i.useEffect(()=>{if(!c)return;const r=n=>{n.key==="Escape"&&b(null)},s=n=>{g.current&&!g.current.contains(n.target)&&b(null)};return window.addEventListener("keydown",r),document.addEventListener("mousedown",s),()=>{window.removeEventListener("keydown",r),document.removeEventListener("mousedown",s)}},[c]),{activeKey:c,setActiveKey:b,rootRef:g,onClick:r=>s=>{xa(s)||c!==r&&(s.preventDefault(),b(r))}}},yc=({item:c,color:b,compact:g=!1})=>{const t=ha(c.href);return e.jsxs(e.Fragment,{children:[e.jsx("span",{className:`block font-bold tracking-tight text-ink ${g?"text-xs":"text-sm"}`,children:(t==null?void 0:t.title)??c.name}),e.jsxs("span",{className:"mt-1 block font-mono text-[10px] uppercase tracking-eyebrow text-ink-3",children:[(t==null?void 0:t.year)??String(c.year),t!=null&&t.category?` · ${t.category}`:""]}),(t==null?void 0:t.description)&&e.jsx("span",{className:`mt-2 block leading-relaxed text-ink-2 ${g?"text-[11px]":"text-xs"}`,children:t.description}),!g&&e.jsx("span",{className:"mt-2.5 block text-[10px] font-medium",style:{color:b},children:"再点一次进入项目 →"})]})},ka=({item:c,color:b,expanded:g,onExpandClick:t})=>e.jsxs($,{to:c.href,onClick:t,"aria-expanded":g,"aria-label":`${c.name}（${c.year}）`,className:"group relative flex w-16 shrink-0 flex-col items-center",children:[e.jsx("span",{className:`flex h-16 w-16 items-center justify-center rounded-xl border bg-surface p-1.5 shadow-lift transition-all duration-300 ease-editorial group-hover:-translate-y-1 ${g?"-translate-y-1 border-transparent":"border-rule"}`,style:g?{boxShadow:`0 0 0 2px ${b}, 0 18px 44px -22px rgba(0,0,0,0.4)`}:void 0,children:e.jsx("img",{src:c.logo,alt:"",onError:jc,className:"h-full w-full rounded-lg object-cover"})}),e.jsx("span",{className:`mt-2.5 max-w-[7rem] truncate rounded-full border px-2 py-0.5 text-[11px] font-medium transition-colors duration-200 ${g?"border-rule-strong bg-surface text-ink":"border-rule bg-surface-2 text-ink-2 group-hover:border-rule-strong group-hover:text-ink"}`,children:c.name}),g&&e.jsxs("span",{className:"absolute bottom-full left-1/2 z-20 mb-3 w-64 rounded-lg border border-rule bg-surface p-3 text-left shadow-lift-lg animate-rise-in",style:{marginLeft:ya},children:[e.jsx(yc,{item:c,color:b}),e.jsx("span",{className:"absolute -bottom-[5px] left-1/2 h-2.5 w-2.5 -translate-x-1/2 rotate-45 border-b border-r border-rule bg-surface","aria-hidden":"true"})]})]}),fc=({category:c,className:b=""})=>e.jsxs($,{to:c.listHref,className:`group block ${b}`,children:[e.jsx("p",{className:"text-sm font-bold leading-snug text-ink underline decoration-1 underline-offset-4 transition-colors group-hover:text-accent-text group-hover:decoration-accent-text",children:c.zh}),e.jsx("p",{className:"text-sm font-bold leading-snug text-ink underline decoration-1 underline-offset-4 transition-colors group-hover:text-accent-text group-hover:decoration-accent-text",children:c.en})]}),za=()=>{const{activeKey:c,rootRef:b,onClick:g}=wa();return e.jsxs("section",{ref:b,className:"shell border-t border-rule pt-12 md:pt-16",children:[e.jsxs("div",{className:"section-head",children:[e.jsx("p",{className:"eyebrow",children:"Timeline"}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[Ie[0]," — ",Ie[Ie.length-1]]})]}),e.jsxs("div",{className:"mt-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between sm:gap-6",children:[e.jsx("h2",{className:"font-serif text-4xl tracking-tight text-ink md:text-5xl",children:"Content"}),e.jsxs("p",{className:"text-xs leading-relaxed text-ink-3 sm:text-right",children:["* 点击图标查看项目简介，再点一次进入项目",e.jsx("br",{}),"* 点击下方文字标签跳转到作品集页面"]})]}),e.jsxs("div",{className:"mt-10 hidden md:block",children:[e.jsxs("div",{className:"grid grid-cols-[9rem_repeat(5,minmax(0,1fr))] gap-x-2",children:[e.jsx("div",{}),Ie.map(t=>e.jsx("div",{className:"nums-tabular text-center text-sm font-bold text-ink",children:t},t))]}),dc.map(t=>e.jsxs("div",{className:"mt-10 grid grid-cols-[9rem_repeat(5,minmax(0,1fr))] gap-x-2",children:[e.jsx(fc,{category:t,className:"pt-4"}),e.jsxs("div",{className:"relative col-span-5 pt-4",children:[e.jsx("div",{className:"absolute left-0 right-0 h-[3px]",style:{top:ma,background:t.color},"aria-hidden":"true"}),e.jsx("div",{className:"relative grid grid-cols-5 gap-x-2",children:Ie.map(r=>e.jsx("div",{className:"flex flex-wrap items-start justify-center gap-x-3 gap-y-5",children:t.items.filter(s=>s.year===r).map(s=>e.jsx(ka,{item:s,color:t.color,expanded:c===s.name,onExpandClick:g(s.name)},s.name))},r))})]})]},t.zh))]}),e.jsx("div",{className:"mt-8 space-y-8 md:hidden",children:dc.map(t=>e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2.5 border-t border-rule pt-3",children:[e.jsx("span",{className:"h-[3px] w-5 shrink-0",style:{background:t.color},"aria-hidden":"true"}),e.jsx(fc,{category:t})]}),e.jsx("div",{className:"mt-3 grid grid-cols-2 items-start gap-2.5 sm:grid-cols-3",children:[...t.items].sort((r,s)=>r.year-s.year).map(r=>{const s=c===r.name;return e.jsxs($,{to:r.href,onClick:g(r.name),"aria-expanded":s,className:`flex items-start gap-2.5 border bg-surface p-2 transition-colors ${s?"col-span-2 border-rule-strong sm:col-span-3":"border-rule hover:border-rule-strong"}`,children:[e.jsx("img",{src:r.logo,alt:"",onError:jc,className:"h-9 w-9 shrink-0 rounded-lg border border-rule object-cover"}),s?e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsx(yc,{item:r,color:t.color,compact:!0}),e.jsx("span",{className:"mt-2 block text-[10px] font-medium",style:{color:t.color},children:"再点一次进入项目 →"})]}):e.jsxs("span",{className:"min-w-0",children:[e.jsx("span",{className:"block truncate text-xs font-semibold text-ink",children:r.name}),e.jsx("span",{className:"nums-tabular block text-[10px] text-ink-3",children:r.year})]})]},r.name)})})]},t.zh))})]})},Na=[{key:"all",label:"All"},{key:"design",label:"Product"},{key:"game",label:"Game"},{key:"ai",label:"AI"},{key:"planning",label:"Planning"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"}],uc={all:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"设计、开发、游戏、AI 和城市规划"}),"领域的项目。"]}),design:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"产品"}),"领域的项目。"]}),planning:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"城市规划"}),"领域的项目。"]}),game:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"游戏"}),"领域的项目。"]}),ai:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"AI"}),"领域的项目。"]}),platform:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"平台开发"}),"领域的项目。"]}),tutorial:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"教程"}),"领域的项目。"]})},Qe=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/kitty-0317.mp4",title:"Kitty Video"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/%E5%BE%AE%E4%BF%A1%E8%A7%86%E9%A2%912026-02-09_184301_354.mp4",title:"Kitty Video 2"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260225-192100.mp4",title:"Riffle Loading 1"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video3.mp4",title:"Video Title 3"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video4.mp4",title:"Video Title 4"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video5.mp4",title:"Video Title 5"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video6.mp4",title:"Video Title 6"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video7.mp4",title:"Video Title 7"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video8.mp4",title:"Video Title 8"}],oc=()=>e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})}),hc=()=>e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M9 5l7 7-7 7"})}),qa={1:[4],2:[0,8],3:[0,4,8],4:[0,2,6,8],5:[0,2,4,6,8],6:[0,2,3,5,6,8]},we=({value:c,transform:b})=>e.jsx("div",{className:"absolute inset-0 grid grid-cols-3 grid-rows-3 border border-neutral-400 bg-white p-[2px]",style:{transform:b,backfaceVisibility:"hidden"},children:Array.from({length:9}).map((g,t)=>e.jsx("span",{className:"flex items-center justify-center",children:qa[c].includes(t)&&e.jsx("span",{className:"block h-[2.5px] w-[2.5px] rounded-full",style:{background:c===1||c===4?"#cc2a18":"#171717"}})},t))}),Ca=()=>{var Ae,p,m,N,x;const[c,b]=i.useState("all"),g={all:[...De.map(a=>({...a,type:"design"})),...Ee.map(a=>({...a,type:"game"})),..._e.map(a=>({...a,type:"ai"})),...Le.map(a=>({...a,type:"planning"})),...Pe.map(a=>({...a,type:"platform"})),...Re.map(a=>({...a,type:"tutorial"}))],design:De.map(a=>({...a,type:"design"})),planning:Le.map(a=>({...a,type:"planning"})),game:Ee.map(a=>({...a,type:"game"})),ai:_e.map(a=>({...a,type:"ai"})),platform:Pe.map(a=>({...a,type:"platform"})),tutorial:Re.map(a=>({...a,type:"tutorial"}))},t=a=>g[a].length,r=g[c]??g.all,s=Math.max(0,r.length-1),[n,k]=i.useState(0),j=a=>{b(a),k(0)},E=a=>{if(!a)return[];const d=/<video[^>]+src="([^"]+)"/gi;return Array.from(a.matchAll(d),f=>f[1])},q=a=>{var f,u;if(!a)return null;const d=(f=a.details)==null?void 0:f.image;return d!=null&&d.length?d[0]:((u=a.details)==null?void 0:u.logo)??null},y=r[(n-1+r.length)%r.length],z=r[(n+1)%r.length],C=q(y),o=q(z),[_,G]=i.useState(0),[U,D]=i.useState(!1),ce=i.useRef(null),R=i.useRef(null),M=r[n],Z=((Ae=M==null?void 0:M.details)==null?void 0:Ae.image)??[];Z.length>=2&&Z[(_-1+Z.length)%Z.length],Z.length>=3?Z[(_+1)%Z.length]:Z.length===2&&Z[(_+1)%2],i.useEffect(()=>{G(0),D(!1)},[n,c]);const[Ce,X]=i.useState({x:0,y:0}),Fe=()=>{X(a=>({x:a.x+720+Math.round(Math.random()*360),y:a.y+720+Math.round(Math.random()*360)})),setTimeout(()=>Q(Math.floor(Math.random()*r.length)),900)},Me=E(((p=M==null?void 0:M.details)==null?void 0:p.content)??""),oe=((m=M==null?void 0:M.details)==null?void 0:m.image)??[],Y=[...Me,...oe],he=Y.length>0?Y[_%Y.length]:(N=M==null?void 0:M.details)==null?void 0:N.logo,be=Me.length>0&&_<Me.length,pe=oe.length>0?oe[0]:(x=M==null?void 0:M.details)==null?void 0:x.logo,Se=()=>{G(a=>(a+1)%(Y.length||1))};i.useEffect(()=>{if(R.current&&(clearInterval(R.current),R.current=null),!(be||Y.length<=1))return R.current=setInterval(Se,5e3),()=>{R.current&&(clearInterval(R.current),R.current=null)}},[n,c,be,Y.length]);const ne=()=>{const a=ce.current;a&&(a.muted=!a.muted,D(!a.muted))},te=i.useRef(null),ae=3,F=i.useRef({isDown:!1,isDragging:!1,startX:0,scrollLeft:0}),He=a=>{var d;F.current={isDown:!0,isDragging:!1,startX:a.clientX,scrollLeft:((d=te.current)==null?void 0:d.scrollLeft)??0}},re=a=>{var f;if(!F.current.isDown)return;const d=a.clientX-F.current.startX;!F.current.isDragging&&Math.abs(d)<ae||(F.current.isDragging||(F.current.isDragging=!0,(f=te.current)==null||f.setPointerCapture(a.pointerId)),a.preventDefault(),te.current.scrollLeft=F.current.scrollLeft-d)},Te=a=>{var d;F.current.isDragging&&((d=te.current)==null||d.releasePointerCapture(a.pointerId)),F.current={isDown:!1,isDragging:!1,startX:0,scrollLeft:0}},Q=a=>{k(a)};i.useEffect(()=>{const a=te.current;if(!a)return;const d=a.children[n];d&&d.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})},[n]);const ie=i.useRef(null),le=i.useRef([]),[ve,Je]=i.useState(0),[xc,H]=i.useState(0),[Ge,me]=i.useState({start:!0,end:!1}),[Be,We]=i.useState({}),ge=a=>{const d=a%Qe.length;Je(d);const f=ie.current;if(f){const u=f.children[d];u&&f.scrollTo({left:u.offsetLeft-f.offsetWidth/2+u.offsetWidth/2,behavior:"smooth"})}};i.useEffect(()=>{const a=le.current[ve];a&&(a.currentTime=0,a.play().catch(()=>{}))},[ve]);const se=i.useCallback(()=>{const a=ie.current;if(!a)return;const d=a.firstElementChild,f=(d==null?void 0:d.offsetWidth)||1;H(Math.round(a.scrollLeft/f)),me({start:a.scrollLeft<=1,end:a.scrollLeft+a.clientWidth>=a.scrollWidth-1})},[]);i.useEffect(()=>(se(),window.addEventListener("resize",se),()=>window.removeEventListener("resize",se)),[se]);const Ue=a=>{const d=ie.current;if(!d)return;const f=d.firstElementChild;d.scrollBy({left:a*((f==null?void 0:f.offsetWidth)||d.clientWidth/2),behavior:"smooth"})},Ve=(a,d)=>{var l;const f=a,u=w=>We(v=>v[d]===w?v:{...v,[d]:w});if((l=f.audioTracks)!=null&&l.length){u(Array.from(f.audioTracks).some(w=>w.enabled));return}if("mozHasAudio"in f){u(!!f.mozHasAudio);return}if(typeof f.webkitAudioDecodedByteCount=="number"&&f.webkitAudioDecodedByteCount>0){u(!0);return}if(f.readyState>=3){setTimeout(()=>u(f.webkitAudioDecodedByteCount>0||f.mozHasAudio===!0),500);return}u(!0)};return e.jsxs("div",{className:"animate-rise-in pb-16",children:[he&&e.jsxs("section",{className:"relative w-full overflow-hidden border-b border-neutral-800",style:{background:"linear-gradient(to bottom, #3f3f3f 100%, #0a0a0a 100%)"},children:[e.jsx("div",{className:"absolute inset-0 bg-grid-pattern opacity-[0.07]","aria-hidden":"true"}),e.jsx("div",{className:"absolute inset-0 z-20 pointer-events-none",style:{boxShadow:"inset 0 0 140px 50px rgba(0,0,0,0.75)"},"aria-hidden":"true"}),e.jsxs("div",{className:"relative mx-auto flex w-full max-w-12xl items-stretch px-0 py-6 md:py-0",children:[e.jsx("button",{onClick:()=>Q((n-1+r.length)%r.length),className:"group relative z-10 hidden w-[11%] h-[80%] shrink-0 md:block",title:y==null?void 0:y.title,children:e.jsxs("div",{className:"aspect-[1/3] w-full overflow-hidden border border-white/[0.06] bg-white/[0.03]",children:[C&&e.jsx("img",{src:C,alt:"",onError:a=>{a.target.style.display="none"},className:"absolute inset-0 h-full w-full object-cover opacity-40 transition-opacity group-hover:opacity-65"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-black/60 via-black/10 to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2",children:e.jsx("p",{className:"truncate text-center font-mono text-[9px] uppercase tracking-eyebrow text-white/50",children:y==null?void 0:y.title})})]})}),e.jsx("div",{className:"relative z-10 hidden flex-1 overflow-hidden md:block","aria-hidden":"true",children:e.jsx("div",{className:"h-full w-full",style:{clipPath:"polygon(0 0%, 100% 0%, 100% 86%, 0 100%)"},children:e.jsx("img",{src:pe,alt:"",className:"absolute inset-0 h-full w-full object-cover blur-xl scale-125 opacity-30",onError:a=>{a.target.style.display="none"}})})}),e.jsx("div",{className:"relative z-20 flex h-auto w-full shrink-0 flex-col md:h-[98%] md:w-[50%]",children:e.jsxs("div",{className:"aspect-video max-h-[70vh] w-full overflow-hidden border border-white/[0.08]",style:{boxShadow:"0 0 70px -10px rgba(0,0,0,0.5)"},children:[be?e.jsx("video",{ref:a=>{ce.current=a},src:he,autoPlay:!0,muted:U,playsInline:!0,onEnded:Se,className:"absolute inset-0 h-full w-full object-cover animate-rise-in"},he):e.jsx("img",{src:he,alt:(M==null?void 0:M.title)??"",className:"absolute inset-0 h-full w-full object-cover animate-rise-in",onError:a=>{a.target.style.display="none"}},he),be&&e.jsx("button",{onClick:ne,className:"absolute bottom-2 right-2 z-30 flex h-8 w-8 items-center justify-center border border-white/30 bg-black/55 text-white/80 hover:border-white hover:text-white",title:U?"Unmute":"Mute",children:U?e.jsxs("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"}),e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2"})]}):e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})})]})}),e.jsx("div",{className:"relative z-10 hidden flex-1 overflow-hidden md:block","aria-hidden":"true",children:e.jsx("div",{className:"h-full w-full",style:{clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0 86%)"},children:e.jsx("img",{src:pe,alt:"",className:"absolute inset-0 h-full w-full object-cover blur-xl scale-125 opacity-30",onError:a=>{a.target.style.display="none"}})})}),e.jsx("button",{onClick:()=>Q((n+1)%r.length),className:"group relative z-10 hidden w-[11%]  h-[80%] shrink-0 md:block",title:z==null?void 0:z.title,children:e.jsxs("div",{className:"aspect-[1/3] w-full overflow-hidden border border-white/[0.06] bg-white/[0.03]",children:[o&&e.jsx("img",{src:o,alt:"",onError:a=>{a.target.style.display="none"},className:"absolute inset-0 h-full w-full object-cover opacity-40 transition-opacity group-hover:opacity-65"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-l from-black/60 via-black/10 to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2",children:e.jsx("p",{className:"truncate text-center font-mono text-[9px] uppercase tracking-eyebrow text-white/50",children:z==null?void 0:z.title})})]})})]})]}),e.jsxs("section",{className:"shell pt-10 md:pt-0",children:[e.jsxs("div",{className:"flex items-center justify-between gap-2 mb-2 py-2 md:mb-4 overflow-hidden",children:[e.jsxs("div",{className:"flex items-baseline gap-3 min-w-0",children:[e.jsx("p",{className:"text-sm font-bold text-ink truncate",children:M==null?void 0:M.title}),e.jsxs("p",{className:"eyebrow shrink-0",children:[M==null?void 0:M.type," · ",M==null?void 0:M.year]})]}),e.jsxs("div",{className:"flex items-center gap-3 shrink-0 min-w-0",children:[Y.length>1&&e.jsx("span",{className:"flex items-center gap-1.5 overflow-x-auto hide-scrollbar max-w-[80px] sm:max-w-[200px]",children:Y.map((a,d)=>e.jsx("button",{onClick:()=>G(d),"aria-label":`Media ${d+1}`,className:`h-1.5 shrink-0 rounded-full transition-all duration-300 ${d===_?"w-6 bg-accent":"w-1.5 bg-rule hover:bg-ink-3"}`},d))}),e.jsx("button",{onClick:Fe,className:"btn-ghost shrink-0 !px-2",title:"Roll a random project",children:e.jsx("span",{className:"h-5 w-5",style:{perspective:"120px"},children:e.jsxs("span",{className:"relative block h-full w-full transition-transform duration-[900ms] ease-out",style:{transform:`rotateX(${Ce.x}deg) rotateY(${Ce.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx(we,{value:1,transform:"translateZ(10px)"}),e.jsx(we,{value:6,transform:"rotateY(180deg) translateZ(10px)"}),e.jsx(we,{value:3,transform:"rotateY(-90deg) translateZ(10px)"}),e.jsx(we,{value:4,transform:"rotateY(90deg) translateZ(10px)"}),e.jsx(we,{value:2,transform:"rotateX(90deg) translateZ(10px)"}),e.jsx(we,{value:5,transform:"rotateX(-90deg) translateZ(10px)"})]})})})]})]}),e.jsx("div",{className:"mt-4 -mx-1 flex overflow-x-auto hide-scrollbar border-b border-rule",children:Na.map(a=>{const d=c===a.key;return e.jsxs("button",{onClick:()=>j(a.key),"aria-pressed":d,className:`relative shrink-0 px-3.5 pb-3 pt-1 font-mono text-[11px] uppercase tracking-eyebrow transition-colors duration-200 ${d?"text-ink":"text-ink-3 hover:text-ink"}`,children:[a.label,e.jsx("span",{className:"ml-1.5 nums-tabular text-ink-3",children:t(a.key)}),e.jsx("span",{className:`absolute inset-x-2 bottom-0 h-[3px] origin-left bg-accent transition-transform duration-300 ease-editorial ${d?"scale-x-100":"scale-x-0"}`,"aria-hidden":"true"})]},a.key)})}),e.jsxs("div",{className:"mt-5 flex items-center gap-2",children:[e.jsx("button",{onClick:()=>Q(Math.max(0,n-1)),disabled:n<=0,"aria-label":"Previous project",className:"icon-btn shrink-0 disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(oc,{})}),e.jsx("div",{ref:te,className:"flex flex-1 gap-2 overflow-x-auto hide-scrollbar py-2 cursor-grab active:cursor-grabbing select-none touch-pan-y",onPointerDown:He,onPointerMove:re,onPointerUp:Te,onPointerLeave:Te,children:r.map((a,d)=>{const f=d===n;return e.jsxs("button",{onClick:()=>Q(d),className:`group flex shrink-0 items-center gap-3 border px-3 py-2.5 transition-all duration-200 ${f?"border-rule-strong bg-surface shadow-lift":"border-rule bg-surface-2 hover:border-rule-strong hover:bg-surface"}`,style:{minWidth:"220px",maxWidth:"280px"},children:[e.jsx("span",{className:`nums-tabular text-lg font-bold leading-none tracking-masthead transition-colors ${f?"text-accent-text":"text-ink-3/60 group-hover:text-ink-3"}`,children:String(d+1).padStart(2,"0")}),e.jsx("div",{className:"h-10 w-10 shrink-0 overflow-hidden border border-rule bg-surface-2",children:e.jsx("img",{src:a.details.logo,alt:"",className:"h-full w-full object-cover",onError:u=>{u.target.style.display="none"}})}),e.jsxs("div",{className:"min-w-0 text-left",children:[e.jsx("p",{className:"truncate text-sm font-bold tracking-tight text-ink",children:a.title}),e.jsxs("p",{className:"eyebrow",children:[a.type," · ",a.year]})]})]},`${a.type}-${a.slug}`)})}),e.jsx("button",{onClick:()=>Q(Math.min(s,n+1)),disabled:n>=s,"aria-label":"Next project",className:"icon-btn shrink-0 disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(hc,{})})]}),e.jsxs("div",{className:"mt-2 flex items-center justify-between",children:[e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(n+1).padStart(2,"0"),e.jsx("span",{className:"mx-1.5 text-rule",children:"/"}),String(r.length).padStart(2,"0")]}),e.jsx($,{to:`/${M==null?void 0:M.type}/${M==null?void 0:M.slug}`,className:"font-mono text-[11px] uppercase tracking-eyebrow text-accent-text transition-colors hover:text-ink",children:"View details →"})]})]}),e.jsx("section",{className:"shell border-t border-rule py-10 md:py-0",children:e.jsxs("div",{className:"max-w-12xl",children:[e.jsx("p",{className:"mt-4 max-w-3xl text-lg text-ink",children:"你好！我是林丽丽，欢迎来到我的作品集。"}),e.jsx("p",{className:"mt-4 max-w-measure text-base leading-relaxed text-ink-2",children:uc[c]??uc.all})]})}),e.jsx(za,{}),e.jsx(fa,{}),e.jsxs("section",{className:"shell pt-12 md:pt-16",children:[e.jsxs("div",{className:"section-head",children:[e.jsx("p",{className:"eyebrow",children:"Motion"}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(ve+1).padStart(2,"0"),e.jsx("span",{className:"mx-1.5 text-rule",children:"/"}),String(Qe.length).padStart(2,"0")]})]}),e.jsxs("div",{className:"mt-5 flex items-end justify-between gap-4",children:[e.jsx("h2",{className:"text-display-sm",children:"Video Gallery"}),e.jsxs("div",{className:"flex shrink-0 gap-2",children:[e.jsx("button",{onClick:()=>Ue(-1),disabled:Ge.start,"aria-label":"Scroll gallery left",className:"icon-btn disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(oc,{})}),e.jsx("button",{onClick:()=>Ue(1),disabled:Ge.end,"aria-label":"Scroll gallery right",className:"icon-btn disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(hc,{})})]})]}),e.jsx("div",{ref:ie,onScroll:se,className:"mt-6 flex snap-x snap-mandatory gap-3 overflow-x-auto hide-scrollbar scroll-smooth md:gap-4",children:Qe.map((a,d)=>{const f=d===ve;return e.jsxs("figure",{className:`group relative w-[62%] shrink-0 snap-start sm:w-[40%] md:w-[30%] lg:w-[23%] ${f?"ring-1 ring-accent ring-offset-2 ring-offset-canvas":""}`,onMouseEnter:u=>{const l=u.currentTarget.querySelector("video");l&&!f&&l.play().catch(()=>{})},onMouseLeave:u=>{const l=u.currentTarget.querySelector("video");l&&!f&&l.pause()},children:[e.jsxs("div",{className:"relative aspect-[9/16] overflow-hidden border border-rule bg-surface-2",children:[e.jsx("video",{ref:u=>{le.current[d]=u},className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105",src:a.src,muted:!0,playsInline:!0,preload:"metadata",onCanPlay:u=>Ve(u.currentTarget,d),onEnded:()=>{f&&ge(d+1)}}),f&&e.jsxs("span",{className:"absolute left-2 top-2 flex items-center gap-1 border border-white/30 bg-black/60 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-eyebrow text-white",children:[e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-accent animate-pulse"}),"Now"]}),Be[d]&&e.jsx("span",{className:"absolute right-2 top-2 flex h-6 w-6 items-center justify-center bg-black/55 text-white",title:"Has audio",children:e.jsx("svg",{className:"h-3 w-3",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"})]}),e.jsxs("figcaption",{className:"mt-2.5 flex items-baseline gap-2",children:[e.jsx("span",{className:"eyebrow nums-tabular shrink-0",children:String(d+1).padStart(2,"0")}),e.jsx("span",{className:"truncate text-sm text-ink-2",children:a.title})]})]},a.src)})})]})]})},Ma=()=>typeof document<"u"&&document.documentElement.classList.contains("dark"),Sa=()=>{const[c,b]=i.useState(Ma),g=()=>{const t=!c;b(t),document.documentElement.classList.toggle("dark",t);try{localStorage.setItem("theme",t?"dark":"light")}catch{}};return e.jsx("button",{onClick:g,className:"icon-btn","aria-label":c?"Switch to light theme":"Switch to dark theme",title:c?"切换到日间模式":"切换到夜间模式",children:c?e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"})}):e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"})})})},lc="https://pub-e0170f3fece2419a85fa1ce02c1f1a28.r2.dev/223_cities_cluster_with_index.zip",Aa="/data/223_cities_cluster_with_index_deciles.csv",ke=c=>{const b=c.replace("#",""),g=parseInt(b.slice(0,2),16),t=parseInt(b.slice(2,4),16),r=parseInt(b.slice(4,6),16);return[g,t,r]},ze=(c,b,g)=>{const t=Math.round(c[0]+(b[0]-c[0])*g),r=Math.round(c[1]+(b[1]-c[1])*g),s=Math.round(c[2]+(b[2]-c[2])*g);return`rgb(${t}, ${r}, ${s})`},Ne=[{key:"K_5",label:"Cluster K=5",category:"cluster",type:"number"},{key:"K_12",label:"Cluster K=12",category:"cluster",type:"number"},{key:"K_20",label:"Cluster K=20",category:"cluster",type:"number"},{key:"K_26",label:"Cluster K=26",category:"cluster",type:"number"},{key:"elev_mean",label:"Elevation Mean(m)",category:"terrain",type:"number"},{key:"elev_std",label:"Elevation Std(m)",category:"terrain",type:"number"},{key:"elev_range",label:"Elevation Range(m)",category:"terrain",type:"number"},{key:"slope_mean",label:"Slope Mean(°)",category:"terrain",type:"number"},{key:"slope_std",label:"Slope Std(N/A)",category:"terrain",type:"number"},{key:"slope_rang",label:"Slope Range(N/A)",category:"terrain",type:"number"},{key:"LandArea",label:"Land Area",category:"urban",type:"number"},{key:"Buiheight",label:"Building Height(m)",category:"urban",type:"number"},{key:"BldArea",label:"Building Area(m²)",category:"urban",type:"number"},{key:"CoverRatio",label:"Building Coverage",category:"urban",type:"number"},{key:"FAR",label:"Floor Area Ratio(N/A)",category:"urban",type:"number"},{key:"GreenArea",label:"Green Area(m²)",category:"urban",type:"number"},{key:"GrHeight",label:"Green Height(m)",category:"urban",type:"number"},{key:"GreenRatio",label:"Green Ratio(N/A)",category:"urban",type:"number"},{key:"GrVolRatio",label:"Green Volume Ratio(N/A)",category:"urban",type:"number"},{key:"ISF",label:"Impervious Surface Fraction(N/A)",category:"urban",type:"number"},{key:"MIN_DistWB",label:"Mini Distance to WaterBody(m)",category:"urban",type:"number"},{key:"MIN_DistGL",label:"Mini Distance to GreenLand(m)",category:"urban",type:"number"},{key:"MIN_DistMT",label:"Mini Distance to Mountain(m)",category:"urban",type:"number"}],Ia=()=>{var Ae;const c=i.useRef(null),b=i.useRef(null),[g,t]=i.useState(!0),[r,s]=i.useState(0),[n,k]=i.useState(null),[j,E]=i.useState(null),[q,y]=i.useState([]),[z,C]=i.useState(null),[o,_]=i.useState("K_12"),[G,U]=i.useState(!0),[D,ce]=i.useState(null),[R,M]=i.useState(null),[Z,Ce]=i.useState(!1),[X,Fe]=i.useState(null),[Me,oe]=i.useState(!1),[Y,he]=i.useState(null),[be,pe]=i.useState(!1),[Se,ne]=i.useState(0),[te,ae]=i.useState(""),[F,He]=i.useState(!1),[re,Te]=i.useState(!0),[Q,ie]=i.useState(!0),[le,ve]=i.useState({}),[Je,xc]=i.useState(!1),[H,Ge]=i.useState("global"),me=i.useRef(null),Be=i.useRef(null),We=i.useRef(!1),ge=i.useRef(null),se=(p,m)=>{let N=p.features;z!==null&&(N=N.filter(l=>{var v;const w=(v=l.properties)==null?void 0:v.Place;return w!==void 0&&Number(w)===Number(z)}));const x=N.map(l=>{var w;return(w=l.properties)==null?void 0:w[m]}).filter(l=>{if(l==null)return!1;if(typeof l=="string"){const v=l.trim();if(v===""||/^(na|nan|null)$/i.test(v))return!1}const w=Number(l);return!(Number.isNaN(w)||w===-9999)}).map(l=>Number(l)),a=N.reduce((l,w)=>{var S;const v=(S=w.properties)==null?void 0:S[m];let h=!1;if(v==null)h=!0;else if(typeof v=="string"){const I=v.trim();if(I===""||/^(na|nan|null)$/i.test(I))h=!0;else{const P=Number(v);(Number.isNaN(P)||P===-9999)&&(h=!0)}}else{const I=Number(v);(Number.isNaN(I)||I===-9999)&&(h=!0)}return l+(h?1:0)},0);let d=NaN,f=NaN,u=0;if(x.length>0){d=x[0],f=x[0],u=x[0];for(let l=1;l<x.length;l++){const w=x[l];w<d&&(d=w),w>f&&(f=w),u+=w}}return{count:N.length,min:d,max:f,mean:x.length>0?u/x.length:NaN,nanCount:a}};i.useEffect(()=>{(async()=>{try{const x=(await(await fetch(Aa)).text()).trim().split(`
`);if(x.length<2)return;const a=x[0].split(",").map(v=>v.trim()),d={},u=x[x.length-1].split(","),w=x[1].split(",");a.forEach((v,h)=>{if(v===""||v.includes("Place")||v.includes("Sum")||v.includes("FID")||v.includes("index"))return;const S=parseFloat(w[h]),I=parseFloat(u[h]);!isNaN(S)&&!isNaN(I)&&I>S&&(d[v]={min:S,max:I})}),console.log("Loaded attribute ranges:",d),ve(d)}catch(m){console.error("Failed to load deciles:",m)}})()},[]),i.useEffect(()=>{!F&&!j&&(async()=>{var m;t(!0),s(0),k(null);try{s(10),console.log("开始下载..."),me.current=new AbortController;const N=await fetch(lc,{signal:me.current.signal});if(console.log("响应状态:",N.status),!N.ok)throw new Error(`HTTP error! status: ${N.status}`);s(30);const x=N.headers.get("content-length"),a=x?parseInt(x):null;console.log("预期文件大小:",a);const d=(m=N.body)==null?void 0:m.getReader();if(!d)throw new Error("无法读取响应流");let f=0;const u=[];for(;;){const{done:P,value:L}=await d.read();if(P)break;u.push(L),f+=L.length,s(a?30+Math.round(f/a*60):50)}console.log("下载完成, 收到:",f),a&&f!==a&&console.log("警告: 文件大小不匹配 (可能压缩传输)");const l=new Uint8Array(f);let w=0;for(const P of u)l.set(P,w),w+=P.length;if(s(90),F){console.log("本地数据已加载，跳过网络数据"),t(!1);return}console.log("开始解析 Shapefile...");const v=await ec(l);console.log("Shapefile 解析完成:",v);let h=[];if(v.type==="FeatureCollection"?h=v.features:Array.isArray(v)?h=v:v.type==="Feature"&&(h=[v]),console.log("解析完成，特征数量:",h==null?void 0:h.length),F)return;const S={type:"FeatureCollection",features:h||[]};E(S),s(100);const I=new Map;S.features.forEach(P=>{var J;const L=Number(((J=P.properties)==null?void 0:J.Place)??0);I.has(L)||I.set(L,{id:L,name:`Place ${L}`,featureCount:0});const W=I.get(L);W&&W.featureCount++}),y(Array.from(I.values()).sort((P,L)=>P.id-L.id)),t(!1)}catch(N){if(N.name==="AbortError"){console.log("网络请求已取消");return}k(N instanceof Error?N.message:"Failed to load"),t(!1)}})()},[]),i.useEffect(()=>{j&&ce(se(j,o))},[j,z,o,H,le]),i.useEffect(()=>{if(!j)return;const p=b.current;if(!p)return;const m=()=>{var x,a,d,f;if(j.features.forEach((u,l)=>{u.id===void 0&&(u.id=l)}),p.getSource("cluster"))p.getSource("cluster").setData(j);else{console.log("初始化 cluster 数据源..."),p.addSource("cluster",{type:"geojson",data:j,generateId:!0}),p.addLayer({id:"cluster-fill",type:"fill",source:"cluster",layout:{},paint:{"fill-opacity":.7}}),p.addLayer({id:"cluster-line",type:"line",source:"cluster",layout:{},paint:{"line-color":"#7e7f80ff","line-width":1}}),p.addLayer({id:"cluster-highlight",type:"line",source:"cluster",layout:{},paint:{"line-color":"#632ffdff","line-width":3,"line-opacity":["case",["boolean",["feature-state","selected"],!1],1,0]}}),p.on("click","cluster-fill",l=>{var w;if(l.features&&l.features.length>0){const v=l.features[0],h=v.id;ge.current!==null&&ge.current!==void 0&&p.setFeatureState({source:"cluster",id:ge.current},{selected:!1}),h!==void 0?(p.setFeatureState({source:"cluster",id:h},{selected:!0}),ge.current=h):ge.current=null,Fe(v),oe(!0),((w=v.properties)==null?void 0:w.Place)!==void 0&&C(Number(v.properties.Place))}}),p.on("mouseenter","cluster-fill",()=>{p.getCanvas().style.cursor="pointer"}),p.on("mouseleave","cluster-fill",()=>{p.getCanvas().style.cursor=""});const u=j.features;if(u.length>0)try{const l=new Oe.LngLatBounds,w=Math.max(1,Math.floor(u.length/2e3));for(let v=0;v<u.length;v+=w){const h=u[v];if(!((x=h.geometry)!=null&&x.coordinates))continue;const S=h.geometry.type,I=h.geometry.coordinates;S==="Point"?l.extend(I):S==="LineString"||S==="MultiPoint"?I.forEach(P=>l.extend(P)):S==="Polygon"||S==="MultiLineString"?(a=I[0])==null||a.forEach(P=>l.extend(P)):S==="MultiPolygon"&&((f=(d=I[0])==null?void 0:d[0])==null||f.forEach(P=>l.extend(P)))}l.isEmpty()||p.fitBounds(l,{padding:50,duration:1e3})}catch(l){console.error("Fit bounds error:",l)}}},N=()=>{var L;if(!p.getLayer("cluster-fill"))return;const x=null;p.setFilter("cluster-fill",x),p.setFilter("cluster-line",x),p.setFilter("cluster-highlight",x);const a=(()=>{var Ke;let W=1/0,J=-1/0;for(const $e of j.features){const ee=Number((Ke=$e.properties)==null?void 0:Ke[o]);Number.isNaN(ee)||ee===-9999||(ee<W&&(W=ee),ee>J&&(J=ee))}return{min:W===1/0?0:W,max:J===-1/0?0:J}})(),d=z!==null&&D?{min:D.min,max:D.max}:a,f=H==="city"?d:a,u=f.min,l=f.max;let w;if(o.includes("K_")){const W=Math.round(((L=le[o])==null?void 0:L.max)??l),J=Array.from({length:26},(je,Ze)=>{const K=Ze/25;let de,fe,ue;if(K<.167){const V=K/.167;de=0,fe=0,ue=Math.round(139+116*V)}else if(K<.333){const V=(K-.167)/.167;de=0,fe=Math.round(255*V),ue=255}else if(K<.5){const V=(K-.333)/.167;de=0,fe=Math.round(255-128*V),ue=Math.round(255-255*V)}else if(K<.667){const V=(K-.5)/.167;de=Math.round(255*V),fe=255,ue=0}else if(K<.833){const V=(K-.667)/.167;de=255,fe=Math.round(255-128*V),ue=0}else{const V=(K-.833)/.167;de=255,fe=Math.round(127-127*V),ue=0}return`#${de.toString(16).padStart(2,"0")}${fe.toString(16).padStart(2,"0")}${ue.toString(16).padStart(2,"0")}`}),$e=Array.from({length:W+1},(je,Ze)=>J[Math.round(Ze*25/W)]).slice(0,W+1),ee=["interpolate",["linear"],["get",o]];for(let je=0;je<=W;je++)ee.push(je,$e[je]);w=ee}else o==="CoverRatio"||o==="ISF"||o==="GreenRatio"?w=["interpolate",["linear"],["get",o],u,"#3182bd",l,"#e6550d"]:o.includes("elev")||o.includes("slope")?w=["interpolate",["linear"],["get",o],u,"#31a354",l,"#756bb1"]:w=["interpolate",["linear"],["get",o],u,"#31a354",l,"#756bb1"];p.setPaintProperty("cluster-fill","fill-color",w);const v=z!==null,h=Number(z),P=["case",["any",["==",["get",o],-9999],["==",["get",o],null]],0,v?["case",["==",["to-number",["get","Place"]],h],.8,.15]:.7];p.setPaintProperty("cluster-fill","fill-opacity",P)};p.isStyleLoaded()?(m(),N()):p.once("load",()=>{m(),N()})},[j,z,o]),i.useEffect(()=>{var N,x,a,d;if(!j||z===null)return;const p=b.current;if(!p)return;const m=j.features.filter(f=>{var l;const u=(l=f.properties)==null?void 0:l.Place;return u!==void 0&&Number(u)===Number(z)});if(m.length!==0)try{const f=new Oe.LngLatBounds;let u=0;const l=Math.max(1,Math.floor(m.length/2e3));for(let w=0;w<m.length;w+=l){const v=m[w];if(!((N=v.geometry)!=null&&N.coordinates))continue;const h=v.geometry.type,S=v.geometry.coordinates;h==="Point"?(f.extend(S),u++):h==="LineString"||h==="MultiPoint"?(S.forEach(I=>f.extend(I)),u++):h==="Polygon"||h==="MultiLineString"?((x=S[0])==null||x.forEach(I=>f.extend(I)),u++):h==="MultiPolygon"&&((d=(a=S[0])==null?void 0:a[0])==null||d.forEach(I=>f.extend(I)),u++)}!f.isEmpty()&&u>0&&p.fitBounds(f,{padding:50,duration:1e3})}catch(f){console.error("Fly to error:",f)}},[z]),i.useEffect(()=>((async()=>{(!c.current||b.current)&&console.log("开始初始化地图...");try{const m=new Oe.Map({container:c.current,style:{version:8,sources:{"osm-tiles":{type:"raster",tiles:["https://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png"],tileSize:256,attribution:'&copy; <a href="https://carto.com/">CARTO</a>'}},layers:[{id:"simple-tiles",type:"raster",source:"osm-tiles",minzoom:0,maxzoom:19}]},center:[4.75,45.75],zoom:10});m.addControl(new Oe.NavigationControl,"top-right"),m.on("load",()=>{console.log("地图样式加载完成")}),m.on("error",N=>{var d;const x=String(((d=N==null?void 0:N.error)==null?void 0:d.message)||(N==null?void 0:N.message)||"");x.includes("ERR_ABORTED")||x.includes("AbortError")||x.includes("Canceled")||x.includes("cancelled")||console.error("地图错误:",N)}),b.current=m,console.log("地图初始化完成")}catch(m){console.error("地图初始化错误:",m)}})(),()=>{b.current&&(b.current.remove(),b.current=null,We.current=!1)}),[]),i.useEffect(()=>{const p=b.current;if(!p)return;const m=()=>{p.getLayer("simple-tiles")&&p.setLayoutProperty("simple-tiles","visibility",re?"visible":"none")};p.isStyleLoaded()?m():p.once("style.load",m)},[re]);const Ue=async p=>{var N;const m=(N=p.target.files)==null?void 0:N[0];if(m){me.current&&me.current.abort(),pe(!0),ne(0),ae("正在读取文件..."),k(null),Ce(!0),M(URL.createObjectURL(m));try{console.log("开始读取文件:",m.name,"大小:",m.size);let x=[];const a=m.name.endsWith(".zip"),d=m.name.endsWith(".shp");if(!a&&!d){k("请上传 .zip 文件 (包含 Shapefile)"),pe(!1);return}ae("正在读取文件...");const f=await m.arrayBuffer();ne(30),ae("正在解析 Shapefile...");const u=await ec(f);console.log("Shapefile 解析完成:",u),u.type==="FeatureCollection"?x=u.features:Array.isArray(u)?x=u:u.type==="Feature"&&(x=[u]),console.log("解析到的 features 数量:",x.length),ne(95),ae(`已解析 ${x.length} 个 Features...`);const l={type:"FeatureCollection",features:x};ne(98),ae("正在处理 Place 数据...");const w=new Map;l.features.forEach(v=>{var I;const h=Number(((I=v.properties)==null?void 0:I.Place)??0);w.has(h)||w.set(h,{id:h,name:`Place ${h}`,featureCount:0});const S=w.get(h);S&&S.featureCount++}),ne(100),ae("加载完成!"),setTimeout(()=>{He(!0),E(l),y(Array.from(w.values()).sort((v,h)=>v.id-h.id)),pe(!1),Ce(!1),t(!1)},500)}catch(x){const a=x instanceof Error?x.message:"未知错误";k(`加载失败: ${a}`),pe(!1),t(!1)}}},Ve=Ne.reduce((p,m)=>(p[m.category]||(p[m.category]=[]),p[m.category].push(m),p),{});return e.jsxs("div",{className:"relative w-full h-full bg-gray-100",children:[be&&e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-8 w-80 text-center",children:[e.jsxs("div",{className:"relative w-20 h-20 mx-auto mb-4",children:[e.jsx("div",{className:"absolute inset-0 border-4 border-gray-100 rounded-full"}),e.jsx("div",{className:"absolute inset-0 border-4 border-purple-600 rounded-full border-t-transparent animate-spin"}),e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx(cc,{className:"text-purple-600",size:24})})]}),e.jsx("p",{className:"text-gray-800 font-medium mb-3",children:te}),e.jsx("div",{className:"w-full bg-gray-100 rounded-full h-3 mb-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-purple-500 to-purple-600 transition-all duration-300",style:{width:`${Se}%`}})}),e.jsxs("p",{className:"text-sm text-gray-400",children:[Se,"%"]})]})}),g&&!be?e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(Ec,{className:"animate-spin h-12 w-12 text-purple-600 mx-auto mb-4"}),e.jsx("p",{className:"text-gray-600",children:"正在加载 Shapefile..."}),e.jsx("div",{className:"w-48 h-2 bg-gray-200 rounded-full mx-auto mt-3 overflow-hidden",children:e.jsx("div",{className:"h-full bg-purple-600 transition-all duration-300",style:{width:`${r}%`}})}),e.jsxs("p",{className:"text-xs text-gray-400 mt-2",children:[r,"%"]}),e.jsxs("div",{className:"flex gap-2 mt-4 justify-center",children:[e.jsxs("a",{href:lc,download:"223_cities_cluster_with_index.zip",className:"inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:[e.jsx(_c,{size:14}),"下载本地"]}),e.jsxs("button",{onClick:()=>{var p;return(p=Be.current)==null?void 0:p.click()},className:"inline-flex items-center gap-2 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded-lg text-sm transition-colors",title:"支持 .zip (Shapefile)",children:[e.jsx(cc,{size:14}),"加载 Shapefile"]})]}),e.jsx("p",{className:"text-xs text-gray-400 mt-2",children:"支持 .zip (Shapefile)"}),e.jsx("input",{ref:Be,type:"file",accept:".shp,.zip",onChange:Ue,className:"hidden"})]})}):null,n&&e.jsxs("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-red-50 border border-red-200 rounded-xl px-6 py-5 shadow-lg",children:[e.jsx("p",{className:"text-red-600 font-medium",children:"加载失败"}),e.jsx("p",{className:"text-red-400 text-sm mt-1 mb-4",children:n}),e.jsx("div",{className:"flex gap-2",children:e.jsxs("button",{onClick:()=>window.location.reload(),className:"inline-flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-sm transition-colors",children:[e.jsx(Pc,{size:14}),"刷新重试"]})})]}),G&&e.jsxs("div",{className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-72",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("h2",{className:"font-bold text-gray-800 flex items-center gap-2",children:[e.jsx(Rc,{size:18}),"Cluster Map"]}),e.jsx("button",{onClick:()=>U(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(Tc,{size:18})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("span",{className:"text-sm text-gray-600",children:"显示地图底图"}),e.jsx("button",{onClick:()=>Te(!re),className:`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${re?"bg-purple-600":"bg-gray-300"}`,children:e.jsx("span",{className:`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${re?"translate-x-6":"translate-x-1"}`})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Place (Count)"}),e.jsxs("select",{value:z??"",onChange:p=>C(p.target.value?Number(p.target.value):null),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:[e.jsxs("option",{value:"",children:["All Places (",((Ae=j==null?void 0:j.features)==null?void 0:Ae.length)??0,")"]}),q.map(p=>e.jsxs("option",{value:p.id,children:[p.name," (",p.featureCount,")"]},p.id))]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Attribute"}),e.jsx("select",{value:o,onChange:p=>_(p.target.value),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:Object.entries(Ve).map(([p,m])=>[e.jsx("optgroup",{label:p.charAt(0).toUpperCase()+p.slice(1),children:m.map(N=>e.jsx("option",{value:N.key,children:N.label},N.key))},p)])})]}),D&&e.jsxs("div",{className:"bg-gray-50 rounded-lg p-3 space-y-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(Gc,{size:14,className:"text-purple-500"}),e.jsx("span",{className:"text-xs font-medium text-gray-500",children:"Statistics"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-xs",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Count:"})," ",e.jsx("span",{className:"font-medium",children:D.count})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Min:"})," ",e.jsx("span",{className:"font-medium",children:D.min.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Max:"})," ",e.jsx("span",{className:"font-medium",children:D.max.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Mean:"})," ",e.jsx("span",{className:"font-medium",children:D.mean.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"NaN:"})," ",e.jsx("span",{className:"font-medium",children:D.nanCount})]})]})]})]})]}),!G&&e.jsx("button",{onClick:()=>U(!0),className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(Bc,{size:18})}),Me&&X&&e.jsxs("div",{className:"absolute top-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-80 max-h-96 overflow-y-auto",children:[e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-medium text-gray-400 uppercase tracking-wider mb-1",children:"Feature Details"}),e.jsxs("div",{className:"mb-3",children:[X.properties.Place&&e.jsxs("div",{className:"text-lg font-semibold text-purple-600",children:["Place: ",X.properties.Place]}),X.properties["City Name"]&&e.jsxs("div",{className:"text-sm font-medium text-gray-700",children:["City: ",X.properties["City Name"]]}),e.jsxs("div",{className:"text-sm font-medium text-gray-500",children:["Place ID: ",X.properties["Place ID"]??"N/A"]})]})]}),e.jsx("button",{onClick:()=>oe(!1),className:"p-1 hover:bg-gray-100 rounded-full transition-colors",children:e.jsx(tc,{size:20,className:"text-gray-400"})})]}),e.jsx("div",{className:"space-y-2",children:Ne.map(p=>{var N;const m=(N=X.properties)==null?void 0:N[p.key];return m==null?null:e.jsxs("button",{onClick:()=>_(p.key),className:`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${o===p.key?"bg-purple-100 text-purple-700":"bg-gray-50 text-gray-600 hover:bg-gray-100"}`,children:[e.jsx("span",{children:p.label}),e.jsx("span",{className:"font-mono font-medium",children:typeof m=="number"?m.toFixed(2):m})]},p.key)})}),e.jsx("div",{className:"mt-3 pt-3 border-t border-gray-200",children:e.jsx("button",{onClick:()=>C(null),className:"w-full px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:"显示全部区域"})})]}),e.jsx("div",{ref:c,className:"w-full h-full"}),Q&&j&&e.jsxs("div",{className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-64",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("h3",{className:"font-semibold text-gray-800 flex items-center gap-2",children:[e.jsx(ac,{size:16}),"Legend"]}),e.jsx("button",{onClick:()=>ie(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(tc,{size:16})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"颜色映射"}),e.jsx("button",{onClick:()=>Ge(H==="global"?"city":"global"),className:`text-xs px-2 py-1 rounded ${H==="global"?"bg-gray-200 text-gray-700":"bg-purple-100 text-purple-700"}`,children:H==="global"?"全局":"城市"})]}),e.jsx("div",{className:"space-y-3",children:o.includes("K_")?(()=>{var x,a;const p=Math.round(((x=le[o])==null?void 0:x.max)??30),m=Array.from({length:26},(d,f)=>{const u=f/25;let l,w,v;if(u<.167){const h=u/.167;l=0,w=0,v=Math.round(139+116*h)}else if(u<.333){const h=(u-.167)/.167;l=0,w=Math.round(255*h),v=255}else if(u<.5){const h=(u-.333)/.167;l=0,w=Math.round(255-128*h),v=Math.round(255-255*h)}else if(u<.667){const h=(u-.5)/.167;l=Math.round(255*h),w=255,v=0}else if(u<.833){const h=(u-.667)/.167;l=255,w=Math.round(255-128*h),v=0}else{const h=(u-.833)/.167;l=255,w=Math.round(127-127*h),v=0}return`#${l.toString(16).padStart(2,"0")}${w.toString(16).padStart(2,"0")}${v.toString(16).padStart(2,"0")}`}),N=Array.from({length:p+1},(d,f)=>m[Math.round(f*25/p)]);return e.jsxs("div",{children:[e.jsx("div",{className:"text-xs text-gray-500 mb-2",children:((a=Ne.find(d=>d.key===o))==null?void 0:a.label)||o}),e.jsx("div",{className:"flex flex-wrap gap-px",children:N.map((d,f)=>e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("div",{className:"w-3 h-3 rounded-sm",style:{backgroundColor:d}}),e.jsx("span",{className:"text-[6px] text-gray-400",children:f})]},f))})]})})():o==="CoverRatio"||o==="ISF"||o==="GreenRatio"?(()=>{var v;const p=(()=>{var I;let h=1/0,S=-1/0;for(const P of j.features){const L=Number((I=P.properties)==null?void 0:I[o]);Number.isNaN(L)||L===-9999||(L<h&&(h=L),L>S&&(S=L))}return{min:h===1/0?0:h,max:S===-1/0?0:S}})(),m=z!==null&&D?{min:D.min,max:D.max}:p,N=((v=Ne.find(h=>h.key===o))==null?void 0:v.label)||o,x=p.max>p.min?Math.max(0,Math.min(1,(m.min-p.min)/(p.max-p.min))):0,a=p.max>p.min?Math.max(0,Math.min(1,(m.max-p.min)/(p.max-p.min))):0,d=Math.max(0,a-x),f=ke("#3182bd"),u=ke("#e6550d"),l=ze(f,u,x),w=ze(f,u,a);return e.jsxs("div",{children:[H==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[N,"（城市区间）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,130,189,0.2), rgba(230,85,13,0.2))"},children:z!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${x*100}%`,width:`${d*100}%`,background:`linear-gradient(to right, ${l}, ${w})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(2)}),e.jsx("span",{children:m.max.toFixed(2)})]})]}),H==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[N,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #3182bd, #e6550d)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:p.min.toFixed(2)}),e.jsx("span",{children:p.max.toFixed(2)})]})]})]})})():o.includes("elev")||o.includes("slope")?(()=>{var v;const p=(()=>{var I;let h=1/0,S=-1/0;for(const P of j.features){const L=Number((I=P.properties)==null?void 0:I[o]);Number.isNaN(L)||L===-9999||(L<h&&(h=L),L>S&&(S=L))}return{min:h===1/0?0:h,max:S===-1/0?0:S}})(),m=z!==null&&D?{min:D.min,max:D.max}:p,N=((v=Ne.find(h=>h.key===o))==null?void 0:v.label)||o,x=p.max>p.min?Math.max(0,Math.min(1,(m.min-p.min)/(p.max-p.min))):0,a=p.max>p.min?Math.max(0,Math.min(1,(m.max-p.min)/(p.max-p.min))):0,d=Math.max(0,a-x),f=ke("#31a354"),u=ke("#756bb1"),l=ze(f,u,x),w=ze(f,u,a);return e.jsxs("div",{children:[H==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[N,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:z!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${x*100}%`,width:`${d*100}%`,background:`linear-gradient(to right, ${l}, ${w})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(1)}),e.jsxs("span",{children:[m.max.toFixed(0),"+"]})]})]}),H==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[N,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:p.min.toFixed(1)}),e.jsxs("span",{children:[p.max.toFixed(0),"+"]})]})]})]})})():(()=>{var v;const p=(()=>{var I;let h=1/0,S=-1/0;for(const P of j.features){const L=Number((I=P.properties)==null?void 0:I[o]);Number.isNaN(L)||L===-9999||(L<h&&(h=L),L>S&&(S=L))}return{min:h===1/0?0:h,max:S===-1/0?0:S}})(),m=z!==null&&D?{min:D.min,max:D.max}:p,N=((v=Ne.find(h=>h.key===o))==null?void 0:v.label)||o,x=p.max>p.min?Math.max(0,Math.min(1,(m.min-p.min)/(p.max-p.min))):0,a=p.max>p.min?Math.max(0,Math.min(1,(m.max-p.min)/(p.max-p.min))):0,d=Math.max(0,a-x),f=ke("#31a354"),u=ke("#756bb1"),l=ze(f,u,x),w=ze(f,u,a);return e.jsxs("div",{children:[H==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[N,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:z!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${x*100}%`,width:`${d*100}%`,background:`linear-gradient(to right, ${l}, ${w})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(2)}),e.jsx("span",{children:m.max.toFixed(2)})]})]}),H==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[N,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:p.min.toFixed(2)}),e.jsx("span",{children:p.max.toFixed(2)})]})]})]})})()})]}),!Q&&e.jsx("button",{onClick:()=>ie(!0),className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(ac,{size:18})})]})},La=[{key:"",label:"Home"},{key:"design",label:"Design"},{key:"game",label:"Game"},{key:"ai",label:"AI"},{key:"planning",label:"Planning"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"},{key:"about",label:"About"}],Da={1:[4],2:[0,8],3:[0,4,8],4:[0,2,6,8],5:[0,2,4,6,8],6:[0,2,3,5,6,8]},qe=({value:c,transform:b})=>e.jsx("div",{className:"absolute inset-0 grid grid-cols-3 grid-rows-3 border border-neutral-400 bg-white p-[2px]",style:{transform:b,backfaceVisibility:"hidden"},children:Array.from({length:9}).map((g,t)=>e.jsx("span",{className:"flex items-center justify-center",children:Da[c].includes(t)&&e.jsx("span",{className:"block h-[2.5px] w-[2.5px] rounded-full",style:{background:c===1||c===4?"#cc2a18":"#171717"}})},t))}),Ea=()=>{const[c,b]=i.useState(!1),[g,t]=i.useState(!1),[r,s]=i.useState({x:0,y:0}),n="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/lili",[k,j]=i.useState(`${n}/lili_01.png`),[E,q]=i.useState("Exploring the intersection of technology and creativity."),y=Nc(),z=qc(),o=y.pathname.split("/").filter(Boolean)[0]||"",_={design:`${n}/lili_05.png`,game:`${n}/lili_03.png`,ai:`${n}/lili_07.png`,platform:`${n}/lili_11.png`,tutorial:`${n}/lili_04.png`,about:`${n}/lili_02.png`,planning:`${n}/lili_06.png`},G=[`${n}/lili_01.png`,`${n}/lili_07.png`,`${n}/lili_08.png`,`${n}/lili_09.png`,`${n}/lili_10.png`,`${n}/lili_12.png`],U=["探索科技与创意的交汇点。","把数据转化为有意义的故事。","构建能激发灵感的数字体验。","连接产品与开发的桥梁。","创造在真实世界中落地的解决方案。","热衷于地理空间技术与城市规划。"],D=R=>R[Math.floor(Math.random()*R.length)];i.useEffect(()=>{j(_[o]??D(G)),q(D(U))},[o]);const ce=()=>{s(M=>({x:M.x+720+Math.round(Math.random()*360),y:M.y+720+Math.round(Math.random()*360)}));const R=["design","game","ai","planning","platform","tutorial","about"];setTimeout(()=>z(`/${D(R)}`),900)};return e.jsxs("div",{className:"flex h-screen flex-col bg-canvas text-ink",children:[e.jsx("header",{className:`relative z-30 shrink-0 border-b border-rule bg-surface/85 backdrop-blur transition-all duration-300 ease-editorial ${g?"h-0 border-b-0 overflow-hidden opacity-0":""}`,children:e.jsxs("div",{className:"shell flex h-16 items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 flex-1 items-center",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{onClick:()=>b(!c),className:"icon-btn","aria-expanded":c,"aria-label":c?"Hide profile panel":"Show profile panel",title:c?"Hide profile panel":"Show profile panel",children:e.jsxs("span",{className:"flex flex-col items-center justify-center gap-[3px]","aria-hidden":"true",children:[e.jsx("span",{className:"block h-px w-4 bg-current transition-transform duration-300"}),e.jsx("span",{className:`block h-px w-4 bg-current transition-opacity duration-300 ${c?"opacity-0":"opacity-100"}`}),e.jsx("span",{className:"block h-px w-4 bg-current transition-transform duration-300"})]})}),e.jsxs($,{to:"/",className:"group flex min-w-0 items-baseline gap-2.5",children:[e.jsx("span",{className:"truncate text-lg font-bold tracking-masthead md:text-xl",children:"林丽丽 Lili Lin"}),e.jsx("span",{className:"hidden h-3 w-px bg-rule sm:block","aria-hidden":"true"})]})]}),e.jsx("nav",{className:"-mx-1 flex min-w-0 overflow-x-auto hide-scrollbar",children:e.jsx("ul",{className:"flex shrink-0 items-stretch",children:La.map(R=>{const M=o===R.key;return e.jsx("li",{className:"flex",children:e.jsxs($,{to:`/${R.key}`,onClick:()=>{window.innerWidth<768&&b(!1)},"aria-current":M?"page":void 0,className:`relative flex items-center px-3 text-sm font-medium transition-colors duration-200 md:px-4 ${M?"text-ink":"text-ink-3 hover:text-ink"}`,children:[R.label,e.jsx("span",{className:`absolute inset-x-2 top-0 h-[3px] origin-left bg-accent transition-transform duration-300 ease-editorial md:inset-x-3 ${M?"scale-x-100":"scale-x-0"}`,"aria-hidden":"true"})]})},R.key||"home")})})})]}),e.jsxs("div",{className:"flex shrink-0 items-center gap-2",children:[e.jsx(Sa,{}),e.jsxs("button",{onClick:ce,className:"btn-ghost hidden !px-3 sm:inline-flex",title:"随机探索一个项目",children:[e.jsx("span",{className:"h-5 w-5",style:{perspective:"120px"},children:e.jsxs("span",{className:"relative block h-full w-full transition-transform duration-[900ms] ease-out",style:{transform:`rotateX(${r.x}deg) rotateY(${r.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx(qe,{value:1,transform:"translateZ(10px)"}),e.jsx(qe,{value:6,transform:"rotateY(180deg) translateZ(10px)"}),e.jsx(qe,{value:3,transform:"rotateY(-90deg) translateZ(10px)"}),e.jsx(qe,{value:4,transform:"rotateY(90deg) translateZ(10px)"}),e.jsx(qe,{value:2,transform:"rotateX(90deg) translateZ(10px)"}),e.jsx(qe,{value:5,transform:"rotateX(-90deg) translateZ(10px)"})]})}),"Jump"]}),e.jsx("button",{onClick:()=>t(!0),className:"icon-btn hidden sm:inline-flex",title:"Collapse header","aria-label":"Collapse header",children:e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5 15l7-7 7 7"})})})]})]})}),g&&e.jsx("button",{onClick:()=>t(!1),className:"group flex h-4 w-full items-center justify-center bg-surface/50 hover:bg-surface transition-colors duration-200",title:"Expand header","aria-label":"Expand header",children:e.jsx("svg",{className:"h-3 w-3 text-ink-3 transition-colors group-hover:text-ink",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 9l-7 7-7-7"})})}),e.jsxs("main",{className:"relative flex min-h-0 flex-1 flex-row overflow-hidden",children:[c&&e.jsx("aside",{className:"z-20 h-full w-64 shrink-0 overflow-y-auto border-r border-rule bg-surface md:w-72",children:e.jsxs("div",{className:"flex flex-col gap-8 p-5",children:[k&&e.jsx("img",{src:k,alt:"Lili's avatar",className:"w-full border border-rule bg-surface-2 object-contain"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow",children:"Profile"}),e.jsx("h2",{className:"mt-2 text-xl font-bold tracking-masthead",children:"Lili Lin"}),e.jsx("p",{className:"text-sm text-ink-2",children:"林丽丽"})]}),e.jsx("hr",{className:"hairline"}),e.jsx("p",{className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:"设计师 · 开发者 · 产品创作者"}),e.jsx("p",{className:"text-sm leading-relaxed text-ink-2",children:"创造有意义的数字体验，连接技术与创意。"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("hr",{className:"hairline"}),e.jsx("p",{className:"border-l-2 border-accent pl-3 text-sm italic leading-relaxed text-ink-2",children:E}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(Ye,{href:"https://github.com/lililin0324",label:"GH"}),e.jsx(Ye,{href:"mailto:lili0324@snu.ac.kr",label:"EM"}),e.jsx(Ye,{href:"https://www.linkedin.com/in/lililin0324",label:"LK"})]})]})]})}),e.jsx("section",{className:"relative min-w-0 flex-1 overflow-y-auto",children:e.jsxs(Cc,{children:[e.jsx(O,{path:"/",element:e.jsx(Ca,{})}),e.jsx(O,{path:"/planning",element:e.jsx(ye,{data:Le,type:"planning"})}),e.jsx(O,{path:"/planning/:id",element:e.jsx(xe,{data:Le,type:"planning"})}),e.jsx(O,{path:"/design",element:e.jsx(ye,{data:De,type:"design"})}),e.jsx(O,{path:"/design/:id",element:e.jsx(xe,{data:De,type:"design"})}),e.jsx(O,{path:"/game",element:e.jsx(ye,{data:Ee,type:"game"})}),e.jsx(O,{path:"/game/:id",element:e.jsx(xe,{data:Ee,type:"game"})}),e.jsx(O,{path:"/ai",element:e.jsx(ye,{data:_e,type:"ai"})}),e.jsx(O,{path:"/ai/:id",element:e.jsx(xe,{data:_e,type:"ai"})}),e.jsx(O,{path:"/platform",element:e.jsx(ye,{data:Pe,type:"platform"})}),e.jsx(O,{path:"/platform/:id",element:e.jsx(xe,{data:Pe,type:"platform"})}),e.jsx(O,{path:"/tutorial",element:e.jsx(ye,{data:Re,type:"tutorial"})}),e.jsx(O,{path:"/tutorial/:id",element:e.jsx(xe,{data:Re,type:"tutorial"})}),e.jsx(O,{path:"/clusteringeomap",element:e.jsx(Ia,{})}),e.jsx(O,{path:"/about",element:e.jsx(ia,{})}),e.jsx(O,{path:"/contact",element:e.jsx(ga,{})})]})})]})]})};function _a(){const[c,b]=i.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(Mc,{children:e.jsx(Ea,{})}),!c&&e.jsx(Uc,{onFinish:()=>b(!0)})]})}Sc.createRoot(document.getElementById("root")).render(e.jsx(_a,{}));
