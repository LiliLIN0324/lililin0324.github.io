const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-tJ3FoaVo.js","assets/vendor-BipBZ3yL.js","assets/maplibre-DKOg2DWH.js","assets/vendor-Dgihpmma.css","assets/icons-DfMbvsEP.js","assets/UR-platform-Ccv40zBF.js","assets/openstreetmap-OuA5A2zx.js"])))=>i.map(i=>d[i]);
import{r as u,c as T,j as e,H as A,u as I,L as y,R as O,a as d,N as k,b as U}from"./vendor-BipBZ3yL.js";import"./maplibre-DKOg2DWH.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))c(a);new MutationObserver(a=>{for(const t of a)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&c(l)}).observe(document,{childList:!0,subtree:!0});function i(a){const t={};return a.integrity&&(t.integrity=a.integrity),a.referrerPolicy&&(t.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?t.credentials="include":a.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function c(a){if(a.ep)return;a.ep=!0;const t=i(a);fetch(a.href,t)}})();const E="modulepreload",D=function(r){return"/"+r},w={},v=function(n,i,c){let a=Promise.resolve();if(i&&i.length>0){let l=function(o){return Promise.all(o.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),j=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));a=l(i.map(o=>{if(o=D(o),o in w)return;w[o]=!0;const p=o.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${h}`))return;const m=document.createElement("link");if(m.rel=p?"stylesheet":E,p||(m.as="script"),m.crossOrigin="",m.href=o,j&&m.setAttribute("nonce",j),document.head.appendChild(m),p)return new Promise((S,C)=>{m.addEventListener("load",S),m.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${o}`)))})}))}function t(l){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=l,window.dispatchEvent(s),!s.defaultPrevented)throw l}return a.then(l=>{for(const s of l||[])s.status==="rejected"&&t(s.reason);return n().catch(t)})},P=`import { useState,useEffect, useRef } from 'react';\r
