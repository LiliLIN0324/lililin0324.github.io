...
import{r as n,j as e,L as te,u as hc,R as lc,c as vc,d as mc,e as jc,f as U,H as yc,g as xc}from"./react-vendor-6zld6QO8.js";import{A as wc,m as $e}from"./framer-DvVmTyA1.js";import{M as kc,r as zc,a as Nc}from"./markdown-q3GborES.js";import{b as Qe}from"./geo-Z02C8O4I.js";import{m as _e}from"./maplibre-BedwuVXB.js";import{U as Je,L as qc,D as Cc,R as Mc,M as Sc,C as Ac,a as Lc,b as Ic,X as ec,c as cc}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const g of l.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&t(g)}).observe(document,{childList:!0,subtree:!0});function u(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function t(r){if(r.ep)return;r.ep=!0;const l=u(r);fetch(r.href,l)}})();function Dc({onFinish:c}){const[a,u]=n.useState(!0),t=n.useRef(null),r=n.useRef({x:-1e3,y:-1e3});return n.useEffect(()=>{const l=t.current;if(!l)return;const g=l.getContext("2d");if(!g)return;let L,w=[];const E=()=>{l.width=window.innerWidth,l.height=window.innerHeight},N=f=>{r.current={x:f.clientX,y:f.clientY}},j=f=>{f.touches.length>0&&(r.current={x:f.touches[0].clientX,y:f.touches[0].clientY})};window.addEventListener("resize",E),window.addEventListener("mousemove",N),window.addEventListener("touchmove",j),E();class k{constructor(){this.x=Math.random()*l.width,this.y=Math.random()*l.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>l.width)&&(this.vx*=-1),(this.y<0||this.y>l.height)&&(this.vy*=-1);let _=r.current.x-this.x,T=r.current.y-this.y,B=Math.sqrt(_*_+T*T),D=_/B,J=T/B;const R=150;let C=(R-B)/R;B<R&&(this.x-=D*C*this.density*.5,this.y-=J*C*this.density*.5)}draw(){g&&(g.fillStyle="rgba(255, 255, 255, 0.8)",g.beginPath(),g.arc(this.x,this.y,this.size,0,Math.PI*2),g.fill())}}for(let f=0;f<120;f++)w.push(new k);const q=()=>{g.clearRect(0,0,l.width,l.height);for(let f=0;f<w.length;f++){w[f].update(),w[f].draw();for(let _=f+1;_<w.length;_++){const T=w[f].x-w[_].x,B=w[f].y-w[_].y,D=Math.sqrt(T*T+B*B);D<100&&(g.beginPath(),g.strokeStyle=`rgba(255, 255, 255, ${.2*(1-D/100)})`,g.lineWidth=.6,g.moveTo(w[f].x,w[f].y),g.lineTo(w[_].x,w[_].y),g.stroke())}}L=requestAnimationFrame(q)};return q(),()=>{cancelAnimationFrame(L),window.removeEventListener("resize",E),window.removeEventListener("mousemove",N),window.removeEventListener("touchmove",j)}},[]),e.jsx(wc,{onExitComplete:c,children:a&&e.jsxs($e.div,{onClick:()=>u(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:t,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx($e.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx($e.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const _c=`---
id: "00"
slug: "chicken-utopia"
...
![效果展示](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/cluster-visualizer-3d/106.jpg)`,Gc=`---
id: "01"
slug: "hongqiqu"
title: "红旗渠遗产价值评估"
category: "planning"
...
![Genshot99](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/genshot/99.jpg)`,Wc=`---\r
id: "04"\r
slug: "genstyle"\r
...
![genstyle](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/genstyle/99.jpg)`,Vc=`---\r
id: "05"\r
...
https://learn.u3d.cn/tutorial/instant-game-joker?chapterId=64f5962ca571d50021bb3afb&sectionId=64f5962ca571d50021bb3afa`,ct=`---\r
id: "01"\r
...
> 💡 **小提示**：MCP 是一个快速发展的开放标准，未来会有越来越多的工具和应用支持它。现在学习 MCP，就是提前掌握 AI 时代的「通用语言」！`,vt=`---
id: "09"
...
> 💡 **小提示**：没有绝对最好的数据库，只有最适合你项目的数据库。根据实际需求选择，才是最明智的决定！`,mt=`---\r
id: "10"\r
...
`;function jt(c){const a=/^---\r?\n([\s\S]*?)\r?\n---/,u=c.match(a);let t={},r=c;if(u){const g=u[1];r=c.slice(u[0].length).trim();const L=g.split(/\r?\n/);let w=null,E=[];L.forEach(N=>{if(N.trim()==="")return;const k=N.indexOf(":");if(k!==-1&&!N.startsWith(" ")){w&&(t[w]=E.join(`
`)),w=N.slice(0,k).trim();let q=N.slice(k+1).trim();q==="|"?E=[]:q===""?E=[]:(t[w]=q,w=null,E=[])}else w&&N.startsWith("  ")&&E.push(N.slice(2))}),w&&E.length>0&&(t[w]=E.join(`
...
`)&&/^\s*-/.test(j)){const k=j.split(/\r?\n/).map(q=>q.replace(/^\s*-\s*/,"").trim()).filter(q=>q!=="");t[N]=k.map(q=>q.startsWith('"')&&q.endsWith('"')||q.startsWith("'")&&q.endsWith("'")?q.slice(1,-1):q)}else if(j.startsWith("[")&&j.endsWith("]"))try{t[N]=JSON.parse(j)}catch{t[N]=[j.slice(1,-1).trim()]}else j==="true"?t[N]=!0:j==="false"?t[N]=!1:!isNaN(Number(j))&&j.trim()!==""?t[N]=Number(j):t[N]=j})}let l=[];if(Array.isArray(t.image)&&t.image.length>0)l=t.image;else{const g=/!\[.*?\]\(([^)\s]+)\)/g;let L;for(;(L=g.exec(r))!==null;)l.push(L[1])}return{id:t.id||"",slug:t.slug||"",title:t.title||"",category:t.category||"",year:t.year||"",description:t.description||"",tech:t.tech||[],abstract:t.abstract||"",challenge:t.challenge||"",solution:t.solution||"",hasDemo:t.hasDemo||!1,icon:t.icon||"",code:t.code||"",logo:t.icon||"",image:l,content:r}}function S(c){const a=jt(c);return{id:a.id,slug:a.slug,title:a.title,category:a.category,year:a.year,description:a.description,tech:a.tech,hasDemo:a.hasDemo,details:{abstract:a.abstract,description:a.description,challenge:a.challenge,solution:a.solution,logo:a.logo,icon:a.icon,code:a.code,image:a.image,content:a.content,demoOnly:a.demoOnly||!1}}}const Ee=[S(_c),S(Ec),S(Pc),S(Bc),S(Gc),S(Tc),S(Rc),S(Uc)],Pe=[S(Oc),S(Fc),S(Hc),S(Wc),S(Vc),S(Kc),S($c)],Re=[S(Zc),S(Xc),S(Yc),S(Qc),S(Jc),S(et)],Ge=[S(ct),S(tt),S(bt),S(at),S(pt)],Te=[S(nt),S(rt),S(it)],Be=[S(gt),S(st),S(dt),S(ft),S(ut),S(ot),S(ht),S(lt),S(vt),S(mt)],yt={design:"Products",game:"Games",ai:"AI",planning:"Planning",platform:"Platform",tutorial:"Tutorials",research:"Research"},fc=({className:c})=>e.jsx("div",{className:"flex h-full w-full items-center justify-center text-ink-3/50",children:e.jsx("svg",{className:c,fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})}),uc=({to:c,className:a=""})=>e.jsx(te,{to:c,className:`btn-accent ${a}`,children:"Demo"}),xt=!1,wt=({project:c,type:a,index:u})=>{var t;return e.jsx("li",{className:"group border-b border-rule transition-colors duration-300 hover:bg-surface",children:e.jsxs("div",{className:"flex items-center gap-4 py-4 md:gap-6 md:py-5",children:[e.jsx("span",{className:"nums-tabular hidden w-10 shrink-0 self-start pt-1 text-lg font-bold leading-none tracking-masthead text-ink-3/60 transition-colors group-hover:text-accent-text sm:block",children:String(u+1).padStart(2,"0")}),e.jsxs(te,{to:`/${a}/${c.slug}`,className:"flex min-w-0 flex-1 items-center gap-4 md:gap-6",children:[e.jsx("div",{className:"h-16 w-16 shrink-0 overflow-hidden border border-rule bg-surface-2 md:h-20 md:w-20",children:c.details.logo?e.jsx("img",{src:c.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105",onError:r=>{r.target.style.display="none"}}):e.jsx(fc,{className:"h-7 w-7"})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h3",{className:"truncate text-base font-bold tracking-tight text-ink md:text-lg lg:text-xl",children:e.jsx("span",{className:"wipe-underline",children:c.title})}),e.jsx("p",{className:"mt-1 truncate text-sm text-ink-2",children:c.description})]}),e.jsx("div",{className:"hidden shrink-0 flex-wrap justify-end gap-1.5 lg:flex lg:max-w-[16rem]",children:(t=c.tech)==null?void 0:t.slice(0,3).map(r=>e.jsx("span",{className:"chip",children:r},r))}),e.jsx("span",{className:"eyebrow nums-tabular hidden w-12 shrink-0 text-right md:block",children:c.year})]}),c.hasDemo&&e.jsx(uc,{to:`/${a}/${c.slug}#demo`,className:"shrink-0"})]})})},kt=({project:c,type:a,index:u})=>{var t;return e.jsxs("article",{className:"group flex flex-col border border-rule bg-surface transition-colors duration-300 hover:border-rule-strong",children:[e.jsxs(te,{to:`/${a}/${c.slug}`,className:"flex flex-1 flex-col",children:[e.jsx("div",{className:"aspect-square w-full overflow-hidden border-b border-rule bg-surface-2",children:c.details.logo?e.jsx("img",{src:c.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-[1.05]",onError:r=>{r.target.style.display="none"}}):e.jsx(fc,{className:"h-10 w-10"})}),e.jsxs("div",{className:"flex flex-1 flex-col p-4",children:[e.jsxs("div",{className:"flex items-baseline justify-between gap-3",children:[e.jsx("span",{className:"nums-tabular text-sm font-bold tracking-masthead text-ink-3/70 transition-colors group-hover:text-accent-text",children:String(u+1).padStart(2,"0")}),e.jsx("span",{className:"eyebrow nums-tabular",children:c.year})]}),e.jsx("h3",{className:"mt-2.5 line-clamp-2 text-base font-bold leading-snug tracking-tight text-ink md:text-lg",children:e.jsx("span",{className:"wipe-underline",children:c.title})}),e.jsx("p",{className:"mt-1.5 line-clamp-2 text-sm leading-relaxed text-ink-2",children:c.description}),((t=c.tech)==null?void 0:t.length)>0&&e.jsx("div",{className:"mt-3 flex flex-wrap gap-1.5",children:c.tech.slice(0,2).map(r=>e.jsx("span",{className:"chip",children:r},r))})]})]}),c.hasDemo&&e.jsx("div",{className:"border-t border-rule p-3",children:e.jsx(uc,{to:`/${a}/${c.slug}#demo`,className:"w-full"})})]})},je=({data:c,type:a})=>{const[u,t]=n.useState("grid"),r=yt[a]??"Works";return e.jsxs("div",{className:"shell animate-rise-in py-8 md:py-12",children:[a==="design"&&xt,e.jsxs("div",{className:"section-head",children:[e.jsxs("p",{className:"eyebrow",children:[a," / Index"]}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(c.length).padStart(2,"0")," Entries"]})]}),e.jsxs("div",{className:"mt-5 flex flex-wrap items-end justify-between gap-4 border-b border-rule pb-5",children:[e.jsxs("h1",{className:"text-display-sm",children:["Selected ",r]}),e.jsx("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:["grid","list"].map(l=>e.jsx("button",{onClick:()=>t(l),"aria-pressed":u===l,className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${u===l?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:l},l))})]}),u==="list"?e.jsx("ul",{className:"mt-2 border-t border-rule",children:c.map((l,g)=>e.jsx(wt,{project:l,type:a,index:g},l.slug))}):e.jsx("div",{className:"mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 xl:grid-cols-4",children:c.map((l,g)=>e.jsx(kt,{project:l,type:a,index:g},l.slug))})]})},zt="modulepreload",Nt=function(c,a){return new URL(c,a).href},tc={},G=function(a,u,t){let r=Promise.resolve();if(u&&u.length>0){let g=function(N){return Promise.all(N.map(j=>Promise.resolve(j).then(k=>({status:"fulfilled",value:k}),k=>({status:"rejected",reason:k}))))};const L=document.getElementsByTagName("link"),w=document.querySelector("meta[property=csp-nonce]"),E=(w==null?void 0:w.nonce)||(w==null?void 0:w.getAttribute("nonce"));r=g(u.map(N=>{if(N=Nt(N,t),N in tc)return;tc[N]=!0;const j=N.endsWith(".css"),k=j?'[rel="stylesheet"]':"";if(!!t)for(let _=L.length-1;_>=0;_--){const T=L[_];if(T.href===N&&(!j||T.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${N}"]${k}`))return;const f=document.createElement("link");if(f.rel=j?"stylesheet":zt,j||(f.as="script"),f.crossOrigin="",f.href=N,E&&f.setAttribute("nonce",E),document.head.appendChild(f),j)return new Promise((_,T)=>{f.addEventListener("load",_),f.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${N}`)))})}))}function l(g){const L=new Event("vite:preloadError",{cancelable:!0});if(L.payload=g,window.dispatchEvent(L),!L.defaultPrevented)throw g}return r.then(g=>{for(const L of g||[])L.status==="rejected"&&l(L.reason);return a().catch(l)})},qt=n.lazy(()=>G(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),Ct=n.lazy(()=>G(()=>import("./UR-platform-DFO5eSKd.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),Mt=n.lazy(()=>G(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),St=n.lazy(()=>G(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),At=n.lazy(()=>G(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),Lt=n.lazy(()=>G(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),It=n.lazy(()=>G(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));n.lazy(()=>G(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const Dt=n.lazy(()=>G(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),_t=n.lazy(()=>G(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),bc=n.lazy(()=>G(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),Et=n.lazy(()=>G(()=>import("./72HourGameJamDemo-BWPUgRvj.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),Pt=n.lazy(()=>G(()=>import("./PeaceEliteHustCampusDemo-D-DWwJkq.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),Rt=n.lazy(()=>G(()=>import("./BMWMetaIslandDemo-7uu2MOZP.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),Gt=n.lazy(()=>G(()=>import("./riffle-RlweP75u.js"),__vite__mapDeps([24,1,2,3]),import.meta.url)),Tt=n.lazy(()=>G(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([25,1,2,3]),import.meta.url)),Bt=n.lazy(()=>G(()=>import("./genshot-BoH35G7G.js"),__vite__mapDeps([26,1,2,3]),import.meta.url)),Ut=n.lazy(()=>G(()=>import("./dragon-diffusion-Dj4t-WNK.js"),__vite__mapDeps([27,1,2,3]),import.meta.url)),Ot=n.lazy(()=>G(()=>import("./anyreal-DKKTpW8w.js"),__vite__mapDeps([28,1,2,3]),import.meta.url)),Ft=n.lazy(()=>G(()=>import("./previous-archi-work-CvNoz6hg.js"),__vite__mapDeps([29,1,2,3]),import.meta.url)),Ht=n.lazy(()=>G(()=>import("./hongqiqu-y3eLCJ-3.js"),__vite__mapDeps([30,1,2,3]),import.meta.url)),ac=c=>({"cluster-visualizer-3d":qt,"participatory-urban-regeneration-empowered-by-artificial-intelligence":Ct,heatmapper:Mt,"how-to-add-openstreetmap-in-website":St,"how-to-get-sequential-events-from-photo-by-phone":At,"how-to-visualize-photo-geolocation-data-on-map":Lt,kittylovecarrots:bc,"how-to-build-game-in-wechat-mini-program":bc,"72-hour-game-jam":Et,"peace-elite-hust-campus":Pt,"bmw-meta-island":Rt,"how-to-conduct-time-geo-sequential-clustering-from-album":It,"box-up-my-stuff-in-cyberspace":Dt,"epstein-mystery-archive":_t,"riffle-ai-game-generation-tool":Gt,genstyle:Tt,"genshot-AI-video-generation-tool":Bt,"dragon-diffussion":Ut,anyreal:Ot,"previous-archi-work":Ft,hongqiqu:Ht})[c],pc={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
...
}`},Wt=({images:c,captions:a})=>{const[u,t]=n.useState(0),[r,l]=n.useState(new Set(c.map((j,k)=>k))),g=c.filter((j,k)=>r.has(k));if(n.useEffect(()=>{u>=g.length&&t(Math.max(0,g.length-1))},[g.length,u]),g.length===0)return null;const L=j=>{l(k=>{const q=new Set(k);return q.delete(j),q})},w=()=>{t(j=>j===0?g.length-1:j-1)},E=()=>{t(j=>j===g.length-1?0:j+1)},N=a==null?void 0:a[u];return e.jsxs("div",{className:"w-full",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-lg shadow-lg bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center max-h-[350px]",children:[e.jsx("img",{src:g[u],className:"max-w-full max-h-[350px] w-auto h-auto object-contain",alt:N||`Carousel Image ${u+1}`,onError:()=>L(u)}),e.jsx("button",{onClick:w,className:"absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:E,className:"absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),g.length>1&&e.jsx("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1 z-10",children:g.map((j,k)=>e.jsx("button",{onClick:()=>t(k),className:`h-1.5 rounded-full transition-all duration-300 ${u===k?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2 hover:bg-neutral-400"}`,"aria-label":`Go to slide ${k+1}`},k))})]}),N&&e.jsxs("div",{className:"mt-2 text-center",children:[e.jsx("p",{className:"text-sm text-neutral-600 dark:text-neutral-400 italic",children:N}),e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500 mt-1 font-mono",children:[u+1," / ",g.length]})]}),!N&&e.jsxs("p",{className:"mt-2 text-xs text-neutral-400 dark:text-neutral-500 text-center font-mono",children:[u+1," / ",g.length]})]})},Vt=({src:c,...a})=>{const[u,t]=n.useState(!1),[r,l]=n.useState(!1);return n.useEffect(()=>{const g=setTimeout(()=>{r||(t(!1),l(!0))},3e3);return()=>clearTimeout(g)},[r]),e.jsxs(e.Fragment,{children:[e.jsx("iframe",{src:c,onLoad:()=>{t(!0),l(!0)},onError:()=>{t(!1),l(!0)},style:{display:"none"},title:"detector"}),!r&&e.jsx("div",{className:"my-4 w-full",children:e.jsxs("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"Open link"]})}),r&&u&&e.jsx("div",{className:"my-6 w-full border border-rule bg-surface-2",children:e.jsx("iframe",{src:c,className:"h-96 w-full border-0",allowFullScreen:!0,...a})}),r&&!u&&e.jsx("div",{className:"my-4 w-full",children:e.jsxs("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"Open link"]})})]})},Kt={iframe:({src:c,title:a,...u})=>e.jsx(Vt,{src:c,title:a||"Embedded content",...u}),imagecarousel:({images:c,captions:a})=>{const u=(c||"").split(",").map(r=>r.trim()).filter(Boolean),t=a?a.split("|").map(r=>r.trim()):void 0;return e.jsx(Wt,{images:u,captions:t})},table:({children:c})=>e.jsx("div",{className:"my-6 overflow-x-auto border border-rule",children:e.jsx("table",{className:"min-w-full border-collapse text-sm",children:c})}),thead:({children:c})=>e.jsx("thead",{className:"border-b border-rule bg-surface-2",children:c}),th:({children:c})=>e.jsx("th",{className:"border-r border-rule px-3 py-2 text-left font-mono text-[10px] uppercase tracking-eyebrow text-ink-2 last:border-r-0",children:c}),td:({children:c})=>e.jsx("td",{className:"border-r border-t border-rule px-3 py-2 text-ink-2 last:border-r-0",children:c}),h1:({children:c,...a})=>{const t=(typeof c=="string"?c:(c==null?void 0:c.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h1",{id:t,className:"mt-10 mb-5 text-xl font-bold tracking-tight text-ink first:mt-0",...a,children:c})},h2:({children:c,...a})=>{const t=(typeof c=="string"?c:(c==null?void 0:c.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h2",{id:t,className:"mt-8 mb-4 text-lg font-bold tracking-tight text-ink",...a,children:c})},h3:({children:c,...a})=>{const t=(typeof c=="string"?c:(c==null?void 0:c.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h3",{id:t,className:"mt-6 mb-3 text-base font-bold text-ink",...a,children:c})},h4:({children:c,...a})=>e.jsx("h4",{className:"mt-5 mb-2 text-sm font-semibold text-ink",...a,children:c}),h5:({children:c,...a})=>e.jsx("h5",{className:"mt-4 mb-2 text-sm font-semibold text-ink-2",...a,children:c}),h6:({children:c,...a})=>e.jsx("h6",{className:"mt-3 mb-2 font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",...a,children:c}),p:({children:c,...a})=>{var r;const u=lc.Children.toArray(c),t=u.length===1&&((r=u[0])==null?void 0:r.type)==="img";return e.jsx("p",{className:t?"mb-0 leading-relaxed text-ink-2":"mb-4 leading-relaxed text-ink-2",...a,children:c})},a:({children:c,href:a,...u})=>e.jsx("a",{href:a,className:"text-accent-text underline decoration-1 underline-offset-2 transition-colors hover:text-ink",target:"_blank",rel:"noopener noreferrer",...u,children:c}),img:({src:c,alt:a,...u})=>(a==null?void 0:a.match(/BCR|BHV|SVF|NDVI|EV|WR|Dist_/))?e.jsx("img",{src:c,alt:a,className:"h-32 max-w-full border border-rule object-cover",onError:r=>{r.target.style.display="none"},...u}):e.jsx("img",{src:c,alt:a,className:"my-0 h-auto w-full border border-rule object-cover",onError:r=>{r.target.style.display="none"},...u})},ye=({data:c,type:a})=>{var w,E,N,j,k;const{id:u}=hc(),t=c.find(q=>q.slug===u),[r,l]=n.useState(t!=null&&t.hasDemo&&((w=t==null?void 0:t.details)!=null&&w.demoOnly)?"demo":"details"),[g,L]=n.useState(!1);return n.useEffect(()=>{const q=()=>{var f;t!=null&&t.hasDemo&&((f=t==null?void 0:t.details)!=null&&f.demoOnly)||window.location.hash.includes("demo")&&(t!=null&&t.hasDemo)?l("demo"):l("details")};return q(),window.addEventListener("hashchange",q),()=>window.removeEventListener("hashchange",q)},[u,t==null?void 0:t.hasDemo,(E=t==null?void 0:t.details)==null?void 0:E.demoOnly]),t?e.jsxs("div",{className:"animate-rise-in pb-16",children:[e.jsx("div",{className:"sticky top-0 z-20 border-b border-rule bg-surface/85 backdrop-blur",children:e.jsxs("div",{className:"shell flex h-14 items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-4",children:[e.jsx(te,{to:`/${a}`,className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3 transition-colors hover:text-ink",children:"← Index"}),e.jsx("span",{className:"hidden h-3 w-px bg-rule md:block","aria-hidden":"true"}),e.jsx("h2",{className:"truncate text-sm font-bold tracking-tight text-ink",children:t.title})]}),!((N=t.details)!=null&&N.demoOnly)&&e.jsxs("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:[e.jsx("button",{onClick:()=>l("details"),className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${r==="details"?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:"Docs"}),t.hasDemo&&e.jsxs("button",{onClick:()=>l("demo"),className:`flex items-center gap-2 px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${r==="demo"?"bg-accent text-accent-ink":"text-ink-3 hover:text-ink"}`,children:[e.jsxs("span",{className:"relative flex h-1.5 w-1.5",children:[e.jsx("span",{className:"absolute h-full w-full animate-ping rounded-full bg-accent-ink/75"}),e.jsx("span",{className:"relative h-1.5 w-1.5 rounded-full bg-accent-ink"})]}),"Demo"]})]})]})}),r==="details"?e.jsx("div",{className:"shell py-8 md:py-12",children:e.jsxs("div",{className:"mx-auto max-w-4xl",children:[((j=t.tech)==null?void 0:j.length)>0&&e.jsx("div",{className:"mb-6 flex flex-wrap gap-1.5",children:t.tech.map((q,f)=>e.jsx("span",{className:"chip",children:q},f))}),e.jsxs("div",{className:"mb-6 flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:[e.jsxs("span",{children:["NO. ",t.id]}),e.jsx("span",{className:"text-rule","aria-hidden":"true",children:"/"}),e.jsx("span",{children:t.year}),e.jsx("span",{className:"text-rule","aria-hidden":"true",children:"/"}),e.jsx("span",{children:t.category})]}),e.jsx("h1",{className:"text-display-sm mb-6",children:t.title}),e.jsxs("details",{className:"group mb-12 border border-rule bg-surface",open:g,onToggle:q=>L(q.target.open),children:[e.jsxs("summary",{className:"flex cursor-pointer list-none items-center justify-between px-5 py-4 select-none md:px-7",children:[e.jsx("span",{className:"eyebrow",children:"Overview"}),e.jsxs("span",{className:"font-mono text-[10px] uppercase tracking-eyebrow text-ink-3 transition-transform duration-300 group-open:rotate-180",children:[g?"Collapse":"Expand"," ▾"]})]}),e.jsxs("div",{className:"space-y-6 border-t border-rule px-5 pb-6 pt-5 md:px-7 md:pb-8 md:pt-6",children:[t.description&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Description"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.description})]}),t.details.abstract&&t.details.abstract!==t.description&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Abstract"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.details.abstract})]}),t.details.challenge&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Challenges"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.details.challenge})]}),t.details.solution&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Methodology"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:t.details.solution})]})]})]}),t.details.content&&e.jsxs("section",{id:"content",children:[e.jsx("div",{className:"section-head mb-8",children:e.jsx("p",{className:"eyebrow",children:"Content"})}),e.jsx("div",{className:"prose-custom text-base leading-relaxed text-ink-2",children:e.jsx(kc,{remarkPlugins:[Nc],rehypePlugins:[zc],components:Kt,children:t.details.content})})]}),(t.details.code||t.details.codeComponent||pc[t.slug])&&e.jsxs("section",{id:"code",className:"mt-12",children:[e.jsx("div",{className:"section-head mb-5",children:e.jsx("p",{className:"eyebrow",children:"Code Example"})}),e.jsx("pre",{className:"overflow-x-auto border border-rule bg-ink p-5 font-mono text-[13px] leading-relaxed text-canvas md:p-7",children:e.jsx("code",{children:pc[t.slug]||t.details.codeComponent||`// Code file: ${t.details.code}`})})]})]})}):(k=t.details)!=null&&k.demoOnly?e.jsx(n.Suspense,{fallback:e.jsx("div",{className:"flex items-center justify-center py-20",children:e.jsx("p",{className:"eyebrow",children:"Loading demo..."})}),children:(()=>{const q=ac(t.slug);return q?e.jsx(q,{}):e.jsx("div",{className:"flex items-center justify-center py-20",children:e.jsx("p",{className:"eyebrow",children:"Demo not available"})})})()}):e.jsx("div",{className:"h-[calc(100vh-3.5rem)] w-full bg-surface-2",children:e.jsx(n.Suspense,{fallback:e.jsx("div",{className:"flex h-full items-center justify-center",children:e.jsx("p",{className:"eyebrow",children:"Loading demo..."})}),children:(()=>{const q=ac(t.slug);return q?e.jsx(q,{}):e.jsx("div",{className:"flex h-full items-center justify-center",children:e.jsx("p",{className:"eyebrow",children:"Demo not available"})})})()})})]}):e.jsx("div",{className:"shell flex h-full items-center justify-center py-20",children:e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"eyebrow",children:"Error"}),e.jsx("p",{className:"mt-3 text-display-sm",children:"Project not found"}),e.jsx(te,{to:"/",className:"btn-ghost mt-6",children:"← Back to index"})]})})},$t=["Urban Climate & Resilience","AI-Assisted Urban Planning","Machine Learning & Data Analysis","Spatial Statistics & GIS","React / Next.js Ecosystem","TypeScript Architecture","WebGL / Three.js","UI Systems Design"],Zt=()=>{const[c,a]=n.useState(null);return n.useEffect(()=>{if(!c)return;const u=r=>{r.key==="Escape"&&a(null)};window.addEventListener("keydown",u);const t=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",u),document.body.style.overflow=t}},[c]),e.jsx("div",{className:"shell animate-rise-in py-8 md:py-12",children:e.jsxs("div",{className:"mx-auto max-w-5xl",children:[e.jsx("div",{className:"section-head",children:e.jsx("p",{className:"eyebrow",children:"About / Bio"})}),e.jsx("h1",{className:"mt-5 text-display-sm",children:"关于我"}),e.jsx("h1",{className:"mt-5 text-display-sm",children:"About Me"}),e.jsxs("div",{className:"mt-8 space-y-5 text-base leading-relaxed text-ink-2 md:text-lg",children:[e.jsxs("p",{children:["我是林丽丽，首尔大学硕士生，华中科技大学本科生, 想做",e.jsx("strong",{className:"font-semibold text-ink",children:"AI 相关的产品"}),". 我的研究兴趣包括",e.jsx("strong",{className:"font-semibold text-ink",children:"城市气候韧性、城市规划知识图谱、空间统计与机器学习"}),"，并且我也对",e.jsx("strong",{className:"font-semibold text-ink",children:"产品设计、UI/UX和前端开发"}),"充满热情。"]}),e.jsx("p",{})]}),e.jsxs("div",{className:"mt-12 border-t border-rule pt-10 md:mt-16 md:pt-12",children:[e.jsx("p",{className:"eyebrow",children:"Core Competencies"}),e.jsx("div",{className:"mt-4 flex flex-wrap gap-1.5",children:$t.map(u=>e.jsx("span",{className:"chip",children:u},u))})]})]})})},Xt=()=>e.jsx("div",{className:"shell flex h-full flex-col items-center justify-center py-20 text-center",children:e.jsxs("div",{className:"animate-rise-in max-w-md space-y-8",children:[e.jsx("div",{className:"flex justify-center",children:e.jsx("span",{className:"icon-btn h-14 w-14",children:e.jsx("svg",{className:"h-5 w-5",fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("p",{className:"eyebrow",children:"Contact"}),e.jsx("h2",{className:"text-display-sm",children:"Let's work together"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:"Interested in collaboration, research, or just want to say hello? Reach out anytime."})]}),e.jsxs("div",{className:"flex flex-col items-center gap-3 pt-4",children:[e.jsxs("a",{href:"mailto:lily1326685527@gmail.com?subject=Research%20Collaboration",className:"btn-solid",children:["Send message",e.jsx("svg",{className:"h-3 w-3",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14 5l7 7m0 0l-7 7m7-7H3"})})]}),e.jsx("p",{className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:"lily1326685527@gmail.com"})]})]})}),Ze=({href:c,label:a})=>e.jsx("a",{href:c,target:"_blank",rel:"noopener noreferrer",className:"icon-btn font-mono text-[10px] tracking-eyebrow",children:a}),nc=[{city:"上海",country:"中国",date:"2024",note:"法租界的梧桐树影"},{city:"东京",country:"日本",date:"2025",note:"下北泽的午后散步"},{city:"首尔",country:"韩国",date:"2025",note:"汉江边的晚风与霓虹"},{city:"新加坡",country:"新加坡",date:"2026",note:"滨海湾的花园城市漫游"},{city:"明尼阿波利斯",country:"美国",date:"2025",note:"密西西比河畔的秋日"},{city:"剑桥",country:"英国",date:"2025",note:"康河上的撑船与学院回廊"},{city:"武汉",country:"中国",date:"2023",note:"东湖绿道与热干面的早晨"},{city:"香港",country:"中国",date:"2024",note:"中环半山扶梯的夜色"}],rc=["from-amber-500/20 via-orange-400/10 to-yellow-500/20","from-emerald-500/20 via-teal-400/10 to-cyan-500/20","from-rose-500/20 via-pink-400/10 to-fuchsia-500/20","from-sky-500/20 via-blue-400/10 to-indigo-500/20","from-violet-500/20 via-purple-400/10 to-plum-500/20","from-lime-500/20 via-green-400/10 to-emerald-500/20","from-red-500/20 via-orange-400/10 to-amber-500/20","from-cyan-500/20 via-teal-400/10 to-sky-500/20"],Yt={上海:"🏙️",东京:"🗼",首尔:"🏯",新加坡:"🌿",明尼阿波利斯:"🌊",剑桥:"🎓",武汉:"🌸",香港:"🌃"},Qt=({entry:c,index:a})=>{const[u,t]=n.useState(!1),r=rc[a%rc.length],l=Yt[c.city]??"📍";return e.jsx("div",{className:"relative cursor-pointer select-none",style:{perspective:"800px"},onClick:()=>t(g=>!g),onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),children:e.jsxs("div",{className:"relative w-full transition-transform duration-500 ease-editorial",style:{transformStyle:"preserve-3d",transform:u?"rotateY(180deg)":"rotateY(0deg)",aspectRatio:"3/4"},children:[e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center gap-2 border border-dashed border-rule bg-surface p-4",style:{backfaceVisibility:"hidden"},children:[e.jsx("div",{className:"absolute inset-x-3 top-2 flex justify-between",children:Array.from({length:16}).map((g,L)=>e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-canvas"},L))}),e.jsx("div",{className:"absolute inset-x-3 bottom-2 flex justify-between",children:Array.from({length:16}).map((g,L)=>e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-canvas"},L))}),e.jsx("span",{className:"text-3xl",children:l}),e.jsx("p",{className:"text-base font-bold tracking-tight text-ink",children:c.city}),e.jsx("p",{className:"eyebrow text-ink-3",children:c.country}),c.date&&e.jsx("span",{className:"mt-1 inline-block border border-rule px-2 py-0.5 font-mono text-[10px] uppercase tracking-eyebrow text-ink-3",children:c.date}),e.jsx("div",{className:"absolute right-3 top-5 -rotate-12 opacity-30",children:e.jsxs("svg",{width:"40",height:"40",viewBox:"0 0 40 40",fill:"none",children:[e.jsx("circle",{cx:"20",cy:"20",r:"17",stroke:"currentColor",strokeWidth:"1.5",className:"text-ink-3"}),e.jsx("path",{d:"M8 8l24 24M8 32L32 8",stroke:"currentColor",strokeWidth:"0.8",className:"text-ink-3"})]})})]}),e.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center overflow-hidden border border-rule-strong bg-surface-2",style:{backfaceVisibility:"hidden",transform:"rotateY(180deg)"},children:[c.photo?e.jsx("img",{src:c.photo,alt:c.city,className:"absolute inset-0 h-full w-full object-cover"}):e.jsx("div",{className:`absolute inset-0 bg-gradient-to-br ${r}`}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent"}),e.jsxs("div",{className:"relative z-10 px-4 text-center",children:[e.jsx("p",{className:"text-lg font-bold tracking-tight text-white",children:c.city}),c.note&&e.jsx("p",{className:"mt-1.5 text-xs leading-relaxed text-white/70",children:c.note})]}),e.jsx("div",{className:"absolute inset-2 border border-dashed border-white/10"})]})]})})},Jt=()=>e.jsxs("section",{className:"shell border-t border-rule pt-12 md:pt-16",children:[e.jsxs("div",{className:"section-head",children:[e.jsx("p",{className:"eyebrow",children:"Wander"}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(nc.length).padStart(2,"0")," cities"]})]}),e.jsxs("div",{className:"mt-5 flex items-end justify-between gap-4",children:[e.jsx("h2",{className:"text-display-sm",children:"City Walks"}),e.jsxs("p",{className:"max-w-xs text-right text-xs leading-relaxed text-ink-3",children:["用脚步丈量城市，",e.jsx("br",{className:"hidden sm:inline"}),"在每个街角发现故事。"]})]}),e.jsx("div",{className:"mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5",children:nc.map((c,a)=>e.jsx(Qt,{entry:c,index:a},c.city))})]}),eb=[{key:"all",label:"All"},{key:"design",label:"Product"},{key:"game",label:"Game"},{key:"ai",label:"AI"},{key:"planning",label:"Planning"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"}],ic={all:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"设计、开发、游戏、AI 和城市规划"}),"领域的项目。"]}),design:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"产品"}),"领域的项目。"]}),planning:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"城市规划"}),"领域的项目。"]}),game:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"游戏"}),"领域的项目。"]}),ai:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"AI"}),"领域的项目。"]}),platform:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"平台开发"}),"领域的项目。"]}),tutorial:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"教程"}),"领域的项目。"]})},Xe=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/kitty-0317.mp4",title:"Kitty Video"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/%E5%BE%AE%E4%BF%A1%E8%A7%86%E9%A2%912026-02-09_184301_354.mp4",title:"Kitty Video 2"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260225-192100.mp4",title:"Riffle Loading 1"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video3.mp4",title:"Video Title 3"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video4.mp4",title:"Video Title 4"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video5.mp4",title:"Video Title 5"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video6.mp4",title:"Video Title 6"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video7.mp4",title:"Video Title 7"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video8.mp4",title:"Video Title 8"}],gc=()=>e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})}),sc=()=>e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M9 5l7 7-7 7"})}),cb={1:[4],2:[0,8],3:[0,4,8],4:[0,2,6,8],5:[0,2,4,6,8],6:[0,2,3,5,6,8]},xe=({value:c,transform:a})=>e.jsx("div",{className:"absolute inset-0 grid grid-cols-3 grid-rows-3 border border-neutral-400 bg-white p-[2px]",style:{transform:a,backfaceVisibility:"hidden"},children:Array.from({length:9}).map((u,t)=>e.jsx("span",{className:"flex items-center justify-center",children:cb[c].includes(t)&&e.jsx("span",{className:"block h-[2.5px] w-[2.5px] rounded-full",style:{background:c===1||c===4?"#cc2a18":"#171717"}})},t))}),tb=()=>{var Se,p,m,z,y;const[c,a]=n.useState("all"),u={all:[...Pe.map(b=>({...b,type:"design"})),...Re.map(b=>({...b,type:"game"})),...Ge.map(b=>({...b,type:"ai"})),...Ee.map(b=>({...b,type:"planning"})),...Te.map(b=>({...b,type:"platform"})),...Be.map(b=>({...b,type:"tutorial"}))],design:Pe.map(b=>({...b,type:"design"})),planning:Ee.map(b=>({...b,type:"planning"})),game:Re.map(b=>({...b,type:"game"})),ai:Ge.map(b=>({...b,type:"ai"})),platform:Te.map(b=>({...b,type:"platform"})),tutorial:Be.map(b=>({...b,type:"tutorial"}))},t=b=>u[b].length,r=u[c]??u.all,l=Math.max(0,r.length-1),[g,L]=n.useState(0),w=b=>{a(b),L(0)},E=b=>{if(!b)return[];const i=/<video[^>]+src="([^"]+)"/gi;return Array.from(b.matchAll(i),s=>s[1])},N=b=>{var s,d;if(!b)return null;const i=(s=b.details)==null?void 0:s.image;return i!=null&&i.length?i[0]:((d=b.details)==null?void 0:d.logo)??null},j=r[(g-1+r.length)%r.length],k=r[(g+1)%r.length],q=N(j),f=N(k),[_,T]=n.useState(0),[B,D]=n.useState(!1),J=n.useRef(null),R=n.useRef(null),C=r[g],K=((Se=C==null?void 0:C.details)==null?void 0:Se.image)??[];K.length>=2&&K[(_-1+K.length)%K.length],K.length>=3?K[(_+1)%K.length]:K.length===2&&K[(_+1)%2],n.useEffect(()=>{T(0),D(!1)},[g,c]);const[qe,$]=n.useState({x:0,y:0}),Ue=()=>{$(b=>({x:b.x+720+Math.round(Math.random()*360),y:b.y+720+Math.round(Math.random()*360)})),setTimeout(()=>X(Math.floor(Math.random()*r.length)),900)},Ce=E(((p=C==null?void 0:C.details)==null?void 0:p.content)??""),ue=((m=C==null?void 0:C.details)==null?void 0:m.image)??[],Z=[...Ce,...ue],oe=Z.length>0?Z[_%Z.length]:(z=C==null?void 0:C.details)==null?void 0:z.logo,be=Ce.length>0&&_<Ce.length,ae=ue.length>0?ue[0]:(y=C==null?void 0:C.details)==null?void 0:y.logo,Me=()=>{T(b=>(b+1)%(Z.length||1))};n.useEffect(()=>{if(R.current&&(clearInterval(R.current),R.current=null),!(be||Z.length<=1))return R.current=setInterval(Me,5e3),()=>{R.current&&(clearInterval(R.current),R.current=null)}},[g,c,be,Z.length]);const pe=()=>{const b=J.current;b&&(b.muted=!b.muted,D(!b.muted))},ee=n.useRef(null),ce=3,O=n.useRef({isDown:!1,isDragging:!1,startX:0,scrollLeft:0}),Oe=b=>{var i;O.current={isDown:!0,isDragging:!1,startX:b.clientX,scrollLeft:((i=ee.current)==null?void 0:i.scrollLeft)??0}},ne=b=>{var s;if(!O.current.isDown)return;const i=b.clientX-O.current.startX;!O.current.isDragging&&Math.abs(i)<ce||(O.current.isDragging||(O.current.isDragging=!0,(s=ee.current)==null||s.setPointerCapture(b.pointerId)),b.preventDefault(),ee.current.scrollLeft=O.current.scrollLeft-i)},Ae=b=>{var i;O.current.isDragging&&((i=ee.current)==null||i.releasePointerCapture(b.pointerId)),O.current={isDown:!1,isDragging:!1,startX:0,scrollLeft:0}},X=b=>{L(b)};n.useEffect(()=>{const b=ee.current;if(!b)return;const i=b.children[g];i&&i.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})},[g]);const re=n.useRef(null),he=n.useRef([]),[le,Ye]=n.useState(0),[oc,F]=n.useState(0),[Le,ve]=n.useState({start:!0,end:!1}),[Ie,Fe]=n.useState({}),ie=b=>{const i=b%Xe.length;Ye(i);const s=re.current;if(s){const d=s.children[i];d&&s.scrollTo({left:d.offsetLeft-s.offsetWidth/2+d.offsetWidth/2,behavior:"smooth"})}};n.useEffect(()=>{const b=he.current[le];b&&(b.currentTime=0,b.play().catch(()=>{}))},[le]);const ge=n.useCallback(()=>{const b=re.current;if(!b)return;const i=b.firstElementChild,s=(i==null?void 0:i.offsetWidth)||1;F(Math.round(b.scrollLeft/s)),ve({start:b.scrollLeft<=1,end:b.scrollLeft+b.clientWidth>=b.scrollWidth-1})},[]);n.useEffect(()=>(ge(),window.addEventListener("resize",ge),()=>window.removeEventListener("resize",ge)),[ge]);const De=b=>{const i=re.current;if(!i)return;const s=i.firstElementChild;i.scrollBy({left:b*((s==null?void 0:s.offsetWidth)||i.clientWidth/2),behavior:"smooth"})},He=(b,i)=>{var h;const s=b,d=x=>Fe(v=>v[i]===x?v:{...v,[i]:x});if((h=s.audioTracks)!=null&&h.length){d(Array.from(s.audioTracks).some(x=>x.enabled));return}if("mozHasAudio"in s){d(!!s.mozHasAudio);return}if(typeof s.webkitAudioDecodedByteCount=="number"&&s.webkitAudioDecodedByteCount>0){d(!0);return}if(s.readyState>=3){setTimeout(()=>d(s.webkitAudioDecodedByteCount>0||s.mozHasAudio===!0),500);return}d(!0)};return e.jsxs("div",{className:"animate-rise-in pb-16",children:[oe&&e.jsxs("section",{className:"relative w-full overflow-hidden border-b border-neutral-800",style:{background:"linear-gradient(to bottom, #3f3f3f 100%, #0a0a0a 100%)"},children:[e.jsx("div",{className:"absolute inset-0 bg-grid-pattern opacity-[0.07]","aria-hidden":"true"}),e.jsx("div",{className:"absolute inset-0 z-20 pointer-events-none",style:{boxShadow:"inset 0 0 140px 50px rgba(0,0,0,0.75)"},"aria-hidden":"true"}),e.jsxs("div",{className:"relative mx-auto flex w-full max-w-12xl items-stretch px-0 py-6 md:py-0",children:[e.jsx("button",{onClick:()=>X((g-1+r.length)%r.length),className:"group relative z-10 hidden w-[11%] h-[80%] shrink-0 md:block",title:j==null?void 0:j.title,children:e.jsxs("div",{className:"aspect-[1/3] w-full overflow-hidden border border-white/[0.06] bg-white/[0.03]",children:[q&&e.jsx("img",{src:q,alt:"",onError:b=>{b.target.style.display="none"},className:"absolute inset-0 h-full w-full object-cover opacity-40 transition-opacity group-hover:opacity-65"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-black/60 via-black/10 to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2",children:e.jsx("p",{className:"truncate text-center font-mono text-[9px] uppercase tracking-eyebrow text-white/50",children:j==null?void 0:j.title})})]})}),e.jsx("div",{className:"relative z-10 hidden flex-1 overflow-hidden md:block","aria-hidden":"true",children:e.jsx("div",{className:"h-full w-full",style:{clipPath:"polygon(0 0%, 100% 0%, 100% 86%, 0 100%)"},children:e.jsx("img",{src:ae,alt:"",className:"absolute inset-0 h-full w-full object-cover blur-xl scale-125 opacity-30",onError:b=>{b.target.style.display="none"}})})}),e.jsx("div",{className:"relative z-20 flex h-auto w-full shrink-0 flex-col md:h-[98%] md:w-[50%]",children:e.jsxs("div",{className:"aspect-video max-h-[70vh] w-full overflow-hidden border border-white/[0.08]",style:{boxShadow:"0 0 70px -10px rgba(0,0,0,0.5)"},children:[be?e.jsx("video",{ref:b=>{J.current=b},src:oe,autoPlay:!0,muted:B,playsInline:!0,onEnded:Me,className:"absolute inset-0 h-full w-full object-cover animate-rise-in"},oe):e.jsx("img",{src:oe,alt:(C==null?void 0:C.title)??"",className:"absolute inset-0 h-full w-full object-cover animate-rise-in",onError:b=>{b.target.style.display="none"}},oe),be&&e.jsx("button",{onClick:pe,className:"absolute bottom-2 right-2 z-30 flex h-8 w-8 items-center justify-center border border-white/30 bg-black/55 text-white/80 hover:border-white hover:text-white",title:B?"Unmute":"Mute",children:B?e.jsxs("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"}),e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2"})]}):e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})})]})}),e.jsx("div",{className:"relative z-10 hidden flex-1 overflow-hidden md:block","aria-hidden":"true",children:e.jsx("div",{className:"h-full w-full",style:{clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0 86%)"},children:e.jsx("img",{src:ae,alt:"",className:"absolute inset-0 h-full w-full object-cover blur-xl scale-125 opacity-30",onError:b=>{b.target.style.display="none"}})})}),e.jsx("button",{onClick:()=>X((g+1)%r.length),className:"group relative z-10 hidden w-[11%]  h-[80%] shrink-0 md:block",title:k==null?void 0:k.title,children:e.jsxs("div",{className:"aspect-[1/3] w-full overflow-hidden border border-white/[0.06] bg-white/[0.03]",children:[f&&e.jsx("img",{src:f,alt:"",onError:b=>{b.target.style.display="none"},className:"absolute inset-0 h-full w-full object-cover opacity-40 transition-opacity group-hover:opacity-65"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-l from-black/60 via-black/10 to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2",children:e.jsx("p",{className:"truncate text-center font-mono text-[9px] uppercase tracking-eyebrow text-white/50",children:k==null?void 0:k.title})})]})})]})]}),e.jsxs("section",{className:"shell pt-10 md:pt-0",children:[e.jsxs("div",{className:"flex items-center justify-between gap-2 mb-2 py-2 md:mb-4 overflow-hidden",children:[e.jsxs("div",{className:"flex items-baseline gap-3 min-w-0",children:[e.jsx("p",{className:"text-sm font-bold text-ink truncate",children:C==null?void 0:C.title}),e.jsxs("p",{className:"eyebrow shrink-0",children:[C==null?void 0:C.type," · ",C==null?void 0:C.year]})]}),e.jsxs("div",{className:"flex items-center gap-3 shrink-0 min-w-0",children:[Z.length>1&&e.jsx("span",{className:"flex items-center gap-1.5 overflow-x-auto hide-scrollbar max-w-[80px] sm:max-w-[200px]",children:Z.map((b,i)=>e.jsx("button",{onClick:()=>T(i),"aria-label":`Media ${i+1}`,className:`h-1.5 shrink-0 rounded-full transition-all duration-300 ${i===_?"w-6 bg-accent":"w-1.5 bg-rule hover:bg-ink-3"}`},i))}),e.jsx("button",{onClick:Ue,className:"btn-ghost shrink-0 !px-2",title:"Roll a random project",children:e.jsx("span",{className:"h-5 w-5",style:{perspective:"120px"},children:e.jsxs("span",{className:"relative block h-full w-full transition-transform duration-[900ms] ease-out",style:{transform:`rotateX(${qe.x}deg) rotateY(${qe.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx(xe,{value:1,transform:"translateZ(10px)"}),e.jsx(xe,{value:6,transform:"rotateY(180deg) translateZ(10px)"}),e.jsx(xe,{value:3,transform:"rotateY(-90deg) translateZ(10px)"}),e.jsx(xe,{value:4,transform:"rotateY(90deg) translateZ(10px)"}),e.jsx(xe,{value:2,transform:"rotateX(90deg) translateZ(10px)"}),e.jsx(xe,{value:5,transform:"rotateX(-90deg) translateZ(10px)"})]})})})]})]}),e.jsx("div",{className:"mt-4 -mx-1 flex overflow-x-auto hide-scrollbar border-b border-rule",children:eb.map(b=>{const i=c===b.key;return e.jsxs("button",{onClick:()=>w(b.key),"aria-pressed":i,className:`relative shrink-0 px-3.5 pb-3 pt-1 font-mono text-[11px] uppercase tracking-eyebrow transition-colors duration-200 ${i?"text-ink":"text-ink-3 hover:text-ink"}`,children:[b.label,e.jsx("span",{className:"ml-1.5 nums-tabular text-ink-3",children:t(b.key)}),e.jsx("span",{className:`absolute inset-x-2 bottom-0 h-[3px] origin-left bg-accent transition-transform duration-300 ease-editorial ${i?"scale-x-100":"scale-x-0"}`,"aria-hidden":"true"})]},b.key)})}),e.jsxs("div",{className:"mt-5 flex items-center gap-2",children:[e.jsx("button",{onClick:()=>X(Math.max(0,g-1)),disabled:g<=0,"aria-label":"Previous project",className:"icon-btn shrink-0 disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(gc,{})}),e.jsx("div",{ref:ee,className:"flex flex-1 gap-2 overflow-x-auto hide-scrollbar py-2 cursor-grab active:cursor-grabbing select-none touch-pan-y",onPointerDown:Oe,onPointerMove:ne,onPointerUp:Ae,onPointerLeave:Ae,children:r.map((b,i)=>{const s=i===g;return e.jsxs("button",{onClick:()=>X(i),className:`group flex shrink-0 items-center gap-3 border px-3 py-2.5 transition-all duration-200 ${s?"border-rule-strong bg-surface shadow-lift":"border-rule bg-surface-2 hover:border-rule-strong hover:bg-surface"}`,style:{minWidth:"220px",maxWidth:"280px"},children:[e.jsx("span",{className:`nums-tabular text-lg font-bold leading-none tracking-masthead transition-colors ${s?"text-accent-text":"text-ink-3/60 group-hover:text-ink-3"}`,children:String(i+1).padStart(2,"0")}),e.jsx("div",{className:"h-10 w-10 shrink-0 overflow-hidden border border-rule bg-surface-2",children:e.jsx("img",{src:b.details.logo,alt:"",className:"h-full w-full object-cover",onError:d=>{d.target.style.display="none"}})}),e.jsxs("div",{className:"min-w-0 text-left",children:[e.jsx("p",{className:"truncate text-sm font-bold tracking-tight text-ink",children:b.title}),e.jsxs("p",{className:"eyebrow",children:[b.type," · ",b.year]})]})]},`${b.type}-${b.slug}`)})}),e.jsx("button",{onClick:()=>X(Math.min(l,g+1)),disabled:g>=l,"aria-label":"Next project",className:"icon-btn shrink-0 disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(sc,{})})]}),e.jsxs("div",{className:"mt-2 flex items-center justify-between",children:[e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(g+1).padStart(2,"0"),e.jsx("span",{className:"mx-1.5 text-rule",children:"/"}),String(r.length).padStart(2,"0")]}),e.jsx(te,{to:`/${C==null?void 0:C.type}/${C==null?void 0:C.slug}`,className:"font-mono text-[11px] uppercase tracking-eyebrow text-accent-text transition-colors hover:text-ink",children:"View details →"})]})]}),e.jsx("section",{className:"shell border-t border-rule py-10 md:py-0",children:e.jsxs("div",{className:"max-w-12xl",children:[e.jsx("p",{className:"mt-4 max-w-3xl text-lg text-ink",children:"你好！我是林丽丽，欢迎来到我的作品集。"}),e.jsx("p",{className:"mt-4 max-w-measure text-base leading-relaxed text-ink-2",children:ic[c]??ic.all})]})}),e.jsx(Jt,{}),e.jsxs("section",{className:"shell pt-12 md:pt-16",children:[e.jsxs("div",{className:"section-head",children:[e.jsx("p",{className:"eyebrow",children:"Motion"}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(le+1).padStart(2,"0"),e.jsx("span",{className:"mx-1.5 text-rule",children:"/"}),String(Xe.length).padStart(2,"0")]})]}),e.jsxs("div",{className:"mt-5 flex items-end justify-between gap-4",children:[e.jsx("h2",{className:"text-display-sm",children:"Video Gallery"}),e.jsxs("div",{className:"flex shrink-0 gap-2",children:[e.jsx("button",{onClick:()=>De(-1),disabled:Le.start,"aria-label":"Scroll gallery left",className:"icon-btn disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(gc,{})}),e.jsx("button",{onClick:()=>De(1),disabled:Le.end,"aria-label":"Scroll gallery right",className:"icon-btn disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(sc,{})})]})]}),e.jsx("div",{ref:re,onScroll:ge,className:"mt-6 flex snap-x snap-mandatory gap-3 overflow-x-auto hide-scrollbar scroll-smooth md:gap-4",children:Xe.map((b,i)=>{const s=i===le;return e.jsxs("figure",{className:`group relative w-[62%] shrink-0 snap-start sm:w-[40%] md:w-[30%] lg:w-[23%] ${s?"ring-1 ring-accent ring-offset-2 ring-offset-canvas":""}`,onMouseEnter:d=>{const h=d.currentTarget.querySelector("video");h&&!s&&h.play().catch(()=>{})},onMouseLeave:d=>{const h=d.currentTarget.querySelector("video");h&&!s&&h.pause()},children:[e.jsxs("div",{className:"relative aspect-[9/16] overflow-hidden border border-rule bg-surface-2",children:[e.jsx("video",{ref:d=>{he.current[i]=d},className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105",src:b.src,muted:!0,playsInline:!0,preload:"metadata",onCanPlay:d=>He(d.currentTarget,i),onEnded:()=>{s&&ie(i+1)}}),s&&e.jsxs("span",{className:"absolute left-2 top-2 flex items-center gap-1 border border-white/30 bg-black/60 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-eyebrow text-white",children:[e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-accent animate-pulse"}),"Now"]}),Ie[i]&&e.jsx("span",{className:"absolute right-2 top-2 flex h-6 w-6 items-center justify-center bg-black/55 text-white",title:"Has audio",children:e.jsx("svg",{className:"h-3 w-3",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"})]}),e.jsxs("figcaption",{className:"mt-2.5 flex items-baseline gap-2",children:[e.jsx("span",{className:"eyebrow nums-tabular shrink-0",children:String(i+1).padStart(2,"0")}),e.jsx("span",{className:"truncate text-sm text-ink-2",children:b.title})]})]},b.src)})})]})]})},bb=()=>typeof document<"u"&&document.documentElement.classList.contains("dark"),ab=()=>{const[c,a]=n.useState(bb),u=()=>{const t=!c;a(t),document.documentElement.classList.toggle("dark",t);try{localStorage.setItem("theme",t?"dark":"light")}catch{}};return e.jsx("button",{onClick:u,className:"icon-btn","aria-label":c?"Switch to light theme":"Switch to dark theme",title:c?"切换到日间模式":"切换到夜间模式",children:c?e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"})}):e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"})})})},dc="https://pub-e0170f3fece2419a85fa1ce02c1f1a28.r2.dev/223_cities_cluster_with_index.zip",pb="/data/223_cities_cluster_with_index_deciles.csv",we=c=>{const a=c.replace("#",""),u=parseInt(a.slice(0,2),16),t=parseInt(a.slice(2,4),16),r=parseInt(a.slice(4,6),16);return[u,t,r]},ke=(c,a,u)=>{const t=Math.round(c[0]+(a[0]-c[0])*u),r=Math.round(c[1]+(a[1]-c[1])*u),l=Math.round(c[2]+(a[2]-c[2])*u);return`rgb(${t}, ${r}, ${l})`},ze=[{key:"K_5",label:"Cluster K=5",category:"cluster",type:"number"},{key:"K_12",label:"Cluster K=12",category:"cluster",type:"number"},{key:"K_20",label:"Cluster K=20",category:"cluster",type:"number"},{key:"K_26",label:"Cluster K=26",category:"cluster",type:"number"},{key:"elev_mean",label:"Elevation Mean(m)",category:"terrain",type:"number"},{key:"elev_std",label:"Elevation Std(m)",category:"terrain",type:"number"},{key:"elev_range",label:"Elevation Range(m)",category:"terrain",type:"number"},{key:"slope_mean",label:"Slope Mean(°)",category:"terrain",type:"number"},{key:"slope_std",label:"Slope Std(N/A)",category:"terrain",type:"number"},{key:"slope_rang",label:"Slope Range(N/A)",category:"terrain",type:"number"},{key:"LandArea",label:"Land Area",category:"urban",type:"number"},{key:"Buiheight",label:"Building Height(m)",category:"urban",type:"number"},{key:"BldArea",label:"Building Area(m²)",category:"urban",type:"number"},{key:"CoverRatio",label:"Building Coverage",category:"urban",type:"number"},{key:"FAR",label:"Floor Area Ratio(N/A)",category:"urban",type:"number"},{key:"GreenArea",label:"Green Area(m²)",category:"urban",type:"number"},{key:"GrHeight",label:"Green Height(m)",category:"urban",type:"number"},{key:"GreenRatio",label:"Green Ratio(N/A)",category:"urban",type:"number"},{key:"GrVolRatio",label:"Green Volume Ratio(N/A)",category:"urban",type:"number"},{key:"ISF",label:"Impervious Surface Fraction(N/A)",category:"urban",type:"number"},{key:"MIN_DistWB",label:"Mini Distance to WaterBody(m)",category:"urban",type:"number"},{key:"MIN_DistGL",label:"Mini Distance to GreenLand(m)",category:"urban",type:"number"},{key:"MIN_DistMT",label:"Mini Distance to Mountain(m)",category:"urban",type:"number"}],nb=()=>{var Se;const c=n.useRef(null),a=n.useRef(null),[u,t]=n.useState(!0),[r,l]=n.useState(0),[g,L]=n.useState(null),[w,E]=n.useState(null),[N,j]=n.useState([]),[k,q]=n.useState(null),[f,_]=n.useState("K_12"),[T,B]=n.useState(!0),[D,J]=n.useState(null),[R,C]=n.useState(null),[K,qe]=n.useState(!1),[$,Ue]=n.useState(null),[Ce,ue]=n.useState(!1),[Z,oe]=n.useState(null),[be,ae]=n.useState(!1),[Me,pe]=n.useState(0),[ee,ce]=n.useState(""),[O,Oe]=n.useState(!1),[ne,Ae]=n.useState(!0),[X,re]=n.useState(!0),[he,le]=n.useState({}),[Ye,oc]=n.useState(!1),[F,Le]=n.useState("global"),ve=n.useRef(null),Ie=n.useRef(null),Fe=n.useRef(!1),ie=n.useRef(null),ge=(p,m)=>{let z=p.features;k!==null&&(z=z.filter(h=>{var v;const x=(v=h.properties)==null?void 0:v.Place;return x!==void 0&&Number(x)===Number(k)}));const y=z.map(h=>{var x;return(x=h.properties)==null?void 0:x[m]}).filter(h=>{if(h==null)return!1;if(typeof h=="string"){const v=h.trim();if(v===""||/^(na|nan|null)$/i.test(v))return!1}const x=Number(h);return!(Number.isNaN(x)||x===-9999)}).map(h=>Number(h)),b=z.reduce((h,x)=>{var M;const v=(M=x.properties)==null?void 0:M[m];let o=!1;if(v==null)o=!0;else if(typeof v=="string"){const A=v.trim();if(A===""||/^(na|nan|null)$/i.test(A))o=!0;else{const P=Number(v);(Number.isNaN(P)||P===-9999)&&(o=!0)}}else{const A=Number(v);(Number.isNaN(A)||A===-9999)&&(o=!0)}return h+(o?1:0)},0);let i=NaN,s=NaN,d=0;if(y.length>0){i=y[0],s=y[0],d=y[0];for(let h=1;h<y.length;h++){const x=y[h];x<i&&(i=x),x>s&&(s=x),d+=x}}return{count:z.length,min:i,max:s,mean:y.length>0?d/y.length:NaN,nanCount:b}};n.useEffect(()=>{(async()=>{try{const y=(await(await fetch(pb)).text()).trim().split(`
`);if(y.length<2)return;const b=y[0].split(",").map(v=>v.trim()),i={},d=y[y.length-1].split(","),x=y[1].split(",");b.forEach((v,o)=>{if(v===""||v.includes("Place")||v.includes("Sum")||v.includes("FID")||v.includes("index"))return;const M=parseFloat(x[o]),A=parseFloat(d[o]);!isNaN(M)&&!isNaN(A)&&A>M&&(i[v]={min:M,max:A})}),console.log("Loaded attribute ranges:",i),le(i)}catch(m){console.error("Failed to load deciles:",m)}})()},[]),n.useEffect(()=>{!O&&!w&&(async()=>{var m;t(!0),l(0),L(null);try{l(10),console.log("开始下载..."),ve.current=new AbortController;const z=await fetch(dc,{signal:ve.current.signal});if(console.log("响应状态:",z.status),!z.ok)throw new Error(`HTTP error! status: ${z.status}`);l(30);const y=z.headers.get("content-length"),b=y?parseInt(y):null;console.log("预期文件大小:",b);const i=(m=z.body)==null?void 0:m.getReader();if(!i)throw new Error("无法读取响应流");let s=0;const d=[];for(;;){const{done:P,value:I}=await i.read();if(P)break;d.push(I),s+=I.length,l(b?30+Math.round(s/b*60):50)}console.log("下载完成, 收到:",s),b&&s!==b&&console.log("警告: 文件大小不匹配 (可能压缩传输)");const h=new Uint8Array(s);let x=0;for(const P of d)h.set(P,x),x+=P.length;if(l(90),O){console.log("本地数据已加载，跳过网络数据"),t(!1);return}console.log("开始解析 Shapefile...");const v=await Qe(h);console.log("Shapefile 解析完成:",v);let o=[];if(v.type==="FeatureCollection"?o=v.features:Array.isArray(v)?o=v:v.type==="Feature"&&(o=[v]),console.log("解析完成，特征数量:",o==null?void 0:o.length),O)return;const M={type:"FeatureCollection",features:o||[]};E(M),l(100);const A=new Map;M.features.forEach(P=>{var Y;const I=Number(((Y=P.properties)==null?void 0:Y.Place)??0);A.has(I)||A.set(I,{id:I,name:`Place ${I}`,featureCount:0});const H=A.get(I);H&&H.featureCount++}),j(Array.from(A.values()).sort((P,I)=>P.id-I.id)),t(!1)}catch(z){if(z.name==="AbortError"){console.log("网络请求已取消");return}L(z instanceof Error?z.message:"Failed to load"),t(!1)}})()},[]),n.useEffect(()=>{w&&J(ge(w,f))},[w,k,f,F,he]),n.useEffect(()=>{if(!w)return;const p=a.current;if(!p)return;const m=()=>{var y,b,i,s;if(w.features.forEach((d,h)=>{d.id===void 0&&(d.id=h)}),p.getSource("cluster"))p.getSource("cluster").setData(w);else{console.log("初始化 cluster 数据源..."),p.addSource("cluster",{type:"geojson",data:w,generateId:!0}),p.addLayer({id:"cluster-fill",type:"fill",source:"cluster",layout:{},paint:{"fill-opacity":.7}}),p.addLayer({id:"cluster-line",type:"line",source:"cluster",layout:{},paint:{"line-color":"#7e7f80ff","line-width":1}}),p.addLayer({id:"cluster-highlight",type:"line",source:"cluster",layout:{},paint:{"line-color":"#632ffdff","line-width":3,"line-opacity":["case",["boolean",["feature-state","selected"],!1],1,0]}}),p.on("click","cluster-fill",h=>{var x;if(h.features&&h.features.length>0){const v=h.features[0],o=v.id;ie.current!==null&&ie.current!==void 0&&p.setFeatureState({source:"cluster",id:ie.current},{selected:!1}),o!==void 0?(p.setFeatureState({source:"cluster",id:o},{selected:!0}),ie.current=o):ie.current=null,Ue(v),ue(!0),((x=v.properties)==null?void 0:x.Place)!==void 0&&q(Number(v.properties.Place))}}),p.on("mouseenter","cluster-fill",()=>{p.getCanvas().style.cursor="pointer"}),p.on("mouseleave","cluster-fill",()=>{p.getCanvas().style.cursor=""});const d=w.features;if(d.length>0)try{const h=new _e.LngLatBounds,x=Math.max(1,Math.floor(d.length/2e3));for(let v=0;v<d.length;v+=x){const o=d[v];if(!((y=o.geometry)!=null&&y.coordinates))continue;const M=o.geometry.type,A=o.geometry.coordinates;M==="Point"?h.extend(A):M==="LineString"||M==="MultiPoint"?A.forEach(P=>h.extend(P)):M==="Polygon"||M==="MultiLineString"?(b=A[0])==null||b.forEach(P=>h.extend(P)):M==="MultiPolygon"&&((s=(i=A[0])==null?void 0:i[0])==null||s.forEach(P=>h.extend(P)))}h.isEmpty()||p.fitBounds(h,{padding:50,duration:1e3})}catch(h){console.error("Fit bounds error:",h)}}},z=()=>{var I;if(!p.getLayer("cluster-fill"))return;const y=null;p.setFilter("cluster-fill",y),p.setFilter("cluster-line",y),p.setFilter("cluster-highlight",y);const b=(()=>{var We;let H=1/0,Y=-1/0;for(const Ve of w.features){const Q=Number((We=Ve.properties)==null?void 0:We[f]);Number.isNaN(Q)||Q===-9999||(Q<H&&(H=Q),Q>Y&&(Y=Q))}return{min:H===1/0?0:H,max:Y===-1/0?0:Y}})(),i=k!==null&&D?{min:D.min,max:D.max}:b,s=F==="city"?i:b,d=s.min,h=s.max;let x;if(f.includes("K_")){const H=Math.round(((I=he[f])==null?void 0:I.max)??h),Y=Array.from({length:26},(me,Ke)=>{const V=Ke/25;let se,de,fe;if(V<.167){const W=V/.167;se=0,de=0,fe=Math.round(139+116*W)}else if(V<.333){const W=(V-.167)/.167;se=0,de=Math.round(255*W),fe=255}else if(V<.5){const W=(V-.333)/.167;se=0,de=Math.round(255-128*W),fe=Math.round(255-255*W)}else if(V<.667){const W=(V-.5)/.167;se=Math.round(255*W),de=255,fe=0}else if(V<.833){const W=(V-.667)/.167;se=255,de=Math.round(255-128*W),fe=0}else{const W=(V-.833)/.167;se=255,de=Math.round(127-127*W),fe=0}return`#${se.toString(16).padStart(2,"0")}${de.toString(16).padStart(2,"0")}${fe.toString(16).padStart(2,"0")}`}),Ve=Array.from({length:H+1},(me,Ke)=>Y[Math.round(Ke*25/H)]).slice(0,H+1),Q=["interpolate",["linear"],["get",f]];for(let me=0;me<=H;me++)Q.push(me,Ve[me]);x=Q}else f==="CoverRatio"||f==="ISF"||f==="GreenRatio"?x=["interpolate",["linear"],["get",f],d,"#3182bd",h,"#e6550d"]:f.includes("elev")||f.includes("slope")?x=["interpolate",["linear"],["get",f],d,"#31a354",h,"#756bb1"]:x=["interpolate",["linear"],["get",f],d,"#31a354",h,"#756bb1"];p.setPaintProperty("cluster-fill","fill-color",x);const v=k!==null,o=Number(k),P=["case",["any",["==",["get",f],-9999],["==",["get",f],null]],0,v?["case",["==",["to-number",["get","Place"]],o],.8,.15]:.7];p.setPaintProperty("cluster-fill","fill-opacity",P)};p.isStyleLoaded()?(m(),z()):p.once("load",()=>{m(),z()})},[w,k,f]),n.useEffect(()=>{var z,y,b,i;if(!w||k===null)return;const p=a.current;if(!p)return;const m=w.features.filter(s=>{var h;const d=(h=s.properties)==null?void 0:h.Place;return d!==void 0&&Number(d)===Number(k)});if(m.length!==0)try{const s=new _e.LngLatBounds;let d=0;const h=Math.max(1,Math.floor(m.length/2e3));for(let x=0;x<m.length;x+=h){const v=m[x];if(!((z=v.geometry)!=null&&z.coordinates))continue;const o=v.geometry.type,M=v.geometry.coordinates;o==="Point"?(s.extend(M),d++):o==="LineString"||o==="MultiPoint"?(M.forEach(A=>s.extend(A)),d++):o==="Polygon"||o==="MultiLineString"?((y=M[0])==null||y.forEach(A=>s.extend(A)),d++):o==="MultiPolygon"&&((i=(b=M[0])==null?void 0:b[0])==null||i.forEach(A=>s.extend(A)),d++)}!s.isEmpty()&&d>0&&p.fitBounds(s,{padding:50,duration:1e3})}catch(s){console.error("Fly to error:",s)}},[k]),n.useEffect(()=>((async()=>{(!c.current||a.current)&&console.log("开始初始化地图...");try{const m=new _e.Map({container:c.current,style:{version:8,sources:{"osm-tiles":{type:"raster",tiles:["https://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png"],tileSize:256,attribution:'&copy; <a href="https://carto.com/">CARTO</a>'}},layers:[{id:"simple-tiles",type:"raster",source:"osm-tiles",minzoom:0,maxzoom:19}]},center:[4.75,45.75],zoom:10});m.addControl(new _e.NavigationControl,"top-right"),m.on("load",()=>{console.log("地图样式加载完成")}),m.on("error",z=>{var i;const y=String(((i=z==null?void 0:z.error)==null?void 0:i.message)||(z==null?void 0:z.message)||"");y.includes("ERR_ABORTED")||y.includes("AbortError")||y.includes("Canceled")||y.includes("cancelled")||console.error("地图错误:",z)}),a.current=m,console.log("地图初始化完成")}catch(m){console.error("地图初始化错误:",m)}})(),()=>{a.current&&(a.current.remove(),a.current=null,Fe.current=!1)}),[]),n.useEffect(()=>{const p=a.current;if(!p)return;const m=()=>{p.getLayer("simple-tiles")&&p.setLayoutProperty("simple-tiles","visibility",ne?"visible":"none")};p.isStyleLoaded()?m():p.once("style.load",m)},[ne]);const De=async p=>{var z;const m=(z=p.target.files)==null?void 0:z[0];if(m){ve.current&&ve.current.abort(),ae(!0),pe(0),ce("正在读取文件..."),L(null),qe(!0),C(URL.createObjectURL(m));try{console.log("开始读取文件:",m.name,"大小:",m.size);let y=[];const b=m.name.endsWith(".zip"),i=m.name.endsWith(".shp");if(!b&&!i){L("请上传 .zip 文件 (包含 Shapefile)"),ae(!1);return}ce("正在读取文件...");const s=await m.arrayBuffer();pe(30),ce("正在解析 Shapefile...");const d=await Qe(s);console.log("Shapefile 解析完成:",d),d.type==="FeatureCollection"?y=d.features:Array.isArray(d)?y=d:d.type==="Feature"&&(y=[d]),console.log("解析到的 features 数量:",y.length),pe(95),ce(`已解析 ${y.length} 个 Features...`);const h={type:"FeatureCollection",features:y};pe(98),ce("正在处理 Place 数据...");const x=new Map;h.features.forEach(v=>{var A;const o=Number(((A=v.properties)==null?void 0:A.Place)??0);x.has(o)||x.set(o,{id:o,name:`Place ${o}`,featureCount:0});const M=x.get(o);M&&M.featureCount++}),pe(100),ce("加载完成!"),setTimeout(()=>{Oe(!0),E(h),j(Array.from(x.values()).sort((v,o)=>v.id-o.id)),ae(!1),qe(!1),t(!1)},500)}catch(y){const b=y instanceof Error?y.message:"未知错误";L(`加载失败: ${b}`),ae(!1),t(!1)}}},He=ze.reduce((p,m)=>(p[m.category]||(p[m.category]=[]),p[m.category].push(m),p),{});return e.jsxs("div",{className:"relative w-full h-full bg-gray-100",children:[be&&e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-8 w-80 text-center",children:[e.jsxs("div",{className:"relative w-20 h-20 mx-auto mb-4",children:[e.jsx("div",{className:"absolute inset-0 border-4 border-gray-100 rounded-full"}),e.jsx("div",{className:"absolute inset-0 border-4 border-purple-600 rounded-full border-t-transparent animate-spin"}),e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx(Je,{className:"text-purple-600",size:24})})]}),e.jsx("p",{className:"text-gray-800 font-medium mb-3",children:ee}),e.jsx("div",{className:"w-full bg-gray-100 rounded-full h-3 mb-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-purple-500 to-purple-600 transition-all duration-300",style:{width:`${Me}%`}})}),e.jsxs("p",{className:"text-sm text-gray-400",children:[Me,"%"]})]})}),u&&!be?e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(qc,{className:"animate-spin h-12 w-12 text-purple-600 mx-auto mb-4"}),e.jsx("p",{className:"text-gray-600",children:"正在加载 Shapefile..."}),e.jsx("div",{className:"w-48 h-2 bg-gray-200 rounded-full mx-auto mt-3 overflow-hidden",children:e.jsx("div",{className:"h-full bg-purple-600 transition-all duration-300",style:{width:`${r}%`}})}),e.jsxs("p",{className:"text-xs text-gray-400 mt-2",children:[r,"%"]}),e.jsxs("div",{className:"flex gap-2 mt-4 justify-center",children:[e.jsxs("a",{href:dc,download:"223_cities_cluster_with_index.zip",className:"inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:[e.jsx(Cc,{size:14}),"下载本地"]}),e.jsxs("button",{onClick:()=>{var p;return(p=Ie.current)==null?void 0:p.click()},className:"inline-flex items-center gap-2 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded-lg text-sm transition-colors",title:"支持 .zip (Shapefile)",children:[e.jsx(Je,{size:14}),"加载 Shapefile"]})]}),e.jsx("p",{className:"text-xs text-gray-400 mt-2",children:"支持 .zip (Shapefile)"}),e.jsx("input",{ref:Ie,type:"file",accept:".shp,.zip",onChange:De,className:"hidden"})]})}):null,g&&e.jsxs("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-red-50 border border-red-200 rounded-xl px-6 py-5 shadow-lg",children:[e.jsx("p",{className:"text-red-600 font-medium",children:"加载失败"}),e.jsx("p",{className:"text-red-400 text-sm mt-1 mb-4",children:g}),e.jsx("div",{className:"flex gap-2",children:e.jsxs("button",{onClick:()=>window.location.reload(),className:"inline-flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-sm transition-colors",children:[e.jsx(Mc,{size:14}),"刷新重试"]})})]}),T&&e.jsxs("div",{className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-72",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("h2",{className:"font-bold text-gray-800 flex items-center gap-2",children:[e.jsx(Sc,{size:18}),"Cluster Map"]}),e.jsx("button",{onClick:()=>B(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(Ac,{size:18})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("span",{className:"text-sm text-gray-600",children:"显示地图底图"}),e.jsx("button",{onClick:()=>Ae(!ne),className:`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${ne?"bg-purple-600":"bg-gray-300"}`,children:e.jsx("span",{className:`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${ne?"translate-x-6":"translate-x-1"}`})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Place (Count)"}),e.jsxs("select",{value:k??"",onChange:p=>q(p.target.value?Number(p.target.value):null),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:[e.jsxs("option",{value:"",children:["All Places (",((Se=w==null?void 0:w.features)==null?void 0:Se.length)??0,")"]}),N.map(p=>e.jsxs("option",{value:p.id,children:[p.name," (",p.featureCount,")"]},p.id))]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Attribute"}),e.jsx("select",{value:f,onChange:p=>_(p.target.value),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:Object.entries(He).map(([p,m])=>[e.jsx("optgroup",{label:p.charAt(0).toUpperCase()+p.slice(1),children:m.map(z=>e.jsx("option",{value:z.key,children:z.label},z.key))},p)])})]}),D&&e.jsxs("div",{className:"bg-gray-50 rounded-lg p-3 space-y-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(Lc,{size:14,className:"text-purple-500"}),e.jsx("span",{className:"text-xs font-medium text-gray-500",children:"Statistics"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-xs",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Count:"})," ",e.jsx("span",{className:"font-medium",children:D.count})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Min:"})," ",e.jsx("span",{className:"font-medium",children:D.min.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Max:"})," ",e.jsx("span",{className:"font-medium",children:D.max.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Mean:"})," ",e.jsx("span",{className:"font-medium",children:D.mean.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"NaN:"})," ",e.jsx("span",{className:"font-medium",children:D.nanCount})]})]})]})]})]}),!T&&e.jsx("button",{onClick:()=>B(!0),className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(Ic,{size:18})}),Ce&&$&&e.jsxs("div",{className:"absolute top-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-80 max-h-96 overflow-y-auto",children:[e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-medium text-gray-400 uppercase tracking-wider mb-1",children:"Feature Details"}),e.jsxs("div",{className:"mb-3",children:[$.properties.Place&&e.jsxs("div",{className:"text-lg font-semibold text-purple-600",children:["Place: ",$.properties.Place]}),$.properties["City Name"]&&e.jsxs("div",{className:"text-sm font-medium text-gray-700",children:["City: ",$.properties["City Name"]]}),e.jsxs("div",{className:"text-sm font-medium text-gray-500",children:["Place ID: ",$.properties["Place ID"]??"N/A"]})]})]}),e.jsx("button",{onClick:()=>ue(!1),className:"p-1 hover:bg-gray-100 rounded-full transition-colors",children:e.jsx(ec,{size:20,className:"text-gray-400"})})]}),e.jsx("div",{className:"space-y-2",children:ze.map(p=>{var z;const m=(z=$.properties)==null?void 0:z[p.key];return m==null?null:e.jsxs("button",{onClick:()=>_(p.key),className:`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${f===p.key?"bg-purple-100 text-purple-700":"bg-gray-50 text-gray-600 hover:bg-gray-100"}`,children:[e.jsx("span",{children:p.label}),e.jsx("span",{className:"font-mono font-medium",children:typeof m=="number"?m.toFixed(2):m})]},p.key)})}),e.jsx("div",{className:"mt-3 pt-3 border-t border-gray-200",children:e.jsx("button",{onClick:()=>q(null),className:"w-full px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:"显示全部区域"})})]}),e.jsx("div",{ref:c,className:"w-full h-full"}),X&&w&&e.jsxs("div",{className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-64",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("h3",{className:"font-semibold text-gray-800 flex items-center gap-2",children:[e.jsx(cc,{size:16}),"Legend"]}),e.jsx("button",{onClick:()=>re(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(ec,{size:16})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"颜色映射"}),e.jsx("button",{onClick:()=>Le(F==="global"?"city":"global"),className:`text-xs px-2 py-1 rounded ${F==="global"?"bg-gray-200 text-gray-700":"bg-purple-100 text-purple-700"}`,children:F==="global"?"全局":"城市"})]}),e.jsx("div",{className:"space-y-3",children:f.includes("K_")?(()=>{var y,b;const p=Math.round(((y=he[f])==null?void 0:y.max)??30),m=Array.from({length:26},(i,s)=>{const d=s/25;let h,x,v;if(d<.167){const o=d/.167;h=0,x=0,v=Math.round(139+116*o)}else if(d<.333){const o=(d-.167)/.167;h=0,x=Math.round(255*o),v=255}else if(d<.5){const o=(d-.333)/.167;h=0,x=Math.round(255-128*o),v=Math.round(255-255*o)}else if(d<.667){const o=(d-.5)/.167;h=Math.round(255*o),x=255,v=0}else if(d<.833){const o=(d-.667)/.167;h=255,x=Math.round(255-128*o),v=0}else{const o=(d-.833)/.167;h=255,x=Math.round(127-127*o),v=0}return`#${h.toString(16).padStart(2,"0")}${x.toString(16).padStart(2,"0")}${v.toString(16).padStart(2,"0")}`}),z=Array.from({length:p+1},(i,s)=>m[Math.round(s*25/p)]);return e.jsxs("div",{children:[e.jsx("div",{className:"text-xs text-gray-500 mb-2",children:((b=ze.find(i=>i.key===f))==null?void 0:b.label)||f}),e.jsx("div",{className:"flex flex-wrap gap-px",children:z.map((i,s)=>e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("div",{className:"w-3 h-3 rounded-sm",style:{backgroundColor:i}}),e.jsx("span",{className:"text-[6px] text-gray-400",children:s})]},s))})]})})():f==="CoverRatio"||f==="ISF"||f==="GreenRatio"?(()=>{var v;const p=(()=>{var A;let o=1/0,M=-1/0;for(const P of w.features){const I=Number((A=P.properties)==null?void 0:A[f]);Number.isNaN(I)||I===-9999||(I<o&&(o=I),I>M&&(M=I))}return{min:o===1/0?0:o,max:M===-1/0?0:M}})(),m=k!==null&&D?{min:D.min,max:D.max}:p,z=((v=ze.find(o=>o.key===f))==null?void 0:v.label)||f,y=p.max>p.min?Math.max(0,Math.min(1,(m.min-p.min)/(p.max-p.min))):0,b=p.max>p.min?Math.max(0,Math.min(1,(m.max-p.min)/(p.max-p.min))):0,i=Math.max(0,b-y),s=we("#3182bd"),d=we("#e6550d"),h=ke(s,d,y),x=ke(s,d,b);return e.jsxs("div",{children:[F==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[z,"（城市区间）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,130,189,0.2), rgba(230,85,13,0.2))"},children:k!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${y*100}%`,width:`${i*100}%`,background:`linear-gradient(to right, ${h}, ${x})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(2)}),e.jsx("span",{children:m.max.toFixed(2)})]})]}),F==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[z,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #3182bd, #e6550d)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:p.min.toFixed(2)}),e.jsx("span",{children:p.max.toFixed(2)})]})]})]})})():f.includes("elev")||f.includes("slope")?(()=>{var v;const p=(()=>{var A;let o=1/0,M=-1/0;for(const P of w.features){const I=Number((A=P.properties)==null?void 0:A[f]);Number.isNaN(I)||I===-9999||(I<o&&(o=I),I>M&&(M=I))}return{min:o===1/0?0:o,max:M===-1/0?0:M}})(),m=k!==null&&D?{min:D.min,max:D.max}:p,z=((v=ze.find(o=>o.key===f))==null?void 0:v.label)||f,y=p.max>p.min?Math.max(0,Math.min(1,(m.min-p.min)/(p.max-p.min))):0,b=p.max>p.min?Math.max(0,Math.min(1,(m.max-p.min)/(p.max-p.min))):0,i=Math.max(0,b-y),s=we("#31a354"),d=we("#756bb1"),h=ke(s,d,y),x=ke(s,d,b);return e.jsxs("div",{children:[F==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[z,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:k!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${y*100}%`,width:`${i*100}%`,background:`linear-gradient(to right, ${h}, ${x})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(1)}),e.jsxs("span",{children:[m.max.toFixed(0),"+"]})]})]}),F==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[z,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:p.min.toFixed(1)}),e.jsxs("span",{children:[p.max.toFixed(0),"+"]})]})]})]})})():(()=>{var v;const p=(()=>{var A;let o=1/0,M=-1/0;for(const P of w.features){const I=Number((A=P.properties)==null?void 0:A[f]);Number.isNaN(I)||I===-9999||(I<o&&(o=I),I>M&&(M=I))}return{min:o===1/0?0:o,max:M===-1/0?0:M}})(),m=k!==null&&D?{min:D.min,max:D.max}:p,z=((v=ze.find(o=>o.key===f))==null?void 0:v.label)||f,y=p.max>p.min?Math.max(0,Math.min(1,(m.min-p.min)/(p.max-p.min))):0,b=p.max>p.min?Math.max(0,Math.min(1,(m.max-p.min)/(p.max-p.min))):0,i=Math.max(0,b-y),s=we("#31a354"),d=we("#756bb1"),h=ke(s,d,y),x=ke(s,d,b);return e.jsxs("div",{children:[F==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[z,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:k!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${y*100}%`,width:`${i*100}%`,background:`linear-gradient(to right, ${h}, ${x})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:m.min.toFixed(2)}),e.jsx("span",{children:m.max.toFixed(2)})]})]}),F==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[z,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:p.min.toFixed(2)}),e.jsx("span",{children:p.max.toFixed(2)})]})]})]})})()})]}),!X&&e.jsx("button",{onClick:()=>re(!0),className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(cc,{size:18})})]})},rb=[{key:"",label:"Home"},{key:"design",label:"Design"},{key:"game",label:"Game"},{key:"ai",label:"AI"},{key:"planning",label:"Planning"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"},{key:"about",label:"About"}],ib={1:[4],2:[0,8],3:[0,4,8],4:[0,2,6,8],5:[0,2,4,6,8],6:[0,2,3,5,6,8]},Ne=({value:c,transform:a})=>e.jsx("div",{className:"absolute inset-0 grid grid-cols-3 grid-rows-3 border border-neutral-400 bg-white p-[2px]",style:{transform:a,backfaceVisibility:"hidden"},children:Array.from({length:9}).map((u,t)=>e.jsx("span",{className:"flex items-center justify-center",children:ib[c].includes(t)&&e.jsx("span",{className:"block h-[2.5px] w-[2.5px] rounded-full",style:{background:c===1||c===4?"#cc2a18":"#171717"}})},t))}),gb=()=>{const[c,a]=n.useState(!1),[u,t]=n.useState(!1),[r,l]=n.useState({x:0,y:0}),g="https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/lili",[L,w]=n.useState(`${g}/lili_01.png`),[E,N]=n.useState("Exploring the intersection of technology and creativity."),j=vc(),k=mc(),f=j.pathname.split("/").filter(Boolean)[0]||"",_={design:`${g}/lili_05.png`,game:`${g}/lili_03.png`,ai:`${g}/lili_07.png`,platform:`${g}/lili_11.png`,tutorial:`${g}/lili_04.png`,about:`${g}/lili_02.png`,planning:`${g}/lili_06.png`},T=[`${g}/lili_01.png`,`${g}/lili_07.png`,`${g}/lili_08.png`,`${g}/lili_09.png`,`${g}/lili_10.png`,`${g}/lili_12.png`],B=["探索科技与创意的交汇点。","把数据转化为有意义的故事。","构建能激发灵感的数字体验。","连接产品与开发的桥梁。","创造在真实世界中落地的解决方案。","热衷于地理空间技术与城市规划。"],D=R=>R[Math.floor(Math.random()*R.length)];n.useEffect(()=>{w(_[f]??D(T)),N(D(B))},[f]);const J=()=>{l(C=>({x:C.x+720+Math.round(Math.random()*360),y:C.y+720+Math.round(Math.random()*360)}));const R=["design","game","ai","planning","platform","tutorial","about"];setTimeout(()=>k(`/${D(R)}`),900)};return e.jsxs("div",{className:"flex h-screen flex-col bg-canvas text-ink",children:[e.jsx("header",{className:`relative z-30 shrink-0 border-b border-rule bg-surface/85 backdrop-blur transition-all duration-300 ease-editorial ${u?"h-0 border-b-0 overflow-hidden opacity-0":""}`,children:e.jsxs("div",{className:"shell flex h-16 items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 flex-1 items-center",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{onClick:()=>a(!c),className:"icon-btn","aria-expanded":c,"aria-label":c?"Hide profile panel":"Show profile panel",title:c?"Hide profile panel":"Show profile panel",children:e.jsxs("span",{className:"flex flex-col items-center justify-center gap-[3px]","aria-hidden":"true",children:[e.jsx("span",{className:"block h-px w-4 bg-current transition-transform duration-300"}),e.jsx("span",{className:`block h-px w-4 bg-current transition-opacity duration-300 ${c?"opacity-0":"opacity-100"}`}),e.jsx("span",{className:"block h-px w-4 bg-current transition-transform duration-300"})]})}),e.jsxs(te,{to:"/",className:"group flex min-w-0 items-baseline gap-2.5",children:[e.jsx("span",{className:"truncate text-lg font-bold tracking-masthead md:text-xl",children:"林丽丽 Lili Lin"}),e.jsx("span",{className:"hidden h-3 w-px bg-rule sm:block","aria-hidden":"true"})]})]}),e.jsx("nav",{className:"-mx-1 flex min-w-0 overflow-x-auto hide-scrollbar",children:e.jsx("ul",{className:"flex shrink-0 items-stretch",children:rb.map(R=>{const C=f===R.key;return e.jsx("li",{className:"flex",children:e.jsxs(te,{to:`/${R.key}`,onClick:()=>{window.innerWidth<768&&a(!1)},"aria-current":C?"page":void 0,className:`relative flex items-center px-3 text-sm font-medium transition-colors duration-200 md:px-4 ${C?"text-ink":"text-ink-3 hover:text-ink"}`,children:[R.label,e.jsx("span",{className:`absolute inset-x-2 top-0 h-[3px] origin-left bg-accent transition-transform duration-300 ease-editorial md:inset-x-3 ${C?"scale-x-100":"scale-x-0"}`,"aria-hidden":"true"})]})},R.key||"home")})})})]}),e.jsxs("div",{className:"flex shrink-0 items-center gap-2",children:[e.jsx(ab,{}),e.jsxs("button",{onClick:J,className:"btn-ghost hidden !px-3 sm:inline-flex",title:"随机探索一个项目",children:[e.jsx("span",{className:"h-5 w-5",style:{perspective:"120px"},children:e.jsxs("span",{className:"relative block h-full w-full transition-transform duration-[900ms] ease-out",style:{transform:`rotateX(${r.x}deg) rotateY(${r.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx(Ne,{value:1,transform:"translateZ(10px)"}),e.jsx(Ne,{value:6,transform:"rotateY(180deg) translateZ(10px)"}),e.jsx(Ne,{value:3,transform:"rotateY(-90deg) translateZ(10px)"}),e.jsx(Ne,{value:4,transform:"rotateY(90deg) translateZ(10px)"}),e.jsx(Ne,{value:2,transform:"rotateX(90deg) translateZ(10px)"}),e.jsx(Ne,{value:5,transform:"rotateX(-90deg) translateZ(10px)"})]})}),"Jump"]}),e.jsx("button",{onClick:()=>t(!0),className:"icon-btn hidden sm:inline-flex",title:"Collapse header","aria-label":"Collapse header",children:e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5 15l7-7 7 7"})})})]})]})}),u&&e.jsx("button",{onClick:()=>t(!1),className:"group flex h-4 w-full items-center justify-center bg-surface/50 hover:bg-surface transition-colors duration-200",title:"Expand header","aria-label":"Expand header",children:e.jsx("svg",{className:"h-3 w-3 text-ink-3 transition-colors group-hover:text-ink",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 9l-7 7-7-7"})})}),e.jsxs("main",{className:"relative flex min-h-0 flex-1 flex-row overflow-hidden",children:[c&&e.jsx("aside",{className:"z-20 h-full w-64 shrink-0 overflow-y-auto border-r border-rule bg-surface md:w-72",children:e.jsxs("div",{className:"flex flex-col gap-8 p-5",children:[L&&e.jsx("img",{src:L,alt:"Lili's avatar",className:"w-full border border-rule bg-surface-2 object-contain"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow",children:"Profile"}),e.jsx("h2",{className:"mt-2 text-xl font-bold tracking-masthead",children:"Lili Lin"}),e.jsx("p",{className:"text-sm text-ink-2",children:"林丽丽"})]}),e.jsx("hr",{className:"hairline"}),e.jsx("p",{className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:"设计师 · 开发者 · 产品创作者"}),e.jsx("p",{className:"text-sm leading-relaxed text-ink-2",children:"创造有意义的数字体验，连接技术与创意。"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("hr",{className:"hairline"}),e.jsx("p",{className:"border-l-2 border-accent pl-3 text-sm italic leading-relaxed text-ink-2",children:E}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(Ze,{href:"https://github.com/lililin0324",label:"GH"}),e.jsx(Ze,{href:"mailto:lili0324@snu.ac.kr",label:"EM"}),e.jsx(Ze,{href:"https://www.linkedin.com/in/lililin0324",label:"LK"})]})]})]})}),e.jsx("section",{className:"relative min-w-0 flex-1 overflow-y-auto",children:e.jsxs(jc,{children:[e.jsx(U,{path:"/",element:e.jsx(tb,{})}),e.jsx(U,{path:"/planning",element:e.jsx(je,{data:Ee,type:"planning"})}),e.jsx(U,{path:"/planning/:id",element:e.jsx(ye,{data:Ee,type:"planning"})}),e.jsx(U,{path:"/design",element:e.jsx(je,{data:Pe,type:"design"})}),e.jsx(U,{path:"/design/:id",element:e.jsx(ye,{data:Pe,type:"design"})}),e.jsx(U,{path:"/game",element:e.jsx(je,{data:Re,type:"game"})}),e.jsx(U,{path:"/game/:id",element:e.jsx(ye,{data:Re,type:"game"})}),e.jsx(U,{path:"/ai",element:e.jsx(je,{data:Ge,type:"ai"})}),e.jsx(U,{path:"/ai/:id",element:e.jsx(ye,{data:Ge,type:"ai"})}),e.jsx(U,{path:"/platform",element:e.jsx(je,{data:Te,type:"platform"})}),e.jsx(U,{path:"/platform/:id",element:e.jsx(ye,{data:Te,type:"platform"})}),e.jsx(U,{path:"/tutorial",element:e.jsx(je,{data:Be,type:"tutorial"})}),e.jsx(U,{path:"/tutorial/:id",element:e.jsx(ye,{data:Be,type:"tutorial"})}),e.jsx(U,{path:"/clusteringeomap",element:e.jsx(nb,{})}),e.jsx(U,{path:"/about",element:e.jsx(Zt,{})}),e.jsx(U,{path:"/contact",element:e.jsx(Xt,{})})]})})]})]})};function sb(){const[c,a]=n.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(yc,{children:e.jsx(gb,{})}),!c&&e.jsx(Dc,{onFinish:()=>a(!0)})]})}xc.createRoot(document.getElementById("root")).render(e.jsx(sb,{}));
