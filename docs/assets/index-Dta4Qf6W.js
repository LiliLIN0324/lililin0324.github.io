...
import iconUrl from "leaflet/dist/images/marker-icon.png";\r
import shadowUrl from "leaflet/dist/images/marker-shadow.png";\r
\r
// 覆盖 Leaflet 默认图标\r
const DefaultIcon = L.icon({\r
  iconUrl,\r
  shadowUrl,\r
  iconSize: [25, 41],\r
  iconAnchor: [12, 41],\r
...
\r
L.Marker.prototype.options.icon = DefaultIcon;\r
\r
// ---------------- 定义照片信息类型 ----------------\r
type PhotoInfo = {\r
  file: File;           // 原始文件对象\r
