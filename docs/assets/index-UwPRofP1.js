...
拼拼将迎合以上⽤户的痛点， 以拼单事件为载体， 提供私聊功能， 为⽤户提供⼀个安全⾼效、 能双向选择、 信息对等的平台， 提升同学们的”拼单”效率， 便捷、 丰富同学们的⽣活。<br>`,Gn=`---
id: "02"
slug: "perslearn"
...
\r
同时，我也更加明确了自己的优势与不足：空间设计能力能够迁移到游戏场景中，而构图、色彩和美术表达仍需要持续积累。`,Kn=`---\r
id: "05"\r
...
https://learn.u3d.cn/tutorial/instant-game-joker?chapterId=64f5962ca571d50021bb3afb&sectionId=64f5962ca571d50021bb3afa`,Qn=`---
id: "01"
slug: "litflow"
...
> 💡 **小提示**：MCP 是一个快速发展的开放标准，未来会有越来越多的工具和应用支持它。现在学习 MCP，就是提前掌握 AI 时代的「通用语言」！`,ot=`---\r
id: "09"\r
...
- **团队熟悉**：优先选择团队熟悉的技术\r
\r
> 💡 **小提示**：没有绝对最好的数据库，只有最适合你项目的数据库。根据实际需求选择，才是最明智的决定！`;function lt(t){const a=/^---\r?\n([\s\S]*?)\r?\n---/,p=t.match(a);let i={},l=t;if(p){const f=p[1];l=t.slice(p[0].length).trim();const y=f.split(/\r?\n/);let u=null,x=[];y.forEach(k=>{if(k.trim()==="")return;const T=k.indexOf(":");if(T!==-1&&!k.startsWith(" ")){u&&(i[u]=x.join(`
`)),u=k.slice(0,T).trim();let D=k.slice(T+1).trim();D==="|"?x=[]:(i[u]=D,u=null,x=[])}else u&&k.startsWith("  ")&&x.push(k.slice(2))}),u&&x.length>0&&(i[u]=x.join(`
`)),Object.keys(i).forEach(k=>{let N=i[k];if(typeof N=="string")if(N=N.trim(),N.startsWith('"')&&N.endsWith('"')&&(N=N.slice(1,-1)),N.startsWith("[")&&N.endsWith("]"))try{i[k]=JSON.parse(N)}catch{i[k]=[N.slice(1,-1).trim()]}else N==="true"?i[k]=!0:N==="false"?i[k]=!1:!isNaN(Number(N))&&N.trim()!==""?i[k]=Number(N):i[k]=N})}return{id:i.id||"",slug:i.slug||"",title:i.title||"",category:i.category||"",year:i.year||"",description:i.description||"",tech:i.tech||[],abstract:i.abstract||"",challenge:i.challenge||"",solution:i.solution||"",hasDemo:i.hasDemo||!1,icon:i.icon||"",code:i.code||"",logo:i.icon||"",image:i.image||[],content:l}}function E(t){const a=lt(t);return{id:a.id,slug:a.slug,title:a.title,category:a.category,year:a.year,description:a.description,tech:a.tech,hasDemo:a.hasDemo,details:{abstract:a.abstract,description:a.description,challenge:a.challenge,solution:a.solution,logo:a.logo,icon:a.icon,code:a.code,image:a.image,content:a.content}}}const _e=[E(Dn),E(Ln),E(En),E(Pn),E(_n),E(Tn),E(Rn)],Te=[E(Bn),E(Gn),E(zn),E(Fn),E(Un),E(On),E(Wn)],Re=[E(Vn),E(Hn),E($n),E(qn),E(Kn),E(Zn)],Be=[E(Qn),E(Xn),E(Yn)],Ge=[E(Jn),E(et),E(nt),E(tt),E(at),E(rt),E(st),E(it),E(ot)],ct={design:"Products",game:"Games",planning:"Planning",platform:"Platform",tutorial:"Tutorials",research:"Research"},dn=({className:t})=>e.jsx("div",{className:"flex h-full w-full items-center justify-center text-ink-3/50",children:e.jsx("svg",{className:t,fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})}),mn=({to:t,className:a=""})=>e.jsx(ae,{to:t,className:`btn-accent ${a}`,children:"Demo"}),dt=!1,mt=({project:t,type:a,index:p})=>{var i;return e.jsx("li",{className:"group border-b border-rule transition-colors duration-300 hover:bg-surface",children:e.jsxs("div",{className:"flex items-center gap-4 py-4 md:gap-6 md:py-5",children:[e.jsx("span",{className:"nums-tabular hidden w-10 shrink-0 self-start pt-1 text-lg font-bold leading-none tracking-masthead text-ink-3/60 transition-colors group-hover:text-accent-text sm:block",children:String(p+1).padStart(2,"0")}),e.jsxs(ae,{to:`/${a}/${t.slug}`,className:"flex min-w-0 flex-1 items-center gap-4 md:gap-6",children:[e.jsx("div",{className:"h-16 w-16 shrink-0 overflow-hidden border border-rule bg-surface-2 md:h-20 md:w-20",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105"}):e.jsx(dn,{className:"h-7 w-7"})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h3",{className:"truncate text-base font-bold tracking-tight text-ink md:text-lg lg:text-xl",children:e.jsx("span",{className:"wipe-underline",children:t.title})}),e.jsx("p",{className:"mt-1 truncate text-sm text-ink-2",children:t.description})]}),e.jsx("div",{className:"hidden shrink-0 flex-wrap justify-end gap-1.5 lg:flex lg:max-w-[16rem]",children:(i=t.tech)==null?void 0:i.slice(0,3).map(l=>e.jsx("span",{className:"chip",children:l},l))}),e.jsx("span",{className:"eyebrow nums-tabular hidden w-12 shrink-0 text-right md:block",children:t.year})]}),t.hasDemo&&e.jsx(mn,{to:`/${a}/${t.slug}#demo`,className:"shrink-0"})]})})},pt=({project:t,type:a,index:p})=>{var i;return e.jsxs("article",{className:"group flex flex-col border border-rule bg-surface transition-colors duration-300 hover:border-rule-strong",children:[e.jsxs(ae,{to:`/${a}/${t.slug}`,className:"flex flex-1 flex-col",children:[e.jsx("div",{className:"aspect-square w-full overflow-hidden border-b border-rule bg-surface-2",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-[1.05]"}):e.jsx(dn,{className:"h-10 w-10"})}),e.jsxs("div",{className:"flex flex-1 flex-col p-4",children:[e.jsxs("div",{className:"flex items-baseline justify-between gap-3",children:[e.jsx("span",{className:"nums-tabular text-sm font-bold tracking-masthead text-ink-3/70 transition-colors group-hover:text-accent-text",children:String(p+1).padStart(2,"0")}),e.jsx("span",{className:"eyebrow nums-tabular",children:t.year})]}),e.jsx("h3",{className:"mt-2.5 line-clamp-2 text-base font-bold leading-snug tracking-tight text-ink md:text-lg",children:e.jsx("span",{className:"wipe-underline",children:t.title})}),e.jsx("p",{className:"mt-1.5 line-clamp-2 text-sm leading-relaxed text-ink-2",children:t.description}),((i=t.tech)==null?void 0:i.length)>0&&e.jsx("div",{className:"mt-3 flex flex-wrap gap-1.5",children:t.tech.slice(0,2).map(l=>e.jsx("span",{className:"chip",children:l},l))})]})]}),t.hasDemo&&e.jsx("div",{className:"border-t border-rule p-3",children:e.jsx(mn,{to:`/${a}/${t.slug}#demo`,className:"w-full"})})]})},Ne=({data:t,type:a})=>{const[p,i]=s.useState("grid"),l=ct[a]??"Works";return e.jsxs("div",{className:"shell animate-rise-in py-8 md:py-12",children:[a==="design"&&dt,e.jsxs("div",{className:"section-head",children:[e.jsxs("p",{className:"eyebrow",children:[a," / Index"]}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(t.length).padStart(2,"0")," Entries"]})]}),e.jsxs("div",{className:"mt-5 flex flex-wrap items-end justify-between gap-4 border-b border-rule pb-5",children:[e.jsxs("h1",{className:"text-display-sm",children:["Selected ",l]}),e.jsx("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:["grid","list"].map(f=>e.jsx("button",{onClick:()=>i(f),"aria-pressed":p===f,className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${p===f?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:f},f))})]}),p==="list"?e.jsx("ul",{className:"mt-2 border-t border-rule",children:t.map((f,y)=>e.jsx(mt,{project:f,type:a,index:y},f.slug))}):e.jsx("div",{className:"mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 xl:grid-cols-4",children:t.map((f,y)=>e.jsx(pt,{project:f,type:a,index:y},f.slug))})]})},ut="modulepreload",ht=function(t,a){return new URL(t,a).href},tn={},F=function(a,p,i){let l=Promise.resolve();if(p&&p.length>0){let y=function(N){return Promise.all(N.map(T=>Promise.resolve(T).then(D=>({status:"fulfilled",value:D}),D=>({status:"rejected",reason:D}))))};const u=document.getElementsByTagName("link"),x=document.querySelector("meta[property=csp-nonce]"),k=(x==null?void 0:x.nonce)||(x==null?void 0:x.getAttribute("nonce"));l=y(p.map(N=>{if(N=ht(N,i),N in tn)return;tn[N]=!0;const T=N.endsWith(".css"),D=T?'[rel="stylesheet"]':"";if(!!i)for(let P=u.length-1;P>=0;P--){const B=u[P];if(B.href===N&&(!T||B.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${N}"]${D}`))return;const d=document.createElement("link");if(d.rel=T?"stylesheet":ut,T||(d.as="script"),d.crossOrigin="",d.href=N,k&&d.setAttribute("nonce",k),document.head.appendChild(d),T)return new Promise((P,B)=>{d.addEventListener("load",P),d.addEventListener("error",()=>B(new Error(`Unable to preload CSS for ${N}`)))})}))}function f(y){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=y,window.dispatchEvent(u),!u.defaultPrevented)throw y}return l.then(y=>{for(const u of y||[])u.status==="rejected"&&f(u.reason);return a().catch(f)})},gt=s.lazy(()=>F(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),ft=s.lazy(()=>F(()=>import("./UR-platform-B26NuqWS.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),bt=s.lazy(()=>F(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),xt=s.lazy(()=>F(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),yt=s.lazy(()=>F(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),vt=s.lazy(()=>F(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),wt=s.lazy(()=>F(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));s.lazy(()=>F(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const jt=s.lazy(()=>F(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),kt=s.lazy(()=>F(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),an=s.lazy(()=>F(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),Nt=s.lazy(()=>F(()=>import("./72HourGameJamDemo-DsdI-g3Q.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),Mt=s.lazy(()=>F(()=>import("./PeaceEliteHustCampusDemo-CKWwrGNJ.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),St=s.lazy(()=>F(()=>import("./BMWMetaIslandDemo-DM2oqedJ.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),Ct=s.lazy(()=>F(()=>import("./riffle-BuqCfcTA.js"),__vite__mapDeps([24,1,2,3]),import.meta.url)),It=s.lazy(()=>F(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([25,1,2,3]),import.meta.url)),At=s.lazy(()=>F(()=>import("./genshot-8Uy4GIux.js"),__vite__mapDeps([26,1,2,3]),import.meta.url)),Dt=t=>({"cluster-visualizer-3d":gt,"participatory-urban-regeneration-empowered-by-artificial-intelligence":ft,heatmapper:bt,"how-to-add-openstreetmap-in-website":xt,"how-to-get-sequential-events-from-photo-by-phone":yt,"how-to-visualize-photo-geolocation-data-on-map":vt,kittylovecarrots:an,"how-to-build-game-in-wechat-mini-program":an,"72-hour-game-jam":Nt,"peace-elite-hust-campus":Mt,"bmw-meta-island":St,"how-to-conduct-time-geo-sequential-clustering-from-album":wt,"box-up-my-stuff-in-cyberspace":jt,"epstein-mystery-archive":kt,"riffle-ai-game-generation-tool":Ct,genstyle:It,"genshot-AI-video-generation-tool":At})[t],rn={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
