...
import{r as s,j as e,L as ae,u as pn,c as un,d as hn,e as gn,f as W,H as fn,g as xn}from"./react-vendor-6zld6QO8.js";import{A as bn,m as qe}from"./framer-DvVmTyA1.js";import{M as yn,r as vn,a as wn}from"./markdown-q3GborES.js";import{b as Ye}from"./geo-Z02C8O4I.js";import{m as Pe}from"./maplibre-BedwuVXB.js";import{U as Je,L as jn,D as kn,R as Nn,M as Mn,C as Sn,a as Cn,b as In,X as en,c as nn}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))i(l);new MutationObserver(l=>{for(const f of l)if(f.type==="childList")for(const y of f.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&i(y)}).observe(document,{childList:!0,subtree:!0});function p(l){const f={};return l.integrity&&(f.integrity=l.integrity),l.referrerPolicy&&(f.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?f.credentials="include":l.crossOrigin==="anonymous"?f.credentials="omit":f.credentials="same-origin",f}function i(l){if(l.ep)return;l.ep=!0;const f=p(l);fetch(l.href,f)}})();function An({onFinish:t}){const[a,p]=s.useState(!0),i=s.useRef(null),l=s.useRef({x:-1e3,y:-1e3});return s.useEffect(()=>{const f=i.current;if(!f)return;const y=f.getContext("2d");if(!y)return;let u,b=[];const k=()=>{f.width=window.innerWidth,f.height=window.innerHeight},N=d=>{l.current={x:d.clientX,y:d.clientY}},T=d=>{d.touches.length>0&&(l.current={x:d.touches[0].clientX,y:d.touches[0].clientY})};window.addEventListener("resize",k),window.addEventListener("mousemove",N),window.addEventListener("touchmove",T),k();class D{constructor(){this.x=Math.random()*f.width,this.y=Math.random()*f.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>f.width)&&(this.vx*=-1),(this.y<0||this.y>f.height)&&(this.vy*=-1);let P=l.current.x-this.x,B=l.current.y-this.y,z=Math.sqrt(P*P+B*B),_=P/z,U=B/z;const G=150;let I=(G-z)/G;z<G&&(this.x-=_*I*this.density*.5,this.y-=U*I*this.density*.5)}draw(){y&&(y.fillStyle="rgba(255, 255, 255, 0.8)",y.beginPath(),y.arc(this.x,this.y,this.size,0,Math.PI*2),y.fill())}}for(let d=0;d<120;d++)b.push(new D);const O=()=>{y.clearRect(0,0,f.width,f.height);for(let d=0;d<b.length;d++){b[d].update(),b[d].draw();for(let P=d+1;P<b.length;P++){const B=b[d].x-b[P].x,z=b[d].y-b[P].y,_=Math.sqrt(B*B+z*z);_<100&&(y.beginPath(),y.strokeStyle=`rgba(255, 255, 255, ${.2*(1-_/100)})`,y.lineWidth=.6,y.moveTo(b[d].x,b[d].y),y.lineTo(b[P].x,b[P].y),y.stroke())}}u=requestAnimationFrame(O)};return O(),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",k),window.removeEventListener("mousemove",N),window.removeEventListener("touchmove",T)}},[]),e.jsx(bn,{onExitComplete:t,children:a&&e.jsxs(qe.div,{onClick:()=>p(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:i,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(qe.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(qe.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const Dn=`---\r
id: "01"\r
slug: "neurotopia"\r
title: "neurotopia"\r
category: "planning"\r
...
# 效果展示\r
\r
![效果展示](/data/fig/Neurotopia (1).jpg)\r
![效果展示](/data/fig/Neurotopia (2).jpg)\r
![效果展示](/data/fig/Neurotopia (3).jpg)\r
![效果展示](/data/fig/Neurotopia (4).jpg)\r
![效果展示](/data/fig/Neurotopia (5).jpg)\r
`,Ln=`---
id: "02"
...
https://learn.u3d.cn/tutorial/instant-game-joker?chapterId=64f5962ca571d50021bb3afb&sectionId=64f5962ca571d50021bb3afa`,Zn=`---
id: "01"
slug: "litflow"
...
> 💡 **小提示**：MCP 是一个快速发展的开放标准，未来会有越来越多的工具和应用支持它。现在学习 MCP，就是提前掌握 AI 时代的「通用语言」！`,it=`---\r
id: "09"\r
...
- **团队熟悉**：优先选择团队熟悉的技术\r
\r
> 💡 **小提示**：没有绝对最好的数据库，只有最适合你项目的数据库。根据实际需求选择，才是最明智的决定！`;function ot(t){const a=/^---\r?\n([\s\S]*?)\r?\n---/,p=t.match(a);let i={},l=t;if(p){const f=p[1];l=t.slice(p[0].length).trim();const y=f.split(/\r?\n/);let u=null,b=[];y.forEach(k=>{if(k.trim()==="")return;const T=k.indexOf(":");if(T!==-1&&!k.startsWith(" ")){u&&(i[u]=b.join(`
`)),u=k.slice(0,T).trim();let D=k.slice(T+1).trim();D==="|"?b=[]:(i[u]=D,u=null,b=[])}else u&&k.startsWith("  ")&&b.push(k.slice(2))}),u&&b.length>0&&(i[u]=b.join(`
`)),Object.keys(i).forEach(k=>{let N=i[k];if(typeof N=="string")if(N=N.trim(),N.startsWith('"')&&N.endsWith('"')&&(N=N.slice(1,-1)),N.startsWith("[")&&N.endsWith("]"))try{i[k]=JSON.parse(N)}catch{i[k]=[N.slice(1,-1).trim()]}else N==="true"?i[k]=!0:N==="false"?i[k]=!1:!isNaN(Number(N))&&N.trim()!==""?i[k]=Number(N):i[k]=N})}return{id:i.id||"",slug:i.slug||"",title:i.title||"",category:i.category||"",year:i.year||"",description:i.description||"",tech:i.tech||[],abstract:i.abstract||"",challenge:i.challenge||"",solution:i.solution||"",hasDemo:i.hasDemo||!1,icon:i.icon||"",code:i.code||"",logo:i.icon||"",image:i.image||[],content:l}}function E(t){const a=ot(t);return{id:a.id,slug:a.slug,title:a.title,category:a.category,year:a.year,description:a.description,tech:a.tech,hasDemo:a.hasDemo,details:{abstract:a.abstract,description:a.description,challenge:a.challenge,solution:a.solution,logo:a.logo,icon:a.icon,code:a.code,image:a.image,content:a.content}}}const _e=[E(Dn),E(Ln),E(En),E(Pn),E(_n),E(Tn),E(Rn)],Te=[E(Bn),E(Gn),E(zn),E(Fn),E(Un),E(On)],Re=[E(Wn),E(Vn),E(Hn),E($n),E(qn),E(Kn)],Be=[E(Zn),E(Qn),E(Xn)],Ge=[E(Yn),E(Jn),E(et),E(nt),E(tt),E(at),E(rt),E(st),E(it)],lt={design:"Products",game:"Games",planning:"Planning",platform:"Platform",tutorial:"Tutorials",research:"Research"},dn=({className:t})=>e.jsx("div",{className:"flex h-full w-full items-center justify-center text-ink-3/50",children:e.jsx("svg",{className:t,fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})}),mn=({to:t,className:a=""})=>e.jsx(ae,{to:t,className:`btn-accent ${a}`,children:"Demo"}),ct=!1,dt=({project:t,type:a,index:p})=>{var i;return e.jsx("li",{className:"group border-b border-rule transition-colors duration-300 hover:bg-surface",children:e.jsxs("div",{className:"flex items-center gap-4 py-4 md:gap-6 md:py-5",children:[e.jsx("span",{className:"nums-tabular hidden w-10 shrink-0 self-start pt-1 text-lg font-bold leading-none tracking-masthead text-ink-3/60 transition-colors group-hover:text-accent-text sm:block",children:String(p+1).padStart(2,"0")}),e.jsxs(ae,{to:`/${a}/${t.slug}`,className:"flex min-w-0 flex-1 items-center gap-4 md:gap-6",children:[e.jsx("div",{className:"h-16 w-16 shrink-0 overflow-hidden border border-rule bg-surface-2 md:h-20 md:w-20",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105"}):e.jsx(dn,{className:"h-7 w-7"})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h3",{className:"truncate text-base font-bold tracking-tight text-ink md:text-lg lg:text-xl",children:e.jsx("span",{className:"wipe-underline",children:t.title})}),e.jsx("p",{className:"mt-1 truncate text-sm text-ink-2",children:t.description})]}),e.jsx("div",{className:"hidden shrink-0 flex-wrap justify-end gap-1.5 lg:flex lg:max-w-[16rem]",children:(i=t.tech)==null?void 0:i.slice(0,3).map(l=>e.jsx("span",{className:"chip",children:l},l))}),e.jsx("span",{className:"eyebrow nums-tabular hidden w-12 shrink-0 text-right md:block",children:t.year})]}),t.hasDemo&&e.jsx(mn,{to:`/${a}/${t.slug}#demo`,className:"shrink-0"})]})})},mt=({project:t,type:a,index:p})=>{var i;return e.jsxs("article",{className:"group flex flex-col border border-rule bg-surface transition-colors duration-300 hover:border-rule-strong",children:[e.jsxs(ae,{to:`/${a}/${t.slug}`,className:"flex flex-1 flex-col",children:[e.jsx("div",{className:"aspect-square w-full overflow-hidden border-b border-rule bg-surface-2",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-[1.05]"}):e.jsx(dn,{className:"h-10 w-10"})}),e.jsxs("div",{className:"flex flex-1 flex-col p-4",children:[e.jsxs("div",{className:"flex items-baseline justify-between gap-3",children:[e.jsx("span",{className:"nums-tabular text-sm font-bold tracking-masthead text-ink-3/70 transition-colors group-hover:text-accent-text",children:String(p+1).padStart(2,"0")}),e.jsx("span",{className:"eyebrow nums-tabular",children:t.year})]}),e.jsx("h3",{className:"mt-2.5 line-clamp-2 text-base font-bold leading-snug tracking-tight text-ink md:text-lg",children:e.jsx("span",{className:"wipe-underline",children:t.title})}),e.jsx("p",{className:"mt-1.5 line-clamp-2 text-sm leading-relaxed text-ink-2",children:t.description}),((i=t.tech)==null?void 0:i.length)>0&&e.jsx("div",{className:"mt-3 flex flex-wrap gap-1.5",children:t.tech.slice(0,2).map(l=>e.jsx("span",{className:"chip",children:l},l))})]})]}),t.hasDemo&&e.jsx("div",{className:"border-t border-rule p-3",children:e.jsx(mn,{to:`/${a}/${t.slug}#demo`,className:"w-full"})})]})},Ne=({data:t,type:a})=>{const[p,i]=s.useState("grid"),l=lt[a]??"Works";return e.jsxs("div",{className:"shell animate-rise-in py-8 md:py-12",children:[a==="design"&&ct,e.jsxs("div",{className:"section-head",children:[e.jsxs("p",{className:"eyebrow",children:[a," / Index"]}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(t.length).padStart(2,"0")," Entries"]})]}),e.jsxs("div",{className:"mt-5 flex flex-wrap items-end justify-between gap-4 border-b border-rule pb-5",children:[e.jsxs("h1",{className:"text-display-sm",children:["Selected ",l]}),e.jsx("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:["grid","list"].map(f=>e.jsx("button",{onClick:()=>i(f),"aria-pressed":p===f,className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${p===f?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:f},f))})]}),p==="list"?e.jsx("ul",{className:"mt-2 border-t border-rule",children:t.map((f,y)=>e.jsx(dt,{project:f,type:a,index:y},f.slug))}):e.jsx("div",{className:"mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 xl:grid-cols-4",children:t.map((f,y)=>e.jsx(mt,{project:f,type:a,index:y},f.slug))})]})},pt="modulepreload",ut=function(t,a){return new URL(t,a).href},tn={},F=function(a,p,i){let l=Promise.resolve();if(p&&p.length>0){let y=function(N){return Promise.all(N.map(T=>Promise.resolve(T).then(D=>({status:"fulfilled",value:D}),D=>({status:"rejected",reason:D}))))};const u=document.getElementsByTagName("link"),b=document.querySelector("meta[property=csp-nonce]"),k=(b==null?void 0:b.nonce)||(b==null?void 0:b.getAttribute("nonce"));l=y(p.map(N=>{if(N=ut(N,i),N in tn)return;tn[N]=!0;const T=N.endsWith(".css"),D=T?'[rel="stylesheet"]':"";if(!!i)for(let P=u.length-1;P>=0;P--){const B=u[P];if(B.href===N&&(!T||B.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${N}"]${D}`))return;const d=document.createElement("link");if(d.rel=T?"stylesheet":pt,T||(d.as="script"),d.crossOrigin="",d.href=N,k&&d.setAttribute("nonce",k),document.head.appendChild(d),T)return new Promise((P,B)=>{d.addEventListener("load",P),d.addEventListener("error",()=>B(new Error(`Unable to preload CSS for ${N}`)))})}))}function f(y){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=y,window.dispatchEvent(u),!u.defaultPrevented)throw y}return l.then(y=>{for(const u of y||[])u.status==="rejected"&&f(u.reason);return a().catch(f)})},ht=s.lazy(()=>F(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),gt=s.lazy(()=>F(()=>import("./UR-platform-B26NuqWS.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),ft=s.lazy(()=>F(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),xt=s.lazy(()=>F(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),bt=s.lazy(()=>F(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),yt=s.lazy(()=>F(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),vt=s.lazy(()=>F(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));s.lazy(()=>F(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const wt=s.lazy(()=>F(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),jt=s.lazy(()=>F(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),an=s.lazy(()=>F(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),kt=s.lazy(()=>F(()=>import("./72HourGameJamDemo-DsdI-g3Q.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),Nt=s.lazy(()=>F(()=>import("./PeaceEliteHustCampusDemo-CKWwrGNJ.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),Mt=s.lazy(()=>F(()=>import("./BMWMetaIslandDemo-DM2oqedJ.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),St=s.lazy(()=>F(()=>import("./riffle-BuqCfcTA.js"),__vite__mapDeps([24,1,2,3]),import.meta.url)),Ct=s.lazy(()=>F(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([25,1,2,3]),import.meta.url)),It=s.lazy(()=>F(()=>import("./genshot-8Uy4GIux.js"),__vite__mapDeps([26,1,2,3]),import.meta.url)),At=t=>({"cluster-visualizer-3d":ht,"participatory-urban-regeneration-empowered-by-artificial-intelligence":gt,heatmapper:ft,"how-to-add-openstreetmap-in-website":xt,"how-to-get-sequential-events-from-photo-by-phone":bt,"how-to-visualize-photo-geolocation-data-on-map":yt,kittylovecarrots:an,"how-to-build-game-in-wechat-mini-program":an,"72-hour-game-jam":kt,"peace-elite-hust-campus":Nt,"bmw-meta-island":Mt,"how-to-conduct-time-geo-sequential-clustering-from-album":vt,"box-up-my-stuff-in-cyberspace":wt,"epstein-mystery-archive":jt,"riffle-ai-game-generation-tool":St,genstyle:Ct,"genshot-AI-video-generation-tool":It})[t],rn={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
...
}`},Dt=({images:t,captions:a})=>{const[p,i]=s.useState(0),l=()=>{i(u=>u===0?t.length-1:u-1)},f=()=>{i(u=>u===t.length-1?0:u+1)},y=a==null?void 0:a[p];return e.jsxs("div",{className:"w-full",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-lg shadow-lg bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center max-h-[350px]",children:[e.jsx("img",{src:t[p],className:"max-w-full max-h-[350px] w-auto h-auto object-contain",alt:y||`Carousel Image ${p+1}`}),e.jsx("button",{onClick:l,className:"absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:f,className:"absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),e.jsx("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1 z-10",children:t.map((u,b)=>e.jsx("button",{onClick:()=>i(b),className:`h-1.5 rounded-full transition-all duration-300 ${p===b?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2 hover:bg-neutral-400"}`,"aria-label":`Go to slide ${b+1}`},b))})]}),y&&e.jsxs("div",{className:"mt-2 text-center",children:[e.jsx("p",{className:"text-sm text-neutral-600 dark:text-neutral-400 italic",children:y}),e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500 mt-1 font-mono",children:[p+1," / ",t.length]})]}),!y&&e.jsxs("p",{className:"mt-2 text-xs text-neutral-400 dark:text-neutral-500 text-center font-mono",children:[p+1," / ",t.length]})]})},Lt=({src:t,...a})=>{const[p,i]=s.useState(!1),[l,f]=s.useState(!1);return s.useEffect(()=>{const y=setTimeout(()=>{l||(i(!1),f(!0))},3e3);return()=>clearTimeout(y)},[l]),e.jsxs(e.Fragment,{children:[e.jsx("iframe",{src:t,onLoad:()=>{i(!0),f(!0)},onError:()=>{i(!1),f(!0)},style:{display:"none"},title:"detector"}),!l&&e.jsx("div",{className:"my-4 w-full",children:e.jsxs("a",{href:t,target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"Open link"]})}),l&&p&&e.jsx("div",{className:"my-6 w-full border border-rule bg-surface-2",children:e.jsx("iframe",{src:t,className:"h-96 w-full border-0",allowFullScreen:!0,...a})}),l&&!p&&e.jsx("div",{className:"my-4 w-full",children:e.jsxs("a",{href:t,target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"Open link"]})})]})},Et={iframe:({src:t,title:a,...p})=>e.jsx(Lt,{src:t,title:a||"Embedded content",...p}),imagecarousel:({images:t,captions:a})=>{const p=(t||"").split(",").map(l=>l.trim()).filter(Boolean),i=a?a.split("|").map(l=>l.trim()):void 0;return e.jsx(Dt,{images:p,captions:i})},table:({children:t})=>e.jsx("div",{className:"my-6 overflow-x-auto border border-rule",children:e.jsx("table",{className:"min-w-full border-collapse text-sm",children:t})}),thead:({children:t})=>e.jsx("thead",{className:"border-b border-rule bg-surface-2",children:t}),th:({children:t})=>e.jsx("th",{className:"border-r border-rule px-3 py-2 text-left font-mono text-[10px] uppercase tracking-eyebrow text-ink-2 last:border-r-0",children:t}),td:({children:t})=>e.jsx("td",{className:"border-r border-t border-rule px-3 py-2 text-ink-2 last:border-r-0",children:t}),h1:({children:t,...a})=>{const i=(typeof t=="string"?t:(t==null?void 0:t.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h1",{id:i,className:"mt-10 mb-5 text-xl font-bold tracking-tight text-ink first:mt-0",...a,children:t})},h2:({children:t,...a})=>{const i=(typeof t=="string"?t:(t==null?void 0:t.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h2",{id:i,className:"mt-8 mb-4 text-lg font-bold tracking-tight text-ink",...a,children:t})},h3:({children:t,...a})=>{const i=(typeof t=="string"?t:(t==null?void 0:t.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h3",{id:i,className:"mt-6 mb-3 text-base font-bold text-ink",...a,children:t})},h4:({children:t,...a})=>e.jsx("h4",{className:"mt-5 mb-2 text-sm font-semibold text-ink",...a,children:t}),h5:({children:t,...a})=>e.jsx("h5",{className:"mt-4 mb-2 text-sm font-semibold text-ink-2",...a,children:t}),h6:({children:t,...a})=>e.jsx("h6",{className:"mt-3 mb-2 font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",...a,children:t}),p:({children:t,...a})=>e.jsx("p",{className:"mb-4 leading-relaxed text-ink-2",...a,children:t}),a:({children:t,href:a,...p})=>e.jsx("a",{href:a,className:"text-accent-text underline decoration-1 underline-offset-2 transition-colors hover:text-ink",target:"_blank",rel:"noopener noreferrer",...p,children:t}),img:({src:t,alt:a,...p})=>(a==null?void 0:a.match(/BCR|BHV|SVF|NDVI|EV|WR|Dist_/))?e.jsx("img",{src:t,alt:a,className:"h-32 max-w-full border border-rule object-cover",...p}):e.jsx("img",{src:t,alt:a,className:"my-6 h-auto w-full border border-rule object-cover",...p})},Me=({data:t,type:a})=>{var b;const{id:p}=pn(),[i,l]=s.useState("details"),[f,y]=s.useState(!1),u=t.find(k=>k.slug===p);return s.useEffect(()=>{const k=()=>l(window.location.hash.includes("demo")?"demo":"details");return k(),window.addEventListener("hashchange",k),()=>window.removeEventListener("hashchange",k)},[p]),u?e.jsxs("div",{className:"animate-rise-in pb-16",children:[e.jsx("div",{className:"sticky top-0 z-20 border-b border-rule bg-surface/85 backdrop-blur",children:e.jsxs("div",{className:"shell flex h-14 items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-4",children:[e.jsx(ae,{to:`/${a}`,className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3 transition-colors hover:text-ink",children:"← Index"}),e.jsx("span",{className:"hidden h-3 w-px bg-rule md:block","aria-hidden":"true"}),e.jsx("h2",{className:"truncate text-sm font-bold tracking-tight text-ink",children:u.title})]}),e.jsxs("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:[e.jsx("button",{onClick:()=>l("details"),className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${i==="details"?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:"Docs"}),u.hasDemo&&e.jsxs("button",{onClick:()=>l("demo"),className:`flex items-center gap-2 px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${i==="demo"?"bg-accent text-accent-ink":"text-ink-3 hover:text-ink"}`,children:[e.jsxs("span",{className:"relative flex h-1.5 w-1.5",children:[e.jsx("span",{className:"absolute h-full w-full animate-ping rounded-full bg-accent-ink/75"}),e.jsx("span",{className:"relative h-1.5 w-1.5 rounded-full bg-accent-ink"})]}),"Demo"]})]})]})}),i==="details"?e.jsx("div",{className:"shell py-8 md:py-12",children:e.jsxs("div",{className:"mx-auto max-w-4xl",children:[((b=u.tech)==null?void 0:b.length)>0&&e.jsx("div",{className:"mb-6 flex flex-wrap gap-1.5",children:u.tech.map((k,N)=>e.jsx("span",{className:"chip",children:k},N))}),e.jsxs("div",{className:"mb-6 flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:[e.jsxs("span",{children:["NO. ",u.id]}),e.jsx("span",{className:"text-rule","aria-hidden":"true",children:"/"}),e.jsx("span",{children:u.year}),e.jsx("span",{className:"text-rule","aria-hidden":"true",children:"/"}),e.jsx("span",{children:u.category})]}),e.jsx("h1",{className:"text-display-sm mb-6",children:u.title}),e.jsxs("details",{className:"group mb-12 border border-rule bg-surface",open:f,onToggle:k=>y(k.target.open),children:[e.jsxs("summary",{className:"flex cursor-pointer list-none items-center justify-between px-5 py-4 select-none md:px-7",children:[e.jsx("span",{className:"eyebrow",children:"Overview"}),e.jsxs("span",{className:"font-mono text-[10px] uppercase tracking-eyebrow text-ink-3 transition-transform duration-300 group-open:rotate-180",children:[f?"Collapse":"Expand"," ▾"]})]}),e.jsxs("div",{className:"space-y-6 border-t border-rule px-5 pb-6 pt-5 md:px-7 md:pb-8 md:pt-6",children:[u.description&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Description"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:u.description})]}),u.details.abstract&&u.details.abstract!==u.description&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Abstract"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:u.details.abstract})]}),u.details.challenge&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Challenges"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:u.details.challenge})]}),u.details.solution&&e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow mb-2",children:"Methodology"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:u.details.solution})]})]})]}),u.details.content&&e.jsxs("section",{id:"content",children:[e.jsx("div",{className:"section-head mb-8",children:e.jsx("p",{className:"eyebrow",children:"Content"})}),e.jsx("div",{className:"prose-custom text-base leading-relaxed text-ink-2",children:e.jsx(yn,{remarkPlugins:[wn],rehypePlugins:[vn],components:Et,children:u.details.content})})]}),(u.details.code||u.details.codeComponent||rn[u.slug])&&e.jsxs("section",{id:"code",className:"mt-12",children:[e.jsx("div",{className:"section-head mb-5",children:e.jsx("p",{className:"eyebrow",children:"Code Example"})}),e.jsx("pre",{className:"overflow-x-auto border border-rule bg-ink p-5 font-mono text-[13px] leading-relaxed text-canvas md:p-7",children:e.jsx("code",{children:rn[u.slug]||u.details.codeComponent||`// Code file: ${u.details.code}`})})]})]})}):e.jsx("div",{className:"h-[calc(100vh-3.5rem)] w-full bg-surface-2",children:e.jsx(s.Suspense,{fallback:e.jsx("div",{className:"flex h-full items-center justify-center",children:e.jsx("p",{className:"eyebrow",children:"Loading demo..."})}),children:(()=>{const k=At(u.slug);return k?e.jsx(k,{}):e.jsx("div",{className:"flex h-full items-center justify-center",children:e.jsx("p",{className:"eyebrow",children:"Demo not available"})})})()})})]}):e.jsx("div",{className:"shell flex h-full items-center justify-center py-20",children:e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"eyebrow",children:"Error"}),e.jsx("p",{className:"mt-3 text-display-sm",children:"Project not found"}),e.jsx(ae,{to:"/",className:"btn-ghost mt-6",children:"← Back to index"})]})})},Pt=["Urban Climate & Resilience","AI-Assisted Urban Planning","Machine Learning & Data Analysis","Spatial Statistics & GIS","React / Next.js Ecosystem","TypeScript Architecture","WebGL / Three.js","UI Systems Design"],_t=()=>{const[t,a]=s.useState(null);return s.useEffect(()=>{if(!t)return;const p=l=>{l.key==="Escape"&&a(null)};window.addEventListener("keydown",p);const i=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",p),document.body.style.overflow=i}},[t]),e.jsx("div",{className:"shell animate-rise-in py-8 md:py-12",children:e.jsxs("div",{className:"mx-auto max-w-5xl",children:[e.jsx("div",{className:"section-head",children:e.jsx("p",{className:"eyebrow",children:"About / Bio"})}),e.jsx("h1",{className:"mt-5 text-display-sm",children:"关于我"}),e.jsx("h1",{className:"mt-5 text-display-sm",children:"About Me"}),e.jsxs("div",{className:"mt-8 space-y-5 text-base leading-relaxed text-ink-2 md:text-lg",children:[e.jsxs("p",{children:["我是林丽丽，首尔大学硕士生，华中科技大学本科生, 想做",e.jsx("strong",{className:"font-semibold text-ink",children:"AI 相关的产品"}),". 我的研究兴趣包括",e.jsx("strong",{className:"font-semibold text-ink",children:"城市气候韧性、城市规划知识图谱、空间统计与机器学习"}),"，并且我也对",e.jsx("strong",{className:"font-semibold text-ink",children:"产品设计、UI/UX和前端开发"}),"充满热情。"]}),e.jsx("p",{})]}),e.jsxs("div",{className:"mt-12 border-t border-rule pt-10 md:mt-16 md:pt-12",children:[e.jsx("p",{className:"eyebrow",children:"Core Competencies"}),e.jsx("div",{className:"mt-4 flex flex-wrap gap-1.5",children:Pt.map(p=>e.jsx("span",{className:"chip",children:p},p))})]})]})})},Tt=()=>e.jsx("div",{className:"shell flex h-full flex-col items-center justify-center py-20 text-center",children:e.jsxs("div",{className:"animate-rise-in max-w-md space-y-8",children:[e.jsx("div",{className:"flex justify-center",children:e.jsx("span",{className:"icon-btn h-14 w-14",children:e.jsx("svg",{className:"h-5 w-5",fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("p",{className:"eyebrow",children:"Contact"}),e.jsx("h2",{className:"text-display-sm",children:"Let's work together"}),e.jsx("p",{className:"max-w-measure text-base leading-relaxed text-ink-2",children:"Interested in collaboration, research, or just want to say hello? Reach out anytime."})]}),e.jsxs("div",{className:"flex flex-col items-center gap-3 pt-4",children:[e.jsxs("a",{href:"mailto:lily1326685527@gmail.com?subject=Research%20Collaboration",className:"btn-solid",children:["Send message",e.jsx("svg",{className:"h-3 w-3",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14 5l7 7m0 0l-7 7m7-7H3"})})]}),e.jsx("p",{className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:"lily1326685527@gmail.com"})]})]})}),Ke=({href:t,label:a})=>e.jsx("a",{href:t,target:"_blank",rel:"noopener noreferrer",className:"icon-btn font-mono text-[10px] tracking-eyebrow",children:a}),Rt=[{key:"all",label:"All"},{key:"product",label:"Product"},{key:"game",label:"Game"},{key:"planning",label:"Planning"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"}],sn={all:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"产品、开发、游戏和城市规划"}),"领域的项目。"]}),product:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"产品"}),"领域的项目。"]}),planning:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"城市规划"}),"领域的项目。"]}),game:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"游戏"}),"领域的项目。"]}),platform:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"平台开发"}),"领域的项目。"]}),tutorial:e.jsxs(e.Fragment,{children:["这是我在",e.jsx("strong",{className:"font-semibold text-ink",children:"教程"}),"领域的项目。"]})},Ze=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/kitty-0317.mp4",title:"Kitty Video"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/%E5%BE%AE%E4%BF%A1%E8%A7%86%E9%A2%912026-02-09_184301_354.mp4",title:"Kitty Video 2"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260225-192100.mp4",title:"Riffle Loading 1"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video3.mp4",title:"Video Title 3"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video4.mp4",title:"Video Title 4"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video5.mp4",title:"Video Title 5"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video6.mp4",title:"Video Title 6"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video7.mp4",title:"Video Title 7"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video8.mp4",title:"Video Title 8"}],on=()=>e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})}),ln=()=>e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M9 5l7 7-7 7"})}),Bt={1:[4],2:[0,8],3:[0,4,8],4:[0,2,6,8],5:[0,2,4,6,8],6:[0,2,3,5,6,8]},fe=({value:t,transform:a})=>e.jsx("div",{className:"absolute inset-0 grid grid-cols-3 grid-rows-3 border border-neutral-400 bg-white p-[2px]",style:{transform:a,backfaceVisibility:"hidden"},children:Array.from({length:9}).map((p,i)=>e.jsx("span",{className:"flex items-center justify-center",children:Bt[t].includes(i)&&e.jsx("span",{className:"block h-[2.5px] w-[2.5px] rounded-full",style:{background:t===1||t===4?"#cc2a18":"#171717"}})},i))}),Gt=()=>{var Ae,te,De,Le,Ee;const[t,a]=s.useState("all"),p={all:[...Te.map(o=>({...o,type:"product"})),..._e.map(o=>({...o,type:"planning"})),...Re.map(o=>({...o,type:"game"})),...Be.map(o=>({...o,type:"platform"})),...Ge.map(o=>({...o,type:"tutorial"}))],product:Te.map(o=>({...o,type:"product"})),planning:_e.map(o=>({...o,type:"planning"})),game:Re.map(o=>({...o,type:"game"})),platform:Be.map(o=>({...o,type:"platform"})),tutorial:Ge.map(o=>({...o,type:"tutorial"}))},i=o=>p[o].length,l=p[t]??p.all,f=Math.max(0,l.length-1),[y,u]=s.useState(0),b=o=>{a(o),u(0)},k=o=>{if(!o)return[];const n=/<video[^>]+src="([^"]+)"/gi;return Array.from(o.matchAll(n),r=>r[1])},N=o=>{var r,m;if(!o)return null;const n=(r=o.details)==null?void 0:r.image;return n!=null&&n.length?n[0]:((m=o.details)==null?void 0:m.logo)??null},T=l[(y-1+l.length)%l.length],D=l[(y+1)%l.length],O=N(T),d=N(D),[P,B]=s.useState(0),[z,_]=s.useState(!1),U=s.useRef(null),G=s.useRef(null),I=l[y],Z=((Ae=I==null?void 0:I.details)==null?void 0:Ae.image)??[];Z.length>=2&&Z[(P-1+Z.length)%Z.length],Z.length>=3?Z[(P+1)%Z.length]:Z.length===2&&Z[(P+1)%2],s.useEffect(()=>{B(0),_(!1)},[y,t]);const[we,X]=s.useState({x:0,y:0}),ze=()=>{X(o=>({x:o.x+720+Math.round(Math.random()*360),y:o.y+720+Math.round(Math.random()*360)})),setTimeout(()=>V(Math.floor(Math.random()*l.length)),900)},je=k(((te=I==null?void 0:I.details)==null?void 0:te.content)??""),pe=((De=I==null?void 0:I.details)==null?void 0:De.image)??[],Y=[...je,...pe],ue=Y.length>0?Y[P%Y.length]:(Le=I==null?void 0:I.details)==null?void 0:Le.logo,re=je.length>0&&P<je.length,se=pe.length>0?pe[0]:(Ee=I==null?void 0:I.details)==null?void 0:Ee.logo,ke=()=>{B(o=>(o+1)%(Y.length||1))};s.useEffect(()=>{if(G.current&&(clearInterval(G.current),G.current=null),!(re||Y.length<=1))return G.current=setInterval(ke,5e3),()=>{G.current&&(clearInterval(G.current),G.current=null)}},[y,t,re,Y.length]);const ie=()=>{const o=U.current;o&&(o.muted=!o.muted,_(!o.muted))},Fe=s.useRef(null),V=o=>{u(o)},ne=s.useRef(null),Se=s.useRef([]),[Q,Ue]=s.useState(0),[Oe,Ce]=s.useState(0),[he,We]=s.useState({start:!0,end:!1}),[Qe,Xe]=s.useState({}),H=o=>{const n=o%Ze.length;Ue(n);const r=ne.current;if(r){const m=r.children[n];m&&r.scrollTo({left:m.offsetLeft-r.offsetWidth/2+m.offsetWidth/2,behavior:"smooth"})}};s.useEffect(()=>{const o=Se.current[Q];o&&(o.currentTime=0,o.play().catch(()=>{}))},[Q]);const oe=s.useCallback(()=>{const o=ne.current;if(!o)return;const n=o.firstElementChild,r=(n==null?void 0:n.offsetWidth)||1;Ce(Math.round(o.scrollLeft/r)),We({start:o.scrollLeft<=1,end:o.scrollLeft+o.clientWidth>=o.scrollWidth-1})},[]);s.useEffect(()=>(oe(),window.addEventListener("resize",oe),()=>window.removeEventListener("resize",oe)),[oe]);const le=o=>{const n=ne.current;if(!n)return;const r=n.firstElementChild;n.scrollBy({left:o*((r==null?void 0:r.offsetWidth)||n.clientWidth/2),behavior:"smooth"})},Ie=(o,n)=>{var h;const r=o,m=M=>Xe(S=>S[n]===M?S:{...S,[n]:M});if((h=r.audioTracks)!=null&&h.length){m(Array.from(r.audioTracks).some(M=>M.enabled));return}if("mozHasAudio"in r){m(!!r.mozHasAudio);return}if(typeof r.webkitAudioDecodedByteCount=="number"&&r.webkitAudioDecodedByteCount>0){m(!0);return}if(r.readyState>=3){setTimeout(()=>m(r.webkitAudioDecodedByteCount>0||r.mozHasAudio===!0),500);return}m(!0)};return e.jsxs("div",{className:"animate-rise-in pb-16",children:[ue&&e.jsxs("section",{className:"relative w-full overflow-hidden border-b border-neutral-800",style:{background:"linear-gradient(to bottom, #3f3f3f 100%, #0a0a0a 100%)"},children:[e.jsx("div",{className:"absolute inset-0 bg-grid-pattern opacity-[0.07]","aria-hidden":"true"}),e.jsx("div",{className:"absolute inset-0 z-20 pointer-events-none",style:{boxShadow:"inset 0 0 140px 50px rgba(0,0,0,0.75)"},"aria-hidden":"true"}),e.jsxs("div",{className:"relative mx-auto flex w-full max-w-12xl items-stretch px-0 py-6 md:py-0",children:[e.jsx("button",{onClick:()=>V((y-1+l.length)%l.length),className:"group relative z-10 hidden w-[11%] h-[80%] shrink-0 md:block",title:T==null?void 0:T.title,children:e.jsxs("div",{className:"aspect-[1/3] w-full overflow-hidden border border-white/[0.06] bg-white/[0.03]",children:[O&&e.jsx("img",{src:O,alt:"",onError:o=>{o.target.style.display="none"},className:"absolute inset-0 h-full w-full object-cover opacity-40 transition-opacity group-hover:opacity-65"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-black/60 via-black/10 to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2",children:e.jsx("p",{className:"truncate text-center font-mono text-[9px] uppercase tracking-eyebrow text-white/50",children:T==null?void 0:T.title})})]})}),e.jsx("div",{className:"relative z-10 hidden flex-1 overflow-hidden md:block","aria-hidden":"true",children:e.jsx("div",{className:"h-full w-full",style:{clipPath:"polygon(0 0%, 100% 0%, 100% 86%, 0 100%)"},children:e.jsx("img",{src:se,alt:"",className:"absolute inset-0 h-full w-full object-cover blur-xl scale-125 opacity-30"})})}),e.jsx("div",{className:"relative z-20 flex h-[98%] w-[50%] shrink-0 flex-col",children:e.jsxs("div",{className:"aspect-video max-h-[70vh] w-full overflow-hidden border border-white/[0.08]",style:{boxShadow:"0 0 70px -10px rgba(0,0,0,0.5)"},children:[re?e.jsx("video",{ref:o=>{U.current=o},src:ue,autoPlay:!0,muted:z,playsInline:!0,onEnded:ke,className:"absolute inset-0 h-full w-full object-cover animate-rise-in"},ue):e.jsx("img",{src:ue,alt:(I==null?void 0:I.title)??"",className:"absolute inset-0 h-full w-full object-cover animate-rise-in"},ue),re&&e.jsx("button",{onClick:ie,className:"absolute bottom-2 right-2 z-30 flex h-8 w-8 items-center justify-center border border-white/30 bg-black/55 text-white/80 hover:border-white hover:text-white",title:z?"Unmute":"Mute",children:z?e.jsxs("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"}),e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2"})]}):e.jsx("svg",{className:"h-3.5 w-3.5",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})})]})}),e.jsx("div",{className:"relative z-10 hidden flex-1 overflow-hidden md:block","aria-hidden":"true",children:e.jsx("div",{className:"h-full w-full",style:{clipPath:"polygon(0 0%, 100% 0%, 100% 100%, 0 86%)"},children:e.jsx("img",{src:se,alt:"",className:"absolute inset-0 h-full w-full object-cover blur-xl scale-125 opacity-30"})})}),e.jsx("button",{onClick:()=>V((y+1)%l.length),className:"group relative z-10 hidden w-[11%]  h-[80%] shrink-0 md:block",title:D==null?void 0:D.title,children:e.jsxs("div",{className:"aspect-[1/3] w-full overflow-hidden border border-white/[0.06] bg-white/[0.03]",children:[d&&e.jsx("img",{src:d,alt:"",onError:o=>{o.target.style.display="none"},className:"absolute inset-0 h-full w-full object-cover opacity-40 transition-opacity group-hover:opacity-65"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-l from-black/60 via-black/10 to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2",children:e.jsx("p",{className:"truncate text-center font-mono text-[9px] uppercase tracking-eyebrow text-white/50",children:D==null?void 0:D.title})})]})})]})]}),e.jsxs("section",{className:"shell pt-10 md:pt-0",children:[e.jsxs("div",{className:"flex items-center justify-between gap-2 mb-2 py-2 md:mb-4",children:[e.jsxs("div",{className:"flex items-baseline gap-3 min-w-0",children:[e.jsx("p",{className:"text-sm font-bold text-ink truncate",children:I==null?void 0:I.title}),e.jsxs("p",{className:"eyebrow shrink-0",children:[I==null?void 0:I.type," · ",I==null?void 0:I.year]})]}),e.jsxs("div",{className:"flex items-center gap-3 shrink-0",children:[Y.length>1&&Y.map((o,n)=>e.jsx("button",{onClick:()=>B(n),"aria-label":`Media ${n+1}`,className:`h-1.5 rounded-full transition-all duration-300 ${n===P?"w-6 bg-accent":"w-1.5 bg-rule hover:bg-ink-3"}`},n)),e.jsx("button",{onClick:ze,className:"btn-ghost shrink-0 !px-2",title:"Roll a random project",children:e.jsx("span",{className:"h-5 w-5",style:{perspective:"120px"},children:e.jsxs("span",{className:"relative block h-full w-full transition-transform duration-[900ms] ease-out",style:{transform:`rotateX(${we.x}deg) rotateY(${we.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx(fe,{value:1,transform:"translateZ(10px)"}),e.jsx(fe,{value:6,transform:"rotateY(180deg) translateZ(10px)"}),e.jsx(fe,{value:3,transform:"rotateY(-90deg) translateZ(10px)"}),e.jsx(fe,{value:4,transform:"rotateY(90deg) translateZ(10px)"}),e.jsx(fe,{value:2,transform:"rotateX(90deg) translateZ(10px)"}),e.jsx(fe,{value:5,transform:"rotateX(-90deg) translateZ(10px)"})]})})})]})]}),e.jsx("div",{className:"mt-4 -mx-1 flex overflow-x-auto hide-scrollbar border-b border-rule",children:Rt.map(o=>{const n=t===o.key;return e.jsxs("button",{onClick:()=>b(o.key),"aria-pressed":n,className:`relative shrink-0 px-3.5 pb-3 pt-1 font-mono text-[11px] uppercase tracking-eyebrow transition-colors duration-200 ${n?"text-ink":"text-ink-3 hover:text-ink"}`,children:[o.label,e.jsx("span",{className:"ml-1.5 nums-tabular text-ink-3",children:i(o.key)}),e.jsx("span",{className:`absolute inset-x-2 bottom-0 h-[3px] origin-left bg-accent transition-transform duration-300 ease-editorial ${n?"scale-x-100":"scale-x-0"}`,"aria-hidden":"true"})]},o.key)})}),e.jsxs("div",{className:"mt-5 flex items-center gap-2",children:[e.jsx("button",{onClick:()=>V(Math.max(0,y-1)),disabled:y<=0,"aria-label":"Previous project",className:"icon-btn shrink-0 disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(on,{})}),e.jsx("div",{ref:Fe,className:"flex flex-1 gap-2 overflow-x-auto hide-scrollbar py-2",children:l.map((o,n)=>{const r=n===y;return e.jsxs("button",{onClick:()=>V(n),className:`group flex shrink-0 items-center gap-3 border px-3 py-2.5 transition-all duration-200 ${r?"border-rule-strong bg-surface shadow-lift":"border-rule bg-surface-2 hover:border-rule-strong hover:bg-surface"}`,style:{minWidth:"220px",maxWidth:"280px"},children:[e.jsx("span",{className:`nums-tabular text-lg font-bold leading-none tracking-masthead transition-colors ${r?"text-accent-text":"text-ink-3/60 group-hover:text-ink-3"}`,children:String(n+1).padStart(2,"0")}),e.jsx("div",{className:"h-10 w-10 shrink-0 overflow-hidden border border-rule bg-surface-2",children:e.jsx("img",{src:o.details.logo,alt:"",className:"h-full w-full object-cover"})}),e.jsxs("div",{className:"min-w-0 text-left",children:[e.jsx("p",{className:"truncate text-sm font-bold tracking-tight text-ink",children:o.title}),e.jsxs("p",{className:"eyebrow",children:[o.type," · ",o.year]})]})]},`${o.type}-${o.slug}`)})}),e.jsx("button",{onClick:()=>V(Math.min(f,y+1)),disabled:y>=f,"aria-label":"Next project",className:"icon-btn shrink-0 disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(ln,{})})]}),e.jsxs("div",{className:"mt-2 flex items-center justify-between",children:[e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(y+1).padStart(2,"0"),e.jsx("span",{className:"mx-1.5 text-rule",children:"/"}),String(l.length).padStart(2,"0")]}),e.jsx(ae,{to:`/${I==null?void 0:I.type}/${I==null?void 0:I.slug}`,className:"font-mono text-[11px] uppercase tracking-eyebrow text-accent-text transition-colors hover:text-ink",children:"View details →"})]})]}),e.jsx("section",{className:"shell border-t border-rule py-10 md:py-0",children:e.jsxs("div",{className:"max-w-12xl",children:[e.jsx("p",{className:"mt-4 max-w-3xl text-lg text-ink",children:"你好！我是林丽丽，欢迎来到我的作品集。"}),e.jsx("p",{className:"mt-4 max-w-measure text-base leading-relaxed text-ink-2",children:sn[t]??sn.all})]})}),e.jsxs("section",{className:"shell pt-12 md:pt-16",children:[e.jsxs("div",{className:"section-head",children:[e.jsx("p",{className:"eyebrow",children:"Motion"}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(Q+1).padStart(2,"0"),e.jsx("span",{className:"mx-1.5 text-rule",children:"/"}),String(Ze.length).padStart(2,"0")]})]}),e.jsxs("div",{className:"mt-5 flex items-end justify-between gap-4",children:[e.jsx("h2",{className:"text-display-sm",children:"Video Gallery"}),e.jsxs("div",{className:"flex shrink-0 gap-2",children:[e.jsx("button",{onClick:()=>le(-1),disabled:he.start,"aria-label":"Scroll gallery left",className:"icon-btn disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(on,{})}),e.jsx("button",{onClick:()=>le(1),disabled:he.end,"aria-label":"Scroll gallery right",className:"icon-btn disabled:cursor-not-allowed disabled:opacity-30",children:e.jsx(ln,{})})]})]}),e.jsx("div",{ref:ne,onScroll:oe,className:"mt-6 flex snap-x snap-mandatory gap-3 overflow-x-auto hide-scrollbar scroll-smooth md:gap-4",children:Ze.map((o,n)=>{const r=n===Q;return e.jsxs("figure",{className:`group relative w-[62%] shrink-0 snap-start sm:w-[40%] md:w-[30%] lg:w-[23%] ${r?"ring-1 ring-accent ring-offset-2 ring-offset-canvas":""}`,onMouseEnter:m=>{const h=m.currentTarget.querySelector("video");h&&!r&&h.play().catch(()=>{})},onMouseLeave:m=>{const h=m.currentTarget.querySelector("video");h&&!r&&h.pause()},children:[e.jsxs("div",{className:"relative aspect-[9/16] overflow-hidden border border-rule bg-surface-2",children:[e.jsx("video",{ref:m=>{Se.current[n]=m},className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105",src:o.src,muted:!0,playsInline:!0,preload:"metadata",onCanPlay:m=>Ie(m.currentTarget,n),onEnded:()=>{r&&H(n+1)}}),r&&e.jsxs("span",{className:"absolute left-2 top-2 flex items-center gap-1 border border-white/30 bg-black/60 px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-eyebrow text-white",children:[e.jsx("span",{className:"h-1.5 w-1.5 rounded-full bg-accent animate-pulse"}),"Now"]}),Qe[n]&&e.jsx("span",{className:"absolute right-2 top-2 flex h-6 w-6 items-center justify-center bg-black/55 text-white",title:"Has audio",children:e.jsx("svg",{className:"h-3 w-3",fill:"none",stroke:"currentColor",strokeWidth:2,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"})]}),e.jsxs("figcaption",{className:"mt-2.5 flex items-baseline gap-2",children:[e.jsx("span",{className:"eyebrow nums-tabular shrink-0",children:String(n+1).padStart(2,"0")}),e.jsx("span",{className:"truncate text-sm text-ink-2",children:o.title})]})]},o.src)})})]})]})},zt=()=>typeof document<"u"&&document.documentElement.classList.contains("dark"),Ft=()=>{const[t,a]=s.useState(zt),p=()=>{const i=!t;a(i),document.documentElement.classList.toggle("dark",i);try{localStorage.setItem("theme",i?"dark":"light")}catch{}};return e.jsx("button",{onClick:p,className:"icon-btn","aria-label":t?"Switch to light theme":"Switch to dark theme",title:t?"切换到日间模式":"切换到夜间模式",children:t?e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"})}):e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"})})})},cn="https://pub-e0170f3fece2419a85fa1ce02c1f1a28.r2.dev/223_cities_cluster_with_index.zip",Ut="/data/223_cities_cluster_with_index_deciles.csv",xe=t=>{const a=t.replace("#",""),p=parseInt(a.slice(0,2),16),i=parseInt(a.slice(2,4),16),l=parseInt(a.slice(4,6),16);return[p,i,l]},be=(t,a,p)=>{const i=Math.round(t[0]+(a[0]-t[0])*p),l=Math.round(t[1]+(a[1]-t[1])*p),f=Math.round(t[2]+(a[2]-t[2])*p);return`rgb(${i}, ${l}, ${f})`},ye=[{key:"K_5",label:"Cluster K=5",category:"cluster",type:"number"},{key:"K_12",label:"Cluster K=12",category:"cluster",type:"number"},{key:"K_20",label:"Cluster K=20",category:"cluster",type:"number"},{key:"K_26",label:"Cluster K=26",category:"cluster",type:"number"},{key:"elev_mean",label:"Elevation Mean(m)",category:"terrain",type:"number"},{key:"elev_std",label:"Elevation Std(m)",category:"terrain",type:"number"},{key:"elev_range",label:"Elevation Range(m)",category:"terrain",type:"number"},{key:"slope_mean",label:"Slope Mean(°)",category:"terrain",type:"number"},{key:"slope_std",label:"Slope Std(N/A)",category:"terrain",type:"number"},{key:"slope_rang",label:"Slope Range(N/A)",category:"terrain",type:"number"},{key:"LandArea",label:"Land Area",category:"urban",type:"number"},{key:"Buiheight",label:"Building Height(m)",category:"urban",type:"number"},{key:"BldArea",label:"Building Area(m²)",category:"urban",type:"number"},{key:"CoverRatio",label:"Building Coverage",category:"urban",type:"number"},{key:"FAR",label:"Floor Area Ratio(N/A)",category:"urban",type:"number"},{key:"GreenArea",label:"Green Area(m²)",category:"urban",type:"number"},{key:"GrHeight",label:"Green Height(m)",category:"urban",type:"number"},{key:"GreenRatio",label:"Green Ratio(N/A)",category:"urban",type:"number"},{key:"GrVolRatio",label:"Green Volume Ratio(N/A)",category:"urban",type:"number"},{key:"ISF",label:"Impervious Surface Fraction(N/A)",category:"urban",type:"number"},{key:"MIN_DistWB",label:"Mini Distance to WaterBody(m)",category:"urban",type:"number"},{key:"MIN_DistGL",label:"Mini Distance to GreenLand(m)",category:"urban",type:"number"},{key:"MIN_DistMT",label:"Mini Distance to Mountain(m)",category:"urban",type:"number"}],Ot=()=>{var o;const t=s.useRef(null),a=s.useRef(null),[p,i]=s.useState(!0),[l,f]=s.useState(0),[y,u]=s.useState(null),[b,k]=s.useState(null),[N,T]=s.useState([]),[D,O]=s.useState(null),[d,P]=s.useState("K_12"),[B,z]=s.useState(!0),[_,U]=s.useState(null),[G,I]=s.useState(null),[Z,we]=s.useState(!1),[X,ze]=s.useState(null),[je,pe]=s.useState(!1),[Y,ue]=s.useState(null),[re,se]=s.useState(!1),[ke,ie]=s.useState(0),[Fe,V]=s.useState(""),[ne,Se]=s.useState(!1),[Q,Ue]=s.useState(!0),[Oe,Ce]=s.useState(!0),[he,We]=s.useState({}),[Qe,Xe]=s.useState(!1),[H,oe]=s.useState("global"),le=s.useRef(null),Ie=s.useRef(null),Ae=s.useRef(!1),te=s.useRef(null),De=(n,r)=>{let m=n.features;D!==null&&(m=m.filter(x=>{var g;const w=(g=x.properties)==null?void 0:g.Place;return w!==void 0&&Number(w)===Number(D)}));const h=m.map(x=>{var w;return(w=x.properties)==null?void 0:w[r]}).filter(x=>{if(x==null)return!1;if(typeof x=="string"){const g=x.trim();if(g===""||/^(na|nan|null)$/i.test(g))return!1}const w=Number(x);return!(Number.isNaN(w)||w===-9999)}).map(x=>Number(x)),M=m.reduce((x,w)=>{var C;const g=(C=w.properties)==null?void 0:C[r];let c=!1;if(g==null)c=!0;else if(typeof g=="string"){const A=g.trim();if(A===""||/^(na|nan|null)$/i.test(A))c=!0;else{const R=Number(g);(Number.isNaN(R)||R===-9999)&&(c=!0)}}else{const A=Number(g);(Number.isNaN(A)||A===-9999)&&(c=!0)}return x+(c?1:0)},0);let S=NaN,j=NaN,v=0;if(h.length>0){S=h[0],j=h[0],v=h[0];for(let x=1;x<h.length;x++){const w=h[x];w<S&&(S=w),w>j&&(j=w),v+=w}}return{count:m.length,min:S,max:j,mean:h.length>0?v/h.length:NaN,nanCount:M}};s.useEffect(()=>{(async()=>{try{const h=(await(await fetch(Ut)).text()).trim().split(`
`);if(h.length<2)return;const M=h[0].split(",").map(g=>g.trim()),S={},v=h[h.length-1].split(","),w=h[1].split(",");M.forEach((g,c)=>{if(g===""||g.includes("Place")||g.includes("Sum")||g.includes("FID")||g.includes("index"))return;const C=parseFloat(w[c]),A=parseFloat(v[c]);!isNaN(C)&&!isNaN(A)&&A>C&&(S[g]={min:C,max:A})}),console.log("Loaded attribute ranges:",S),We(S)}catch(r){console.error("Failed to load deciles:",r)}})()},[]),s.useEffect(()=>{!ne&&!b&&(async()=>{var r;i(!0),f(0),u(null);try{f(10),console.log("开始下载..."),le.current=new AbortController;const m=await fetch(cn,{signal:le.current.signal});if(console.log("响应状态:",m.status),!m.ok)throw new Error(`HTTP error! status: ${m.status}`);f(30);const h=m.headers.get("content-length"),M=h?parseInt(h):null;console.log("预期文件大小:",M);const S=(r=m.body)==null?void 0:r.getReader();if(!S)throw new Error("无法读取响应流");let j=0;const v=[];for(;;){const{done:R,value:L}=await S.read();if(R)break;v.push(L),j+=L.length,f(M?30+Math.round(j/M*60):50)}console.log("下载完成, 收到:",j),M&&j!==M&&console.log("警告: 文件大小不匹配 (可能压缩传输)");const x=new Uint8Array(j);let w=0;for(const R of v)x.set(R,w),w+=R.length;if(f(90),ne){console.log("本地数据已加载，跳过网络数据"),i(!1);return}console.log("开始解析 Shapefile...");const g=await Ye(x);console.log("Shapefile 解析完成:",g);let c=[];if(g.type==="FeatureCollection"?c=g.features:Array.isArray(g)?c=g:g.type==="Feature"&&(c=[g]),console.log("解析完成，特征数量:",c==null?void 0:c.length),ne)return;const C={type:"FeatureCollection",features:c||[]};k(C),f(100);const A=new Map;C.features.forEach(R=>{var J;const L=Number(((J=R.properties)==null?void 0:J.Place)??0);A.has(L)||A.set(L,{id:L,name:`Place ${L}`,featureCount:0});const $=A.get(L);$&&$.featureCount++}),T(Array.from(A.values()).sort((R,L)=>R.id-L.id)),i(!1)}catch(m){if(m.name==="AbortError"){console.log("网络请求已取消");return}u(m instanceof Error?m.message:"Failed to load"),i(!1)}})()},[]),s.useEffect(()=>{b&&U(De(b,d))},[b,D,d,H,he]),s.useEffect(()=>{if(!b)return;const n=a.current;if(!n)return;const r=()=>{var h,M,S,j;if(b.features.forEach((v,x)=>{v.id===void 0&&(v.id=x)}),n.getSource("cluster"))n.getSource("cluster").setData(b);else{console.log("初始化 cluster 数据源..."),n.addSource("cluster",{type:"geojson",data:b,generateId:!0}),n.addLayer({id:"cluster-fill",type:"fill",source:"cluster",layout:{},paint:{"fill-opacity":.7}}),n.addLayer({id:"cluster-line",type:"line",source:"cluster",layout:{},paint:{"line-color":"#7e7f80ff","line-width":1}}),n.addLayer({id:"cluster-highlight",type:"line",source:"cluster",layout:{},paint:{"line-color":"#632ffdff","line-width":3,"line-opacity":["case",["boolean",["feature-state","selected"],!1],1,0]}}),n.on("click","cluster-fill",x=>{var w;if(x.features&&x.features.length>0){const g=x.features[0],c=g.id;te.current!==null&&te.current!==void 0&&n.setFeatureState({source:"cluster",id:te.current},{selected:!1}),c!==void 0?(n.setFeatureState({source:"cluster",id:c},{selected:!0}),te.current=c):te.current=null,ze(g),pe(!0),((w=g.properties)==null?void 0:w.Place)!==void 0&&O(Number(g.properties.Place))}}),n.on("mouseenter","cluster-fill",()=>{n.getCanvas().style.cursor="pointer"}),n.on("mouseleave","cluster-fill",()=>{n.getCanvas().style.cursor=""});const v=b.features;if(v.length>0)try{const x=new Pe.LngLatBounds,w=Math.max(1,Math.floor(v.length/2e3));for(let g=0;g<v.length;g+=w){const c=v[g];if(!((h=c.geometry)!=null&&h.coordinates))continue;const C=c.geometry.type,A=c.geometry.coordinates;C==="Point"?x.extend(A):C==="LineString"||C==="MultiPoint"?A.forEach(R=>x.extend(R)):C==="Polygon"||C==="MultiLineString"?(M=A[0])==null||M.forEach(R=>x.extend(R)):C==="MultiPolygon"&&((j=(S=A[0])==null?void 0:S[0])==null||j.forEach(R=>x.extend(R)))}x.isEmpty()||n.fitBounds(x,{padding:50,duration:1e3})}catch(x){console.error("Fit bounds error:",x)}}},m=()=>{var L;if(!n.getLayer("cluster-fill"))return;const h=null;n.setFilter("cluster-fill",h),n.setFilter("cluster-line",h),n.setFilter("cluster-highlight",h);const M=(()=>{var Ve;let $=1/0,J=-1/0;for(const He of b.features){const ee=Number((Ve=He.properties)==null?void 0:Ve[d]);Number.isNaN(ee)||ee===-9999||(ee<$&&($=ee),ee>J&&(J=ee))}return{min:$===1/0?0:$,max:J===-1/0?0:J}})(),S=D!==null&&_?{min:_.min,max:_.max}:M,j=H==="city"?S:M,v=j.min,x=j.max;let w;if(d.includes("K_")){const $=Math.round(((L=he[d])==null?void 0:L.max)??x),J=Array.from({length:26},(ge,$e)=>{const K=$e/25;let ce,de,me;if(K<.167){const q=K/.167;ce=0,de=0,me=Math.round(139+116*q)}else if(K<.333){const q=(K-.167)/.167;ce=0,de=Math.round(255*q),me=255}else if(K<.5){const q=(K-.333)/.167;ce=0,de=Math.round(255-128*q),me=Math.round(255-255*q)}else if(K<.667){const q=(K-.5)/.167;ce=Math.round(255*q),de=255,me=0}else if(K<.833){const q=(K-.667)/.167;ce=255,de=Math.round(255-128*q),me=0}else{const q=(K-.833)/.167;ce=255,de=Math.round(127-127*q),me=0}return`#${ce.toString(16).padStart(2,"0")}${de.toString(16).padStart(2,"0")}${me.toString(16).padStart(2,"0")}`}),He=Array.from({length:$+1},(ge,$e)=>J[Math.round($e*25/$)]).slice(0,$+1),ee=["interpolate",["linear"],["get",d]];for(let ge=0;ge<=$;ge++)ee.push(ge,He[ge]);w=ee}else d==="CoverRatio"||d==="ISF"||d==="GreenRatio"?w=["interpolate",["linear"],["get",d],v,"#3182bd",x,"#e6550d"]:d.includes("elev")||d.includes("slope")?w=["interpolate",["linear"],["get",d],v,"#31a354",x,"#756bb1"]:w=["interpolate",["linear"],["get",d],v,"#31a354",x,"#756bb1"];n.setPaintProperty("cluster-fill","fill-color",w);const g=D!==null,c=Number(D),R=["case",["any",["==",["get",d],-9999],["==",["get",d],null]],0,g?["case",["==",["to-number",["get","Place"]],c],.8,.15]:.7];n.setPaintProperty("cluster-fill","fill-opacity",R)};n.isStyleLoaded()?(r(),m()):n.once("load",()=>{r(),m()})},[b,D,d]),s.useEffect(()=>{var m,h,M,S;if(!b||D===null)return;const n=a.current;if(!n)return;const r=b.features.filter(j=>{var x;const v=(x=j.properties)==null?void 0:x.Place;return v!==void 0&&Number(v)===Number(D)});if(r.length!==0)try{const j=new Pe.LngLatBounds;let v=0;const x=Math.max(1,Math.floor(r.length/2e3));for(let w=0;w<r.length;w+=x){const g=r[w];if(!((m=g.geometry)!=null&&m.coordinates))continue;const c=g.geometry.type,C=g.geometry.coordinates;c==="Point"?(j.extend(C),v++):c==="LineString"||c==="MultiPoint"?(C.forEach(A=>j.extend(A)),v++):c==="Polygon"||c==="MultiLineString"?((h=C[0])==null||h.forEach(A=>j.extend(A)),v++):c==="MultiPolygon"&&((S=(M=C[0])==null?void 0:M[0])==null||S.forEach(A=>j.extend(A)),v++)}!j.isEmpty()&&v>0&&n.fitBounds(j,{padding:50,duration:1e3})}catch(j){console.error("Fly to error:",j)}},[D]),s.useEffect(()=>((async()=>{(!t.current||a.current)&&console.log("开始初始化地图...");try{const r=new Pe.Map({container:t.current,style:{version:8,sources:{"osm-tiles":{type:"raster",tiles:["https://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png"],tileSize:256,attribution:'&copy; <a href="https://carto.com/">CARTO</a>'}},layers:[{id:"simple-tiles",type:"raster",source:"osm-tiles",minzoom:0,maxzoom:19}]},center:[4.75,45.75],zoom:10});r.addControl(new Pe.NavigationControl,"top-right"),r.on("load",()=>{console.log("地图样式加载完成")}),r.on("error",m=>{var S;const h=String(((S=m==null?void 0:m.error)==null?void 0:S.message)||(m==null?void 0:m.message)||"");h.includes("ERR_ABORTED")||h.includes("AbortError")||h.includes("Canceled")||h.includes("cancelled")||console.error("地图错误:",m)}),a.current=r,console.log("地图初始化完成")}catch(r){console.error("地图初始化错误:",r)}})(),()=>{a.current&&(a.current.remove(),a.current=null,Ae.current=!1)}),[]),s.useEffect(()=>{const n=a.current;if(!n)return;const r=()=>{n.getLayer("simple-tiles")&&n.setLayoutProperty("simple-tiles","visibility",Q?"visible":"none")};n.isStyleLoaded()?r():n.once("style.load",r)},[Q]);const Le=async n=>{var m;const r=(m=n.target.files)==null?void 0:m[0];if(r){le.current&&le.current.abort(),se(!0),ie(0),V("正在读取文件..."),u(null),we(!0),I(URL.createObjectURL(r));try{console.log("开始读取文件:",r.name,"大小:",r.size);let h=[];const M=r.name.endsWith(".zip"),S=r.name.endsWith(".shp");if(!M&&!S){u("请上传 .zip 文件 (包含 Shapefile)"),se(!1);return}V("正在读取文件...");const j=await r.arrayBuffer();ie(30),V("正在解析 Shapefile...");const v=await Ye(j);console.log("Shapefile 解析完成:",v),v.type==="FeatureCollection"?h=v.features:Array.isArray(v)?h=v:v.type==="Feature"&&(h=[v]),console.log("解析到的 features 数量:",h.length),ie(95),V(`已解析 ${h.length} 个 Features...`);const x={type:"FeatureCollection",features:h};ie(98),V("正在处理 Place 数据...");const w=new Map;x.features.forEach(g=>{var A;const c=Number(((A=g.properties)==null?void 0:A.Place)??0);w.has(c)||w.set(c,{id:c,name:`Place ${c}`,featureCount:0});const C=w.get(c);C&&C.featureCount++}),ie(100),V("加载完成!"),setTimeout(()=>{Se(!0),k(x),T(Array.from(w.values()).sort((g,c)=>g.id-c.id)),se(!1),we(!1),i(!1)},500)}catch(h){const M=h instanceof Error?h.message:"未知错误";u(`加载失败: ${M}`),se(!1),i(!1)}}},Ee=ye.reduce((n,r)=>(n[r.category]||(n[r.category]=[]),n[r.category].push(r),n),{});return e.jsxs("div",{className:"relative w-full h-full bg-gray-100",children:[re&&e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-8 w-80 text-center",children:[e.jsxs("div",{className:"relative w-20 h-20 mx-auto mb-4",children:[e.jsx("div",{className:"absolute inset-0 border-4 border-gray-100 rounded-full"}),e.jsx("div",{className:"absolute inset-0 border-4 border-purple-600 rounded-full border-t-transparent animate-spin"}),e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx(Je,{className:"text-purple-600",size:24})})]}),e.jsx("p",{className:"text-gray-800 font-medium mb-3",children:Fe}),e.jsx("div",{className:"w-full bg-gray-100 rounded-full h-3 mb-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-purple-500 to-purple-600 transition-all duration-300",style:{width:`${ke}%`}})}),e.jsxs("p",{className:"text-sm text-gray-400",children:[ke,"%"]})]})}),p&&!re?e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(jn,{className:"animate-spin h-12 w-12 text-purple-600 mx-auto mb-4"}),e.jsx("p",{className:"text-gray-600",children:"正在加载 Shapefile..."}),e.jsx("div",{className:"w-48 h-2 bg-gray-200 rounded-full mx-auto mt-3 overflow-hidden",children:e.jsx("div",{className:"h-full bg-purple-600 transition-all duration-300",style:{width:`${l}%`}})}),e.jsxs("p",{className:"text-xs text-gray-400 mt-2",children:[l,"%"]}),e.jsxs("div",{className:"flex gap-2 mt-4 justify-center",children:[e.jsxs("a",{href:cn,download:"223_cities_cluster_with_index.zip",className:"inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:[e.jsx(kn,{size:14}),"下载本地"]}),e.jsxs("button",{onClick:()=>{var n;return(n=Ie.current)==null?void 0:n.click()},className:"inline-flex items-center gap-2 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded-lg text-sm transition-colors",title:"支持 .zip (Shapefile)",children:[e.jsx(Je,{size:14}),"加载 Shapefile"]})]}),e.jsx("p",{className:"text-xs text-gray-400 mt-2",children:"支持 .zip (Shapefile)"}),e.jsx("input",{ref:Ie,type:"file",accept:".shp,.zip",onChange:Le,className:"hidden"})]})}):null,y&&e.jsxs("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-red-50 border border-red-200 rounded-xl px-6 py-5 shadow-lg",children:[e.jsx("p",{className:"text-red-600 font-medium",children:"加载失败"}),e.jsx("p",{className:"text-red-400 text-sm mt-1 mb-4",children:y}),e.jsx("div",{className:"flex gap-2",children:e.jsxs("button",{onClick:()=>window.location.reload(),className:"inline-flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-sm transition-colors",children:[e.jsx(Nn,{size:14}),"刷新重试"]})})]}),B&&e.jsxs("div",{className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-72",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("h2",{className:"font-bold text-gray-800 flex items-center gap-2",children:[e.jsx(Mn,{size:18}),"Cluster Map"]}),e.jsx("button",{onClick:()=>z(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(Sn,{size:18})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("span",{className:"text-sm text-gray-600",children:"显示地图底图"}),e.jsx("button",{onClick:()=>Ue(!Q),className:`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${Q?"bg-purple-600":"bg-gray-300"}`,children:e.jsx("span",{className:`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${Q?"translate-x-6":"translate-x-1"}`})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Place (Count)"}),e.jsxs("select",{value:D??"",onChange:n=>O(n.target.value?Number(n.target.value):null),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:[e.jsxs("option",{value:"",children:["All Places (",((o=b==null?void 0:b.features)==null?void 0:o.length)??0,")"]}),N.map(n=>e.jsxs("option",{value:n.id,children:[n.name," (",n.featureCount,")"]},n.id))]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Attribute"}),e.jsx("select",{value:d,onChange:n=>P(n.target.value),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:Object.entries(Ee).map(([n,r])=>[e.jsx("optgroup",{label:n.charAt(0).toUpperCase()+n.slice(1),children:r.map(m=>e.jsx("option",{value:m.key,children:m.label},m.key))},n)])})]}),_&&e.jsxs("div",{className:"bg-gray-50 rounded-lg p-3 space-y-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(Cn,{size:14,className:"text-purple-500"}),e.jsx("span",{className:"text-xs font-medium text-gray-500",children:"Statistics"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-xs",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Count:"})," ",e.jsx("span",{className:"font-medium",children:_.count})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Min:"})," ",e.jsx("span",{className:"font-medium",children:_.min.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Max:"})," ",e.jsx("span",{className:"font-medium",children:_.max.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Mean:"})," ",e.jsx("span",{className:"font-medium",children:_.mean.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"NaN:"})," ",e.jsx("span",{className:"font-medium",children:_.nanCount})]})]})]})]})]}),!B&&e.jsx("button",{onClick:()=>z(!0),className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(In,{size:18})}),je&&X&&e.jsxs("div",{className:"absolute top-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-80 max-h-96 overflow-y-auto",children:[e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-medium text-gray-400 uppercase tracking-wider mb-1",children:"Feature Details"}),e.jsxs("div",{className:"mb-3",children:[X.properties.Place&&e.jsxs("div",{className:"text-lg font-semibold text-purple-600",children:["Place: ",X.properties.Place]}),X.properties["City Name"]&&e.jsxs("div",{className:"text-sm font-medium text-gray-700",children:["City: ",X.properties["City Name"]]}),e.jsxs("div",{className:"text-sm font-medium text-gray-500",children:["Place ID: ",X.properties["Place ID"]??"N/A"]})]})]}),e.jsx("button",{onClick:()=>pe(!1),className:"p-1 hover:bg-gray-100 rounded-full transition-colors",children:e.jsx(en,{size:20,className:"text-gray-400"})})]}),e.jsx("div",{className:"space-y-2",children:ye.map(n=>{var m;const r=(m=X.properties)==null?void 0:m[n.key];return r==null?null:e.jsxs("button",{onClick:()=>P(n.key),className:`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${d===n.key?"bg-purple-100 text-purple-700":"bg-gray-50 text-gray-600 hover:bg-gray-100"}`,children:[e.jsx("span",{children:n.label}),e.jsx("span",{className:"font-mono font-medium",children:typeof r=="number"?r.toFixed(2):r})]},n.key)})}),e.jsx("div",{className:"mt-3 pt-3 border-t border-gray-200",children:e.jsx("button",{onClick:()=>O(null),className:"w-full px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:"显示全部区域"})})]}),e.jsx("div",{ref:t,className:"w-full h-full"}),Oe&&b&&e.jsxs("div",{className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-64",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("h3",{className:"font-semibold text-gray-800 flex items-center gap-2",children:[e.jsx(nn,{size:16}),"Legend"]}),e.jsx("button",{onClick:()=>Ce(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(en,{size:16})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"颜色映射"}),e.jsx("button",{onClick:()=>oe(H==="global"?"city":"global"),className:`text-xs px-2 py-1 rounded ${H==="global"?"bg-gray-200 text-gray-700":"bg-purple-100 text-purple-700"}`,children:H==="global"?"全局":"城市"})]}),e.jsx("div",{className:"space-y-3",children:d.includes("K_")?(()=>{var h,M;const n=Math.round(((h=he[d])==null?void 0:h.max)??30),r=Array.from({length:26},(S,j)=>{const v=j/25;let x,w,g;if(v<.167){const c=v/.167;x=0,w=0,g=Math.round(139+116*c)}else if(v<.333){const c=(v-.167)/.167;x=0,w=Math.round(255*c),g=255}else if(v<.5){const c=(v-.333)/.167;x=0,w=Math.round(255-128*c),g=Math.round(255-255*c)}else if(v<.667){const c=(v-.5)/.167;x=Math.round(255*c),w=255,g=0}else if(v<.833){const c=(v-.667)/.167;x=255,w=Math.round(255-128*c),g=0}else{const c=(v-.833)/.167;x=255,w=Math.round(127-127*c),g=0}return`#${x.toString(16).padStart(2,"0")}${w.toString(16).padStart(2,"0")}${g.toString(16).padStart(2,"0")}`}),m=Array.from({length:n+1},(S,j)=>r[Math.round(j*25/n)]);return e.jsxs("div",{children:[e.jsx("div",{className:"text-xs text-gray-500 mb-2",children:((M=ye.find(S=>S.key===d))==null?void 0:M.label)||d}),e.jsx("div",{className:"flex flex-wrap gap-px",children:m.map((S,j)=>e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("div",{className:"w-3 h-3 rounded-sm",style:{backgroundColor:S}}),e.jsx("span",{className:"text-[6px] text-gray-400",children:j})]},j))})]})})():d==="CoverRatio"||d==="ISF"||d==="GreenRatio"?(()=>{var g;const n=(()=>{var A;let c=1/0,C=-1/0;for(const R of b.features){const L=Number((A=R.properties)==null?void 0:A[d]);Number.isNaN(L)||L===-9999||(L<c&&(c=L),L>C&&(C=L))}return{min:c===1/0?0:c,max:C===-1/0?0:C}})(),r=D!==null&&_?{min:_.min,max:_.max}:n,m=((g=ye.find(c=>c.key===d))==null?void 0:g.label)||d,h=n.max>n.min?Math.max(0,Math.min(1,(r.min-n.min)/(n.max-n.min))):0,M=n.max>n.min?Math.max(0,Math.min(1,(r.max-n.min)/(n.max-n.min))):0,S=Math.max(0,M-h),j=xe("#3182bd"),v=xe("#e6550d"),x=be(j,v,h),w=be(j,v,M);return e.jsxs("div",{children:[H==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[m,"（城市区间）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,130,189,0.2), rgba(230,85,13,0.2))"},children:D!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${h*100}%`,width:`${S*100}%`,background:`linear-gradient(to right, ${x}, ${w})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:r.min.toFixed(2)}),e.jsx("span",{children:r.max.toFixed(2)})]})]}),H==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[m,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #3182bd, #e6550d)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:n.min.toFixed(2)}),e.jsx("span",{children:n.max.toFixed(2)})]})]})]})})():d.includes("elev")||d.includes("slope")?(()=>{var g;const n=(()=>{var A;let c=1/0,C=-1/0;for(const R of b.features){const L=Number((A=R.properties)==null?void 0:A[d]);Number.isNaN(L)||L===-9999||(L<c&&(c=L),L>C&&(C=L))}return{min:c===1/0?0:c,max:C===-1/0?0:C}})(),r=D!==null&&_?{min:_.min,max:_.max}:n,m=((g=ye.find(c=>c.key===d))==null?void 0:g.label)||d,h=n.max>n.min?Math.max(0,Math.min(1,(r.min-n.min)/(n.max-n.min))):0,M=n.max>n.min?Math.max(0,Math.min(1,(r.max-n.min)/(n.max-n.min))):0,S=Math.max(0,M-h),j=xe("#31a354"),v=xe("#756bb1"),x=be(j,v,h),w=be(j,v,M);return e.jsxs("div",{children:[H==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[m,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:D!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${h*100}%`,width:`${S*100}%`,background:`linear-gradient(to right, ${x}, ${w})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:r.min.toFixed(1)}),e.jsxs("span",{children:[r.max.toFixed(0),"+"]})]})]}),H==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[m,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:n.min.toFixed(1)}),e.jsxs("span",{children:[n.max.toFixed(0),"+"]})]})]})]})})():(()=>{var g;const n=(()=>{var A;let c=1/0,C=-1/0;for(const R of b.features){const L=Number((A=R.properties)==null?void 0:A[d]);Number.isNaN(L)||L===-9999||(L<c&&(c=L),L>C&&(C=L))}return{min:c===1/0?0:c,max:C===-1/0?0:C}})(),r=D!==null&&_?{min:_.min,max:_.max}:n,m=((g=ye.find(c=>c.key===d))==null?void 0:g.label)||d,h=n.max>n.min?Math.max(0,Math.min(1,(r.min-n.min)/(n.max-n.min))):0,M=n.max>n.min?Math.max(0,Math.min(1,(r.max-n.min)/(n.max-n.min))):0,S=Math.max(0,M-h),j=xe("#31a354"),v=xe("#756bb1"),x=be(j,v,h),w=be(j,v,M);return e.jsxs("div",{children:[H==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[m,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:D!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${h*100}%`,width:`${S*100}%`,background:`linear-gradient(to right, ${x}, ${w})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:r.min.toFixed(2)}),e.jsx("span",{children:r.max.toFixed(2)})]})]}),H==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[m,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:n.min.toFixed(2)}),e.jsx("span",{children:n.max.toFixed(2)})]})]})]})})()})]}),!Oe&&e.jsx("button",{onClick:()=>Ce(!0),className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(nn,{size:18})})]})},Wt=[{key:"",label:"Home"},{key:"product",label:"Product"},{key:"game",label:"Game"},{key:"planning",label:"Planning"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"},{key:"about",label:"About"}],Vt={1:[4],2:[0,8],3:[0,4,8],4:[0,2,6,8],5:[0,2,4,6,8],6:[0,2,3,5,6,8]},ve=({value:t,transform:a})=>e.jsx("div",{className:"absolute inset-0 grid grid-cols-3 grid-rows-3 border border-neutral-400 bg-white p-[2px]",style:{transform:a,backfaceVisibility:"hidden"},children:Array.from({length:9}).map((p,i)=>e.jsx("span",{className:"flex items-center justify-center",children:Vt[t].includes(i)&&e.jsx("span",{className:"block h-[2.5px] w-[2.5px] rounded-full",style:{background:t===1||t===4?"#cc2a18":"#171717"}})},i))}),Ht=()=>{const[t,a]=s.useState(!1),[p,i]=s.useState(!1),[l,f]=s.useState({x:0,y:0}),[y,u]=s.useState("/data/fig/lili/lili_01.png"),[b,k]=s.useState("Exploring the intersection of technology and creativity."),N=un(),T=hn(),O=N.pathname.split("/").filter(Boolean)[0]||"",d={product:"/data/fig/lili/lili_05.png",game:"/data/fig/lili/lili_03.png",platform:"/data/fig/lili/lili_11.png",tutorial:"/data/fig/lili/lili_04.png",about:"/data/fig/lili/lili_02.png",planning:"/data/fig/lili/lili_06.png"},P=["/data/fig/lili/lili_01.png","/data/fig/lili/lili_07.png","/data/fig/lili/lili_08.png","/data/fig/lili/lili_09.png","/data/fig/lili/lili_10.png","/data/fig/lili/lili_12.png"],B=["Exploring the intersection of technology and creativity.","Turning data into meaningful visual stories.","Building digital experiences that inspire.","Bridging the gap between product and development.","Creating solutions that matter in the real world.","Passionate about geospatial technology and urban planning."],z=U=>U[Math.floor(Math.random()*U.length)];s.useEffect(()=>{u(d[O]??z(P)),k(z(B))},[O]);const _=()=>{f(G=>({x:G.x+720+Math.round(Math.random()*360),y:G.y+720+Math.round(Math.random()*360)}));const U=["product","game","planning","platform","tutorial","about"];setTimeout(()=>T(`/${z(U)}`),900)};return e.jsxs("div",{className:"flex h-screen flex-col bg-canvas text-ink",children:[e.jsx("header",{className:`relative z-30 shrink-0 border-b border-rule bg-surface/85 backdrop-blur transition-all duration-300 ease-editorial ${p?"h-0 border-b-0 overflow-hidden opacity-0":""}`,children:e.jsxs("div",{className:"shell flex h-16 items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{onClick:()=>a(!t),className:"icon-btn","aria-expanded":t,"aria-label":t?"Hide profile panel":"Show profile panel",title:t?"Hide profile panel":"Show profile panel",children:e.jsxs("span",{className:"flex flex-col items-center justify-center gap-[3px]","aria-hidden":"true",children:[e.jsx("span",{className:"block h-px w-4 bg-current transition-transform duration-300"}),e.jsx("span",{className:`block h-px w-4 bg-current transition-opacity duration-300 ${t?"opacity-0":"opacity-100"}`}),e.jsx("span",{className:"block h-px w-4 bg-current transition-transform duration-300"})]})}),e.jsxs(ae,{to:"/",className:"group flex min-w-0 items-baseline gap-2.5",children:[e.jsx("span",{className:"truncate text-lg font-bold tracking-masthead md:text-xl",children:"Lili Lin"}),e.jsx("span",{className:"hidden h-3 w-px bg-rule sm:block","aria-hidden":"true"}),e.jsx("span",{className:"hidden font-mono text-[11px] uppercase tracking-eyebrow text-ink-3 transition-colors group-hover:text-accent-text sm:block",children:"Portfolio"})]})]}),e.jsx("nav",{className:"-mx-1 flex min-w-0 flex-1 justify-end overflow-x-auto hide-scrollbar",children:e.jsx("ul",{className:"flex shrink-0 items-stretch",children:Wt.map(U=>{const G=O===U.key;return e.jsx("li",{className:"flex",children:e.jsxs(ae,{to:`/${U.key}`,onClick:()=>{window.innerWidth<768&&a(!1)},"aria-current":G?"page":void 0,className:`relative flex items-center px-3 text-sm font-medium transition-colors duration-200 md:px-4 ${G?"text-ink":"text-ink-3 hover:text-ink"}`,children:[U.label,e.jsx("span",{className:`absolute inset-x-2 top-0 h-[3px] origin-left bg-accent transition-transform duration-300 ease-editorial md:inset-x-3 ${G?"scale-x-100":"scale-x-0"}`,"aria-hidden":"true"})]})},U.key||"home")})})}),e.jsxs("div",{className:"flex shrink-0 items-center gap-2",children:[e.jsx(Ft,{}),e.jsxs("button",{onClick:_,className:"btn-ghost hidden !px-3 sm:inline-flex",title:"Explore a random project",children:[e.jsx("span",{className:"h-5 w-5",style:{perspective:"120px"},children:e.jsxs("span",{className:"relative block h-full w-full transition-transform duration-[900ms] ease-out",style:{transform:`rotateX(${l.x}deg) rotateY(${l.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx(ve,{value:1,transform:"translateZ(10px)"}),e.jsx(ve,{value:6,transform:"rotateY(180deg) translateZ(10px)"}),e.jsx(ve,{value:3,transform:"rotateY(-90deg) translateZ(10px)"}),e.jsx(ve,{value:4,transform:"rotateY(90deg) translateZ(10px)"}),e.jsx(ve,{value:2,transform:"rotateX(90deg) translateZ(10px)"}),e.jsx(ve,{value:5,transform:"rotateX(-90deg) translateZ(10px)"})]})}),"Jump"]}),e.jsx("button",{onClick:()=>i(!0),className:"icon-btn hidden sm:inline-flex",title:"Collapse header","aria-label":"Collapse header",children:e.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M5 15l7-7 7 7"})})})]})]})}),p&&e.jsx("button",{onClick:()=>i(!1),className:"group flex h-4 w-full items-center justify-center bg-surface/50 hover:bg-surface transition-colors duration-200",title:"Expand header","aria-label":"Expand header",children:e.jsx("svg",{className:"h-3 w-3 text-ink-3 transition-colors group-hover:text-ink",fill:"none",stroke:"currentColor",strokeWidth:1.6,viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 9l-7 7-7-7"})})}),e.jsxs("main",{className:"relative flex min-h-0 flex-1 flex-row overflow-hidden",children:[t&&e.jsx("aside",{className:"z-20 h-full w-64 shrink-0 overflow-y-auto border-r border-rule bg-surface md:w-72",children:e.jsxs("div",{className:"flex flex-col gap-8 p-5",children:[y&&e.jsx("img",{src:y,alt:"Lili's avatar",className:"w-full border border-rule bg-surface-2 object-contain"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"eyebrow",children:"Profile"}),e.jsx("h2",{className:"mt-2 text-xl font-bold tracking-masthead",children:"Lili Lin"}),e.jsx("p",{className:"text-sm text-ink-2",children:"林丽丽"})]}),e.jsx("hr",{className:"hairline"}),e.jsx("p",{className:"font-mono text-[11px] uppercase tracking-eyebrow text-ink-3",children:"Designer · Developer · Product Maker"}),e.jsx("p",{className:"text-sm leading-relaxed text-ink-2",children:"Creating meaningful digital experiences that bridge technology and creativity."})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("hr",{className:"hairline"}),e.jsx("p",{className:"border-l-2 border-accent pl-3 text-sm italic leading-relaxed text-ink-2",children:b}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(Ke,{href:"https://github.com/lililin0324",label:"GH"}),e.jsx(Ke,{href:"mailto:lili0324@snu.ac.kr",label:"EM"}),e.jsx(Ke,{href:"https://www.linkedin.com/in/lililin0324",label:"LK"})]})]})]})}),e.jsx("section",{className:"relative min-w-0 flex-1 overflow-y-auto",children:e.jsxs(gn,{children:[e.jsx(W,{path:"/",element:e.jsx(Gt,{})}),e.jsx(W,{path:"/planning",element:e.jsx(Ne,{data:_e,type:"planning"})}),e.jsx(W,{path:"/planning/:id",element:e.jsx(Me,{data:_e,type:"planning"})}),e.jsx(W,{path:"/product",element:e.jsx(Ne,{data:Te,type:"product"})}),e.jsx(W,{path:"/product/:id",element:e.jsx(Me,{data:Te,type:"product"})}),e.jsx(W,{path:"/game",element:e.jsx(Ne,{data:Re,type:"game"})}),e.jsx(W,{path:"/game/:id",element:e.jsx(Me,{data:Re,type:"game"})}),e.jsx(W,{path:"/platform",element:e.jsx(Ne,{data:Be,type:"platform"})}),e.jsx(W,{path:"/platform/:id",element:e.jsx(Me,{data:Be,type:"platform"})}),e.jsx(W,{path:"/tutorial",element:e.jsx(Ne,{data:Ge,type:"tutorial"})}),e.jsx(W,{path:"/tutorial/:id",element:e.jsx(Me,{data:Ge,type:"tutorial"})}),e.jsx(W,{path:"/clusteringeomap",element:e.jsx(Ot,{})}),e.jsx(W,{path:"/about",element:e.jsx(_t,{})}),e.jsx(W,{path:"/contact",element:e.jsx(Tt,{})})]})})]})]})};function $t(){const[t,a]=s.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(fn,{children:e.jsx(Ht,{})}),!t&&e.jsx(An,{onFinish:()=>a(!0)})]})}xn.createRoot(document.getElementById("root")).render(e.jsx($t,{}));
