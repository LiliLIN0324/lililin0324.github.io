...
import{r as i,j as e,L as ee,u as nt,c as at,d as rt,e as st,f as W,H as it,g as lt}from"./react-vendor-6zld6QO8.js";import{A as $e,m as Se}from"./framer-DvVmTyA1.js";import{M as ot,r as dt,a as ct}from"./markdown-q3GborES.js";import{b as ze}from"./geo-Z02C8O4I.js";import{m as Ce}from"./maplibre-BedwuVXB.js";import{U as Be,L as ut,D as mt,R as ht,M as gt,C as pt,a as xt,b as ft,X as Ge,c as Ue}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))o(m);new MutationObserver(m=>{for(const l of m)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function M(m){const l={};return m.integrity&&(l.integrity=m.integrity),m.referrerPolicy&&(l.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?l.credentials="include":m.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(m){if(m.ep)return;m.ep=!0;const l=M(m);fetch(m.href,l)}})();function bt({onFinish:u}){const[s,M]=i.useState(!0),o=i.useRef(null),m=i.useRef({x:-1e3,y:-1e3});return i.useEffect(()=>{const l=o.current;if(!l)return;const n=l.getContext("2d");if(!n)return;let r,t=[];const k=()=>{l.width=window.innerWidth,l.height=window.innerHeight},f=c=>{m.current={x:c.clientX,y:c.clientY}},F=c=>{c.touches.length>0&&(m.current={x:c.touches[0].clientX,y:c.touches[0].clientY})};window.addEventListener("resize",k),window.addEventListener("mousemove",f),window.addEventListener("touchmove",F),k();class C{constructor(){this.x=Math.random()*l.width,this.y=Math.random()*l.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>l.width)&&(this.vx*=-1),(this.y<0||this.y>l.height)&&(this.vy*=-1);let B=m.current.x-this.x,G=m.current.y-this.y,T=Math.sqrt(B*B+G*G),E=B/T,_=G/T;const $=150;let te=($-T)/$;T<$&&(this.x-=E*te*this.density*.5,this.y-=_*te*this.density*.5)}draw(){n&&(n.fillStyle="rgba(255, 255, 255, 0.8)",n.beginPath(),n.arc(this.x,this.y,this.size,0,Math.PI*2),n.fill())}}for(let c=0;c<120;c++)t.push(new C);const U=()=>{n.clearRect(0,0,l.width,l.height);for(let c=0;c<t.length;c++){t[c].update(),t[c].draw();for(let B=c+1;B<t.length;B++){const G=t[c].x-t[B].x,T=t[c].y-t[B].y,E=Math.sqrt(G*G+T*T);E<100&&(n.beginPath(),n.strokeStyle=`rgba(255, 255, 255, ${.2*(1-E/100)})`,n.lineWidth=.6,n.moveTo(t[c].x,t[c].y),n.lineTo(t[B].x,t[B].y),n.stroke())}}r=requestAnimationFrame(U)};return U(),()=>{cancelAnimationFrame(r),window.removeEventListener("resize",k),window.removeEventListener("mousemove",f),window.removeEventListener("touchmove",F)}},[]),e.jsx($e,{onExitComplete:u,children:s&&e.jsxs(Se.div,{onClick:()=>M(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:o,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(Se.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(Se.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const vt=`---
id: "01"
