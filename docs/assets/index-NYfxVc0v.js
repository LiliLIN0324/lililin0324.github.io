...
import{r as n,j as e,L as te,u as oc,R as hc,c as lc,d as vc,e as mc,f as F,H as jc,g as yc}from"./react-vendor-6zld6QO8.js";import{A as xc,m as $e}from"./framer-DvVmTyA1.js";import{M as wc,r as kc,a as zc}from"./markdown-q3GborES.js";import{b as Ye}from"./geo-Z02C8O4I.js";import{m as Pe}from"./maplibre-BedwuVXB.js";import{U as Qe,L as Nc,D as Mc,R as Ac,M as Sc,C as Ic,a as Cc,b as Dc,X as Je,c as ec}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const s of l.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function u(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function t(i){if(i.ep)return;i.ep=!0;const l=u(i);fetch(i.href,l)}})();function Lc({onFinish:c}){const[a,u]=n.useState(!0),t=n.useRef(null),i=n.useRef({x:-1e3,y:-1e3});return n.useEffect(()=>{const l=t.current;if(!l)return;const s=l.getContext("2d");if(!s)return;let C,w=[];const R=()=>{l.width=window.innerWidth,l.height=window.innerHeight},N=f=>{i.current={x:f.clientX,y:f.clientY}},j=f=>{f.touches.length>0&&(i.current={x:f.touches[0].clientX,y:f.touches[0].clientY})};window.addEventListener("resize",R),window.addEventListener("mousemove",N),window.addEventListener("touchmove",j),R();class k{constructor(){this.x=Math.random()*l.width,this.y=Math.random()*l.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>l.width)&&(this.vx*=-1),(this.y<0||this.y>l.height)&&(this.vy*=-1);let P=i.current.x-this.x,G=i.current.y-this.y,B=Math.sqrt(P*P+G*G),E=P/B,J=G/B;const _=150;let A=(_-B)/_;B<_&&(this.x-=E*A*this.density*.5,this.y-=J*A*this.density*.5)}draw(){s&&(s.fillStyle="rgba(255, 255, 255, 0.8)",s.beginPath(),s.arc(this.x,this.y,this.size,0,Math.PI*2),s.fill())}}for(let f=0;f<120;f++)w.push(new k);const M=()=>{s.clearRect(0,0,l.width,l.height);for(let f=0;f<w.length;f++){w[f].update(),w[f].draw();for(let P=f+1;P<w.length;P++){const G=w[f].x-w[P].x,B=w[f].y-w[P].y,E=Math.sqrt(G*G+B*B);E<100&&(s.beginPath(),s.strokeStyle=`rgba(255, 255, 255, ${.2*(1-E/100)})`,s.lineWidth=.6,s.moveTo(w[f].x,w[f].y),s.lineTo(w[P].x,w[P].y),s.stroke())}}C=requestAnimationFrame(M)};return M(),()=>{cancelAnimationFrame(C),window.removeEventListener("resize",R),window.removeEventListener("mousemove",N),window.removeEventListener("touchmove",j)}},[]),e.jsx(xc,{onExitComplete:c,children:a&&e.jsxs($e.div,{onClick:()=>u(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:t,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx($e.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx($e.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const Ec=`---
id: "00"
slug: "chicken-utopia"
...
https://learn.u3d.cn/tutorial/instant-game-joker?chapterId=64f5962ca571d50021bb3afb&sectionId=64f5962ca571d50021bb3afa`,bt=`---
id: "01"
slug: "litflow"
