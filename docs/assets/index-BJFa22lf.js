...
import{r as n,j as e,L as te,u as hc,R as lc,c as vc,d as mc,e as jc,f as F,H as yc,g as xc}from"./react-vendor-6zld6QO8.js";import{A as wc,m as Ke}from"./framer-DvVmTyA1.js";import{M as kc,r as zc,a as Nc}from"./markdown-q3GborES.js";import{b as Ye}from"./geo-Z02C8O4I.js";import{m as Ee}from"./maplibre-BedwuVXB.js";import{U as Je,L as qc,D as Mc,R as Cc,M as Ac,C as Sc,a as Ic,b as Lc,X as ec,c as cc}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))t(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const g of l.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&t(g)}).observe(document,{childList:!0,subtree:!0});function u(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function t(r){if(r.ep)return;r.ep=!0;const l=u(r);fetch(r.href,l)}})();function Dc({onFinish:c}){const[a,u]=n.useState(!0),t=n.useRef(null),r=n.useRef({x:-1e3,y:-1e3});return n.useEffect(()=>{const l=t.current;if(!l)return;const g=l.getContext("2d");if(!g)return;let I,w=[];const P=()=>{l.width=window.innerWidth,l.height=window.innerHeight},N=f=>{r.current={x:f.clientX,y:f.clientY}},j=f=>{f.touches.length>0&&(r.current={x:f.touches[0].clientX,y:f.touches[0].clientY})};window.addEventListener("resize",P),window.addEventListener("mousemove",N),window.addEventListener("touchmove",j),P();class k{constructor(){this.x=Math.random()*l.width,this.y=Math.random()*l.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>l.width)&&(this.vx*=-1),(this.y<0||this.y>l.height)&&(this.vy*=-1);let E=r.current.x-this.x,_=r.current.y-this.y,B=Math.sqrt(E*E+_*_),D=E/B,J=_/B;const G=150;let M=(G-B)/G;B<G&&(this.x-=D*M*this.density*.5,this.y-=J*M*this.density*.5)}draw(){g&&(g.fillStyle="rgba(255, 255, 255, 0.8)",g.beginPath(),g.arc(this.x,this.y,this.size,0,Math.PI*2),g.fill())}}for(let f=0;f<120;f++)w.push(new k);const q=()=>{g.clearRect(0,0,l.width,l.height);for(let f=0;f<w.length;f++){w[f].update(),w[f].draw();for(let E=f+1;E<w.length;E++){const _=w[f].x-w[E].x,B=w[f].y-w[E].y,D=Math.sqrt(_*_+B*B);D<100&&(g.beginPath(),g.strokeStyle=`rgba(255, 255, 255, ${.2*(1-D/100)})`,g.lineWidth=.6,g.moveTo(w[f].x,w[f].y),g.lineTo(w[E].x,w[E].y),g.stroke())}}I=requestAnimationFrame(q)};return q(),()=>{cancelAnimationFrame(I),window.removeEventListener("resize",P),window.removeEventListener("mousemove",N),window.removeEventListener("touchmove",j)}},[]),e.jsx(wc,{onExitComplete:c,children:a&&e.jsxs(Ke.div,{onClick:()=>u(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:t,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(Ke.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(Ke.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const Ec=`---
id: "00"
slug: "chicken-utopia"
...
\r
Keywords: heat resilience, climate zone, local climate zone\r
Topic Category: WELL BEING_Thermal environment\r
\r
`,Bc=`---\r
id: "03"\r
...
---\r
\r
硕士期间总共参与了 **5 项研究课题**，参加了一场 **AI for Cities 夏令营**，同时加入 **联合国人居署项目 × 首尔大学** 研究课题。\r
\r
---\r
\r
## 国际会议发表（4 项）\r
\r
### [Knowledge Graph Generation from Urban Planning Texts](#/ai/knowledge-graph-urban-planning)\r
\r
基于城市规划文本的知识图谱生成：纽约和上海总体规划中气候变化适应的比较分析\r
\r
> 2025.2 · 第39届 AAAI 城市规划人工智能研讨会 · 海报展示 [Workshop]\r
\r
> 2025.6 · 英国伦敦 CUPUM 计算城市规划与城市管理会议 · 口头报告\r
\r
> 2025.7 · 中国厦门 第19届 IACP 国际中国规划协会会议 · 口头报告\r
\r
### [Local Climate Zones and Urban Heat Resilience](#/planning/local-climate-zones-urban-heat-resilience)\r
\r
局部气候区与城市热岛效应韧性：纽约实证研究\r
\r
> 2025.4 · 加拿大温哥华 第52届 ICUA 国际城市事务会议 · 口头报告\r
\r
### [Assessing Urban Heat Resilience](#/ai/urban-heat-resilience-machine-learning)\r
\r
利用机器学习评估城市形态对不同尺度下热韧性的非线性影响\r
\r
> 2025.10 · 美国明尼阿波利斯 第65届 ACSP 美国大学规划学院协会会议 · 口头报告\r
> 2025.6 · 英国剑桥 学术交流研讨会 · 口头报告 [Seminar]\r
> 2025.5 · 佛罗里达大学 AI Cities 研讨会 · 口头报告 [Workshop, 线上]\r
> 2026.2 · 新加坡 第40届 AAAI 城市规划人工智能研讨会 · 海报展示 [Workshop]\r
\r
### 利用机器学习评估首尔城市形态在不同天气下热韧性的非线性影响\r
\r
> 2026.7 · 中国西安 第20届 IACP 国际中国规划协会会议 · 口头报告\r
\r
---\r
\r
## [Participatory Urban Regeneration Empowered by AI](#/ai/participatory-urban-regeneration-empowered-by-artificial-intelligence)\r
\r
AI for Cities 夏令营 · 人工智能赋能下的参与式城市更新\r
\r
> 2025.7 · 上海同济大学 · 作为数据组组长参与工作坊 [Workshop]\r
\r
---\r
\r
## 联合国人居署项目 × 首尔大学\r
...
![Genshot99](https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/fig/genshot/99.jpg)`,Hc=`---\r
id: "04"\r
slug: "genstyle"\r
...
> 💡 **小提示**：没有绝对最好的数据库，只有最适合你项目的数据库。根据实际需求选择，才是最明智的决定！`,vt=`---\r
id: "10"\r
...
`;function mt(c){const a=/^---\r?\n([\s\S]*?)\r?\n---/,u=c.match(a);let t={},r=c;if(u){const g=u[1];r=c.slice(u[0].length).trim();const I=g.split(/\r?\n/);let w=null,P=[];I.forEach(N=>{if(N.trim()==="")return;const k=N.indexOf(":");if(k!==-1&&!N.startsWith(" ")){w&&(t[w]=P.join(`
...
`)&&/^\s*-/.test(j)){const k=j.split(/\r?\n/).map(q=>q.replace(/^\s*-\s*/,"").trim()).filter(q=>q!=="");t[N]=k.map(q=>q.startsWith('"')&&q.endsWith('"')||q.startsWith("'")&&q.endsWith("'")?q.slice(1,-1):q)}else if(j.startsWith("[")&&j.endsWith("]"))try{t[N]=JSON.parse(j)}catch{t[N]=[j.slice(1,-1).trim()]}else j==="true"?t[N]=!0:j==="false"?t[N]=!1:!isNaN(Number(j))&&j.trim()!==""?t[N]=Number(j):t[N]=j})}let l=[];if(Array.isArray(t.image)&&t.image.length>0)l=t.image;else{const g=/!\[.*?\]\(([^)\s]+)\)/g;let I;for(;(I=g.exec(r))!==null;)l.push(I[1])}return{id:t.id||"",slug:t.slug||"",title:t.title||"",category:t.category||"",year:t.year||"",description:t.description||"",tech:t.tech||[],abstract:t.abstract||"",challenge:t.challenge||"",solution:t.solution||"",hasDemo:t.hasDemo||!1,icon:t.icon||"",code:t.code||"",logo:t.icon||"",image:l,content:r}}function S(c){const a=mt(c);return{id:a.id,slug:a.slug,title:a.title,category:a.category,year:a.year,description:a.description,tech:a.tech,hasDemo:a.hasDemo,details:{abstract:a.abstract,description:a.description,challenge:a.challenge,solution:a.solution,logo:a.logo,icon:a.icon,code:a.code,image:a.image,content:a.content,demoOnly:a.demoOnly||!1}}}const Pe=[S(Ec),S(Pc),S(Rc),S(Bc),S(Tc),S(_c),S(Gc),S(Fc)],Re=[S(Uc),S(Wc),S(Oc),S(Hc),S(Vc),S($c),S(Kc)],Ge=[S(Zc),S(Xc),S(Qc),S(Yc),S(Jc),S(et)],Te=[S(ct),S(tt),S(bt),S(at)],_e=[S(pt),S(nt),S(rt)],Be=[S(it),S(gt),S(dt),S(st),S(ft),S(ut),S(ot),S(ht),S(lt),S(vt)],jt={design:"Products",game:"Games",ai:"AI",planning:"Planning",platform:"Platform",tutorial:"Tutorials",research:"Research"},fc=({className:c})=>e.jsx("div",{className:"flex h-full w-full items-center justify-center text-ink-3/50",children:e.jsx("svg",{className:c,fill:"none",stroke:"currentColor",strokeWidth:1.4,viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})}),uc=({to:c,className:a=""})=>e.jsx(te,{to:c,className:`btn-accent ${a}`,children:"Demo"}),yt=!1,xt=({project:c,type:a,index:u})=>{var t;return e.jsx("li",{className:"group border-b border-rule transition-colors duration-300 hover:bg-surface",children:e.jsxs("div",{className:"flex items-center gap-4 py-4 md:gap-6 md:py-5",children:[e.jsx("span",{className:"nums-tabular hidden w-10 shrink-0 self-start pt-1 text-lg font-bold leading-none tracking-masthead text-ink-3/60 transition-colors group-hover:text-accent-text sm:block",children:String(u+1).padStart(2,"0")}),e.jsxs(te,{to:`/${a}/${c.slug}`,className:"flex min-w-0 flex-1 items-center gap-4 md:gap-6",children:[e.jsx("div",{className:"h-16 w-16 shrink-0 overflow-hidden border border-rule bg-surface-2 md:h-20 md:w-20",children:c.details.logo?e.jsx("img",{src:c.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-105",onError:r=>{r.target.style.display="none"}}):e.jsx(fc,{className:"h-7 w-7"})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h3",{className:"truncate text-base font-bold tracking-tight text-ink md:text-lg lg:text-xl",children:e.jsx("span",{className:"wipe-underline",children:c.title})}),e.jsx("p",{className:"mt-1 truncate text-sm text-ink-2",children:c.description})]}),e.jsx("div",{className:"hidden shrink-0 flex-wrap justify-end gap-1.5 lg:flex lg:max-w-[16rem]",children:(t=c.tech)==null?void 0:t.slice(0,3).map(r=>e.jsx("span",{className:"chip",children:r},r))}),e.jsx("span",{className:"eyebrow nums-tabular hidden w-12 shrink-0 text-right md:block",children:c.year})]}),c.hasDemo&&e.jsx(uc,{to:`/${a}/${c.slug}#demo`,className:"shrink-0"})]})})},wt=({project:c,type:a,index:u})=>{var t;return e.jsxs("article",{className:"group flex flex-col border border-rule bg-surface transition-colors duration-300 hover:border-rule-strong",children:[e.jsxs(te,{to:`/${a}/${c.slug}`,className:"flex flex-1 flex-col",children:[e.jsx("div",{className:"aspect-square w-full overflow-hidden border-b border-rule bg-surface-2",children:c.details.logo?e.jsx("img",{src:c.details.logo,alt:"",className:"h-full w-full object-cover transition-transform duration-700 ease-editorial group-hover:scale-[1.05]",onError:r=>{r.target.style.display="none"}}):e.jsx(fc,{className:"h-10 w-10"})}),e.jsxs("div",{className:"flex flex-1 flex-col p-4",children:[e.jsxs("div",{className:"flex items-baseline justify-between gap-3",children:[e.jsx("span",{className:"nums-tabular text-sm font-bold tracking-masthead text-ink-3/70 transition-colors group-hover:text-accent-text",children:String(u+1).padStart(2,"0")}),e.jsx("span",{className:"eyebrow nums-tabular",children:c.year})]}),e.jsx("h3",{className:"mt-2.5 line-clamp-2 text-base font-bold leading-snug tracking-tight text-ink md:text-lg",children:e.jsx("span",{className:"wipe-underline",children:c.title})}),e.jsx("p",{className:"mt-1.5 line-clamp-2 text-sm leading-relaxed text-ink-2",children:c.description}),((t=c.tech)==null?void 0:t.length)>0&&e.jsx("div",{className:"mt-3 flex flex-wrap gap-1.5",children:c.tech.slice(0,2).map(r=>e.jsx("span",{className:"chip",children:r},r))})]})]}),c.hasDemo&&e.jsx("div",{className:"border-t border-rule p-3",children:e.jsx(uc,{to:`/${a}/${c.slug}#demo`,className:"w-full"})})]})},je=({data:c,type:a})=>{const[u,t]=n.useState("grid"),r=jt[a]??"Works";return e.jsxs("div",{className:"shell animate-rise-in py-8 md:py-12",children:[a==="design"&&yt,e.jsxs("div",{className:"section-head",children:[e.jsxs("p",{className:"eyebrow",children:[a," / Index"]}),e.jsxs("p",{className:"eyebrow nums-tabular",children:[String(c.length).padStart(2,"0")," Entries"]})]}),e.jsxs("div",{className:"mt-5 flex flex-wrap items-end justify-between gap-4 border-b border-rule pb-5",children:[e.jsxs("h1",{className:"text-display-sm",children:["Selected ",r]}),e.jsx("div",{className:"flex shrink-0 border border-rule",role:"group","aria-label":"View mode",children:["grid","list"].map(l=>e.jsx("button",{onClick:()=>t(l),"aria-pressed":u===l,className:`px-3 py-1.5 font-mono text-[10px] uppercase tracking-eyebrow transition-colors duration-200 ${u===l?"bg-ink text-canvas":"text-ink-3 hover:text-ink"}`,children:l},l))})]}),u==="list"?e.jsx("ul",{className:"mt-2 border-t border-rule",children:c.map((l,g)=>e.jsx(xt,{project:l,type:a,index:g},l.slug))}):e.jsx("div",{className:"mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 xl:grid-cols-4",children:c.map((l,g)=>e.jsx(wt,{project:l,type:a,index:g},l.slug))})]})},kt="modulepreload",zt=function(c,a){return new URL(c,a).href},tc={},T=function(a,u,t){let r=Promise.resolve();if(u&&u.length>0){let g=function(N){return Promise.all(N.map(j=>Promise.resolve(j).then(k=>({status:"fulfilled",value:k}),k=>({status:"rejected",reason:k}))))};const I=document.getElementsByTagName("link"),w=document.querySelector("meta[property=csp-nonce]"),P=(w==null?void 0:w.nonce)||(w==null?void 0:w.getAttribute("nonce"));r=g(u.map(N=>{if(N=zt(N,t),N in tc)return;tc[N]=!0;const j=N.endsWith(".css"),k=j?'[rel="stylesheet"]':"";if(!!t)for(let E=I.length-1;E>=0;E--){const _=I[E];if(_.href===N&&(!j||_.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${N}"]${k}`))return;const f=document.createElement("link");if(f.rel=j?"stylesheet":kt,j||(f.as="script"),f.crossOrigin="",f.href=N,P&&f.setAttribute("nonce",P),document.head.appendChild(f),j)return new Promise((E,_)=>{f.addEventListener("load",E),f.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${N}`)))})}))}function l(g){const I=new Event("vite:preloadError",{cancelable:!0});if(I.payload=g,window.dispatchEvent(I),!I.defaultPrevented)throw g}return r.then(g=>{for(const I of g||[])I.status==="rejected"&&l(I.reason);return a().catch(l)})},Nt=n.lazy(()=>T(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),qt=n.lazy(()=>T(()=>import("./UR-platform-DFO5eSKd.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),Mt=n.lazy(()=>T(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),Ct=n.lazy(()=>T(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),At=n.lazy(()=>T(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),St=n.lazy(()=>T(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),It=n.lazy(()=>T(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));n.lazy(()=>T(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const Lt=n.lazy(()=>T(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),Dt=n.lazy(()=>T(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),bc=n.lazy(()=>T(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),Et=n.lazy(()=>T(()=>import("./72HourGameJamDemo-BWPUgRvj.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),Pt=n.lazy(()=>T(()=>import("./PeaceEliteHustCampusDemo-D-DWwJkq.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),Rt=n.lazy(()=>T(()=>import("./BMWMetaIslandDemo-7uu2MOZP.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),Gt=n.lazy(()=>T(()=>import("./riffle-RlweP75u.js"),__vite__mapDeps([24,1,2,3]),import.meta.url)),Tt=n.lazy(()=>T(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([25,1,2,3]),import.meta.url)),_t=n.lazy(()=>T(()=>import("./genshot-BoH35G7G.js"),__vite__mapDeps([26,1,2,3]),import.meta.url)),Bt=n.lazy(()=>T(()=>import("./dragon-diffusion-Dj4t-WNK.js"),__vite__mapDeps([27,1,2,3]),import.meta.url)),Ft=n.lazy(()=>T(()=>import("./anyreal-DKKTpW8w.js"),__vite__mapDeps([28,1,2,3]),import.meta.url)),Ut=n.lazy(()=>T(()=>import("./previous-archi-work-CvNoz6hg.js"),__vite__mapDeps([29,1,2,3]),import.meta.url)),Wt=n.lazy(()=>T(()=>import("./hongqiqu-y3eLCJ-3.js"),__vite__mapDeps([30,1,2,3]),import.meta.url)),ac=c=>({"cluster-visualizer-3d":Nt,"participatory-urban-regeneration-empowered-by-artificial-intelligence":qt,heatmapper:Mt,"how-to-add-openstreetmap-in-website":Ct,"how-to-get-sequential-events-from-photo-by-phone":At,"how-to-visualize-photo-geolocation-data-on-map":St,kittylovecarrots:bc,"how-to-build-game-in-wechat-mini-program":bc,"72-hour-game-jam":Et,"peace-elite-hust-campus":Pt,"bmw-meta-island":Rt,"how-to-conduct-time-geo-sequential-clustering-from-album":It,"box-up-my-stuff-in-cyberspace":Lt,"epstein-mystery-archive":Dt,"riffle-ai-game-generation-tool":Gt,genstyle:Tt,"genshot-AI-video-generation-tool":_t,"dragon-diffussion":Bt,anyreal:Ft,"previous-archi-work":Ut,hongqiqu:Wt})[c],pc={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
