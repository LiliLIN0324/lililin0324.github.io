...
import{r as i,j as e,L as J,u as nt,c as at,d as rt,e as st,f as W,H as it,g as lt}from"./react-vendor-6zld6QO8.js";import{A as $e,m as Se}from"./framer-DvVmTyA1.js";import{M as ot,r as dt,a as ct}from"./markdown-q3GborES.js";import{b as Fe}from"./geo-Z02C8O4I.js";import{m as Ce}from"./maplibre-BedwuVXB.js";import{U as Be,L as ut,D as mt,R as ht,M as gt,C as pt,a as xt,b as ft,X as Ge,c as Ue}from"./icons-Dw2J7OpA.js";import"./vendor-C2tZ253J.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))o(m);new MutationObserver(m=>{for(const l of m)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function C(m){const l={};return m.integrity&&(l.integrity=m.integrity),m.referrerPolicy&&(l.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?l.credentials="include":m.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(m){if(m.ep)return;m.ep=!0;const l=C(m);fetch(m.href,l)}})();function bt({onFinish:u}){const[s,C]=i.useState(!0),o=i.useRef(null),m=i.useRef({x:-1e3,y:-1e3});return i.useEffect(()=>{const l=o.current;if(!l)return;const n=l.getContext("2d");if(!n)return;let r,t=[];const w=()=>{l.width=window.innerWidth,l.height=window.innerHeight},x=c=>{m.current={x:c.clientX,y:c.clientY}},T=c=>{c.touches.length>0&&(m.current={x:c.touches[0].clientX,y:c.touches[0].clientY})};window.addEventListener("resize",w),window.addEventListener("mousemove",x),window.addEventListener("touchmove",T),w();class L{constructor(){this.x=Math.random()*l.width,this.y=Math.random()*l.height,this.baseX=this.x,this.baseY=this.y,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.size=Math.random()*2+.5,this.density=Math.random()*30+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>l.width)&&(this.vx*=-1),(this.y<0||this.y>l.height)&&(this.vy*=-1);let R=m.current.x-this.x,_=m.current.y-this.y,U=Math.sqrt(R*R+_*_),D=R/U,F=_/U;const ne=150;let Y=(ne-U)/ne;U<ne&&(this.x-=D*Y*this.density*.5,this.y-=F*Y*this.density*.5)}draw(){n&&(n.fillStyle="rgba(255, 255, 255, 0.8)",n.beginPath(),n.arc(this.x,this.y,this.size,0,Math.PI*2),n.fill())}}for(let c=0;c<120;c++)t.push(new L);const G=()=>{n.clearRect(0,0,l.width,l.height);for(let c=0;c<t.length;c++){t[c].update(),t[c].draw();for(let R=c+1;R<t.length;R++){const _=t[c].x-t[R].x,U=t[c].y-t[R].y,D=Math.sqrt(_*_+U*U);D<100&&(n.beginPath(),n.strokeStyle=`rgba(255, 255, 255, ${.2*(1-D/100)})`,n.lineWidth=.6,n.moveTo(t[c].x,t[c].y),n.lineTo(t[R].x,t[R].y),n.stroke())}}r=requestAnimationFrame(G)};return G(),()=>{cancelAnimationFrame(r),window.removeEventListener("resize",w),window.removeEventListener("mousemove",x),window.removeEventListener("touchmove",T)}},[]),e.jsx($e,{onExitComplete:u,children:s&&e.jsxs(Se.div,{onClick:()=>C(!1),initial:{opacity:1},exit:{opacity:0,filter:"blur(30px)",transition:{duration:1.2,ease:[.43,.13,.23,.96]}},className:"fixed inset-0 z-50 bg-black cursor-pointer overflow-hidden flex flex-col items-center justify-center",children:[e.jsx("canvas",{ref:o,className:"absolute inset-0 w-full h-full "}),e.jsx("div",{className:"relative z-20 text-center  select-none",children:e.jsx(Se.p,{initial:{opacity:0,y:10},animate:{opacity:.7,y:0},transition:{duration:2},className:"text-white font-extralight text-lg md:text-sm uppercase tracking-[0.8em]",children:"LILI LIN's Space 林丽丽"})}),e.jsx(Se.div,{initial:{opacity:0},animate:{opacity:.4},className:"absolute bottom-12 text-[10px] text-white font-light tracking-[0.5em] uppercase",children:"Touch the stars to enter"})]},"intro-screen")})}const vt=`---
id: "01"
...
https://learn.u3d.cn/tutorial/instant-game-joker?chapterId=64f5962ca571d50021bb3afb&sectionId=64f5962ca571d50021bb3afa`,Tt=`---
id: "01"
slug: "litflow"
...
- **团队熟悉**：优先选择团队熟悉的技术\r
\r
> 💡 **小提示**：没有绝对最好的数据库，只有最适合你项目的数据库。根据实际需求选择，才是最明智的决定！`;function qt(u){const s=/^---\r?\n([\s\S]*?)\r?\n---/,C=u.match(s);let o={},m=u;if(C){const l=C[1];m=u.slice(C[0].length).trim();const n=l.split(/\r?\n/);let r=null,t=[];n.forEach(w=>{if(w.trim()==="")return;const T=w.indexOf(":");if(T!==-1&&!w.startsWith(" ")){r&&(o[r]=t.join(`
`)),r=w.slice(0,T).trim();let L=w.slice(T+1).trim();L==="|"?t=[]:(o[r]=L,r=null,t=[])}else r&&w.startsWith("  ")&&t.push(w.slice(2))}),r&&t.length>0&&(o[r]=t.join(`
`)),Object.keys(o).forEach(w=>{let x=o[w];if(typeof x=="string")if(x=x.trim(),x.startsWith('"')&&x.endsWith('"')&&(x=x.slice(1,-1)),x.startsWith("[")&&x.endsWith("]"))try{o[w]=JSON.parse(x)}catch{o[w]=[x.slice(1,-1).trim()]}else x==="true"?o[w]=!0:x==="false"?o[w]=!1:!isNaN(Number(x))&&x.trim()!==""?o[w]=Number(x):o[w]=x})}return{id:o.id||"",slug:o.slug||"",title:o.title||"",category:o.category||"",year:o.year||"",description:o.description||"",tech:o.tech||[],abstract:o.abstract||"",challenge:o.challenge||"",solution:o.solution||"",hasDemo:o.hasDemo||!1,icon:o.icon||"",code:o.code||"",logo:o.icon||"",image:o.image||[],content:m}}function z(u){const s=qt(u);return{id:s.id,slug:s.slug,title:s.title,category:s.category,year:s.year,description:s.description,tech:s.tech,hasDemo:s.hasDemo,details:{abstract:s.abstract,description:s.description,challenge:s.challenge,solution:s.solution,logo:s.logo,icon:s.icon,code:s.code,image:s.image,content:s.content}}}const ge=[z(vt),z(yt),z(jt),z(wt),z(kt),z(Nt)],pe=[z(Mt),z(Ct),z(St),z(It),z(Lt),z(At),z(Dt)],xe=[z(Pt),z(Et),z(_t)],fe=[z(Tt),z(Rt),z(zt)],be=[z(Ft),z(Bt),z(Gt),z(Ut),z(Ot),z(Vt),z(Wt),z(Ht),z($t)],we=({data:u,type:s})=>{const[C,o]=i.useState("grid"),[m,l]=i.useState(1),n=55,r={2:{text:"Self-introduction",link:"/about"},5:{text:"View 1037pinpin Project",link:"/design/1037pinpin"},11:{text:"View Perslearn Project",link:"/design/perslearn"},21:{text:"View Dragon Diffusion Project",link:"/design/dragon-diffussion"},27:{text:"View Genstyle Project",link:"/design/genstyle"},43:{text:"View Luoshu Project",link:"/design/bazi-fengshui-analysis"},48:{text:"View Genshot Project",link:"/design/genshot"}};return e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500",children:[s==="design"?e.jsxs("div",{className:"flex flex-col lg:flex-row gap-6 lg:gap-8",children:[e.jsxs("div",{className:"flex-1 lg:flex-shrink-0 lg:w-[55%]",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-4",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Portfolio PDF"}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Page ",m," / ",n]})]}),e.jsxs("div",{className:"relative flex items-center justify-center gap-2",children:[e.jsx("button",{onClick:()=>l(t=>Math.max(1,t-1)),disabled:m<=1,className:"flex-shrink-0 w-10 h-10 rounded-full bg-white dark:bg-neutral-800 shadow-lg hover:shadow-xl disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-300 border border-neutral-200 dark:border-neutral-700",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsxs("div",{className:"relative flex-1 bg-neutral-100 dark:bg-neutral-800 rounded-lg overflow-hidden shadow-2xl border border-neutral-300 dark:border-neutral-600",style:{aspectRatio:"4/2.8"},children:[e.jsx("iframe",{src:`https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/lili_ui_portfolio.pdf#page=${m}&view=Fit&scrollbar=0&toolbar=0&navpanes=0`,className:"absolute inset-0 w-[110%] h-[110%] pointer-events-none",title:"Portfolio PDF",style:{border:"none",transform:"translate(-2.5%, -5%)"}},m),e.jsx("div",{className:"absolute inset-0 bg-transparent z-10",style:{pointerEvents:"none"}})]}),e.jsx("button",{onClick:()=>l(t=>Math.min(n,t+1)),disabled:m>=n,className:"flex-shrink-0 w-10 h-10 rounded-full bg-white dark:bg-neutral-800 shadow-lg hover:shadow-xl disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-300 border border-neutral-200 dark:border-neutral-700",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),e.jsx("div",{className:"flex justify-center gap-1 mt-4 flex-wrap",children:Array.from({length:n}).map((t,w)=>{const x=w+1,T=m===x,L=r[x];return e.jsx("button",{onClick:()=>l(x),className:`h-1.5 rounded-full transition-all duration-300 ${T?"bg-neutral-800 dark:bg-neutral-200 w-6":L?"bg-blue-500 w-1.5 hover:bg-blue-600":"bg-neutral-300 dark:bg-neutral-600 w-1.5 hover:bg-neutral-400"}`,title:L?r[x].text:`Page ${x}`},w)})}),r[m]&&e.jsx("div",{className:"mt-3 flex justify-center",children:e.jsxs(J,{to:r[m].link,className:"inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded-full transition-colors shadow-md hover:shadow-lg",children:[e.jsx("span",{children:r[m].text}),e.jsx("svg",{className:"w-3 h-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M14 5l7 7m0 0l-7 7m7-7H3"})})]})})]}),e.jsxs("div",{className:"flex-1 lg:w-[45%]",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-4",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Selected Designs"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>o("grid"),className:`px-2 py-1 text-xs font-mono ${C==="grid"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"GRID"}),e.jsx("button",{onClick:()=>o("list"),className:`px-2 py-1 text-xs font-mono ${C==="list"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"LIST"})]}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Idx: ",u.length]})]})]}),e.jsx("div",{className:"overflow-y-auto",style:{aspectRatio:"4/2.7"},children:C==="list"?e.jsx("div",{className:"space-y-0",children:u.map(t=>e.jsx("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-3 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm",children:e.jsxs("div",{className:"flex flex-row gap-3 items-center flex-1",children:[e.jsxs(J,{to:`/${s}/${t.slug}`,className:"flex-grow min-w-0 w-full flex flex-row gap-3 items-center",children:[e.jsx("div",{className:"flex-shrink-0 w-12 h-12 border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:t.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-1",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",t.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:t.year})]}),e.jsx("h3",{className:"text-sm font-bold text-neutral-900 dark:text-neutral-100 mb-0.5 group-hover:text-blue-600 truncate",children:t.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-xs line-clamp-1",children:t.description})]})]}),t.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${t.slug}#demo`},className:"flex-shrink-0 px-2 py-1 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]})},t.slug))}):e.jsx("div",{className:"grid grid-cols-2 gap-3",children:u.map(t=>e.jsxs("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-3 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm flex flex-col",children:[e.jsxs(J,{to:`/${s}/${t.slug}`,className:"flex flex-col h-full",children:[e.jsx("div",{className:"flex-shrink-0 w-full aspect-square border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800 mb-2",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:t.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-8 h-8",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-1",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",t.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:t.year})]}),e.jsx("h3",{className:"text-sm font-bold text-neutral-900 dark:text-neutral-100 mb-0.5 group-hover:text-blue-600 line-clamp-2",children:t.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-xs line-clamp-2",children:t.description})]})]}),t.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${t.slug}#demo`},className:"flex-shrink-0 w-full mt-2 px-2 py-1 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]},t.slug))})})]})]}):e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8",children:[e.jsxs("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:["Selected ",s==="research"?"Researches":s==="game"?"Games":s==="planning"?"Planning":s==="tutorials"?"Tutorials":"Platform"]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>o("grid"),className:`px-3 py-1 text-xs font-mono ${C==="grid"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"GRID"}),e.jsx("button",{onClick:()=>o("list"),className:`px-3 py-1 text-xs font-mono ${C==="list"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"LIST"})]}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Idx: ",u.length]})]})]}),s!=="design"&&(C==="list"?e.jsx("div",{className:"space-y-4",children:u.map(t=>e.jsx("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-4 md:p-6 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm",children:e.jsxs("div",{className:"flex flex-row gap-4 md:gap-6 items-center flex-1",children:[e.jsxs(J,{to:`/${s}/${t.slug}`,className:"flex-grow min-w-0 w-full flex flex-row gap-4 md:gap-6 items-center",children:[e.jsx("div",{className:"flex-shrink-0 w-16 h-16 md:w-20 md:h-20 border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:t.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-8 h-8",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",t.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:t.year})]}),e.jsx("h3",{className:"text-base md:text-lg lg:text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 truncate",children:t.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-sm line-clamp-1",children:t.description})]})]}),t.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${t.slug}#demo`},className:"flex-shrink-0 px-3 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]})},t.slug))}):e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6",children:u.map(t=>e.jsxs("div",{className:"group relative border border-neutral-200 dark:border-neutral-700 p-4 md:p-6 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all duration-300 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-sm flex flex-col",children:[e.jsxs(J,{to:`/${s}/${t.slug}`,className:"flex flex-col h-full",children:[e.jsx("div",{className:"flex-shrink-0 w-full aspect-square border border-neutral-100 dark:border-neutral-700 overflow-hidden bg-neutral-50 dark:bg-neutral-800 mb-4",children:t.details.logo?e.jsx("img",{src:t.details.logo,alt:t.title,className:"w-full h-full object-cover"}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-300 dark:text-neutral-600",children:e.jsx("svg",{className:"w-12 h-12",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"})})})}),e.jsxs("div",{className:"flex-grow min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsxs("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:["NO. ",t.id]}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-500 dark:text-neutral-400",children:t.year})]}),e.jsx("h3",{className:"text-base md:text-lg font-bold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-blue-600 line-clamp-2",children:t.title}),e.jsx("p",{className:"text-neutral-500 dark:text-neutral-400 text-sm line-clamp-2",children:t.description})]})]}),t.hasDemo&&e.jsx("button",{onClick:()=>{window.location.href=`#/${s}/${t.slug}#demo`},className:"flex-shrink-0 w-full mt-4 px-3 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 transition-colors rounded-sm",children:"DEMO"})]},t.slug))}))]})},Kt="modulepreload",Xt=function(u,s){return new URL(u,s).href},Oe={},H=function(s,C,o){let m=Promise.resolve();if(C&&C.length>0){let n=function(x){return Promise.all(x.map(T=>Promise.resolve(T).then(L=>({status:"fulfilled",value:L}),L=>({status:"rejected",reason:L}))))};const r=document.getElementsByTagName("link"),t=document.querySelector("meta[property=csp-nonce]"),w=(t==null?void 0:t.nonce)||(t==null?void 0:t.getAttribute("nonce"));m=n(C.map(x=>{if(x=Xt(x,o),x in Oe)return;Oe[x]=!0;const T=x.endsWith(".css"),L=T?'[rel="stylesheet"]':"";if(!!o)for(let R=r.length-1;R>=0;R--){const _=r[R];if(_.href===x&&(!T||_.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${x}"]${L}`))return;const c=document.createElement("link");if(c.rel=T?"stylesheet":Kt,T||(c.as="script"),c.crossOrigin="",c.href=x,w&&c.setAttribute("nonce",w),document.head.appendChild(c),T)return new Promise((R,_)=>{c.addEventListener("load",R),c.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${x}`)))})}))}function l(n){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=n,window.dispatchEvent(r),!r.defaultPrevented)throw n}return m.then(n=>{for(const r of n||[])r.status==="rejected"&&l(r.reason);return s().catch(l)})},Qt=i.lazy(()=>H(()=>import("./ClusterVisualizer-D_ileyyg.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)),Zt=i.lazy(()=>H(()=>import("./UR-platform-B26NuqWS.js"),__vite__mapDeps([6,1,2,3,7,8,5]),import.meta.url)),Yt=i.lazy(()=>H(()=>import("./heatmapper-CQ7wneDH.js"),__vite__mapDeps([9,1,2,3]),import.meta.url)),Jt=i.lazy(()=>H(()=>import("./openstreetmap-wceuEFyo.js"),__vite__mapDeps([10,1,2,3,11,12,5]),import.meta.url)),en=i.lazy(()=>H(()=>import("./photogeo-DUM1KJgS.js"),__vite__mapDeps([13,1,2,3]),import.meta.url)),tn=i.lazy(()=>H(()=>import("./photogeomap-BZHaPQu1.js"),__vite__mapDeps([14,1,2,3,11,12]),import.meta.url)),nn=i.lazy(()=>H(()=>import("./clusteringevents-CQdjjSQo.js"),__vite__mapDeps([15,1,2,3,11,12,16]),import.meta.url));i.lazy(()=>H(()=>import("./litflow-DYT07kb5.js"),__vite__mapDeps([17,1,2,3]),import.meta.url));const an=i.lazy(()=>H(()=>import("./boxupcyberspace-CJjHQ5R1.js"),__vite__mapDeps([18,1,2,3]),import.meta.url)),rn=i.lazy(()=>H(()=>import("./epsteinscret-mLJBzIXl.js"),__vite__mapDeps([19,1,2,3]),import.meta.url)),sn=i.lazy(()=>H(()=>import("./wechatgame-BR7BpSrd.js"),__vite__mapDeps([20,1,2,3]),import.meta.url)),ln=i.lazy(()=>H(()=>import("./riffle-BuqCfcTA.js"),__vite__mapDeps([21,1,2,3]),import.meta.url)),on=i.lazy(()=>H(()=>import("./genstyle-DuJ38oKx.js"),__vite__mapDeps([22,1,2,3]),import.meta.url)),dn=i.lazy(()=>H(()=>import("./genshot-8Uy4GIux.js"),__vite__mapDeps([23,1,2,3]),import.meta.url)),cn=u=>({"cluster-visualizer-3d":Qt,"participatory-urban-regeneration-empowered-by-artificial-intelligence":Zt,heatmapper:Yt,"how-to-add-openstreetmap-in-website":Jt,"how-to-get-sequential-events-from-photo-by-phone":en,"how-to-visualize-photo-geolocation-data-on-map":tn,"how-to-build-game-in-wechat-mini-program":sn,"how-to-conduct-time-geo-sequential-clustering-from-album":nn,"box-up-my-stuff-in-cyberspace":an,"epstein-mystery-archive":rn,"riffle-ai-game-generation-tool":ln,genstyle:on,"genshot-AI-video-generation-tool":dn})[u],Ve={"how-to-add-openstreetmap-in-website":`// 1. 导入必要的库
...
}`},We=({images:u,captions:s})=>{const[C,o]=i.useState(0),m=()=>{o(r=>r===0?u.length-1:r-1)},l=()=>{o(r=>r===u.length-1?0:r+1)},n=s==null?void 0:s[C];return e.jsxs("div",{className:"w-full",children:[e.jsxs("div",{className:"relative overflow-hidden rounded-lg shadow-lg bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center max-h-[350px]",children:[e.jsx("img",{src:u[C],className:"max-w-full max-h-[350px] w-auto h-auto object-contain",alt:n||`Carousel Image ${C+1}`}),e.jsx("button",{onClick:m,className:"absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:l,className:"absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/70 dark:bg-neutral-800/70 shadow-md hover:bg-white dark:hover:bg-neutral-700 transition-colors z-10",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),e.jsx("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1 z-10",children:u.map((r,t)=>e.jsx("button",{onClick:()=>o(t),className:`h-1.5 rounded-full transition-all duration-300 ${C===t?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2 hover:bg-neutral-400"}`,"aria-label":`Go to slide ${t+1}`},t))})]}),n&&e.jsxs("div",{className:"mt-2 text-center",children:[e.jsx("p",{className:"text-sm text-neutral-600 dark:text-neutral-400 italic",children:n}),e.jsxs("p",{className:"text-xs text-neutral-400 dark:text-neutral-500 mt-1 font-mono",children:[C+1," / ",u.length]})]}),!n&&e.jsxs("p",{className:"mt-2 text-xs text-neutral-400 dark:text-neutral-500 text-center font-mono",children:[C+1," / ",u.length]})]})},un=({src:u,...s})=>{const[C,o]=i.useState(!1),[m,l]=i.useState(!1),n=()=>{o(!0),l(!0)},r=()=>{o(!1),l(!0)};return i.useEffect(()=>{const t=setTimeout(()=>{m||(o(!1),l(!0))},3e3);return()=>clearTimeout(t)},[m]),e.jsxs(e.Fragment,{children:[e.jsx("iframe",{src:u,onLoad:n,onError:r,style:{display:"none"},title:"detector"}),!m&&e.jsx("div",{className:"w-full my-4",children:e.jsxs("a",{href:u,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-600 hover:bg-neutral-100 transition-colors",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"访问链接"]})}),m&&C&&e.jsx("div",{className:"w-full my-6",children:e.jsx("iframe",{src:u,className:"w-full h-96 rounded-lg shadow-md border border-neutral-200",allowFullScreen:!0,...s})}),m&&!C&&e.jsx("div",{className:"w-full my-4",children:e.jsxs("a",{href:u,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-neutral-600 hover:bg-neutral-100 transition-colors",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})}),"访问链接"]})})]})},ke=({data:u,type:s})=>{const{id:C}=nt(),[o,m]=i.useState("details"),l=u.find(n=>n.slug===C);return i.useEffect(()=>{const n=()=>{window.location.hash.includes("demo")?m("demo"):m("details")};return n(),window.addEventListener("hashchange",n),()=>window.removeEventListener("hashchange",n)},[C]),l?e.jsxs("div",{className:"flex flex-col animate-in slide-in-from-right-4 duration-500 h-screen",children:[e.jsxs("div",{className:"sticky top-0 z-5 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-800 px-4 md:px-6 py-3 md:py-4 flex justify-between items-center shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-4 md:gap-6",children:[e.jsx(J,{to:`/${s}`,className:"flex items-center gap-2 text-xs font-mono text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors uppercase tracking-wider",children:"← Index"}),e.jsx("div",{className:"h-4 w-px bg-neutral-200 dark:bg-neutral-700 hidden md:block"}),e.jsx("h2",{className:"text-xs md:text-sm font-bold text-neutral-900 dark:text-neutral-100 truncate max-w-[120px] md:max-w-[200px]",children:l.title})]}),e.jsxs("div",{className:"flex bg-neutral-100 dark:bg-neutral-800 p-1 rounded-sm border border-neutral-200 dark:border-neutral-700",children:[e.jsx("button",{onClick:()=>m("details"),className:`px-2 md:px-3 py-1 text-xs font-mono ${o==="details"?"bg-white dark:bg-neutral-700 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:"DOCS"}),l.hasDemo&&e.jsxs("button",{onClick:()=>m("demo"),className:`px-2 md:px-3 py-1 text-xs font-mono flex items-center gap-2 ${o==="demo"?"bg-white dark:bg-neutral-700 text-blue-600 dark:text-blue-400 shadow-sm":"text-neutral-500 dark:text-neutral-400"}`,children:[e.jsxs("span",{className:"relative flex h-2 w-2",children:[e.jsx("span",{className:"animate-ping absolute h-full w-full rounded-full bg-blue-400 opacity-75"}),e.jsx("span",{className:"relative rounded-full h-2 w-2 bg-blue-500"})]}),"DEMO"]})]})]}),e.jsx("div",{className:`flex-1 ${o==="details"?"overflow-y-auto":"overflow-hidden"}`,children:o==="details"?e.jsxs("div",{className:"flex flex-col p-4 md:p-6 lg:p-10 w-full h-full max-w-7xl mx-auto",children:[e.jsxs("div",{className:"mb-8 md:mb-10",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:l.tech.map((n,r)=>e.jsx("span",{className:"px-2 py-1 text-xs font-mono bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700 rounded-sm",children:n},r))}),e.jsxs("div",{className:"flex items-center gap-4 text-sm text-neutral-500 dark:text-neutral-400 mb-4",children:[e.jsxs("span",{className:"font-mono text-xs uppercase tracking-wide",children:["NO. ",l.id]}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("span",{children:l.year}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("span",{children:l.category})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-light mb-6 text-neutral-900 dark:text-neutral-100 tracking-tight",children:l.title}),e.jsx("div",{className:"bg-gradient-to-r from-neutral-50 dark:from-neutral-800 to-white dark:to-neutral-900 border-l-4 border-neutral-900 dark:border-neutral-500 p-6 md:p-8 rounded-r-lg",children:e.jsxs("p",{className:"font-serif text-base md:text-lg text-neutral-700 dark:text-neutral-300 leading-relaxed italic",children:['"',l.description,'"']})})]}),e.jsx("div",{className:"w-full flex-grow",children:e.jsxs("div",{className:"space-y-8 md:space-y-10 max-w-4xl mx-auto",children:[l.details.abstract&&e.jsxs("section",{id:"abstract",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Abstract"}),e.jsx("p",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 whitespace-normal",children:l.details.abstract})]}),l.details.challenge&&e.jsxs("section",{id:"challenges",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Challenges"}),e.jsx("p",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 whitespace-normal",children:l.details.challenge})]}),l.details.solution&&e.jsxs("section",{id:"methodology",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Methodology"}),e.jsx("p",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 whitespace-normal",children:l.details.solution})]}),l.details.content&&e.jsxs("section",{id:"content",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Content"}),e.jsx("div",{className:"text-base md:text-lg leading-relaxed text-neutral-800 dark:text-neutral-200 prose prose-neutral dark:prose-invert max-w-none",children:e.jsx(ot,{remarkPlugins:[ct],rehypePlugins:[dt],components:{iframe:({src:n,title:r,...t})=>e.jsx(un,{src:n,title:r||"Embedded content",...t}),imagecarousel:({images:n,captions:r})=>{const t=(n||"").split(",").map(x=>x.trim()).filter(Boolean),w=r?r.split("|").map(x=>x.trim()):void 0;return e.jsx(We,{images:t,captions:w})},imageCarousel:({images:n,captions:r})=>{const t=(n||"").split(",").map(x=>x.trim()).filter(Boolean),w=r?r.split("|").map(x=>x.trim()):void 0;return e.jsx(We,{images:t,captions:w})},table:({children:n})=>e.jsx("table",{className:"min-w-full border-collapse border border-neutral-300 dark:border-neutral-600",children:n}),thead:({children:n})=>e.jsx("thead",{className:"bg-neutral-50 dark:bg-neutral-800",children:n}),th:({children:n})=>e.jsx("th",{className:"border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-left font-semibold text-neutral-900 dark:text-neutral-100 text-sm",children:n}),td:({children:n})=>e.jsx("td",{className:"border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-neutral-700 dark:text-neutral-300 text-sm",children:n}),h1:({children:n,...r})=>{const w=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h1",{id:w,className:"text-2xl font-bold mb-4 text-neutral-900 dark:text-neutral-100",...r,children:n})},h2:({children:n,...r})=>{const w=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h2",{id:w,className:"text-xl font-bold mb-6 mt-8 text-neutral-800 dark:text-neutral-200",...r,children:n})},h3:({children:n,...r})=>{const w=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h3",{id:w,className:"text-lg font-semibold mb-4 mt-6 text-neutral-800 dark:text-neutral-200",...r,children:n})},h4:({children:n,...r})=>{const w=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h4",{id:w,className:"text-base font-semibold mb-3 mt-4 text-neutral-700 dark:text-neutral-300",...r,children:n})},h5:({children:n,...r})=>{const w=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h5",{id:w,className:"text-sm font-semibold mb-2 mt-3 text-neutral-700 dark:text-neutral-300",...r,children:n})},h6:({children:n,...r})=>{const w=(typeof n=="string"?n:(n==null?void 0:n.toString())||"").toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-");return e.jsx("h6",{id:w,className:"text-xs font-semibold mb-2 mt-2 text-neutral-600 dark:text-neutral-400",...r,children:n})},p:({children:n,...r})=>e.jsx("p",{className:"mb-4 leading-relaxed",...r,children:n}),a:({children:n,href:r,...t})=>e.jsx("a",{href:r,className:"text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline decoration-1 hover:decoration-2 transition-all duration-200 font-medium",target:"_blank",rel:"noopener noreferrer",...t,children:n}),img:({src:n,alt:r,...t})=>{var x;return((x=t.className)==null?void 0:x.includes("h-32"))||(r==null?void 0:r.includes("BCR"))||(r==null?void 0:r.includes("BHV"))||(r==null?void 0:r.includes("SVF"))||(r==null?void 0:r.includes("NDVI"))||(r==null?void 0:r.includes("EV"))||(r==null?void 0:r.includes("WR"))||(r==null?void 0:r.includes("Dist_"))?e.jsx("img",{src:n,alt:r,className:"max-w-full h-32 object-cover rounded-lg shadow-sm",...t}):e.jsx("img",{src:n,alt:r,className:"w-full max-w-full h-auto rounded-lg shadow-md my-6",...t})}},children:l.details.content})})]}),(l.details.code||l.details.codeComponent||Ve[l.slug])&&e.jsxs("section",{id:"code",children:[e.jsx("h3",{className:"text-sm font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-4 pb-2 border-b border-neutral-100 dark:border-neutral-800",children:"Code Example"}),e.jsx("div",{className:"bg-neutral-900 dark:bg-neutral-800 text-neutral-100 dark:text-neutral-100 p-6 rounded-lg overflow-x-auto",children:e.jsx("pre",{className:"text-sm font-mono leading-relaxed",children:e.jsx("code",{children:Ve[l.slug]||l.details.codeComponent||`// Code file: ${l.details.code}`})})})]})]})})]}):e.jsx("div",{className:"w-full h-full bg-neutral-100 dark:bg-neutral-900 relative",children:e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"absolute inset-0 flex items-center justify-center text-neutral-400 dark:text-neutral-500 font-mono",children:"Loading demo..."}),children:(()=>{const n=cn(l.slug);return n?e.jsx(n,{}):e.jsx("div",{className:"absolute inset-0 flex items-center justify-center text-neutral-400 dark:text-neutral-500 font-mono",children:"DEMO NOT AVAILABLE"})})()})})})]}):e.jsx("div",{className:"p-4 md:p-10 font-mono",children:"PROJECT_NOT_FOUND"})},mn=()=>e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100 border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8",children:"About Me"}),e.jsxs("div",{className:"font-light text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed max-w-none",children:[e.jsxs("p",{className:"text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 md:mb-6 font-light",children:["I am Lili Lin, a Master's student at Seoul National University in the City Energy Lab, where my research focuses on ",e.jsx("span",{className:"font-medium border-b border-neutral-300 dark:border-neutral-600",children:"AI-assisted urban planning"}),", especially on ",e.jsx("span",{className:"font-medium border-b border-neutral-300 dark:border-neutral-600",children:"urban heat environments"}),". I received my Bachelor's degree in Architecture from Huazhong University of Science and Technology."]}),e.jsx("p",{className:"text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 md:mb-6 font-light",children:"In my current researches, I use machine learning models and statistic analysis to understand how environmental factors influence climate-related risks. Using Landsat 8 and spatial regression to quantified how Local Climate Zones affect urban heat resilience in NYC and LA; Examined the MAUP problem using GBDT and PDP analyses to reveal non-linear relationships between urban form, land cover, and heat exposure across multiple spatial scales in Seoul."}),e.jsxs("p",{className:"text-base md:text-lg text-neutral-800 dark:text-neutral-200 leading-relaxed mb-4 md:mb-6 font-light",children:["I am also ",e.jsx("span",{className:"font-medium border-b border-neutral-300 dark:border-neutral-600",children:"UI&UX designer and front-end developer"})," passionate about creating intuitive digital experiences. I have designed and developed several web applications and design systems. My technical skills include React, TypeScript, Three.js, Figma."]}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-8 md:mt-12 border-t border-neutral-100 dark:border-neutral-800 pt-6 md:pt-8",children:e.jsxs("div",{children:[e.jsx("h4",{className:"font-mono text-xs text-neutral-400 dark:text-neutral-500 uppercase mb-4",children:"Core Competencies"}),e.jsxs("ul",{className:"space-y-2 text-sm text-neutral-700 dark:text-neutral-300",children:[e.jsx("li",{children:"Urban Climate & Resilience"}),e.jsx("li",{children:"AI-Assisted Urban Planning"}),e.jsx("li",{children:"Machine Learning & Data Analysis"}),e.jsx("li",{children:"Spatial Statistics & GIS"}),e.jsx("li",{children:"React / Next.js ecosystem"}),e.jsx("li",{children:"TypeScript Architecture"}),e.jsx("li",{children:"WebGL / Three.js"}),e.jsx("li",{children:"UI Systems Design"})]})]})}),e.jsxs("div",{className:"mt-8 md:mt-12 border-t border-neutral-100 dark:border-neutral-800 pt-6 md:pt-8",children:[e.jsx("h4",{className:"font-mono text-xs text-neutral-400 dark:text-neutral-500 uppercase mb-4",children:"Conference Presentations"}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium text-sm text-neutral-900 dark:text-neutral-100 mb-3",children:"Knowledge Graph Generation from Urban Planning Texts"}),e.jsxs("div",{className:"space-y-3 text-sm text-neutral-700 dark:text-neutral-300 pl-2",children:[e.jsx("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:"Poster presentation at 39th AAAI Workshop - AI for Urban Planning, Philadelphia, PA, USA, February 28-March 3, 2025"})}),e.jsx("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:"Oral presentation at Computational Urban Planning and Urban Management Conference (CUPUM), London, UK, June 23-27, 2025"})}),e.jsx("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400",children:"Oral presentation at the 19th International Association for China Planning Conference (IACP) Annual Conference, Xiamen, China, July 3-7, 2025"})})]})]}),e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium text-sm text-neutral-900 dark:text-neutral-100 mb-3",children:"Urban Form & Heat Resilience"}),e.jsxs("div",{className:"space-y-3 text-sm text-neutral-700 dark:text-neutral-300 pl-2",children:[e.jsxs("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:[e.jsx("p",{className:"text-xs font-medium text-neutral-800 dark:text-neutral-200",children:'"Local Climate Zone and Urban Heat Resilience: An Empirical Study in New York"'}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 mt-1",children:"Oral presentation at the 52nd International Conference on Urban Affairs (ICUA), Vancouver, Canada, April 15-19, 2025"})]}),e.jsxs("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:[e.jsx("p",{className:"text-xs font-medium text-neutral-800 dark:text-neutral-200",children:'"Reveal nonlinear relationships between urban form factors and extreme heat with an explainable machine learning approach"'}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 mt-1",children:"Oral presentation at 65th Association of Collegiate Schools of Planning Annual Conference (ACSP), Minneapolis, MN, USA, October 23-25, 2025"})]}),e.jsxs("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:[e.jsx("p",{className:"text-xs font-medium text-neutral-800 dark:text-neutral-200",children:'"Assessing Nonlinear Impacts of Urban Form on Heat Resilience Across Scales Using Machine Learning"'}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 mt-1",children:"Poster presentation at 39th AAAI Workshop - AI for Urban Planning, Singapore, January 26, 2026"})]}),e.jsxs("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:[e.jsx("p",{className:"text-xs font-medium text-neutral-800 dark:text-neutral-200",children:'"Nonlinear Impacts of Urban Form on Urban Heat Islands: A Machine Learning Analysis Across Scales and Weather Conditions in Seoul"'}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 mt-1",children:"Oral presentation at the 20th International Association for China Planning (IACP) Annual Conference, Xi'an, China, July 10-13, 2026"})]})]})]}),e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium text-sm text-neutral-900 dark:text-neutral-100 mb-3",children:"NEUROTOPIA"}),e.jsx("div",{className:"space-y-3 text-sm text-neutral-700 dark:text-neutral-300 pl-2",children:e.jsxs("div",{className:"border-l-2 border-neutral-200 dark:border-neutral-700 pl-3",children:[e.jsx("p",{className:"text-xs font-medium text-neutral-800 dark:text-neutral-200",children:'"Decentralized future urban design based on the biological characteristics of neurons"'}),e.jsx("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 mt-1",children:"Oral presentation at Urban Design Institute of Korea (UDIK) Autumn Conference, Seoul, South Korea, October 10, 2024"})]})})]})]})]})]})]}),hn=()=>e.jsxs("div",{className:"h-full flex flex-col justify-center items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500",children:[e.jsx("div",{className:"w-16 h-16 border border-neutral-300 dark:border-neutral-600 flex items-center justify-center mb-6 text-2xl rotate-45 hover:rotate-90 transition-transform duration-500",children:"✉️"}),e.jsx("h2",{className:"text-3xl font-bold text-neutral-900 dark:text-neutral-100 mb-4",children:"CONTACT_FOR_COLLABORATION"}),e.jsx("a",{href:"mailto:lily1326685527@gmail.com?subject=Research%20Collaboration",className:"bg-neutral-900 dark:bg-neutral-700 text-white px-8 py-3 text-sm font-mono hover:bg-neutral-700 dark:hover:bg-neutral-600 transition-colors",children:"SEND_TRANSMISSION"})]}),Ee=({href:u,label:s})=>e.jsx("a",{href:u,target:"_blank",rel:"noopener noreferrer",className:"w-8 h-8 flex items-center justify-center border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 hover:border-neutral-900 dark:hover:border-neutral-500 transition-all rounded-sm text-xs font-mono",children:s}),gn=()=>{const[u,s]=i.useState("all"),[C,o]=i.useState("/data/fig/lili/lili_01.png"),m={all:"/data/fig/lili/lili_01.png",design:"/data/fig/lili/lili_05.png",planning:"/data/fig/lili/lili_06.png",game:"/data/fig/lili/lili_03.png",platform:"/data/fig/lili/lili_11.png",tutorial:"/data/fig/lili/lili_04.png"};i.useEffect(()=>{o(m[u]||m.all)},[u]);const l=(()=>{const j={all:[...pe.map(f=>({...f,type:"design"})),...ge.map(f=>({...f,type:"planning"})),...xe.map(f=>({...f,type:"game"})),...fe.map(f=>({...f,type:"platform"})),...be.map(f=>({...f,type:"tutorial"}))],design:pe.map(f=>({...f,type:"design"})),planning:ge.map(f=>({...f,type:"planning"})),game:xe.map(f=>({...f,type:"game"})),platform:fe.map(f=>({...f,type:"platform"})),tutorial:be.map(f=>({...f,type:"tutorial"}))};return j[u]||j.all})(),[n,r]=i.useState(0),t=l.length-1,[w,x]=i.useState(0),T=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260305-222003.mp4",title:"Welcome to My Portfolio",subtitle:"Explore my projects in urban planning, design, game development, and AI tutorials."},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260304_heatmap_2.mp4",title:"Data Visualization",subtitle:"Interactive heatmaps and spatial analysis for urban research."}],[L,G]=i.useState(0),[c,R]=i.useState({}),[_,U]=i.useState(1),D=20,F=[{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/kitty-0317.mp4",title:"Kitty Video"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/%E5%BE%AE%E4%BF%A1%E8%A7%86%E9%A2%912026-02-09_184301_354.mp4",title:"Kitty Video 2"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/20260225-192100.mp4",title:"Riffle Loading 1"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video3.mp4",title:"Video Title 3"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video4.mp4",title:"Video Title 4"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video5.mp4",title:"Video Title 5"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video6.mp4",title:"Video Title 6"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video7.mp4",title:"Video Title 7"},{src:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/video8.mp4",title:"Video Title 8"}],ne=(j,f)=>{var K,se;const N=j;if(console.log(`Checking audio for video ${f}:`,{audioTracks:(K=N.audioTracks)==null?void 0:K.length,mozHasAudio:N.mozHasAudio,webkitAudioDecodedByteCount:N.webkitAudioDecodedByteCount,videoTracks:(se=N.videoTracks)==null?void 0:se.length,readyState:N.readyState}),N.audioTracks&&N.audioTracks.length>0){const V=Array.from(N.audioTracks).some(X=>X.enabled);console.log(`Video ${f} has audioTracks:`,V),R(X=>({...X,[f]:V}));return}if("mozHasAudio"in N){const V=N.mozHasAudio;console.log(`Video ${f} mozHasAudio:`,V),R(X=>({...X,[f]:V}));return}const O=N.webkitAudioDecodedByteCount;if(typeof O=="number"&&O>0){console.log(`Video ${f} webkitAudioDecodedByteCount:`,O),R(V=>({...V,[f]:!0}));return}if(N.readyState>=3){setTimeout(()=>{const V=N.webkitAudioDecodedByteCount,X=N.mozHasAudio,ae=V>0||X===!0;console.log(`Video ${f} delayed check:`,{delayedWebkitAudio:V,delayedMozAudio:X,hasAudio:ae}),R(re=>({...re,[f]:ae}))},500);return}console.log(`Video ${f} default to has audio`),R(V=>({...V,[f]:!0}))};i.useEffect(()=>{const j=setInterval(()=>{x(f=>(f+1)%T.length)},8e3);return()=>clearInterval(j)},[T.length]);const Y=i.useRef(null);return i.useEffect(()=>{const j=Y.current;if(!j)return;const f=N=>{const O=N.target;j.contains(O)&&(N.preventDefault(),r(K=>N.deltaY>0?Math.min(K+1,t):Math.max(K-1,0)))};return j.addEventListener("wheel",f,{passive:!1}),()=>j.removeEventListener("wheel",f)},[t]),e.jsxs("div",{className:"p-4 md:p-6 lg:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500",children:[e.jsx("div",{className:"flex flex-col items-center border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6 md:mb-8 gap-4",children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"flex justify-center mb-4",children:e.jsx("img",{src:C,alt:"Lili Avatar",className:"w-24 h-24 md:w-32 md:h-32 object-contain"})}),e.jsxs("div",{className:"flex flex-wrap gap-4 justify-center mb-3",children:[e.jsxs("button",{onClick:()=>{s("all"),r(0)},className:`px-3 py-1.5 rounded transition-all ${u==="all"?"text-lg font-bold text-neutral-900 dark:text-neutral-100 border-b-2 border-neutral-900 dark:border-neutral-100":"text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:["All (",pe.length+ge.length+xe.length+fe.length+be.length,")"]}),e.jsxs("button",{onClick:()=>{s("design"),r(0)},className:`px-3 py-1.5 rounded transition-all ${u==="design"?"text-lg font-bold text-neutral-900 dark:text-neutral-100 border-b-2 border-neutral-900 dark:border-neutral-100":"text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:["Design (",pe.length,")"]}),e.jsxs("button",{onClick:()=>{s("planning"),r(0)},className:`px-3 py-1.5 rounded transition-all ${u==="planning"?"text-lg font-bold text-neutral-900 dark:text-neutral-100 border-b-2 border-neutral-900 dark:border-neutral-100":"text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:["Planning (",ge.length,")"]}),e.jsxs("button",{onClick:()=>{s("game"),r(0)},className:`px-3 py-1.5 rounded transition-all ${u==="game"?"text-lg font-bold text-neutral-900 dark:text-neutral-100 border-b-2 border-neutral-900 dark:border-neutral-100":"text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:["Game (",xe.length,")"]}),e.jsxs("button",{onClick:()=>{s("platform"),r(0)},className:`px-3 py-1.5 rounded transition-all ${u==="platform"?"text-lg font-bold text-neutral-900 dark:text-neutral-100 border-b-2 border-neutral-900 dark:border-neutral-100":"text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:["Platform (",fe.length,")"]}),e.jsxs("button",{onClick:()=>{s("tutorial"),r(0)},className:`px-3 py-1.5 rounded transition-all ${u==="tutorial"?"text-lg font-bold text-neutral-900 dark:text-neutral-100 border-b-2 border-neutral-900 dark:border-neutral-100":"text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100"}`,children:["Tutorial (",be.length,")"]})]}),e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:[n+1," / ",l.length]})]})}),e.jsx("div",{ref:Y,className:"relative w-full h-[400px] flex items-center justify-center overflow-hidden z-10 mb-10 md:mb-12",children:l.map((j,f)=>{var ae;const N=f-n;if(N<-2||N>3)return null;const O=1-Math.abs(N)*.08,K=N*60,se=-Math.abs(N)*120,V=N*-6,X=N===0?1:.5;return e.jsx("div",{className:"absolute w-full max-w-7xl transition-all duration-500 ease-out",style:{transform:`
                  translateY(${K+20}px)
                  translateZ(${se}px)
                  rotateX(${V}deg)
                  scale(${O})
                `,opacity:X,zIndex:100-Math.abs(N)},children:e.jsx("div",{className:"bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl p-6 shadow-lg",children:e.jsxs("div",{className:"flex gap-6",children:[e.jsx("div",{className:"w-36 h-36 bg-neutral-100 dark:bg-neutral-800 overflow-hidden rounded-md flex-shrink-0",children:e.jsx("img",{src:j.details.logo,alt:j.title,className:"w-full h-full object-cover"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("span",{className:"text-[10px] font-mono px-2 py-1 bg-neutral-100 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-200 rounded",children:j.type.toUpperCase()}),e.jsx("span",{className:"text-[10px] font-mono text-neutral-400 dark:text-neutral-500",children:j.year})]}),e.jsx("h3",{className:"text-xl font-bold mb-2 text-neutral-900 dark:text-neutral-100",children:j.title}),e.jsx("p",{className:"text-sm text-neutral-600 dark:text-neutral-400 mb-4 line-clamp-3",children:j.description}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:(ae=j.tech)==null?void 0:ae.slice(0,3).map((re,Ne)=>e.jsx("span",{className:"text-[10px] font-mono px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded",children:re},Ne))}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("a",{href:`#/${j.type}/${j.slug}`,className:"px-4 py-2 text-xs font-mono bg-neutral-200 dark:bg-neutral-700 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-neutral-700 dark:text-neutral-200 rounded",children:"VIEW"}),j.hasDemo&&e.jsx("a",{href:`#/${j.type}/${j.slug}#demo`,className:"px-4 py-2 text-xs font-mono bg-blue-600 text-white hover:bg-blue-700 rounded",children:"DEMO"})]})]})]})})},`${j.type}-${j.slug}`)})}),e.jsxs("div",{className:"relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-2xl overflow-hidden mb-8 md:mb-10 shadow-2xl",children:[T.map((j,f)=>e.jsx("div",{className:`absolute inset-0 transition-opacity duration-1000 ${f===w?"opacity-100":"opacity-0"}`,children:e.jsx("video",{className:"absolute inset-0 w-full h-full object-cover",src:j.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0})},f)),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"}),e.jsxs("div",{className:"absolute bottom-0 left-0 right-0 p-6 md:p-10",children:[e.jsx("h1",{className:"text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3",children:T[w].title}),e.jsx("p",{className:"text-base md:text-lg text-white/80 max-w-2xl",children:T[w].subtitle})]}),e.jsx("div",{className:"absolute bottom-6 right-6 md:bottom-10 md:right-10 flex gap-2",children:T.map((j,f)=>e.jsx("button",{onClick:()=>x(f),className:`w-2 h-2 md:w-3 md:h-3 rounded-full transition-all duration-300 ${f===w?"bg-white w-6 md:w-8":"bg-white/50 hover:bg-white/80"}`},f))}),e.jsx("button",{onClick:()=>x(j=>(j-1+T.length)%T.length),className:"absolute left-4 md:left-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/30 hover:bg-black/50 text-white flex items-center justify-center transition-all duration-300 opacity-0 hover:opacity-100 group-hover:opacity-100",style:{opacity:.7},children:e.jsx("svg",{className:"w-5 h-5 md:w-6 md:h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:()=>x(j=>(j+1)%T.length),className:"absolute right-4 md:right-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/30 hover:bg-black/50 text-white flex items-center justify-center transition-all duration-300 opacity-0 hover:opacity-100 group-hover:opacity-100",style:{opacity:.7},children:e.jsx("svg",{className:"w-5 h-5 md:w-6 md:h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),e.jsxs("div",{className:"mb-10 md:mb-12",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Video Gallery"}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:[L+1," / ",F.length]}),e.jsxs("div",{className:"flex gap-1",children:[e.jsx("button",{onClick:()=>G(j=>(j-1+F.length)%F.length),className:"w-8 h-8 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 flex items-center justify-center transition-colors",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:()=>G(j=>(j+1)%F.length),className:"w-8 h-8 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 flex items-center justify-center transition-colors",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]})]})]}),e.jsx("div",{className:"relative overflow-hidden",children:e.jsx("div",{className:"flex transition-transform duration-500 ease-out",style:{transform:`translateX(-${L*(100/4)}%)`},children:F.map((j,f)=>e.jsx("div",{className:"w-1/4 flex-shrink-0 px-2",children:e.jsxs("div",{className:"relative aspect-[9/16] rounded-xl overflow-hidden bg-neutral-100 dark:bg-neutral-800 group cursor-pointer",onMouseEnter:N=>{const O=N.currentTarget.querySelector("video");O&&O.play().catch(K=>console.log("Video play failed:",K))},onMouseLeave:N=>{const O=N.currentTarget.querySelector("video");O&&O.pause()},children:[e.jsx("video",{className:"w-full h-full object-cover transition-transform duration-300 group-hover:scale-105",src:j.src,muted:!0,loop:!0,playsInline:!0,preload:"metadata",onCanPlay:N=>ne(N.currentTarget,f)}),c[f]&&e.jsx("div",{className:"absolute top-2 right-2 w-6 h-6 rounded-full bg-black/50 flex items-center justify-center",children:e.jsx("svg",{className:"w-3 h-3 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"})})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),e.jsx("div",{className:"absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300",children:e.jsx("p",{className:"text-white text-xs font-medium truncate",children:j.title})})]})},f))})}),e.jsx("div",{className:"flex justify-center gap-2 mt-4",children:Array.from({length:Math.ceil(F.length/4)}).map((j,f)=>e.jsx("button",{onClick:()=>G(f*4),className:`h-2 rounded-full transition-all duration-300 ${Math.floor(L/4)===f?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2"}`},f))})]}),e.jsxs("div",{className:"mb-10 md:mb-12",children:[e.jsxs("div",{className:"flex justify-between items-end border-b border-neutral-100 dark:border-neutral-800 pb-4 mb-6",children:[e.jsx("h2",{className:"text-lg md:text-xl font-medium text-neutral-900 dark:text-neutral-100",children:"Portfolio PDF"}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("span",{className:"text-xs font-mono text-neutral-400 dark:text-neutral-500",children:["Pages ",_,"-",Math.min(_+1,D)," / ",D]}),e.jsxs("div",{className:"flex gap-1",children:[e.jsx("button",{onClick:()=>U(j=>Math.max(1,j-2)),disabled:_<=1,className:"w-8 h-8 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 disabled:opacity-30 flex items-center justify-center transition-colors",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:()=>U(j=>Math.min(D,j+2)),disabled:_>=D-1,className:"w-8 h-8 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 disabled:opacity-30 flex items-center justify-center transition-colors",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),e.jsx("a",{href:"https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/lili_planning_portfolio.pdf",target:"_blank",rel:"noopener noreferrer",className:"p-2 text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"Open in new window",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})})})]})]}),e.jsx("div",{className:"max-w-5xl mx-auto relative group/pdf",children:e.jsxs("div",{className:"grid grid-cols-2 gap-0 relative overflow-hidden px-10",children:[e.jsx($e,{mode:"wait",children:e.jsxs(Se.div,{initial:{x:50,opacity:0},animate:{x:0,opacity:1},exit:{x:-50,opacity:0},transition:{duration:.3,ease:"easeInOut"},className:"grid grid-cols-2 gap-0 col-span-2",children:[e.jsxs("div",{className:"relative aspect-[0.98/1.4] bg-neutral-100 dark:bg-neutral-800 rounded-l-lg overflow-hidden shadow-md border-y border-l border-neutral-200 dark:border-neutral-700",children:[e.jsx("iframe",{src:`https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/lili_planning_portfolio.pdf#page=${_}&view=Fit&scrollbar=0&toolbar=0&navpanes=0`,className:"absolute w-[105%] h-[105%] pointer-events-none",title:`Portfolio PDF Page ${_}`,style:{border:"none",maxWidth:"none",left:"-1%",top:"-0.4%",transform:"none"}}),e.jsx("div",{className:"absolute inset-0 bg-transparent z-10"})]}),e.jsx("div",{className:"relative aspect-[0.98/1.4] bg-neutral-100 dark:bg-neutral-800 rounded-r-lg overflow-hidden shadow-md border-y border-r border-neutral-200 dark:border-neutral-700",children:_+1<=D?e.jsxs(e.Fragment,{children:[e.jsx("iframe",{src:`https://pub-3209bcb7fc36444a914deb0e70ceca92.r2.dev/lili_planning_portfolio.pdf#page=${_+1}&view=Fit&scrollbar=0&toolbar=0&navpanes=0`,className:"absolute w-[105%] h-[103%] pointer-events-none",title:`Portfolio PDF Page ${_+1}`,style:{border:"none",maxWidth:"none",left:"-1%",top:"-0.4%",transform:"none"}}),e.jsx("div",{className:"absolute inset-0 bg-transparent z-10"})]}):e.jsx("div",{className:"w-full h-full flex items-center justify-center text-neutral-400 font-mono text-sm",children:"END"})})]},`page-container-${_}`)}),e.jsx("button",{onClick:()=>U(j=>Math.max(1,j-2)),disabled:_<=1,className:"absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/80 dark:bg-neutral-800/80 shadow-lg hover:bg-white dark:hover:bg-neutral-700 flex items-center justify-center transition-all z-20 disabled:opacity-0",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),e.jsx("button",{onClick:()=>U(j=>Math.min(D,j+2)),disabled:_>=D-1,className:"absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/80 dark:bg-neutral-800/80 shadow-lg hover:bg-white dark:hover:bg-neutral-700 flex items-center justify-center transition-all z-20 disabled:opacity-0",children:e.jsx("svg",{className:"w-5 h-5 text-neutral-700 dark:text-neutral-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]})}),e.jsx("div",{className:"flex justify-center gap-1 mt-6 flex-wrap",children:Array.from({length:Math.ceil(D/2)}).map((j,f)=>{const N=f*2+1,O=_===N||_===N-1;return e.jsx("button",{onClick:()=>U(N),className:`h-1.5 rounded-full transition-all duration-300 ${O?"bg-neutral-800 dark:bg-neutral-200 w-6":"bg-neutral-300 dark:bg-neutral-600 w-2 hover:bg-neutral-400"}`,title:`Pages ${N}-${Math.min(N+1,D)}`},f)})})]})]})},pn=()=>{const[u,s]=i.useState(!1);i.useEffect(()=>{const o=localStorage.getItem("theme"),m=window.matchMedia("(prefers-color-scheme: dark)").matches;(o==="dark"||!o&&m)&&(s(!0),document.documentElement.classList.add("dark"))},[]);const C=()=>{const o=!u;s(o),o?(document.documentElement.classList.add("dark"),localStorage.setItem("theme","dark")):(document.documentElement.classList.remove("dark"),localStorage.setItem("theme","light"))};return e.jsx("button",{onClick:C,className:"flex items-center gap-2 px-3 py-2 border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all",title:u?"切换到日间模式":"切换到夜间模式",children:u?e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"})}):e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"})})})},He="https://pub-e0170f3fece2419a85fa1ce02c1f1a28.r2.dev/223_cities_cluster_with_index.zip",xn="/data/223_cities_cluster_with_index_deciles.csv",ue=u=>{const s=u.replace("#",""),C=parseInt(s.slice(0,2),16),o=parseInt(s.slice(2,4),16),m=parseInt(s.slice(4,6),16);return[C,o,m]},me=(u,s,C)=>{const o=Math.round(u[0]+(s[0]-u[0])*C),m=Math.round(u[1]+(s[1]-u[1])*C),l=Math.round(u[2]+(s[2]-u[2])*C);return`rgb(${o}, ${m}, ${l})`},he=[{key:"K_5",label:"Cluster K=5",category:"cluster",type:"number"},{key:"K_12",label:"Cluster K=12",category:"cluster",type:"number"},{key:"K_20",label:"Cluster K=20",category:"cluster",type:"number"},{key:"K_26",label:"Cluster K=26",category:"cluster",type:"number"},{key:"elev_mean",label:"Elevation Mean(m)",category:"terrain",type:"number"},{key:"elev_std",label:"Elevation Std(m)",category:"terrain",type:"number"},{key:"elev_range",label:"Elevation Range(m)",category:"terrain",type:"number"},{key:"slope_mean",label:"Slope Mean(°)",category:"terrain",type:"number"},{key:"slope_std",label:"Slope Std(N/A)",category:"terrain",type:"number"},{key:"slope_rang",label:"Slope Range(N/A)",category:"terrain",type:"number"},{key:"LandArea",label:"Land Area",category:"urban",type:"number"},{key:"Buiheight",label:"Building Height(m)",category:"urban",type:"number"},{key:"BldArea",label:"Building Area(m²)",category:"urban",type:"number"},{key:"CoverRatio",label:"Building Coverage",category:"urban",type:"number"},{key:"FAR",label:"Floor Area Ratio(N/A)",category:"urban",type:"number"},{key:"GreenArea",label:"Green Area(m²)",category:"urban",type:"number"},{key:"GrHeight",label:"Green Height(m)",category:"urban",type:"number"},{key:"GreenRatio",label:"Green Ratio(N/A)",category:"urban",type:"number"},{key:"GrVolRatio",label:"Green Volume Ratio(N/A)",category:"urban",type:"number"},{key:"ISF",label:"Impervious Surface Fraction(N/A)",category:"urban",type:"number"},{key:"MIN_DistWB",label:"Mini Distance to WaterBody(m)",category:"urban",type:"number"},{key:"MIN_DistGL",label:"Mini Distance to GreenLand(m)",category:"urban",type:"number"},{key:"MIN_DistMT",label:"Mini Distance to Mountain(m)",category:"urban",type:"number"}],fn=()=>{var ze;const u=i.useRef(null),s=i.useRef(null),[C,o]=i.useState(!0),[m,l]=i.useState(0),[n,r]=i.useState(null),[t,w]=i.useState(null),[x,T]=i.useState([]),[L,G]=i.useState(null),[c,R]=i.useState("K_12"),[_,U]=i.useState(!0),[D,F]=i.useState(null),[ne,Y]=i.useState(null),[j,f]=i.useState(!1),[N,O]=i.useState(null),[K,se]=i.useState(!1),[V,X]=i.useState(null),[ae,re]=i.useState(!1),[Ne,ve]=i.useState(0),[qe,de]=i.useState(""),[Ie,Ke]=i.useState(!1),[ye,Xe]=i.useState(!0),[_e,Te]=i.useState(!0),[Le,Qe]=i.useState({}),[yn,jn]=i.useState(!1),[Q,Ze]=i.useState("global"),Me=i.useRef(null),Re=i.useRef(null),Ye=i.useRef(!1),je=i.useRef(null),Je=(a,g)=>{let k=a.features;L!==null&&(k=k.filter(p=>{var h;const y=(h=p.properties)==null?void 0:h.Place;return y!==void 0&&Number(y)===Number(L)}));const v=k.map(p=>{var y;return(y=p.properties)==null?void 0:y[g]}).filter(p=>{if(p==null)return!1;if(typeof p=="string"){const h=p.trim();if(h===""||/^(na|nan|null)$/i.test(h))return!1}const y=Number(p);return!(Number.isNaN(y)||y===-9999)}).map(p=>Number(p)),P=k.reduce((p,y)=>{var S;const h=(S=y.properties)==null?void 0:S[g];let d=!1;if(h==null)d=!0;else if(typeof h=="string"){const I=h.trim();if(I===""||/^(na|nan|null)$/i.test(I))d=!0;else{const B=Number(h);(Number.isNaN(B)||B===-9999)&&(d=!0)}}else{const I=Number(h);(Number.isNaN(I)||I===-9999)&&(d=!0)}return p+(d?1:0)},0);let A=NaN,M=NaN,b=0;if(v.length>0){A=v[0],M=v[0],b=v[0];for(let p=1;p<v.length;p++){const y=v[p];y<A&&(A=y),y>M&&(M=y),b+=y}}return{count:k.length,min:A,max:M,mean:v.length>0?b/v.length:NaN,nanCount:P}};i.useEffect(()=>{(async()=>{try{const v=(await(await fetch(xn)).text()).trim().split(`
`);if(v.length<2)return;const P=v[0].split(",").map(h=>h.trim()),A={},b=v[v.length-1].split(","),y=v[1].split(",");P.forEach((h,d)=>{if(h===""||h.includes("Place")||h.includes("Sum")||h.includes("FID")||h.includes("index"))return;const S=parseFloat(y[d]),I=parseFloat(b[d]);!isNaN(S)&&!isNaN(I)&&I>S&&(A[h]={min:S,max:I})}),console.log("Loaded attribute ranges:",A),Qe(A)}catch(g){console.error("Failed to load deciles:",g)}})()},[]),i.useEffect(()=>{!Ie&&!t&&(async()=>{var g;o(!0),l(0),r(null);try{l(10),console.log("开始下载..."),Me.current=new AbortController;const k=await fetch(He,{signal:Me.current.signal});if(console.log("响应状态:",k.status),!k.ok)throw new Error(`HTTP error! status: ${k.status}`);l(30);const v=k.headers.get("content-length"),P=v?parseInt(v):null;console.log("预期文件大小:",P);const A=(g=k.body)==null?void 0:g.getReader();if(!A)throw new Error("无法读取响应流");let M=0;const b=[];for(;;){const{done:B,value:E}=await A.read();if(B)break;b.push(E),M+=E.length,l(P?30+Math.round(M/P*60):50)}console.log("下载完成, 收到:",M),P&&M!==P&&console.log("警告: 文件大小不匹配 (可能压缩传输)");const p=new Uint8Array(M);let y=0;for(const B of b)p.set(B,y),y+=B.length;if(l(90),Ie){console.log("本地数据已加载，跳过网络数据"),o(!1);return}console.log("开始解析 Shapefile...");const h=await Fe(p);console.log("Shapefile 解析完成:",h);let d=[];if(h.type==="FeatureCollection"?d=h.features:Array.isArray(h)?d=h:h.type==="Feature"&&(d=[h]),console.log("解析完成，特征数量:",d==null?void 0:d.length),Ie)return;const S={type:"FeatureCollection",features:d||[]};w(S),l(100);const I=new Map;S.features.forEach(B=>{var ee;const E=Number(((ee=B.properties)==null?void 0:ee.Place)??0);I.has(E)||I.set(E,{id:E,name:`Place ${E}`,featureCount:0});const $=I.get(E);$&&$.featureCount++}),T(Array.from(I.values()).sort((B,E)=>B.id-E.id)),o(!1)}catch(k){if(k.name==="AbortError"){console.log("网络请求已取消");return}r(k instanceof Error?k.message:"Failed to load"),o(!1)}})()},[]),i.useEffect(()=>{t&&F(Je(t,c))},[t,L,c,Q,Le]),i.useEffect(()=>{if(!t)return;const a=s.current;if(!a)return;const g=()=>{var v,P,A,M;if(t.features.forEach((b,p)=>{b.id===void 0&&(b.id=p)}),a.getSource("cluster"))a.getSource("cluster").setData(t);else{console.log("初始化 cluster 数据源..."),a.addSource("cluster",{type:"geojson",data:t,generateId:!0}),a.addLayer({id:"cluster-fill",type:"fill",source:"cluster",layout:{},paint:{"fill-opacity":.7}}),a.addLayer({id:"cluster-line",type:"line",source:"cluster",layout:{},paint:{"line-color":"#7e7f80ff","line-width":1}}),a.addLayer({id:"cluster-highlight",type:"line",source:"cluster",layout:{},paint:{"line-color":"#632ffdff","line-width":3,"line-opacity":["case",["boolean",["feature-state","selected"],!1],1,0]}}),a.on("click","cluster-fill",p=>{var y;if(p.features&&p.features.length>0){const h=p.features[0],d=h.id;je.current!==null&&je.current!==void 0&&a.setFeatureState({source:"cluster",id:je.current},{selected:!1}),d!==void 0?(a.setFeatureState({source:"cluster",id:d},{selected:!0}),je.current=d):je.current=null,O(h),se(!0),((y=h.properties)==null?void 0:y.Place)!==void 0&&G(Number(h.properties.Place))}}),a.on("mouseenter","cluster-fill",()=>{a.getCanvas().style.cursor="pointer"}),a.on("mouseleave","cluster-fill",()=>{a.getCanvas().style.cursor=""});const b=t.features;if(b.length>0)try{const p=new Ce.LngLatBounds,y=Math.max(1,Math.floor(b.length/2e3));for(let h=0;h<b.length;h+=y){const d=b[h];if(!((v=d.geometry)!=null&&v.coordinates))continue;const S=d.geometry.type,I=d.geometry.coordinates;S==="Point"?p.extend(I):S==="LineString"||S==="MultiPoint"?I.forEach(B=>p.extend(B)):S==="Polygon"||S==="MultiLineString"?(P=I[0])==null||P.forEach(B=>p.extend(B)):S==="MultiPolygon"&&((M=(A=I[0])==null?void 0:A[0])==null||M.forEach(B=>p.extend(B)))}p.isEmpty()||a.fitBounds(p,{padding:50,duration:1e3})}catch(p){console.error("Fit bounds error:",p)}}},k=()=>{var E;if(!a.getLayer("cluster-fill"))return;const v=null;a.setFilter("cluster-fill",v),a.setFilter("cluster-line",v),a.setFilter("cluster-highlight",v);const P=(()=>{var Ae;let $=1/0,ee=-1/0;for(const De of t.features){const te=Number((Ae=De.properties)==null?void 0:Ae[c]);Number.isNaN(te)||te===-9999||(te<$&&($=te),te>ee&&(ee=te))}return{min:$===1/0?0:$,max:ee===-1/0?0:ee}})(),A=L!==null&&D?{min:D.min,max:D.max}:P,M=Q==="city"?A:P,b=M.min,p=M.max;let y;if(c.includes("K_")){const $=Math.round(((E=Le[c])==null?void 0:E.max)??p),ee=Array.from({length:26},(ce,Pe)=>{const Z=Pe/25;let ie,le,oe;if(Z<.167){const q=Z/.167;ie=0,le=0,oe=Math.round(139+116*q)}else if(Z<.333){const q=(Z-.167)/.167;ie=0,le=Math.round(255*q),oe=255}else if(Z<.5){const q=(Z-.333)/.167;ie=0,le=Math.round(255-128*q),oe=Math.round(255-255*q)}else if(Z<.667){const q=(Z-.5)/.167;ie=Math.round(255*q),le=255,oe=0}else if(Z<.833){const q=(Z-.667)/.167;ie=255,le=Math.round(255-128*q),oe=0}else{const q=(Z-.833)/.167;ie=255,le=Math.round(127-127*q),oe=0}return`#${ie.toString(16).padStart(2,"0")}${le.toString(16).padStart(2,"0")}${oe.toString(16).padStart(2,"0")}`}),De=Array.from({length:$+1},(ce,Pe)=>ee[Math.round(Pe*25/$)]).slice(0,$+1),te=["interpolate",["linear"],["get",c]];for(let ce=0;ce<=$;ce++)te.push(ce,De[ce]);y=te}else c==="CoverRatio"||c==="ISF"||c==="GreenRatio"?y=["interpolate",["linear"],["get",c],b,"#3182bd",p,"#e6550d"]:c.includes("elev")||c.includes("slope")?y=["interpolate",["linear"],["get",c],b,"#31a354",p,"#756bb1"]:y=["interpolate",["linear"],["get",c],b,"#31a354",p,"#756bb1"];a.setPaintProperty("cluster-fill","fill-color",y);const h=L!==null,d=Number(L),B=["case",["any",["==",["get",c],-9999],["==",["get",c],null]],0,h?["case",["==",["to-number",["get","Place"]],d],.8,.15]:.7];a.setPaintProperty("cluster-fill","fill-opacity",B)};a.isStyleLoaded()?(g(),k()):a.once("load",()=>{g(),k()})},[t,L,c]),i.useEffect(()=>{var k,v,P,A;if(!t||L===null)return;const a=s.current;if(!a)return;const g=t.features.filter(M=>{var p;const b=(p=M.properties)==null?void 0:p.Place;return b!==void 0&&Number(b)===Number(L)});if(g.length!==0)try{const M=new Ce.LngLatBounds;let b=0;const p=Math.max(1,Math.floor(g.length/2e3));for(let y=0;y<g.length;y+=p){const h=g[y];if(!((k=h.geometry)!=null&&k.coordinates))continue;const d=h.geometry.type,S=h.geometry.coordinates;d==="Point"?(M.extend(S),b++):d==="LineString"||d==="MultiPoint"?(S.forEach(I=>M.extend(I)),b++):d==="Polygon"||d==="MultiLineString"?((v=S[0])==null||v.forEach(I=>M.extend(I)),b++):d==="MultiPolygon"&&((A=(P=S[0])==null?void 0:P[0])==null||A.forEach(I=>M.extend(I)),b++)}!M.isEmpty()&&b>0&&a.fitBounds(M,{padding:50,duration:1e3})}catch(M){console.error("Fly to error:",M)}},[L]),i.useEffect(()=>((async()=>{(!u.current||s.current)&&console.log("开始初始化地图...");try{const g=new Ce.Map({container:u.current,style:{version:8,sources:{"osm-tiles":{type:"raster",tiles:["https://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png"],tileSize:256,attribution:'&copy; <a href="https://carto.com/">CARTO</a>'}},layers:[{id:"simple-tiles",type:"raster",source:"osm-tiles",minzoom:0,maxzoom:19}]},center:[4.75,45.75],zoom:10});g.addControl(new Ce.NavigationControl,"top-right"),g.on("load",()=>{console.log("地图样式加载完成")}),g.on("error",k=>{var A;const v=String(((A=k==null?void 0:k.error)==null?void 0:A.message)||(k==null?void 0:k.message)||"");v.includes("ERR_ABORTED")||v.includes("AbortError")||v.includes("Canceled")||v.includes("cancelled")||console.error("地图错误:",k)}),s.current=g,console.log("地图初始化完成")}catch(g){console.error("地图初始化错误:",g)}})(),()=>{s.current&&(s.current.remove(),s.current=null,Ye.current=!1)}),[]),i.useEffect(()=>{const a=s.current;if(!a)return;const g=()=>{a.getLayer("simple-tiles")&&a.setLayoutProperty("simple-tiles","visibility",ye?"visible":"none")};a.isStyleLoaded()?g():a.once("style.load",g)},[ye]);const et=async a=>{var k;const g=(k=a.target.files)==null?void 0:k[0];if(g){Me.current&&Me.current.abort(),re(!0),ve(0),de("正在读取文件..."),r(null),f(!0),Y(URL.createObjectURL(g));try{console.log("开始读取文件:",g.name,"大小:",g.size);let v=[];const P=g.name.endsWith(".zip"),A=g.name.endsWith(".shp");if(!P&&!A){r("请上传 .zip 文件 (包含 Shapefile)"),re(!1);return}de("正在读取文件...");const M=await g.arrayBuffer();ve(30),de("正在解析 Shapefile...");const b=await Fe(M);console.log("Shapefile 解析完成:",b),b.type==="FeatureCollection"?v=b.features:Array.isArray(b)?v=b:b.type==="Feature"&&(v=[b]),console.log("解析到的 features 数量:",v.length),ve(95),de(`已解析 ${v.length} 个 Features...`);const p={type:"FeatureCollection",features:v};ve(98),de("正在处理 Place 数据...");const y=new Map;p.features.forEach(h=>{var I;const d=Number(((I=h.properties)==null?void 0:I.Place)??0);y.has(d)||y.set(d,{id:d,name:`Place ${d}`,featureCount:0});const S=y.get(d);S&&S.featureCount++}),ve(100),de("加载完成!"),setTimeout(()=>{Ke(!0),w(p),T(Array.from(y.values()).sort((h,d)=>h.id-d.id)),re(!1),f(!1),o(!1)},500)}catch(v){const P=v instanceof Error?v.message:"未知错误";r(`加载失败: ${P}`),re(!1),o(!1)}}},tt=he.reduce((a,g)=>(a[g.category]||(a[g.category]=[]),a[g.category].push(g),a),{});return e.jsxs("div",{className:"relative w-full h-full bg-gray-100",children:[ae&&e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-8 w-80 text-center",children:[e.jsxs("div",{className:"relative w-20 h-20 mx-auto mb-4",children:[e.jsx("div",{className:"absolute inset-0 border-4 border-gray-100 rounded-full"}),e.jsx("div",{className:"absolute inset-0 border-4 border-purple-600 rounded-full border-t-transparent animate-spin"}),e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx(Be,{className:"text-purple-600",size:24})})]}),e.jsx("p",{className:"text-gray-800 font-medium mb-3",children:qe}),e.jsx("div",{className:"w-full bg-gray-100 rounded-full h-3 mb-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-purple-500 to-purple-600 transition-all duration-300",style:{width:`${Ne}%`}})}),e.jsxs("p",{className:"text-sm text-gray-400",children:[Ne,"%"]})]})}),C&&!ae?e.jsx("div",{className:"absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(ut,{className:"animate-spin h-12 w-12 text-purple-600 mx-auto mb-4"}),e.jsx("p",{className:"text-gray-600",children:"正在加载 Shapefile..."}),e.jsx("div",{className:"w-48 h-2 bg-gray-200 rounded-full mx-auto mt-3 overflow-hidden",children:e.jsx("div",{className:"h-full bg-purple-600 transition-all duration-300",style:{width:`${m}%`}})}),e.jsxs("p",{className:"text-xs text-gray-400 mt-2",children:[m,"%"]}),e.jsxs("div",{className:"flex gap-2 mt-4 justify-center",children:[e.jsxs("a",{href:He,download:"223_cities_cluster_with_index.zip",className:"inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:[e.jsx(mt,{size:14}),"下载本地"]}),e.jsxs("button",{onClick:()=>{var a;return(a=Re.current)==null?void 0:a.click()},className:"inline-flex items-center gap-2 px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-600 rounded-lg text-sm transition-colors",title:"支持 .zip (Shapefile)",children:[e.jsx(Be,{size:14}),"加载 Shapefile"]})]}),e.jsx("p",{className:"text-xs text-gray-400 mt-2",children:"支持 .zip (Shapefile)"}),e.jsx("input",{ref:Re,type:"file",accept:".shp,.zip",onChange:et,className:"hidden"})]})}):null,n&&e.jsxs("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-red-50 border border-red-200 rounded-xl px-6 py-5 shadow-lg",children:[e.jsx("p",{className:"text-red-600 font-medium",children:"加载失败"}),e.jsx("p",{className:"text-red-400 text-sm mt-1 mb-4",children:n}),e.jsx("div",{className:"flex gap-2",children:e.jsxs("button",{onClick:()=>window.location.reload(),className:"inline-flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-sm transition-colors",children:[e.jsx(ht,{size:14}),"刷新重试"]})})]}),_&&e.jsxs("div",{className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-72",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("h2",{className:"font-bold text-gray-800 flex items-center gap-2",children:[e.jsx(gt,{size:18}),"Cluster Map"]}),e.jsx("button",{onClick:()=>U(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(pt,{size:18})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("span",{className:"text-sm text-gray-600",children:"显示地图底图"}),e.jsx("button",{onClick:()=>Xe(!ye),className:`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${ye?"bg-purple-600":"bg-gray-300"}`,children:e.jsx("span",{className:`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${ye?"translate-x-6":"translate-x-1"}`})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Place (Count)"}),e.jsxs("select",{value:L??"",onChange:a=>G(a.target.value?Number(a.target.value):null),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:[e.jsxs("option",{value:"",children:["All Places (",((ze=t==null?void 0:t.features)==null?void 0:ze.length)??0,")"]}),x.map(a=>e.jsxs("option",{value:a.id,children:[a.name," (",a.featureCount,")"]},a.id))]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs font-medium text-gray-500 block mb-1",children:"Attribute"}),e.jsx("select",{value:c,onChange:a=>R(a.target.value),className:"w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white",children:Object.entries(tt).map(([a,g])=>[e.jsx("optgroup",{label:a.charAt(0).toUpperCase()+a.slice(1),children:g.map(k=>e.jsx("option",{value:k.key,children:k.label},k.key))},a)])})]}),D&&e.jsxs("div",{className:"bg-gray-50 rounded-lg p-3 space-y-1",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(xt,{size:14,className:"text-purple-500"}),e.jsx("span",{className:"text-xs font-medium text-gray-500",children:"Statistics"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-xs",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Count:"})," ",e.jsx("span",{className:"font-medium",children:D.count})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Min:"})," ",e.jsx("span",{className:"font-medium",children:D.min.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Max:"})," ",e.jsx("span",{className:"font-medium",children:D.max.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"Mean:"})," ",e.jsx("span",{className:"font-medium",children:D.mean.toFixed(2)})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-gray-400",children:"NaN:"})," ",e.jsx("span",{className:"font-medium",children:D.nanCount})]})]})]})]})]}),!_&&e.jsx("button",{onClick:()=>U(!0),className:"absolute top-4 left-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(ft,{size:18})}),K&&N&&e.jsxs("div",{className:"absolute top-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-80 max-h-96 overflow-y-auto",children:[e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-xs font-medium text-gray-400 uppercase tracking-wider mb-1",children:"Feature Details"}),e.jsxs("div",{className:"mb-3",children:[N.properties.Place&&e.jsxs("div",{className:"text-lg font-semibold text-purple-600",children:["Place: ",N.properties.Place]}),N.properties["City Name"]&&e.jsxs("div",{className:"text-sm font-medium text-gray-700",children:["City: ",N.properties["City Name"]]}),e.jsxs("div",{className:"text-sm font-medium text-gray-500",children:["Place ID: ",N.properties["Place ID"]??"N/A"]})]})]}),e.jsx("button",{onClick:()=>se(!1),className:"p-1 hover:bg-gray-100 rounded-full transition-colors",children:e.jsx(Ge,{size:20,className:"text-gray-400"})})]}),e.jsx("div",{className:"space-y-2",children:he.map(a=>{var k;const g=(k=N.properties)==null?void 0:k[a.key];return g==null?null:e.jsxs("button",{onClick:()=>R(a.key),className:`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${c===a.key?"bg-purple-100 text-purple-700":"bg-gray-50 text-gray-600 hover:bg-gray-100"}`,children:[e.jsx("span",{children:a.label}),e.jsx("span",{className:"font-mono font-medium",children:typeof g=="number"?g.toFixed(2):g})]},a.key)})}),e.jsx("div",{className:"mt-3 pt-3 border-t border-gray-200",children:e.jsx("button",{onClick:()=>G(null),className:"w-full px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-sm transition-colors",children:"显示全部区域"})})]}),e.jsx("div",{ref:u,className:"w-full h-full"}),_e&&t&&e.jsxs("div",{className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md rounded-xl shadow-lg p-4 w-64",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("h3",{className:"font-semibold text-gray-800 flex items-center gap-2",children:[e.jsx(Ue,{size:16}),"Legend"]}),e.jsx("button",{onClick:()=>Te(!1),className:"text-gray-400 hover:text-gray-600",children:e.jsx(Ge,{size:16})})]}),e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"颜色映射"}),e.jsx("button",{onClick:()=>Ze(Q==="global"?"city":"global"),className:`text-xs px-2 py-1 rounded ${Q==="global"?"bg-gray-200 text-gray-700":"bg-purple-100 text-purple-700"}`,children:Q==="global"?"全局":"城市"})]}),e.jsx("div",{className:"space-y-3",children:c.includes("K_")?(()=>{var v,P;const a=Math.round(((v=Le[c])==null?void 0:v.max)??30),g=Array.from({length:26},(A,M)=>{const b=M/25;let p,y,h;if(b<.167){const d=b/.167;p=0,y=0,h=Math.round(139+116*d)}else if(b<.333){const d=(b-.167)/.167;p=0,y=Math.round(255*d),h=255}else if(b<.5){const d=(b-.333)/.167;p=0,y=Math.round(255-128*d),h=Math.round(255-255*d)}else if(b<.667){const d=(b-.5)/.167;p=Math.round(255*d),y=255,h=0}else if(b<.833){const d=(b-.667)/.167;p=255,y=Math.round(255-128*d),h=0}else{const d=(b-.833)/.167;p=255,y=Math.round(127-127*d),h=0}return`#${p.toString(16).padStart(2,"0")}${y.toString(16).padStart(2,"0")}${h.toString(16).padStart(2,"0")}`}),k=Array.from({length:a+1},(A,M)=>g[Math.round(M*25/a)]);return e.jsxs("div",{children:[e.jsx("div",{className:"text-xs text-gray-500 mb-2",children:((P=he.find(A=>A.key===c))==null?void 0:P.label)||c}),e.jsx("div",{className:"flex flex-wrap gap-px",children:k.map((A,M)=>e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("div",{className:"w-3 h-3 rounded-sm",style:{backgroundColor:A}}),e.jsx("span",{className:"text-[6px] text-gray-400",children:M})]},M))})]})})():c==="CoverRatio"||c==="ISF"||c==="GreenRatio"?(()=>{var h;const a=(()=>{var I;let d=1/0,S=-1/0;for(const B of t.features){const E=Number((I=B.properties)==null?void 0:I[c]);Number.isNaN(E)||E===-9999||(E<d&&(d=E),E>S&&(S=E))}return{min:d===1/0?0:d,max:S===-1/0?0:S}})(),g=L!==null&&D?{min:D.min,max:D.max}:a,k=((h=he.find(d=>d.key===c))==null?void 0:h.label)||c,v=a.max>a.min?Math.max(0,Math.min(1,(g.min-a.min)/(a.max-a.min))):0,P=a.max>a.min?Math.max(0,Math.min(1,(g.max-a.min)/(a.max-a.min))):0,A=Math.max(0,P-v),M=ue("#3182bd"),b=ue("#e6550d"),p=me(M,b,v),y=me(M,b,P);return e.jsxs("div",{children:[Q==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[k,"（城市区间）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,130,189,0.2), rgba(230,85,13,0.2))"},children:L!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${v*100}%`,width:`${A*100}%`,background:`linear-gradient(to right, ${p}, ${y})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:g.min.toFixed(2)}),e.jsx("span",{children:g.max.toFixed(2)})]})]}),Q==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[k,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #3182bd, #e6550d)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:a.min.toFixed(2)}),e.jsx("span",{children:a.max.toFixed(2)})]})]})]})})():c.includes("elev")||c.includes("slope")?(()=>{var h;const a=(()=>{var I;let d=1/0,S=-1/0;for(const B of t.features){const E=Number((I=B.properties)==null?void 0:I[c]);Number.isNaN(E)||E===-9999||(E<d&&(d=E),E>S&&(S=E))}return{min:d===1/0?0:d,max:S===-1/0?0:S}})(),g=L!==null&&D?{min:D.min,max:D.max}:a,k=((h=he.find(d=>d.key===c))==null?void 0:h.label)||c,v=a.max>a.min?Math.max(0,Math.min(1,(g.min-a.min)/(a.max-a.min))):0,P=a.max>a.min?Math.max(0,Math.min(1,(g.max-a.min)/(a.max-a.min))):0,A=Math.max(0,P-v),M=ue("#31a354"),b=ue("#756bb1"),p=me(M,b,v),y=me(M,b,P);return e.jsxs("div",{children:[Q==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[k,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:L!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${v*100}%`,width:`${A*100}%`,background:`linear-gradient(to right, ${p}, ${y})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:g.min.toFixed(1)}),e.jsxs("span",{children:[g.max.toFixed(0),"+"]})]})]}),Q==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[k,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:a.min.toFixed(1)}),e.jsxs("span",{children:[a.max.toFixed(0),"+"]})]})]})]})})():(()=>{var h;const a=(()=>{var I;let d=1/0,S=-1/0;for(const B of t.features){const E=Number((I=B.properties)==null?void 0:I[c]);Number.isNaN(E)||E===-9999||(E<d&&(d=E),E>S&&(S=E))}return{min:d===1/0?0:d,max:S===-1/0?0:S}})(),g=L!==null&&D?{min:D.min,max:D.max}:a,k=((h=he.find(d=>d.key===c))==null?void 0:h.label)||c,v=a.max>a.min?Math.max(0,Math.min(1,(g.min-a.min)/(a.max-a.min))):0,P=a.max>a.min?Math.max(0,Math.min(1,(g.max-a.min)/(a.max-a.min))):0,A=Math.max(0,P-v),M=ue("#31a354"),b=ue("#756bb1"),p=me(M,b,v),y=me(M,b,P);return e.jsxs("div",{children:[Q==="city"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-2",children:[k,"（城市区间，映射到全局色带）"]}),e.jsx("div",{className:"relative h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, rgba(49,163,84,0.2), rgba(117,107,177,0.2))"},children:L!==null&&e.jsx("div",{className:"absolute top-0 h-3 rounded ring-1 ring-black/20",style:{left:`${v*100}%`,width:`${A*100}%`,background:`linear-gradient(to right, ${p}, ${y})`}})}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:g.min.toFixed(2)}),e.jsx("span",{children:g.max.toFixed(2)})]})]}),Q==="global"&&e.jsxs("div",{className:"mt-2",children:[e.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:[k,"（全局）"]}),e.jsx("div",{className:"h-3 rounded overflow-hidden",style:{background:"linear-gradient(to right, #31a354, #756bb1)"}}),e.jsxs("div",{className:"flex justify-between text-xs text-gray-500 mt-1",children:[e.jsx("span",{children:a.min.toFixed(2)}),e.jsx("span",{children:a.max.toFixed(2)})]})]})]})})()})]}),!_e&&e.jsx("button",{onClick:()=>Te(!0),className:"absolute bottom-4 right-4 z-40 bg-white/95 backdrop-blur-md p-2 rounded-xl shadow-lg hover:bg-white transition-colors",children:e.jsx(Ue,{size:18})})]})},bn=()=>{const[u,s]=i.useState(!1),[C,o]=i.useState(!1),[m,l]=i.useState({x:0,y:0}),[n,r]=i.useState("/data/fig/lili/lili_01.png"),[t,w]=i.useState("Exploring the intersection of technology and creativity."),x=at(),T=rt(),G=x.pathname.split("/").filter(Boolean)[0]||"",c={design:"/data/fig/lili/lili_05.png",game:"/data/fig/lili/lili_03.png",platform:"/data/fig/lili/lili_11.png",tutorial:"/data/fig/lili/lili_04.png",about:"/data/fig/lili/lili_02.png",planning:"/data/fig/lili/lili_06.png"},R=["/data/fig/lili/lili_01.png","/data/fig/lili/lili_07.png","/data/fig/lili/lili_08.png","/data/fig/lili/lili_09.png","/data/fig/lili/lili_10.png","/data/fig/lili/lili_12.png"],_=["Exploring the intersection of technology and creativity.","Turning data into meaningful visual stories.","Building digital experiences that inspire.","Bridging the gap between design and development.","Creating solutions that matter in the real world.","Passionate about geospatial technology and urban planning."],U=()=>{const F=Math.floor(Math.random()*R.length);return R[F]},D=()=>{const F=Math.floor(Math.random()*_.length);return _[F]};return i.useEffect(()=>{G===""?r(U()):c[G]?r(c[G]):r(U()),w(D())},[G]),e.jsx("div",{className:"h-screen p-0 bg-neutral-100 dark:bg-neutral-900 flex flex-col",children:e.jsxs("div",{className:"w-full flex flex-col relative h-full",children:[e.jsxs("header",{className:"border-b border-neutral-200 dark:border-neutral-800 p-4 flex justify-between items-center bg-white dark:bg-neutral-900 z-30 shrink-0 relative",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("button",{onClick:()=>s(!u),className:"relative w-8 h-8 flex items-center justify-center border border-neutral-200 dark:border-neutral-700 text-[0px] text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100","aria-label":u?"Hide profile panel":"Show profile panel",title:u?"Hide profile panel":"Show profile panel",children:[e.jsxs("span",{className:"absolute inset-0 flex flex-col items-center justify-center gap-1",children:[e.jsx("span",{className:"block w-3.5 h-px bg-neutral-500 dark:bg-neutral-400"}),e.jsx("span",{className:"block w-3.5 h-px bg-neutral-500 dark:bg-neutral-400"}),e.jsx("span",{className:"block w-3.5 h-px bg-neutral-500 dark:bg-neutral-400"})]}),"☰"]}),e.jsxs("h1",{className:"text-xl md:text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100",children:["Lili Lin ",e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600 font-light mx-2",children:"/"})," ",e.jsx("span",{className:"text-sm font-mono font-normal text-neutral-500 dark:text-neutral-400",children:"PORTFOLIO"})]})]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("nav",{className:"hidden sm:flex gap-0",children:[e.jsx(J,{to:"/",onClick:()=>{window.innerWidth<768&&s(!1)},className:`px-4 py-3 text font-medium border-b-4 transition-all ${G===""?"border-neutral-900 dark:border-neutral-100 text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-950":"border-transparent text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"}`,children:e.jsx("span",{children:"Home"})}),[{key:"design",label:"Design",short:"Design"},{key:"planning",label:"Planning",short:"Planning"},{key:"game",label:"Game",short:"G"},{key:"platform",label:"Platform",short:"P"},{key:"tutorial",label:"Tutorial",short:"T"},{key:"about",label:"About",short:"A"}].map(F=>e.jsx(J,{to:`/${F.key}`,onClick:()=>{window.innerWidth<768&&s(!1)},className:`px-4 py-3 text font-medium border-b-4 transition-all ${G===F.key?"border-neutral-900 dark:border-neutral-100 text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-950":"border-transparent text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"}`,children:e.jsx("span",{children:F.label})},F.key))]}),e.jsxs("nav",{className:"sm:hidden flex gap-0",children:[e.jsx(J,{to:"/",onClick:()=>{window.innerWidth<768&&s(!1)},className:`px-3 py-2 text-sm font-medium border-b-4 transition-all ${G===""?"border-neutral-900 dark:border-neutral-100 text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-950":"border-transparent text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"}`,children:e.jsx("span",{children:"Home"})}),[{key:"design",label:"Design"},{key:"planning",label:"Planning"},{key:"game",label:"Game"},{key:"platform",label:"Platform"},{key:"tutorial",label:"Tutorial"},{key:"about",label:"About"}].map(F=>e.jsx(J,{to:`/${F.key}`,onClick:()=>{window.innerWidth<768&&s(!1)},className:`px-3 py-2 text-sm font-medium border-b-4 transition-all ${G===F.key?"border-neutral-900 dark:border-neutral-100 text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-950":"border-transparent text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"}`,children:e.jsx("span",{children:F.label})},F.key))]}),e.jsx(pn,{}),e.jsxs("button",{onClick:()=>{o(!0);const F=m.x+360*2+Math.random()*360,ne=m.y+360*2+Math.random()*360;l({x:F,y:ne}),setTimeout(()=>{const Y=["planning","design","game","platform","tutorial","about"],j=Y[Math.floor(Math.random()*Y.length)];T(`/${j}`),o(!1)},1e3)},className:"flex items-center gap-2 px-3 py-2 border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all",title:"🎲 Explore a random project",children:[e.jsx("div",{className:"w-5 h-5",style:{perspective:"100px"},children:e.jsxs("div",{className:"w-full h-full relative transition-transform duration-1000 ease-out",style:{transform:`rotateX(${m.x}deg) rotateY(${m.y}deg)`,transformStyle:"preserve-3d"},children:[e.jsx("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"translateZ(10px)"},children:e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"5px",height:"5px",backgroundColor:"#dc2626"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]})}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateY(180deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-3  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-3  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-3  w-full h-full justify-center"})]}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateY(-90deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-5 marg w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-5  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-5  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"})]}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateY(90deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-1  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-1  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{}),e.jsx("div",{className:" rounded-full justify-center",style:{width:"4px",height:"4px",backgroundColor:"#dc2626"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-1  w-full h-full justify-center"})]}),e.jsx("div",{className:"absolute w-full h-full bg-white border-gray-400  justify-center rounded flex  p-0.5",style:{transform:"rotateX(90deg) translateZ(10px)"},children:e.jsxs("div",{className:"grid grid-cols-3 border w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]})}),e.jsxs("div",{className:"absolute w-full h-full bg-white border border-gray-400 rounded flex items-center justify-center",style:{transform:"rotateX(-90deg) translateZ(10px)"},children:[e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{children:e.jsx("div",{})}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsxs("div",{className:"grid grid-cols-3  w-full h-full justify-center",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{children:e.jsx("div",{})}),e.jsx("div",{className:"bg-gray-800 rounded-full justify-center",style:{width:"4px",height:"4px"}}),e.jsx("div",{})]}),e.jsx("div",{className:"grid grid-cols-5  w-full h-full justify-center"})]})]})}),e.jsx("span",{className:"text-sm font-medium",children:"Jump"})]})]})]}),e.jsxs("main",{className:"flex flex-row flex-1 overflow-hidden relative",children:[u&&e.jsx("aside",{className:"md:hidden border-r border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 w-64 pt-2 px-4 pb-4 flex-shrink-0 overflow-y-auto h-full z-20",children:e.jsxs("div",{className:"flex flex-col gap-6 w-full mt-4",children:[n&&e.jsx("div",{className:"w-full flex justify-center py-4",children:e.jsx("img",{src:n,alt:"Lili's avatar",className:"w-40 h-auto object-contain rounded-lg border border-neutral-100 dark:border-neutral-800 shadow-sm",style:{display:"block",maxWidth:"100%"}})}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("h3",{className:"text-sm font-mono text-neutral-500 dark:text-neutral-400 mb-2",children:"Lili Lin"}),e.jsx("h3",{className:"text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-2",children:"林丽丽"}),e.jsx("p",{className:"text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed",children:"Designer | Developer | Product Maker"}),e.jsx("p",{className:"text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed",children:"Passionate about creating meaningful digital experiences that bridge technology and creativity."})]}),e.jsxs("div",{className:"pt-6 border-t border-neutral-100 dark:border-neutral-800 text-center gap-4",children:[e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 italic mb-3",children:['"',t,'"']}),e.jsxs("div",{className:"flex items-center justify-center gap-2 text-xs",children:[e.jsx("a",{href:"https://github.com/lililin0324",className:"flex items-center gap-1 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"GitHub",children:e.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})})}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("a",{href:"mailto:lili0324@snu.ac.kr",className:"flex items-center gap-1 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"Email",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})})}),e.jsx("span",{className:"text-neutral-300 dark:text-neutral-600",children:"|"}),e.jsx("a",{href:"https://www.linkedin.com/in/lililin0324",className:"flex items-center gap-1 text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors",title:"LinkedIn",children:e.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"})})})]})]})]})]})}),u&&e.jsx("aside",{className:"hidden md:flex border-r border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex-col w-64 p-4 overflow-y-auto h-full z-10 shrink-0",children:e.jsxs("div",{className:"flex flex-col gap-6 w-full mt-4 black",children:[n&&e.jsx("div",{className:"w-full flex justify-center py-4",children:e.jsx("img",{src:n,alt:"Lili's avatar",className:"w-40 h-auto object-contain rounded-lg border border-neutral-100 dark:border-neutral-800 shadow-sm",style:{display:"block",maxWidth:"100%"}})}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(Ee,{href:"https://github.com/lililin0324",label:"GH"}),e.jsx(Ee,{href:"mailto:lili0324@snu.ac.kr",label:"EM"}),e.jsx(Ee,{href:"https://www.linkedin.com/in/lililin0324",label:"LK"})]}),e.jsxs("div",{className:"mt-4 space-y-3",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("h3",{className:"text-sm font-mono text-neutral-500 dark:text-neutral-400 mb-2",children:"ABOUT"}),e.jsx("p",{className:"text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed",children:"I'm Lili, a designer and developer passionate about creating meaningful digital experiences that bridge technology and creativity."})]}),e.jsx("div",{className:"pt-3 border-t border-neutral-100 dark:border-neutral-800 text-center",children:e.jsxs("p",{className:"text-xs text-neutral-500 dark:text-neutral-400 italic",children:['"',t,'"']})})]})]})}),e.jsx("section",{className:"flex-1 relative w-full h-[calc(100vh-4rem)] overflow-y-auto",children:e.jsxs(st,{children:[e.jsx(W,{path:"/",element:e.jsx(gn,{})}),e.jsx(W,{path:"/planning",element:e.jsx(we,{data:ge,type:"planning"})}),e.jsx(W,{path:"/planning/:id",element:e.jsx(ke,{data:ge,type:"planning"})}),e.jsx(W,{path:"/design",element:e.jsx(we,{data:pe,type:"design"})}),e.jsx(W,{path:"/design/:id",element:e.jsx(ke,{data:pe,type:"design"})}),e.jsx(W,{path:"/game",element:e.jsx(we,{data:xe,type:"game"})}),e.jsx(W,{path:"/game/:id",element:e.jsx(ke,{data:xe,type:"game"})}),e.jsx(W,{path:"/platform",element:e.jsx(we,{data:fe,type:"platform"})}),e.jsx(W,{path:"/platform/:id",element:e.jsx(ke,{data:fe,type:"platform"})}),e.jsx(W,{path:"/tutorial",element:e.jsx(we,{data:be,type:"tutorial"})}),e.jsx(W,{path:"/tutorial/:id",element:e.jsx(ke,{data:be,type:"tutorial"})}),e.jsx(W,{path:"/clusteringeomap",element:e.jsx(fn,{})}),e.jsx(W,{path:"/about",element:e.jsx(mn,{})}),e.jsx(W,{path:"/contact",element:e.jsx(hn,{})})]})})]})]})})};function vn(){const[u,s]=i.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(it,{children:e.jsx(bn,{})}),!u&&e.jsx(bt,{onFinish:()=>s(!0)})]})}lt.createRoot(document.getElementById("root")).render(e.jsx(vn,{}));
