        ...
        <header className="border-b border-neutral-200 dark:border-neutral-800 p-4 flex justify-between items-center bg-white dark:bg-neutral-900 z-30 shrink-0 relative">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="sm:hidden relative">
              ...
              {isMobileNavOpen && (
                <div className="absolute right-0 top-10 bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-lg z-50 min-w-[160px]">
                  <Link
                    to="/"
                    onClick={() => {
                    ...
                    className={`block px-4 py-3 text-sm font-medium transition-all ${activeTab === '' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-600 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800'}`}
                  >
                    Home
                  </Link>
                  {[
                    ...
                    <Link
                      ...
                      className={`block px-4 py-3 text-sm font-medium transition-all ${activeTab === tab.key ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-600 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800'}`}
                    >
                      {tab.label}
                    </Link>
                  ))}
